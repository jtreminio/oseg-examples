...
class ExtendedContact(BaseModel):
    ...
    ExtendedContact
    """ # noqa: E501
    payload: Optional[ContactPayload] = None
    id: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Id of the user")
    availability_status: Optional[StrictStr] = Field(default=None, description="Availability status of the user")
    __properties: ClassVar[List[str]] = ["payload", "id", "availability_status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "payload": ContactPayload.from_dict(obj["payload"]) if obj.get("payload") is not None else None,
            "id": obj.get("id"),
