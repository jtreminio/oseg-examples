...
class Article(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "content", "meta", "position", "status", "title", "slug", "views", "portal_id", "account_id", "author_id", "category_id", "folder_id", "associated_article_id"]
