...
class ConversationStatusTogglePayload(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["success", "current_status", "conversation_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConversationStatusTogglePayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConversationStatusTogglePayload from a dict"""
        if obj is None:
            return None
