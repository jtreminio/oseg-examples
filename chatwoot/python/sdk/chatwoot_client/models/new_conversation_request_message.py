...
class NewConversationRequestMessage(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["content", "template_params"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NewConversationRequestMessage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NewConversationRequestMessage from a dict"""
        if obj is None:
            return None
