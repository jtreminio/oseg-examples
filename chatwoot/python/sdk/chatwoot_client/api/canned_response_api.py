...
class CannedResponseApi:
    ...
    @validate_call
    def update_canned_response_in_account(
        self,
        account_id: Annotated[StrictInt, Field(description="The numeric ID of the account")],
        id: Annotated[StrictInt, Field(description="The ID of the canned response to be updated.")],
        ...
        :type account_id: int
        :param id: The ID of the canned response to be updated. (required)
        :type id: int
        :param data: (required)
        ...
        _param = self._update_canned_response_in_account_serialize(
    ...
    @validate_call
    def update_canned_response_in_account_with_http_info(
        self,
        account_id: Annotated[StrictInt, Field(description="The numeric ID of the account")],
        id: Annotated[StrictInt, Field(description="The ID of the canned response to be updated.")],
        data: CannedResponseCreateUpdatePayload,
    ...
    @validate_call
    def update_canned_response_in_account_without_preload_content(
        self,
        account_id: Annotated[StrictInt, Field(description="The numeric ID of the account")],
        id: Annotated[StrictInt, Field(description="The ID of the canned response to be updated.")],
        data: CannedResponseCreateUpdatePayload,
    ...
    def _update_canned_response_in_account_serialize(
        self,
        account_id,
        id,
        data,
