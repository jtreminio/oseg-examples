...
class AccountsApi:
    ...
    def create_an_account(
        ...
        :param data: (required)
        :type data: AccountCreateUpdatePayload
        ...
        _param = self._create_an_account_serialize(
            data=data,
    ...
    @validate_call
    def create_an_account_with_http_info(
        self,
        data: AccountCreateUpdatePayload,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def create_an_account_without_preload_content(
        self,
        data: AccountCreateUpdatePayload,
        _request_timeout: Union[
            None,
    ...
    def _create_an_account_serialize(
        self,
        data,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/platform/api/v1/accounts',
    ...
    def delete_an_account(
        ...
        _param = self._delete_an_account_serialize(
    ...
    @validate_call
    def delete_an_account_with_http_info(
        self,
        account_id: Annotated[StrictInt, Field(description="The numeric ID of the account")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_an_account_without_preload_content(
        self,
        account_id: Annotated[StrictInt, Field(description="The numeric ID of the account")],
        _request_timeout: Union[
            None,
    ...
    def _delete_an_account_serialize(
        self,
        account_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/platform/api/v1/accounts/{account_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_details_of_an_account(
        ...
        _param = self._get_details_of_an_account_serialize(
            account_id=account_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_details_of_an_account_with_http_info(
        self,
        account_id: Annotated[StrictInt, Field(description="The numeric ID of the account")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_details_of_an_account_without_preload_content(
        self,
        account_id: Annotated[StrictInt, Field(description="The numeric ID of the account")],
        _request_timeout: Union[
            None,
    ...
    def _get_details_of_an_account_serialize(
        self,
        account_id,
        _request_auth,
        _content_type,
