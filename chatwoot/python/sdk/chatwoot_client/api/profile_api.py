...
class ProfileApi:
    ...
    def fetch_profile(
        ...
        _param = self._fetch_profile_serialize(
    ...
    @validate_call
    def fetch_profile_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def fetch_profile_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
