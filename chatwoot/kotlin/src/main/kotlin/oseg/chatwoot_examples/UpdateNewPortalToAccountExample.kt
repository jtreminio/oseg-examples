...
class UpdateNewPortalToAccountExample
{
    fun updateNewPortalToAccount()
    {
        ...
        try
        {
            ...
            println("4xx response calling HelpCenterApi#updateNewPortalToAccount")
            e.printStackTrace()
        } catch (e: ServerException) {
            println("5xx response calling HelpCenterApi#updateNewPortalToAccount")
            e.printStackTrace()
        }
    }
}
