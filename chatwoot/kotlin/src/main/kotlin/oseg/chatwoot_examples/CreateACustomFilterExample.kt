...
class CreateACustomFilterExample
{
    fun createACustomFilter()
    {
        ...
        try
        {
            ...
            println("4xx response calling CustomFiltersApi#createACustomFilter")
            e.printStackTrace()
        } catch (e: ServerException) {
            println("5xx response calling CustomFiltersApi#createACustomFilter")
            e.printStackTrace()
        }
    }
}
