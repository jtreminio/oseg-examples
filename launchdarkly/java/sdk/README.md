...
<dependency>
  ...
  <artifactId>launchdarkly-java-client</artifactId>
  <version>2.0</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'launchdarkly-java-client' jar has been published to maven central.
    mavenLocal()       // Needed if the 'launchdarkly-java-client' jar has been published to the local maven repo.
  }

  dependencies {
     implementation "org.openapitools:launchdarkly-java-client:2.0"
  }
```
...
* `target/launchdarkly-java-client-2.0.jar`
* `target/lib/*.jar`
...
import com.launchdarkly.client.api.AccessTokensApi;
