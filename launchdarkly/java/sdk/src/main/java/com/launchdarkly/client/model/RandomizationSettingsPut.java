...
import com.launchdarkly.client.model.RandomizationUnitInput;
...
public class RandomizationSettingsPut {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(randomizationUnits);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RandomizationSettingsPut.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RandomizationSettingsPut` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
