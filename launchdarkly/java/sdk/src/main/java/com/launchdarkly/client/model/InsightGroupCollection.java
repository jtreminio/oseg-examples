...
import com.launchdarkly.client.model.InsightGroupCollectionMetadata;
import com.launchdarkly.client.model.InsightGroupCollectionScoreMetadata;
...
public class InsightGroupCollection {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(totalCount, items, links, metadata, scoreMetadata);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InsightGroupCollection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InsightGroupCollection` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
