...
import com.launchdarkly.client.model.AiConfigsAccessAllowedRep;
import com.launchdarkly.client.model.AiConfigsAccessDenied;
...
public class AiConfigsAccess {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(denied, allowed);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AiConfigsAccess.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AiConfigsAccess` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
