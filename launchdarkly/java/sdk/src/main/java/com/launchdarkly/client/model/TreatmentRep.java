...
import com.launchdarkly.client.model.ParameterRep;
...
public class TreatmentRep {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TreatmentRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TreatmentRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
