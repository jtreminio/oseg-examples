...
public class NamingConvention {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(_case, prefix);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NamingConvention.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NamingConvention` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
