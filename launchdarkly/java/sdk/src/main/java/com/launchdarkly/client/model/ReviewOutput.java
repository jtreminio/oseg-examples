...
public class ReviewOutput {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, kind, creationDate, comment, memberId, serviceTokenId);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReviewOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReviewOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
