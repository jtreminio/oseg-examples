...
public class ContextAttributeName {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, weight, redacted);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContextAttributeName.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContextAttributeName` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
