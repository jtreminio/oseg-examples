...
public class FlagConfigMigrationSettingsRep {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(checkRatio);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FlagConfigMigrationSettingsRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FlagConfigMigrationSettingsRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
