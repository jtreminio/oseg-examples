...
public class DependentMetricGroupRep {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(key, name, kind, links);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DependentMetricGroupRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DependentMetricGroupRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
