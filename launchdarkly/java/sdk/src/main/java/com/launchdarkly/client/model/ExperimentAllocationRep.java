...
public class ExperimentAllocationRep {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(defaultVariation, canReshuffle);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExperimentAllocationRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExperimentAllocationRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
