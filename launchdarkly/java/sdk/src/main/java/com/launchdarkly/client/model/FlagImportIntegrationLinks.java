...
public class FlagImportIntegrationLinks {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(self, parent, project);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FlagImportIntegrationLinks.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FlagImportIntegrationLinks` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
