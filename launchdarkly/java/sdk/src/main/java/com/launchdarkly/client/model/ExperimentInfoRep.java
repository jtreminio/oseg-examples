...
import com.launchdarkly.client.model.LegacyExperimentRep;
...
public class ExperimentInfoRep {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(baselineIdx, items);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExperimentInfoRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExperimentInfoRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
