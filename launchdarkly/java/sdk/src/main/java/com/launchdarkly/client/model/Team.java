...
import com.launchdarkly.client.model.TeamMembers;
import com.launchdarkly.client.model.TeamProjects;
...
public class Team {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, key, name, access, creationDate, links, lastModified, version, idpSynced, roleAttributes, roles, members, projects, maintainers);
  }
