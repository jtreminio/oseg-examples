...
import com.launchdarkly.client.model.PermissionGrantInput;
...
public class TeamPostInput {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(customRoleKeys, description, key, memberIDs, name, permissionGrants, roleAttributes);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TeamPostInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TeamPostInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
