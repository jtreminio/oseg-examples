...
import com.launchdarkly.client.model.Series;
...
public class SeriesIntervalsRep {
  ...
  public SeriesIntervalsRep series(@javax.annotation.Nonnull List<Series> series) {
    this.series = series;
    return this;
  }
  ...
  public void setSeries(@javax.annotation.Nonnull List<Series> series) {
    this.series = series;
  }


  public SeriesIntervalsRep links(@javax.annotation.Nonnull Map<String, Object> links) {
    this.links = links;
    return this;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(series, links);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SeriesIntervalsRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SeriesIntervalsRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SeriesIntervalsRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SeriesIntervalsRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
