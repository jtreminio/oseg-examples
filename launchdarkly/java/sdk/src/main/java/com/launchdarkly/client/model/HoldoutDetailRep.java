...
public class HoldoutDetailRep {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, status, description, holdoutAmount, isDirty, createdAt, updatedAt, baseExperiment, relatedExperiments);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!HoldoutDetailRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `HoldoutDetailRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
