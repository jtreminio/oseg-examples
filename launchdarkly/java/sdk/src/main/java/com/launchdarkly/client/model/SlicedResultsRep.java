...
public class SlicedResultsRep {
  ...
  public SlicedResultsRep attribute(@javax.annotation.Nullable String attribute) {
  ...
  public SlicedResultsRep attributeValue(@javax.annotation.Nullable String attributeValue) {
  ...
  public SlicedResultsRep treatmentResults(@javax.annotation.Nullable List<TreatmentResultRep> treatmentResults) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(attribute, attributeValue, treatmentResults);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SlicedResultsRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SlicedResultsRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SlicedResultsRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SlicedResultsRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
