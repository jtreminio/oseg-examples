...
import com.launchdarkly.client.model.FlagReferenceRep;
...
public class FlagReferenceCollectionRep {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FlagReferenceCollectionRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FlagReferenceCollectionRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
