...
import com.launchdarkly.client.model.DynamicOptions;
...
public class FormVariable {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(key, name, type, description, placeholder, isOptional, defaultValue, allowedValues, dynamicOptions);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FormVariable.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FormVariable` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
