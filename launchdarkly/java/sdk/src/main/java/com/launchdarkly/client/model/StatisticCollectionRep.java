...
import com.launchdarkly.client.model.StatisticRep;
...
public class StatisticCollectionRep {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StatisticCollectionRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StatisticCollectionRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
