...
public class UpsertContextKindPayload {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, description, hideInTargeting, archived, version);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpsertContextKindPayload.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpsertContextKindPayload` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
