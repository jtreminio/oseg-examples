...
import com.launchdarkly.client.model.InsightGroupScores;
...
public class InsightGroup {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(environment, scores, scoreMetadata, key, name, projectKey, environmentKey, applicationKeys, createdAt);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InsightGroup.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InsightGroup` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
