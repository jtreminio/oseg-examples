...
public class AudiencePost {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(environmentKey, name, segmentKeys, _configuration);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AudiencePost.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AudiencePost` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
