...
import com.launchdarkly.client.model.ExperimentEnvironmentSettingRep;
import com.launchdarkly.client.model.MetricListingRep;
...
public class LegacyExperimentRep {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LegacyExperimentRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LegacyExperimentRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
