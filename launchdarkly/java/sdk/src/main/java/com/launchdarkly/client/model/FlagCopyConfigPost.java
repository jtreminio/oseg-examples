...
import com.launchdarkly.client.model.FlagCopyConfigEnvironment;
...
public class FlagCopyConfigPost {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FlagCopyConfigPost.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FlagCopyConfigPost` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
