...
import com.launchdarkly.client.model.FlagEventExperimentCollection;
import com.launchdarkly.client.model.FlagEventImpactRep;
import com.launchdarkly.client.model.FlagEventMemberRep;
...
public class FlagEventRep {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, projectId, projectKey, environmentId, environmentKey, flagKey, eventType, eventTime, description, auditLogEntryId, member, actions, impact, experiments);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FlagEventRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FlagEventRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
