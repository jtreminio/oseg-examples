...
import com.launchdarkly.client.model.InsightPeriod;
...
public class InsightScores {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(period, lastPeriod, scores, links);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InsightScores.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InsightScores` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
