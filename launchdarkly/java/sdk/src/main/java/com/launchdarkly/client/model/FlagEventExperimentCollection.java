...
import com.launchdarkly.client.model.FlagEventExperiment;
...
public class FlagEventExperimentCollection {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FlagEventExperimentCollection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FlagEventExperimentCollection` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
