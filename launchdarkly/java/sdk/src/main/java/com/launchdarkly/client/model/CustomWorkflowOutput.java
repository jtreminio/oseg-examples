...
import com.launchdarkly.client.model.ConflictOutput;
import com.launchdarkly.client.model.ExecutionOutput;
import com.launchdarkly.client.model.Link;
import com.launchdarkly.client.model.StageOutput;
import com.launchdarkly.client.model.WorkflowTemplateMetadata;
...
public class CustomWorkflowOutput {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, version, conflicts, creationDate, maintainerId, links, name, description, kind, stages, execution, meta, templateKey);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CustomWorkflowOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CustomWorkflowOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
