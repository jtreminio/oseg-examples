...
public class FlagRep {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(targetingRule, targetingRuleDescription, targetingRuleClauses, flagConfigVersion, notInExperimentVariationId, links);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FlagRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FlagRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
