...
import com.launchdarkly.client.auth.Authentication;
import com.launchdarkly.client.auth.HttpBasicAuth;
import com.launchdarkly.client.auth.HttpBearerAuth;
import com.launchdarkly.client.auth.ApiKeyAuth;
...
public class ApiClient {
     ...
     * @return a {@link com.launchdarkly.client.ApiClient} object
     */
    ...
    */
     ...
     * @throws com.launchdarkly.client.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws com.launchdarkly.client.ApiException If fail to serialize the given object
     */
     ...
     * @throws com.launchdarkly.client.ApiException If fail to read file content from response and write to disk
     ...
     * @throws com.launchdarkly.client.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws com.launchdarkly.client.ApiException If the response has an unsuccessful status code or
     ...
     * @throws com.launchdarkly.client.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws com.launchdarkly.client.ApiException If fails to update the parameters
     */
     ...
     * @throws com.launchdarkly.client.ApiException If fail to serialize the request body object into a string
     */
