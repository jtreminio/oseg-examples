...
public class RandomizationUnitInput {
  ...
  public enum StandardRandomizationUnitEnum {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      StandardRandomizationUnitEnum.fromValue(value);
    }
  }
  ...
  public RandomizationUnitInput standardRandomizationUnit(@javax.annotation.Nonnull StandardRandomizationUnitEnum standardRandomizationUnit) {
  ...
  public void setStandardRandomizationUnit(@javax.annotation.Nonnull StandardRandomizationUnitEnum standardRandomizationUnit) {
    this.standardRandomizationUnit = standardRandomizationUnit;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(randomizationUnit, _default, standardRandomizationUnit);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RandomizationUnitInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RandomizationUnitInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (!jsonObj.get("standardRandomizationUnit").isJsonPrimitive()) {
      ...
      // validate the required field `standardRandomizationUnit`
      StandardRandomizationUnitEnum.validateJsonElement(jsonObj.get("standardRandomizationUnit"));
  }
