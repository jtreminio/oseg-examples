...
import com.launchdarkly.client.model.StoreIntegrationError;
...
public class BigSegmentStoreStatus {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(available, potentiallyStale, lastSync, lastError, errors);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BigSegmentStoreStatus.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BigSegmentStoreStatus` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
