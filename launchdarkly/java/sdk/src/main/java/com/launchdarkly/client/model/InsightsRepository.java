...
import com.launchdarkly.client.model.ProjectSummaryCollection;
...
public class InsightsRepository {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, version, key, type, url, mainBranch, projects);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InsightsRepository.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InsightsRepository` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
