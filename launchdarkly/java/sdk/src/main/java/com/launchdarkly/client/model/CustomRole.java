...
import com.launchdarkly.client.model.AssignedToRep;
...
public class CustomRole {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, links, access, description, key, name, policy, basePermissions, resourceCategory, assignedTo);
  }
