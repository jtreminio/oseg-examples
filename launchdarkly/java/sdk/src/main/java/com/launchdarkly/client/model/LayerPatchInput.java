...
public class LayerPatchInput {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(comment, environmentKey, instructions);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LayerPatchInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LayerPatchInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
