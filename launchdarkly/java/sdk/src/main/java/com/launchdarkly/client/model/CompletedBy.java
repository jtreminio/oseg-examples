...
public class CompletedBy {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(member, token);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CompletedBy.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CompletedBy` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
