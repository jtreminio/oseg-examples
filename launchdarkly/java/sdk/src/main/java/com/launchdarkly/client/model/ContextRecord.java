...
public class ContextRecord {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(lastSeen, applicationId, context, links, access, associatedContexts);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContextRecord.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContextRecord` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
