...
public class CallerIdentityRep {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, environmentId, projectId, environmentName, projectName, authKind, tokenKind, clientId, tokenName, tokenId, memberId, serviceToken);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CallerIdentityRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CallerIdentityRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
