...
public class SimpleHoldoutRep {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, key, name, status, createdAt, updatedAt, experiments);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SimpleHoldoutRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SimpleHoldoutRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
