...
import com.launchdarkly.client.model.ContextInstanceEvaluation;
...
public class ContextInstanceEvaluations {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContextInstanceEvaluations.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContextInstanceEvaluations` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
