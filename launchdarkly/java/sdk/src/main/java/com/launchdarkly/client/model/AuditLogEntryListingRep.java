...
public class AuditLogEntryListingRep {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AuditLogEntryListingRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AuditLogEntryListingRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
