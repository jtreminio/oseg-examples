...
import com.launchdarkly.client.model.FlagImportIntegrationCollectionLinks;
...
public class FlagImportIntegrationCollection {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FlagImportIntegrationCollection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FlagImportIntegrationCollection` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
