...
public class RecentTriggerBody {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(timestamp, jsonBody);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RecentTriggerBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RecentTriggerBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
