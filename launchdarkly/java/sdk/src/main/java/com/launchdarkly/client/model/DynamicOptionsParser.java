...
import com.launchdarkly.client.model.OptionsArray;
...
public class DynamicOptionsParser {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(optionsItems, optionsPath);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DynamicOptionsParser.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DynamicOptionsParser` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
