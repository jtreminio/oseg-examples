...
import com.launchdarkly.client.model.VariationSummary;
...
public class FlagSummary {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(variations, prerequisites);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FlagSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FlagSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
