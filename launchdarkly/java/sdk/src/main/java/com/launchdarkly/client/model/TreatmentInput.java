...
import com.launchdarkly.client.model.TreatmentParameterInput;
...
public class TreatmentInput {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TreatmentInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TreatmentInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
