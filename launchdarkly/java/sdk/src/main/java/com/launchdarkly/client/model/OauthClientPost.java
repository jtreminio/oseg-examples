...
public class OauthClientPost {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, redirectUri, description);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OauthClientPost.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OauthClientPost` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
