...
public class ContextInstanceSearch {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(filter, sort, limit, continuationToken);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContextInstanceSearch.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContextInstanceSearch` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
