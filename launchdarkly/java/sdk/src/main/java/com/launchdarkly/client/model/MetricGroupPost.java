...
import com.launchdarkly.client.model.MetricInMetricGroupInput;
...
public class MetricGroupPost {
  ...
  public MetricGroupPost key(@javax.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(key, name, kind, description, maintainerId, tags, metrics);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MetricGroupPost.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MetricGroupPost` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
