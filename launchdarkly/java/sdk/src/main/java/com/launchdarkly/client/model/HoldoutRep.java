...
import com.launchdarkly.client.model.RelatedExperimentRep;
...
public class HoldoutRep {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, status, description, holdoutAmount, createdAt, updatedAt, baseExperiment, experiments);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!HoldoutRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `HoldoutRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
