...
import com.launchdarkly.client.model.Message;
import com.launchdarkly.client.model.ParentLink;
...
public class AIConfigVariation {
  ...
  public AIConfigVariation messages(@javax.annotation.Nonnull List<Message> messages) {
  ...
  public AIConfigVariation publishedAt(@javax.annotation.Nonnull Long publishedAt) {
  ...
  public void setPublishedAt(@javax.annotation.Nonnull Long publishedAt) {
    this.publishedAt = publishedAt;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(links, key, messages, model, modelConfigKey, name, createdAt, version, publishedAt);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AIConfigVariation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AIConfigVariation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
