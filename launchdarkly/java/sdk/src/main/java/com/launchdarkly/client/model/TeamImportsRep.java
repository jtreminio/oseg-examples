...
import com.launchdarkly.client.model.MemberImportItem;
...
public class TeamImportsRep {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TeamImportsRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TeamImportsRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
