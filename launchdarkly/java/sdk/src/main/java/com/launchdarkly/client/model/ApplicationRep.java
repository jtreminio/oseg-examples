...
import com.launchdarkly.client.model.ApplicationFlagCollectionRep;
...
public class ApplicationRep {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(flags, access, links, version, autoAdded, creationDate, description, key, kind, maintainer, name);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApplicationRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApplicationRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
