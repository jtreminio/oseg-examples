...
public class MetricByVariation {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(variationKey, metrics);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MetricByVariation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MetricByVariation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
