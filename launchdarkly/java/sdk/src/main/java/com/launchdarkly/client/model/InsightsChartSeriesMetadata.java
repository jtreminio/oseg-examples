...
import com.launchdarkly.client.model.InsightsChartBounds;
...
public class InsightsChartSeriesMetadata {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, count, bounds);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InsightsChartSeriesMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InsightsChartSeriesMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
