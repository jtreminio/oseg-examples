...
public class FlagImportConfigurationPost {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(config, tags, name);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FlagImportConfigurationPost.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FlagImportConfigurationPost` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
