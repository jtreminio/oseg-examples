...
import com.launchdarkly.client.model.AudiencePost;
...
public class CreatePhaseInput {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(audiences, name, _configuration);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreatePhaseInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreatePhaseInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
