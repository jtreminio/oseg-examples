...
public class AIConfigVariationPost {
  ...
  public AIConfigVariationPost model(@javax.annotation.Nonnull Object model) {
    this.model = model;
    return this;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(key, messages, model, name, modelConfigKey);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AIConfigVariationPost.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AIConfigVariationPost` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
