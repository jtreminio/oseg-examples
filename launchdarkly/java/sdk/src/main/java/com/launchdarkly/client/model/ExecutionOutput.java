...
public class ExecutionOutput {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(status, stopDate);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExecutionOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExecutionOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
