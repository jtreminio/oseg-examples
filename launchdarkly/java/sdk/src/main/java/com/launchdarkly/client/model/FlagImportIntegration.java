...
import com.launchdarkly.client.model.FlagImportIntegrationLinks;
import com.launchdarkly.client.model.FlagImportStatus;
...
public class FlagImportIntegration {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(links, id, integrationKey, projectKey, config, tags, name, version, access, status);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FlagImportIntegration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FlagImportIntegration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
