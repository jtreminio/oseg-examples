...
public class CreateReleaseInput {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(releaseVariationId, releasePipelineKey);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateReleaseInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateReleaseInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
