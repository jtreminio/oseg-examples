...
public class CustomWorkflowInput {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(maintainerId, name, description, stages, templateKey);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CustomWorkflowInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CustomWorkflowInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
