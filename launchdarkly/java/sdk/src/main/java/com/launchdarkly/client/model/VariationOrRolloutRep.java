...
import com.launchdarkly.client.model.Rollout;
...
public class VariationOrRolloutRep {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VariationOrRolloutRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VariationOrRolloutRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
