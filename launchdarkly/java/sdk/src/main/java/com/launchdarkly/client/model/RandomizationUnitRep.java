...
public class RandomizationUnitRep {
  ...
  public RandomizationUnitRep standardRandomizationUnit(@javax.annotation.Nullable String standardRandomizationUnit) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(randomizationUnit, standardRandomizationUnit, _default, hidden, displayName);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RandomizationUnitRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RandomizationUnitRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
