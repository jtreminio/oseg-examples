...
import com.launchdarkly.client.model.MetricGroupCollectionRep;
import com.launchdarkly.client.model.MetricGroupPost;
import com.launchdarkly.client.model.MetricGroupRep;
...
public class MetricsBetaApi {
    ...
    private okhttp3.Call getMetricGroupsValidateBeforeCall(String projectKey, String filter, String expand, Long limit, Long offset, final ApiCallback _callback) throws ApiException {
        ...
        return getMetricGroupsCall(projectKey, filter, expand, limit, offset, _callback);
