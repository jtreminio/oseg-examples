...
public class CredibleIntervalRep {
  ...
  public CredibleIntervalRep upper(@javax.annotation.Nullable BigDecimal upper) {
    this.upper = upper;
    return this;
  }
  ...
  public CredibleIntervalRep lower(@javax.annotation.Nullable BigDecimal lower) {
    this.lower = lower;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CredibleIntervalRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CredibleIntervalRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CredibleIntervalRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CredibleIntervalRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
