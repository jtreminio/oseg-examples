...
import com.launchdarkly.client.model.InsightsChartMetric;
import com.launchdarkly.client.model.InsightsChartSeriesMetadataAxis;
...
public class InsightsChartMetadata {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(summary, name, metrics, xAxis, yAxis);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InsightsChartMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InsightsChartMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
