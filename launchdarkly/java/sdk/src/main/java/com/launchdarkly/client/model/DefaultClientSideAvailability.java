...
public class DefaultClientSideAvailability {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(usingMobileKey, usingEnvironmentId);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DefaultClientSideAvailability.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DefaultClientSideAvailability` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
