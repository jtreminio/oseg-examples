...
import com.launchdarkly.client.model.StageInput;
...
public class CreateWorkflowTemplateInput {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(key, name, description, workflowId, stages, projectKey, environmentKey, flagKey);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateWorkflowTemplateInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateWorkflowTemplateInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
