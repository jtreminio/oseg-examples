...
public class ReleaseProgression {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(createdAt, completedAt, flagKey, activePhaseId, links);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReleaseProgression.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReleaseProgression` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
