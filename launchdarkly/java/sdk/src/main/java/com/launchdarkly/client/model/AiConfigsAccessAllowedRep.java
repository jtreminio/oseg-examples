...
import com.launchdarkly.client.model.AiConfigsAccessAllowedReason;
...
public class AiConfigsAccessAllowedRep {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AiConfigsAccessAllowedRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AiConfigsAccessAllowedRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
