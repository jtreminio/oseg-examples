...
import com.launchdarkly.client.model.BigSegmentStoreIntegrationCollectionLinks;
...
public class BigSegmentStoreIntegrationCollection {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BigSegmentStoreIntegrationCollection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BigSegmentStoreIntegrationCollection` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
