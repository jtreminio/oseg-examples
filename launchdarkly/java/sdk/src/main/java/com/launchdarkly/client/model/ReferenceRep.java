...
import com.launchdarkly.client.model.HunkRep;
...
public class ReferenceRep {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReferenceRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReferenceRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
