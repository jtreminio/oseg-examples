...
import com.launchdarkly.client.model.InsightsRepositoryProject;
...
public class InsightsRepositoryProjectCollection {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InsightsRepositoryProjectCollection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InsightsRepositoryProjectCollection` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
