...
import com.launchdarkly.client.model.ContextInstanceRecord;
...
public class ContextInstances {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(links, totalCount, environmentId, continuationToken, items);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContextInstances.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContextInstances` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
