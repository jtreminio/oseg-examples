...
public class MemberTeamSummaryRep {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(customRoleKeys, key, links, name);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MemberTeamSummaryRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MemberTeamSummaryRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
