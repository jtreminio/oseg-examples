...
import com.launchdarkly.client.model.PhaseInfo;
import com.launchdarkly.client.model.ReleaseProgression;
...
public class ReleaseProgressionCollection {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(activeCount, completedCount, items, phases, totalCount, links);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReleaseProgressionCollection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReleaseProgressionCollection` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
