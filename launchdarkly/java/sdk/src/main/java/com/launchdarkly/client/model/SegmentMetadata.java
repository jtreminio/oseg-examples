...
public class SegmentMetadata {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(envId, segmentId, version, includedCount, excludedCount, lastModified, deleted);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SegmentMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SegmentMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
