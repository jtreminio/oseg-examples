...
public class LayerSnapshotRep {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(key, name, reservationPercent, otherReservationPercent);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LayerSnapshotRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LayerSnapshotRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
