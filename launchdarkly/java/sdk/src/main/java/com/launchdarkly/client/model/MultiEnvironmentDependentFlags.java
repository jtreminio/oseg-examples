...
import com.launchdarkly.client.model.MultiEnvironmentDependentFlag;
...
public class MultiEnvironmentDependentFlags {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MultiEnvironmentDependentFlags.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MultiEnvironmentDependentFlags` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
