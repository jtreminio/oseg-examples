...
import com.launchdarkly.client.model.ApprovalsCapabilityConfig;
import com.launchdarkly.client.model.AuditLogEventsHookCapabilityConfigPost;
...
public class CapabilityConfigPost {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(approvals, auditLogEventsHook);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CapabilityConfigPost.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CapabilityConfigPost` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
