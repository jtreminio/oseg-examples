...
import com.launchdarkly.client.model.BooleanDefaults;
...
public class FlagDefaultsRep {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(links, key, tags, temporary, defaultClientSideAvailability, booleanDefaults);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FlagDefaultsRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FlagDefaultsRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
