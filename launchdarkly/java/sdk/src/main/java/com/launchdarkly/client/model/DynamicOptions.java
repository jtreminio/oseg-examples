...
import com.launchdarkly.client.model.DynamicOptionsParser;
import com.launchdarkly.client.model.Endpoint;
...
public class DynamicOptions {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(endpoint, parser);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DynamicOptions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DynamicOptions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
