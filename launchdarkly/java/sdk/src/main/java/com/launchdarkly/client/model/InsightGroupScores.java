...
import com.launchdarkly.client.model.InsightsMetricScore;
...
public class InsightGroupScores {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(overall, deploymentFrequency, deploymentFailureRate, leadTime, impactSize, experimentationCoverage, flagHealth, velocity, risk, efficiency, creationRatio);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InsightGroupScores.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InsightGroupScores` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
