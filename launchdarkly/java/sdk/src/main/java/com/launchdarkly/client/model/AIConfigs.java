...
import com.launchdarkly.client.model.PaginatedLinks;
...
public class AIConfigs {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AIConfigs.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AIConfigs` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
