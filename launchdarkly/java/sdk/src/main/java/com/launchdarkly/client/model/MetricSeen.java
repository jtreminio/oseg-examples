...
public class MetricSeen {
  ...
  public MetricSeen ever(@javax.annotation.Nullable Boolean ever) {
    this.ever = ever;
    return this;
  }
  ...
  public void setEver(@javax.annotation.Nullable Boolean ever) {
    this.ever = ever;
  }


  public MetricSeen timestamp(@javax.annotation.Nullable Long timestamp) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to MetricSeen
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MetricSeen.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MetricSeen.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MetricSeen` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
