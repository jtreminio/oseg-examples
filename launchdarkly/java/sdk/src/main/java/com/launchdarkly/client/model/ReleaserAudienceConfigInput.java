...
import com.launchdarkly.client.model.ReleaseGuardianConfigurationInput;
...
public class ReleaserAudienceConfigInput {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(audienceId, releaseGuardianConfiguration, notifyMemberIds, notifyTeamKeys);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReleaserAudienceConfigInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReleaserAudienceConfigInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
