...
import com.launchdarkly.client.model.AuditLogEventsHookCapabilityConfigRep;
...
public class CapabilityConfigRep {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CapabilityConfigRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CapabilityConfigRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
