...
import com.launchdarkly.client.model.ContextKindRep;
...
public class ContextKindsCollectionRep {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContextKindsCollectionRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContextKindsCollectionRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
