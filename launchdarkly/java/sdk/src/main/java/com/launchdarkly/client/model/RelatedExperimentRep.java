...
public class RelatedExperimentRep {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(key, name, environment);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RelatedExperimentRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RelatedExperimentRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
