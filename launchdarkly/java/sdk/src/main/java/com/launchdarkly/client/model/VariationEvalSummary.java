...
public class VariationEvalSummary {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(value, before, after);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VariationEvalSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VariationEvalSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
