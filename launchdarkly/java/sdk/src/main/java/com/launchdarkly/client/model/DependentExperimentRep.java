...
public class DependentExperimentRep {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(key, name, environmentId, environmentKey, creationDate, archivedDate, links);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DependentExperimentRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DependentExperimentRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
