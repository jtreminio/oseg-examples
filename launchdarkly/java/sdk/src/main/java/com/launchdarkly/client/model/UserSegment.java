...
import com.launchdarkly.client.model.SegmentMetadata;
import com.launchdarkly.client.model.SegmentTarget;
import com.launchdarkly.client.model.UserSegmentRule;
...
public class UserSegment {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, description, tags, creationDate, lastModifiedDate, key, included, excluded, includedContexts, excludedContexts, links, rules, version, deleted, access, flags, unbounded, unboundedContextKind, generation, unboundedMetadata, external, externalLink, importInProgress);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserSegment.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserSegment` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
