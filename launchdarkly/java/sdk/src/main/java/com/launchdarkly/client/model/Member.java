...
import com.launchdarkly.client.model.LastSeenMetadata;
import com.launchdarkly.client.model.Link;
import com.launchdarkly.client.model.MemberPermissionGrantSummaryRep;
import com.launchdarkly.client.model.MemberTeamSummaryRep;
...
public class Member {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(links, id, firstName, lastName, role, email, pendingInvite, verified, pendingEmail, customRoles, mfa, excludedDashboards, lastSeen, lastSeenMetadata, integrationMetadata, teams, permissionGrants, creationDate, oauthProviders, version, roleAttributes);
  }
