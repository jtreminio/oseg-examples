...
public class UpsertPayloadRep {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(links, tags, temporary, booleanDefaults, defaultClientSideAvailability);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpsertPayloadRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpsertPayloadRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
