...
import com.launchdarkly.client.model.FailureReasonRep;
...
public class ValidationFailedErrorRep {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ValidationFailedErrorRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ValidationFailedErrorRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
