...
public class FlagInput {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(ruleId, flagConfigVersion, notInExperimentVariationId);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FlagInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FlagInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
