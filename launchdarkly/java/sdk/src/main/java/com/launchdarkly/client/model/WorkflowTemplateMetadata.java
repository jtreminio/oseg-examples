...
import com.launchdarkly.client.model.WorkflowTemplateParameter;
...
public class WorkflowTemplateMetadata {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WorkflowTemplateMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WorkflowTemplateMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
