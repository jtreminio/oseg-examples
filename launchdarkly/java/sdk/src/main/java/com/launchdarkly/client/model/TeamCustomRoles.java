...
import com.launchdarkly.client.model.TeamCustomRole;
...
public class TeamCustomRoles {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TeamCustomRoles.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TeamCustomRoles` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
