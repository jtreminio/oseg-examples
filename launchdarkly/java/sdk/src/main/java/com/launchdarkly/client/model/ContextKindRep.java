...
public class ContextKindRep {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(key, name, description, version, creationDate, lastModified, lastSeen, createdFrom, hideInTargeting, archived, links);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContextKindRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContextKindRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
