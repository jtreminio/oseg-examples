...
public class ExpiringTargetError {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(instructionIndex, message);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExpiringTargetError.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExpiringTargetError` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
