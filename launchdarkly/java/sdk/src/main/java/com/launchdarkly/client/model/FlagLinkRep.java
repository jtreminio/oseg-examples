...
import com.launchdarkly.client.model.FlagLinkMember;
import com.launchdarkly.client.model.Link;
import com.launchdarkly.client.model.TimestampRep;
...
public class FlagLinkRep {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FlagLinkRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FlagLinkRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
