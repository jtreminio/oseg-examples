...
import com.launchdarkly.client.model.AiConfigsAccess;
import com.launchdarkly.client.model.ParentAndSelfLinks;
...
public class AIConfig {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(access, links, description, key, name, tags, version, variations, createdAt, updatedAt);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AIConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AIConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
