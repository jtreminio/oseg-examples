...
import com.launchdarkly.client.model.ExpiringTarget;
...
public class ExpiringTargetPatchResponse {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExpiringTargetPatchResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExpiringTargetPatchResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
