...
public class AIConfigPost {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, key, name, tags);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AIConfigPost.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AIConfigPost` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
