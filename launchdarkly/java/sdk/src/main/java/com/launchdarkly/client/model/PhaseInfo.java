...
public class PhaseInfo {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, releaseCount);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PhaseInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PhaseInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
