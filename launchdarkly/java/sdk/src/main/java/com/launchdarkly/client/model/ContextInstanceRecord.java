...
public class ContextInstanceRecord {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(lastSeen, id, applicationId, anonymousKinds, context, links, access);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContextInstanceRecord.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContextInstanceRecord` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
