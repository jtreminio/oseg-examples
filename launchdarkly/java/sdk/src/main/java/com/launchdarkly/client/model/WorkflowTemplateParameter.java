...
import com.launchdarkly.client.model.ParameterDefault;
...
public class WorkflowTemplateParameter {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, path, _default, valid);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WorkflowTemplateParameter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WorkflowTemplateParameter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
