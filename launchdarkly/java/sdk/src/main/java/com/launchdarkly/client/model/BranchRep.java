...
import com.launchdarkly.client.model.ReferenceRep;
...
public class BranchRep {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BranchRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BranchRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
