...
public class BulkEditTeamsRep {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(memberIDs, teamKeys, errors);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BulkEditTeamsRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BulkEditTeamsRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
