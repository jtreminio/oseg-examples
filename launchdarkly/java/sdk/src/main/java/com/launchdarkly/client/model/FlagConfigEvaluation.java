...
public class FlagConfigEvaluation {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(contextKinds);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FlagConfigEvaluation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FlagConfigEvaluation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
