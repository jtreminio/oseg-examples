...
public class MetricInput {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(key, isGroup, primary);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MetricInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MetricInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
