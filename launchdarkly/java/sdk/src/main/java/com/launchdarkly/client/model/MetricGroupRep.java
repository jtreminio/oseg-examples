...
import com.launchdarkly.client.model.MaintainerRep;
...
public class MetricGroupRep {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, key, name, kind, description, links, access, tags, creationDate, lastModified, maintainer, metrics, version, experiments, experimentCount);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MetricGroupRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MetricGroupRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
