...
import com.launchdarkly.client.model.MetricInGroupRep;
...
public class MetricInGroupResultsRep {
  ...
  public MetricInGroupResultsRep metric(@javax.annotation.Nonnull MetricInGroupRep metric) {
    this.metric = metric;
    return this;
  }
  ...
  public void setMetric(@javax.annotation.Nonnull MetricInGroupRep metric) {
    this.metric = metric;
  }


  public MetricInGroupResultsRep results(@javax.annotation.Nonnull ExperimentBayesianResultsRep results) {
  ...
  public void setResults(@javax.annotation.Nonnull ExperimentBayesianResultsRep results) {
    this.results = results;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(metric, results);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MetricInGroupResultsRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MetricInGroupResultsRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MetricInGroupResultsRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MetricInGroupResultsRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      MetricInGroupRep.validateJsonElement(jsonObj.get("metric"));
      // validate the required field `results`
      ExperimentBayesianResultsRep.validateJsonElement(jsonObj.get("results"));
  }
