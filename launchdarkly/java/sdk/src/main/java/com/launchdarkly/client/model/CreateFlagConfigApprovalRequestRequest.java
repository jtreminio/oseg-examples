...
public class CreateFlagConfigApprovalRequestRequest {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(comment, description, instructions, notifyMemberIds, notifyTeamKeys, executionDate, operatingOnId, integrationConfig);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateFlagConfigApprovalRequestRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateFlagConfigApprovalRequestRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
