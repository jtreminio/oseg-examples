...
public class ApplicationVersionRep {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(access, links, version, autoAdded, creationDate, key, name, supported);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApplicationVersionRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApplicationVersionRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
