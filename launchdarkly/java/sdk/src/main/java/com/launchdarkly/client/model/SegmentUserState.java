...
import com.launchdarkly.client.model.SegmentUserList;
...
public class SegmentUserState {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SegmentUserState.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SegmentUserState` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
