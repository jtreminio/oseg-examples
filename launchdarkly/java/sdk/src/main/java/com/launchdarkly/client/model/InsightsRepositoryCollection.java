...
import com.launchdarkly.client.model.InsightsRepository;
...
public class InsightsRepositoryCollection {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InsightsRepositoryCollection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InsightsRepositoryCollection` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
