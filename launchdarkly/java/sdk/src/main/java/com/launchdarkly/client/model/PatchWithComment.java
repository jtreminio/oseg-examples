...
public class PatchWithComment {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(patch, comment);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PatchWithComment.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PatchWithComment` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
