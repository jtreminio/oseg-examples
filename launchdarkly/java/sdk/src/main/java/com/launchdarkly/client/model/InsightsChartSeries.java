...
import com.launchdarkly.client.model.InsightsChartSeriesDataPoint;
import com.launchdarkly.client.model.InsightsChartSeriesMetadata;
...
public class InsightsChartSeries {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InsightsChartSeries.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InsightsChartSeries` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
