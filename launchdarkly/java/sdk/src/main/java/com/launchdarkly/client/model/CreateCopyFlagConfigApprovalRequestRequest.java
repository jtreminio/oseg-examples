...
import com.launchdarkly.client.model.SourceFlag;
...
public class CreateCopyFlagConfigApprovalRequestRequest {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(comment, description, notifyMemberIds, notifyTeamKeys, source, includedActions, excludedActions);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateCopyFlagConfigApprovalRequestRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateCopyFlagConfigApprovalRequestRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
