...
import com.launchdarkly.client.model.FollowersPerFlag;
...
public class FlagFollowersByProjEnvGetRep {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FlagFollowersByProjEnvGetRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FlagFollowersByProjEnvGetRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
