...
import com.launchdarkly.client.model.ResourceId;
...
public class ExpiringTarget {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, version, expirationDate, contextKind, contextKey, targetType, variationId, resourceId);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExpiringTarget.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExpiringTarget` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
