...
import com.launchdarkly.client.model.CapabilityConfigPost;
...
public class IntegrationConfigurationPost {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, enabled, tags, configValues, capabilityConfig);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IntegrationConfigurationPost.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IntegrationConfigurationPost` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
