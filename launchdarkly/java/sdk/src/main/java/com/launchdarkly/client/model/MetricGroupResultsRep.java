...
import com.launchdarkly.client.model.MetricInGroupResultsRep;
...
public class MetricGroupResultsRep {
  ...
  public MetricGroupResultsRep links(@javax.annotation.Nonnull Map<String, Link> links) {
    this.links = links;
    return this;
  }
  ...
  public MetricGroupResultsRep metrics(@javax.annotation.Nonnull List<MetricInGroupResultsRep> metrics) {
  ...
  public void setMetrics(@javax.annotation.Nonnull List<MetricInGroupResultsRep> metrics) {
    this.metrics = metrics;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(links, metrics);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MetricGroupResultsRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MetricGroupResultsRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MetricGroupResultsRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MetricGroupResultsRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      for (int i = 0; i < jsonArraymetrics.size(); i++) {
        MetricInGroupResultsRep.validateJsonElement(jsonArraymetrics.get(i));
      };
  }
