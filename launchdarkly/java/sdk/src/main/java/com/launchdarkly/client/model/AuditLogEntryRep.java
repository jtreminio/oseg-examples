...
import com.launchdarkly.client.model.AuditLogEntryListingRep;
import com.launchdarkly.client.model.AuthorizedAppDataRep;
import com.launchdarkly.client.model.Link;
import com.launchdarkly.client.model.MemberDataRep;
import com.launchdarkly.client.model.ParentResourceRep;
import com.launchdarkly.client.model.ResourceAccess;
import com.launchdarkly.client.model.SubjectDataRep;
import com.launchdarkly.client.model.TargetResourceRep;
import com.launchdarkly.client.model.TokenSummary;
...
public class AuditLogEntryRep {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AuditLogEntryRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AuditLogEntryRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
