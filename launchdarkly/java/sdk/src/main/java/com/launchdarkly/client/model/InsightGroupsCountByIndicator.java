...
public class InsightGroupsCountByIndicator {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(excellent, good, fair, needsAttention, notCalculated, unknown, total);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InsightGroupsCountByIndicator.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InsightGroupsCountByIndicator` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
