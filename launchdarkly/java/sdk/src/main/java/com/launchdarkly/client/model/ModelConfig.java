...
public class ModelConfig {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(access, name, key, id, icon, provider, global, params, customParams, tags, version);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ModelConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ModelConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
