...
import com.launchdarkly.client.model.Statement;
...
public class AuditLogEventsHookCapabilityConfigRep {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AuditLogEventsHookCapabilityConfigRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AuditLogEventsHookCapabilityConfigRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
