...
public class MigrationSafetyIssueRep {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(causingRuleId, affectedRuleIds, issue, oldSystemAffected);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MigrationSafetyIssueRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MigrationSafetyIssueRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
