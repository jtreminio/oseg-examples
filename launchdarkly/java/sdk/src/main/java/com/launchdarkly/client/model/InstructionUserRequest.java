...
public class InstructionUserRequest {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(kind, flagKey, variationId, value, version);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InstructionUserRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InstructionUserRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
