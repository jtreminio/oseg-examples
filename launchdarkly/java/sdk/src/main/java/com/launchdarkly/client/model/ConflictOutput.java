...
public class ConflictOutput {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(stageId, message);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConflictOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConflictOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
