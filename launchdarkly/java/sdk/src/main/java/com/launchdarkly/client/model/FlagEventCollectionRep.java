...
import com.launchdarkly.client.model.FlagEventRep;
...
public class FlagEventCollectionRep {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FlagEventCollectionRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FlagEventCollectionRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
