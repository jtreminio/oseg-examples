...
import com.launchdarkly.client.model.SimpleHoldoutRep;
...
public class HoldoutsCollectionRep {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!HoldoutsCollectionRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `HoldoutsCollectionRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
