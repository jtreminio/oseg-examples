...
import com.launchdarkly.client.model.LayerConfigurationRep;
...
public class LayerRep {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(key, name, description, createdAt, randomizationUnit, environments);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LayerRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LayerRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
