...
import com.launchdarkly.client.model.InsightGroupsCountByIndicator;
...
public class InsightGroupCollectionMetadata {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(countByIndicator);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InsightGroupCollectionMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InsightGroupCollectionMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
