...
import com.launchdarkly.client.model.VariationEvalSummary;
...
public class EvaluationsSummary {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EvaluationsSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EvaluationsSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
