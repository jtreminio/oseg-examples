...
import com.launchdarkly.client.model.BooleanFlagDefaults;
import com.launchdarkly.client.model.DefaultClientSideAvailability;
...
public class UpsertFlagDefaultsPayload {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(tags, temporary, booleanDefaults, defaultClientSideAvailability);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpsertFlagDefaultsPayload.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpsertFlagDefaultsPayload` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
