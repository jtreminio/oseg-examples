...
import com.launchdarkly.client.model.FlagConfigEvaluation;
import com.launchdarkly.client.model.FlagConfigMigrationSettingsRep;
import com.launchdarkly.client.model.FlagSummary;
import com.launchdarkly.client.model.Link;
import com.launchdarkly.client.model.Prerequisite;
import com.launchdarkly.client.model.Rule;
import com.launchdarkly.client.model.Target;
import com.launchdarkly.client.model.VariationOrRolloutRep;
...
public class FeatureFlagConfig {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(on, archived, salt, sel, lastModified, version, targets, contextTargets, rules, fallthrough, offVariation, prerequisites, site, access, environmentName, trackEvents, trackEventsFallthrough, debugEventsUntilDate, summary, evaluation, migrationSettings);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FeatureFlagConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FeatureFlagConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
