...
public class LeadTimeStagesRep {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(codingDurationMs, reviewDurationMs, waitDurationMs, deployDurationMs, totalLeadTimeMs);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LeadTimeStagesRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LeadTimeStagesRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
