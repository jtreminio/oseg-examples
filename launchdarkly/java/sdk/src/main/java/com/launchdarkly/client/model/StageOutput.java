...
import com.launchdarkly.client.model.ActionOutput;
import com.launchdarkly.client.model.ConditionOutput;
...
public class StageOutput {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StageOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StageOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
