...
public class InsightsChartSeriesDataPoint {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(x, y, values);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InsightsChartSeriesDataPoint.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InsightsChartSeriesDataPoint` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
