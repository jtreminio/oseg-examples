...
import com.launchdarkly.client.model.FlagEventExperimentIteration;
...
public class FlagEventExperiment {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(key, name, iteration, links);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FlagEventExperiment.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FlagEventExperiment` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
