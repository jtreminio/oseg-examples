...
import com.launchdarkly.client.model.PullRequestRep;
...
public class PullRequestCollectionRep {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PullRequestCollectionRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PullRequestCollectionRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
