...
import com.launchdarkly.client.model.DependentFlagEnvironment;
...
public class MultiEnvironmentDependentFlag {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MultiEnvironmentDependentFlag.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MultiEnvironmentDependentFlag` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
