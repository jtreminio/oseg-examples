...
import com.launchdarkly.client.model.CompletedBy;
import com.launchdarkly.client.model.ReleaseAudience;
...
public class ReleasePhase {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, complete, creationDate, completionDate, completedBy, audiences, status, started, startedDate, _configuration);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReleasePhase.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReleasePhase` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
