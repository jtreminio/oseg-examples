...
public class DependentMetricOrMetricGroupRep {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(key, versionId, name, kind, isNumeric, links, isGroup, metrics);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DependentMetricOrMetricGroupRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DependentMetricOrMetricGroupRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
