...
public class ModelConfigPost {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, key, id, icon, provider, params, customParams, tags);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ModelConfigPost.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ModelConfigPost` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
