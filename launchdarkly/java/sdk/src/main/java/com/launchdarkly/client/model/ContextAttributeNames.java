...
import com.launchdarkly.client.model.ContextAttributeName;
...
public class ContextAttributeNames {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(kind, names);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContextAttributeNames.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContextAttributeNames` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
