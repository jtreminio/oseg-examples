...
import com.launchdarkly.client.model.ResourceIDResponse;
...
public class ExpiringUserTargetItem {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExpiringUserTargetItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExpiringUserTargetItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
