...
import com.launchdarkly.client.model.RuleClause;
...
public class ParameterDefault {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(value, booleanVariationValue, ruleClause);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ParameterDefault.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ParameterDefault` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
