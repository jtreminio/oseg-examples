...
import com.launchdarkly.client.model.CapabilityConfigRep;
...
public class IntegrationConfigurationsRep {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(links, id, name, createdAt, integrationKey, tags, enabled, access, configValues, capabilityConfig);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IntegrationConfigurationsRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IntegrationConfigurationsRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
