...
public class InsightGroupCollectionScoreMetadata {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(period, lastPeriod);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InsightGroupCollectionScoreMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InsightGroupCollectionScoreMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
