...
import com.launchdarkly.client.model.SdkVersionRep;
...
public class SdkVersionListRep {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SdkVersionListRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SdkVersionListRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
