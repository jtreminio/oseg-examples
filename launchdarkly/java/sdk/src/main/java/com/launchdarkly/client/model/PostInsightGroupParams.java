...
public class PostInsightGroupParams {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, key, projectKey, environmentKey, applicationKeys);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PostInsightGroupParams.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PostInsightGroupParams` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
