...
public class CreateApprovalRequestRequest {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(resourceId, comment, description, instructions, notifyMemberIds, notifyTeamKeys, integrationConfig);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateApprovalRequestRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateApprovalRequestRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
