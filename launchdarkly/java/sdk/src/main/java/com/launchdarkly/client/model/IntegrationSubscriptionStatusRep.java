...
import com.launchdarkly.client.model.IntegrationStatusRep;
...
public class IntegrationSubscriptionStatusRep {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IntegrationSubscriptionStatusRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IntegrationSubscriptionStatusRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
