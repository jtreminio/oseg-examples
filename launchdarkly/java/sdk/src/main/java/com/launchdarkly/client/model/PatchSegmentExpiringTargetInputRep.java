...
import com.launchdarkly.client.model.PatchSegmentExpiringTargetInstruction;
...
public class PatchSegmentExpiringTargetInputRep {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PatchSegmentExpiringTargetInputRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PatchSegmentExpiringTargetInputRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
