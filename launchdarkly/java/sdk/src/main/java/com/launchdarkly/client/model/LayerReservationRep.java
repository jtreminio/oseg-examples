...
public class LayerReservationRep {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(experimentKey, flagKey, reservationPercent);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LayerReservationRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LayerReservationRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
