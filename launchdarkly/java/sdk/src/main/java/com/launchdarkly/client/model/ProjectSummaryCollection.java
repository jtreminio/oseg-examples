...
import com.launchdarkly.client.model.ProjectSummary;
...
public class ProjectSummaryCollection {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProjectSummaryCollection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProjectSummaryCollection` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
