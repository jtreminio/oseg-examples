...
import com.launchdarkly.client.model.EvaluationsSummary;
...
public class FlagEventImpactRep {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(size, percentage, reason, evaluationsSummary);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FlagEventImpactRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FlagEventImpactRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
