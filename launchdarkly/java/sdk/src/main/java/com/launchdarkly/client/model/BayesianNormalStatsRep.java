...
public class BayesianNormalStatsRep {
  ...
  public BayesianNormalStatsRep dataWeight(@javax.annotation.Nullable BigDecimal dataWeight) {
  ...
  public BayesianNormalStatsRep priorMean(@javax.annotation.Nullable BigDecimal priorMean) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(dataWeight, priorMean);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to BayesianNormalStatsRep
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BayesianNormalStatsRep.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BayesianNormalStatsRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BayesianNormalStatsRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
