...
public class Distribution {
  ...
  @javax.annotation.Nullable
  private Map<String, BigDecimal> parameters = new HashMap<>();

  public Distribution() {
  }

  public Distribution kind(@javax.annotation.Nullable KindEnum kind) {
    this.kind = kind;
    return this;
  }
  ...
  public Distribution parameters(@javax.annotation.Nullable Map<String, BigDecimal> parameters) {
  ...
  public void setParameters(@javax.annotation.Nullable Map<String, BigDecimal> parameters) {
    this.parameters = parameters;
  }
