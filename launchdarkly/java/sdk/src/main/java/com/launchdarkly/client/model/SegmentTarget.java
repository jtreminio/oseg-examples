...
public class SegmentTarget {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(values, contextKind);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SegmentTarget.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SegmentTarget` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
