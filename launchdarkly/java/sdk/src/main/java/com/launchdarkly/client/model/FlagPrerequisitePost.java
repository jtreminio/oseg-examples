...
public class FlagPrerequisitePost {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(key, variationId);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FlagPrerequisitePost.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FlagPrerequisitePost` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
