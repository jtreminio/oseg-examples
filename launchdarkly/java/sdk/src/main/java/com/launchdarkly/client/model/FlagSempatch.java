...
public class FlagSempatch {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(instructions, comment);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FlagSempatch.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FlagSempatch` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
