...
import com.launchdarkly.client.model.IntegrationDeliveryConfigurationLinks;
...
public class IntegrationDeliveryConfiguration {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IntegrationDeliveryConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IntegrationDeliveryConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
