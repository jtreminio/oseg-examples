...
import com.launchdarkly.client.model.AiConfigsLink;
...
public class PaginatedLinks {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PaginatedLinks.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaginatedLinks` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
