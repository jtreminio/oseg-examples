...
import com.launchdarkly.client.model.ReleaserAudienceConfigInput;
...
public class UpdatePhaseStatusInput {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(status, audiences);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdatePhaseStatusInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdatePhaseStatusInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
