...
import com.launchdarkly.client.model.ContextAttributeValue;
...
public class ContextAttributeValues {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContextAttributeValues.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContextAttributeValues` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
