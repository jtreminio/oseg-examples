...
import com.launchdarkly.client.model.ClientSideAvailabilityPost;
import com.launchdarkly.client.model.CustomProperty;
import com.launchdarkly.client.model.Defaults;
import com.launchdarkly.client.model.FlagPrerequisitePost;
import com.launchdarkly.client.model.MigrationSettingsPost;
...
public class FeatureFlagBody {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, key, description, includeInSnippet, clientSideAvailability, variations, temporary, tags, customProperties, defaults, purpose, migrationSettings, maintainerId, maintainerTeamKey, initialPrerequisites);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FeatureFlagBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FeatureFlagBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
