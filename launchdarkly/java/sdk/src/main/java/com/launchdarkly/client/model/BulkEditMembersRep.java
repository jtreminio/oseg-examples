...
public class BulkEditMembersRep {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(members, errors);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BulkEditMembersRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BulkEditMembersRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
