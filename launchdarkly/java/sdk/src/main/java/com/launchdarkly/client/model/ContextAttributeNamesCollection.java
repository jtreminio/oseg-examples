...
import com.launchdarkly.client.model.ContextAttributeNames;
...
public class ContextAttributeNamesCollection {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContextAttributeNamesCollection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContextAttributeNamesCollection` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
