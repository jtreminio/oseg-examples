...
import com.launchdarkly.client.model.Phase;
...
public class ReleasePipeline {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(createdAt, description, key, name, phases, tags, version, access, isProjectDefault, isLegacy);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReleasePipeline.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReleasePipeline` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
