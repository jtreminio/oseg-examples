...
import com.launchdarkly.client.model.ActionInput;
import com.launchdarkly.client.model.ConditionInput;
...
public class StageInput {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StageInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StageInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
