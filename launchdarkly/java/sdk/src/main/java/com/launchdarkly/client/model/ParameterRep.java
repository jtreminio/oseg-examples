...
public class ParameterRep {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(variationId, flagKey);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ParameterRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ParameterRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
