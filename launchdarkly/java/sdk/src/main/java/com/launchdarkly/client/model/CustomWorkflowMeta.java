...
import com.launchdarkly.client.model.CustomWorkflowStageMeta;
...
public class CustomWorkflowMeta {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CustomWorkflowMeta.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CustomWorkflowMeta` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
