...
public class ProjectRep {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(links, id, key, includeInSnippetByDefault, defaultClientSideAvailability, name, access, tags, defaultReleasePipelineKey, environments);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProjectRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProjectRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
