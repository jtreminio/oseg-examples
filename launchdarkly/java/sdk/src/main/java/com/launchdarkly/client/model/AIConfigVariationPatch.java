...
public class AIConfigVariationPatch {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(messages, model, modelConfigKey, name, published);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AIConfigVariationPatch.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AIConfigVariationPatch` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
