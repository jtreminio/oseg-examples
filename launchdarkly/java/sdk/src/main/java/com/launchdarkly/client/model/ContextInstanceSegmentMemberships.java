...
import com.launchdarkly.client.model.ContextInstanceSegmentMembership;
...
public class ContextInstanceSegmentMemberships {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContextInstanceSegmentMemberships.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContextInstanceSegmentMemberships` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
