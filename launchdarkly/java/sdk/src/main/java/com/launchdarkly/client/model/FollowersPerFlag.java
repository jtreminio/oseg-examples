...
import com.launchdarkly.client.model.FollowFlagMember;
...
public class FollowersPerFlag {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(flagKey, followers);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FollowersPerFlag.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FollowersPerFlag` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
