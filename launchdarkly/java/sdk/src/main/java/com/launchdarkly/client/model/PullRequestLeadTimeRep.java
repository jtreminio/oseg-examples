...
public class PullRequestLeadTimeRep {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(codingDurationMs, reviewDurationMs, maxWaitDurationMs, avgWaitDurationMs, maxDeployDurationMs, avgDeployDurationMs, maxTotalLeadTimeMs, avgTotalLeadTimeMs);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PullRequestLeadTimeRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PullRequestLeadTimeRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
