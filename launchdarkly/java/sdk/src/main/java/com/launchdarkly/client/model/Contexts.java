...
import com.launchdarkly.client.model.ContextRecord;
...
public class Contexts {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Contexts.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Contexts` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
