...
public class CustomRolePost {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, key, description, policy, basePermissions, resourceCategory);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CustomRolePost.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CustomRolePost` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
