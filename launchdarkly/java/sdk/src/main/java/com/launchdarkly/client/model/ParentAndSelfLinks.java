...
import com.launchdarkly.client.model.CoreLink;
...
public class ParentAndSelfLinks {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ParentAndSelfLinks.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ParentAndSelfLinks` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
