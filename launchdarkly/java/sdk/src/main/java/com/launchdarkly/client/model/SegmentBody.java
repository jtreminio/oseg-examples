...
public class SegmentBody {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, key, description, tags, unbounded, unboundedContextKind);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SegmentBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SegmentBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
