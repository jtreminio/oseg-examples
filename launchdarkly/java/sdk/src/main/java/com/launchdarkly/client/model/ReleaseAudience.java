...
import com.launchdarkly.client.model.AudienceConfiguration;
import com.launchdarkly.client.model.EnvironmentSummary;
...
public class ReleaseAudience {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, links, environment, name, _configuration, segmentKeys, status, ruleIds);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReleaseAudience.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReleaseAudience` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
