...
import com.launchdarkly.client.model.DependentFlag;
...
public class DependentFlagsByEnvironment {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DependentFlagsByEnvironment.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DependentFlagsByEnvironment` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
