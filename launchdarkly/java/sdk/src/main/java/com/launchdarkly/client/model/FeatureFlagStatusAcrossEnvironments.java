...
import com.launchdarkly.client.model.FeatureFlagStatus;
...
public class FeatureFlagStatusAcrossEnvironments {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FeatureFlagStatusAcrossEnvironments.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FeatureFlagStatusAcrossEnvironments` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
