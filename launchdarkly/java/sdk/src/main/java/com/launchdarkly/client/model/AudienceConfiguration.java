...
import com.launchdarkly.client.model.ReleaseGuardianConfiguration;
...
public class AudienceConfiguration {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(releaseStrategy, requireApproval, notifyMemberIds, notifyTeamKeys, releaseGuardianConfiguration);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AudienceConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AudienceConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
