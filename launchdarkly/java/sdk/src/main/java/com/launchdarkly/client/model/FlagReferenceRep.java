...
public class FlagReferenceRep {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(projectKey, flagKey, referencesAdded, referencesRemoved);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FlagReferenceRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FlagReferenceRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
