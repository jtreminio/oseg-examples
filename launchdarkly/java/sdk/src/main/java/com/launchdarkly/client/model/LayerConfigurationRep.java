...
import com.launchdarkly.client.model.LayerReservationRep;
...
public class LayerConfigurationRep {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LayerConfigurationRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LayerConfigurationRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
