...
public class UpdateReleasePipelineInput {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, name, phases, tags);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateReleasePipelineInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateReleasePipelineInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
