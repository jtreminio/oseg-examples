...
public class IpList {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(addresses, outboundAddresses);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IpList.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IpList` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
