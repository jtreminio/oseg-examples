...
public class ExpandedResourceRep {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(kind, flag, segment);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExpandedResourceRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExpandedResourceRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
