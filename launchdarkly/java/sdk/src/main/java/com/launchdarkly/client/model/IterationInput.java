...
import com.launchdarkly.client.model.FlagInput;
import com.launchdarkly.client.model.MetricInput;
import com.launchdarkly.client.model.TreatmentInput;
...
public class IterationInput {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hypothesis, canReshuffleTraffic, metrics, primarySingleMetricKey, primaryFunnelKey, treatments, flags, randomizationUnit, attributes);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IterationInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IterationInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
