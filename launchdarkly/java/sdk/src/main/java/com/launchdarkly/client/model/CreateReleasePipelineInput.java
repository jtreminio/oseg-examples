...
import com.launchdarkly.client.model.CreatePhaseInput;
...
public class CreateReleasePipelineInput {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, key, name, phases, tags, isProjectDefault, isLegacy);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateReleasePipelineInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateReleasePipelineInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
