...
public class ExperimentPost {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, description, maintainerId, key, iteration, holdoutId);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExperimentPost.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExperimentPost` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
