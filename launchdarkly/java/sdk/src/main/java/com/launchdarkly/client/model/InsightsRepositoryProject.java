...
public class InsightsRepositoryProject {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(repositoryKey, projectKey);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InsightsRepositoryProject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InsightsRepositoryProject` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
