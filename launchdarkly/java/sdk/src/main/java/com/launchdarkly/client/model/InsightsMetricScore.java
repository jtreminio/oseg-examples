...
import com.launchdarkly.client.model.InsightsMetricIndicatorRange;
...
public class InsightsMetricScore {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(score, aggregateOf, diffVsLastPeriod, indicator, indicatorRange, lastPeriod);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InsightsMetricScore.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InsightsMetricScore` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
