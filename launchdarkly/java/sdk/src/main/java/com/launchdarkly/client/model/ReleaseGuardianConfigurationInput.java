...
public class ReleaseGuardianConfigurationInput {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(monitoringWindowMilliseconds, rolloutWeight, rollbackOnRegression, randomizationUnit);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReleaseGuardianConfigurationInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReleaseGuardianConfigurationInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
