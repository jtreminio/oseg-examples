...
import com.launchdarkly.client.model.ContextAttributeValues;
...
public class ContextAttributeValuesCollection {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContextAttributeValuesCollection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContextAttributeValuesCollection` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
