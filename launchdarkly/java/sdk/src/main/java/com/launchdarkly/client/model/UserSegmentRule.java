...
import com.launchdarkly.client.model.Clause;
...
public class UserSegmentRule {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, clauses, weight, rolloutContextKind, bucketBy, description);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserSegmentRule.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserSegmentRule` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
