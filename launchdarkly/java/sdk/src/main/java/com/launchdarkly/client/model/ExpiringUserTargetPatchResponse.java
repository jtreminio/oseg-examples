...
import com.launchdarkly.client.model.ExpiringTargetError;
import com.launchdarkly.client.model.ExpiringUserTargetItem;
...
public class ExpiringUserTargetPatchResponse {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExpiringUserTargetPatchResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExpiringUserTargetPatchResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
