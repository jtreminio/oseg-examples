...
public class FlagEventExperimentIteration {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, status, startedAt, endedAt, links);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FlagEventExperimentIteration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FlagEventExperimentIteration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
