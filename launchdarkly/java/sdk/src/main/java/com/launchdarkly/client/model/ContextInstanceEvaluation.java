...
import com.launchdarkly.client.model.ContextInstanceEvaluationReason;
...
public class ContextInstanceEvaluation {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, key, value, reason, links);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContextInstanceEvaluation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContextInstanceEvaluation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
