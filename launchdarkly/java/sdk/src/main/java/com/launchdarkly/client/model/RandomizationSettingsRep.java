...
import com.launchdarkly.client.model.RandomizationUnitRep;
...
public class RandomizationSettingsRep {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(projectId, projectKey, randomizationUnits, creationDate, links);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RandomizationSettingsRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RandomizationSettingsRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
