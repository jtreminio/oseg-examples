...
import com.launchdarkly.client.model.InsightsChartMetadata;
import com.launchdarkly.client.model.InsightsChartSeries;
...
public class InsightsChart {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(metadata, series);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InsightsChart.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InsightsChart` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
