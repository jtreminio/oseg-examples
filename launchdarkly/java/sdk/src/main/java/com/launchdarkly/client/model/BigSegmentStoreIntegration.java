...
import com.launchdarkly.client.model.BigSegmentStoreIntegrationLinks;
import com.launchdarkly.client.model.BigSegmentStoreStatus;
...
public class BigSegmentStoreIntegration {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(links, id, integrationKey, projectKey, environmentKey, config, on, tags, name, version, access, status);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BigSegmentStoreIntegration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BigSegmentStoreIntegration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
