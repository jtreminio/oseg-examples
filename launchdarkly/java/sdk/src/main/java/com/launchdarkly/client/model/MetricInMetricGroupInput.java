...
public class MetricInMetricGroupInput {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(key, nameInGroup);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MetricInMetricGroupInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MetricInMetricGroupInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
