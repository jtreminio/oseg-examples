...
public class WorkflowTemplateOutput {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, key, name, creationDate, ownerId, maintainerId, links, description, stages);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WorkflowTemplateOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WorkflowTemplateOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
