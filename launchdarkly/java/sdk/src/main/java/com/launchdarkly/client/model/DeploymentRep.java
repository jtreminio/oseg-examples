...
import com.launchdarkly.client.model.FlagReferenceCollectionRep;
import com.launchdarkly.client.model.LeadTimeStagesRep;
...
public class DeploymentRep {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, applicationKey, applicationVersion, startedAt, endedAt, durationMs, status, kind, active, metadata, archived, environmentKey, numberOfContributors, numberOfPullRequests, linesAdded, linesDeleted, leadTime, pullRequests, flagReferences, leadTimeStages);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeploymentRep.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeploymentRep` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
