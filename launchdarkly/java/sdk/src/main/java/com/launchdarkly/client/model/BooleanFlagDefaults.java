...
public class BooleanFlagDefaults {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(trueDisplayName, falseDisplayName, trueDescription, falseDescription, onVariation, offVariation);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BooleanFlagDefaults.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BooleanFlagDefaults` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
