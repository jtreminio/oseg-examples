...
begin
    response = LaunchDarklyClient::ApprovalsApi.new.post_approval_request_review_for_flag(
        nil, # project_key
    ...
    puts "Exception when calling ApprovalsApi#post_approval_request_review_for_flag: #{e}"
end
