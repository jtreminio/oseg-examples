...
class DeleteBigSegmentStoreIntegrationExample
{
    fun deleteBigSegmentStoreIntegration()
    {
        ...
        try
        {
            ...
            println("5xx response calling PersistentStoreIntegrationsBetaApi#deleteBigSegmentStoreIntegration")
            e.printStackTrace()
        }
    }
}
