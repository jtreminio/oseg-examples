...
data class FlagConfigApprovalRequestResponse (
    ...
    val reviewStatus: FlagConfigApprovalRequestResponse.ReviewStatus,
    ...
    @Json(name = "status")
    val status: FlagConfigApprovalRequestResponse.Status,
