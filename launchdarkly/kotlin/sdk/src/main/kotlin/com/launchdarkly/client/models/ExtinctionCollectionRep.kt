 ...
 * @param items An array of extinction events
 */


data class ExtinctionCollectionRep (
    ...
    @Json(name = "items")
    val items: kotlin.collections.Map<kotlin.String, kotlin.collections.List<Extinction>>
