...
import com.launchdarkly.client.models.ContextKindRep
 ...
 * 
 *
 * @param items An array of context kinds
 * @param links The location and content type of related resources
 */


data class ContextKindsCollectionRep (

    /* An array of context kinds */
    @Json(name = "items")
    val items: kotlin.collections.List<ContextKindRep>,
