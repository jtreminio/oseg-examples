...
import com.launchdarkly.client.models.ExpandedResourceRep
 ...
 * @param project 
 * @param environments List of environments the approval impacts
 * @param flag 
 * @param resource 
 */


data class ExpandableApprovalRequestResponse (
    ...
    val reviewStatus: ExpandableApprovalRequestResponse.ReviewStatus,
    ...
    @Json(name = "status")
    val status: ExpandableApprovalRequestResponse.Status,
    ...
    @Json(name = "resource")
    val resource: ExpandedResourceRep? = null
