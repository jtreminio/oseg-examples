...
import com.launchdarkly.client.models.FollowersPerFlag
 ...
 * @param items An array of flags and their followers
 */


data class FlagFollowersByProjEnvGetRep (
    ...
    @Json(name = "items")
    val items: kotlin.collections.List<FollowersPerFlag>? = null
