...
import com.launchdarkly.client.models.DependentFlag
 ...
 * 
 *
 * @param items A list of dependent flags, which are flags that use the requested flag as a prerequisite
 * @param links The location and content type of related resources
 * @param site 
 */


data class DependentFlagsByEnvironment (

    /* A list of dependent flags, which are flags that use the requested flag as a prerequisite */
    @Json(name = "items")
    val items: kotlin.collections.List<DependentFlag>,
