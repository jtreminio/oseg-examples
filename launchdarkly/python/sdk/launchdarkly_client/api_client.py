...
from launchdarkly_client.api_response import ApiResponse, T as ApiResponseT
import launchdarkly_client.models
from launchdarkly_client import rest
from launchdarkly_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(launchdarkly_client.models, klass)
