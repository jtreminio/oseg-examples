...
class FeatureFlag(BaseModel):
    ...
    FeatureFlag
    """ # noqa: E501
    name: StrictStr = Field(description="A human-friendly name for the feature flag")
    kind: StrictStr = Field(description="Kind of feature flag")
    description: Optional[StrictStr] = Field(default=None, description="Description of the feature flag")
    key: StrictStr = Field(description="A unique key used to reference the flag in your code")
    version: StrictInt = Field(description="Version of the feature flag", alias="_version")
    creation_date: StrictInt = Field(alias="creationDate")
    include_in_snippet: Optional[StrictBool] = Field(default=None, description="Deprecated, use <code>clientSideAvailability</code>. Whether this flag should be made available to the client-side JavaScript SDK", alias="includeInSnippet")
    client_side_availability: Optional[ClientSideAvailability] = Field(default=None, alias="clientSideAvailability")
    variations: List[Variation] = Field(description="An array of possible variations for the flag")
    temporary: StrictBool = Field(description="Whether the flag is a temporary flag")
    tags: List[StrictStr] = Field(description="Tags for the feature flag")
    links: Dict[str, Link] = Field(description="The location and content type of related resources", alias="_links")
    maintainer_id: Optional[StrictStr] = Field(default=None, description="Associated maintainerId for the feature flag", alias="maintainerId")
    maintainer: Optional[MemberSummary] = Field(default=None, alias="_maintainer")
    maintainer_team_key: Optional[StrictStr] = Field(default=None, description="The key of the associated team that maintains this feature flag", alias="maintainerTeamKey")
    maintainer_team: Optional[MaintainerTeam] = Field(default=None, alias="_maintainerTeam")
    goal_ids: Optional[List[StrictStr]] = Field(default=None, description="Deprecated, use <code>experiments</code> instead", alias="goalIds")
    experiments: ExperimentInfoRep
    custom_properties: Dict[str, CustomProperty] = Field(alias="customProperties")
    archived: StrictBool = Field(description="Boolean indicating if the feature flag is archived")
    archived_date: Optional[StrictInt] = Field(default=None, alias="archivedDate")
    deprecated: Optional[StrictBool] = Field(default=None, description="Boolean indicating if the feature flag is deprecated")
    deprecated_date: Optional[StrictInt] = Field(default=None, alias="deprecatedDate")
    defaults: Optional[Defaults] = None
    purpose: Optional[StrictStr] = Field(default=None, alias="_purpose")
    migration_settings: Optional[FlagMigrationSettingsRep] = Field(default=None, alias="migrationSettings")
    environments: Dict[str, FeatureFlagConfig] = Field(description="Details on the environments for this flag. Only returned if the request is filtered by environment, using the <code>filterEnv</code> query parameter.")
    __properties: ClassVar[List[str]] = ["name", "kind", "description", "key", "_version", "creationDate", "includeInSnippet", "clientSideAvailability", "variations", "temporary", "tags", "_links", "maintainerId", "_maintainer", "maintainerTeamKey", "_maintainerTeam", "goalIds", "experiments", "customProperties", "archived", "archivedDate", "deprecated", "deprecatedDate", "defaults", "_purpose", "migrationSettings", "environments"]

    @field_validator('kind')
    def kind_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['boolean', 'multivariate']):
            raise ValueError("must be one of enum values ('boolean', 'multivariate')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of client_side_availability
        if self.client_side_availability:
            _dict['clientSideAvailability'] = self.client_side_availability.to_dict()
        ...
        # override the default output from pydantic by calling `to_dict()` of maintainer_team
        if self.maintainer_team:
            _dict['_maintainerTeam'] = self.maintainer_team.to_dict()
        ...
        # override the default output from pydantic by calling `to_dict()` of migration_settings
        if self.migration_settings:
            _dict['migrationSettings'] = self.migration_settings.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "clientSideAvailability": ClientSideAvailability.from_dict(obj["clientSideAvailability"]) if obj.get("clientSideAvailability") is not None else None,
            "variations": [Variation.from_dict(_item) for _item in obj["variations"]] if obj.get("variations") is not None else None,
            ...
            "_maintainerTeam": MaintainerTeam.from_dict(obj["_maintainerTeam"]) if obj.get("_maintainerTeam") is not None else None,
            "goalIds": obj.get("goalIds"),
            "experiments": ExperimentInfoRep.from_dict(obj["experiments"]) if obj.get("experiments") is not None else None,
            "customProperties": dict(
                (_k, CustomProperty.from_dict(_v))
            ...
            "deprecatedDate": obj.get("deprecatedDate"),
            "defaults": Defaults.from_dict(obj["defaults"]) if obj.get("defaults") is not None else None,
            "_purpose": obj.get("_purpose"),
            "migrationSettings": FlagMigrationSettingsRep.from_dict(obj["migrationSettings"]) if obj.get("migrationSettings") is not None else None,
            "environments": dict(
                (_k, FeatureFlagConfig.from_dict(_v))
                for _k, _v in obj["environments"].items()
            )
