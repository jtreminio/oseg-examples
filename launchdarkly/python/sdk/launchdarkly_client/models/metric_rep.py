...
class MetricRep(BaseModel):
    ...
    version_id: StrictStr = Field(description="The version ID of the metric", alias="_versionId")
    key: StrictStr = Field(description="A unique key to reference the metric")
    name: StrictStr = Field(description="A human-friendly name for the metric")
    kind: StrictStr = Field(description="The kind of event the metric tracks")
    attached_flag_count: Optional[StrictInt] = Field(default=None, description="The number of feature flags currently attached to this metric", alias="_attachedFlagCount")
    links: Dict[str, Link] = Field(description="The location and content type of related resources", alias="_links")
    site: Optional[Link] = Field(default=None, alias="_site")
    access: Optional[Access] = Field(default=None, alias="_access")
    tags: List[StrictStr] = Field(description="Tags for the metric")
    creation_date: StrictInt = Field(alias="_creationDate")
    last_modified: Optional[Modification] = Field(default=None, alias="lastModified")
    maintainer_id: Optional[StrictStr] = Field(default=None, description="The ID of the member who maintains this metric", alias="maintainerId")
    maintainer: Optional[MemberSummary] = Field(default=None, alias="_maintainer")
    description: Optional[StrictStr] = Field(default=None, description="Description of the metric")
    is_numeric: Optional[StrictBool] = Field(default=None, description="For custom metrics, whether to track numeric changes in value against a baseline (<code>true</code>) or to track a conversion when an end user takes an action (<code>false</code>).", alias="isNumeric")
    success_criteria: Optional[StrictStr] = Field(default=None, description="For custom metrics, the success criteria", alias="successCriteria")
    unit: Optional[StrictStr] = Field(default=None, description="For numeric custom metrics, the unit of measure")
    event_key: Optional[StrictStr] = Field(default=None, description="For custom metrics, the event key to use in your code", alias="eventKey")
    randomization_units: Optional[List[StrictStr]] = Field(default=None, description="An array of randomization units allowed for this metric", alias="randomizationUnits")
    unit_aggregation_type: Optional[StrictStr] = Field(default=None, description="The method by which multiple unit event values are aggregated", alias="unitAggregationType")
    ...
    metric_groups: Optional[List[DependentMetricGroupRep]] = Field(default=None, description="Metric groups that use this metric", alias="metricGroups")
    is_active: Optional[StrictBool] = Field(default=None, description="Whether the metric is active", alias="isActive")
    attached_features: Optional[List[FlagListingRep]] = Field(default=None, description="Details on the flags attached to this metric", alias="_attachedFeatures")
    version: Optional[StrictInt] = Field(default=None, description="Version of the metric", alias="_version")
    ...
    __properties: ClassVar[List[str]] = ["experimentCount", "metricGroupCount", "_id", "_versionId", "key", "name", "kind", "_attachedFlagCount", "_links", "_site", "_access", "tags", "_creationDate", "lastModified", "maintainerId", "_maintainer", "description", "isNumeric", "successCriteria", "unit", "eventKey", "randomizationUnits", "unitAggregationType", "analysisType", "percentileValue", "eventDefault", "experiments", "metricGroups", "isActive", "_attachedFeatures", "_version", "selector", "urls"]

    @field_validator('kind')
    def kind_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['pageview', 'click', 'custom']):
            raise ValueError("must be one of enum values ('pageview', 'click', 'custom')")
        return value

    @field_validator('success_criteria')
    def success_criteria_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value

        if value not in set(['HigherThanBaseline', 'LowerThanBaseline']):
            raise ValueError("must be one of enum values ('HigherThanBaseline', 'LowerThanBaseline')")
        return value

    @field_validator('unit_aggregation_type')
    def unit_aggregation_type_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value

        if value not in set(['average', 'sum']):
            raise ValueError("must be one of enum values ('average', 'sum')")
        return value

    @field_validator('analysis_type')
    def analysis_type_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value

        if value not in set(['mean', 'percentile']):
            raise ValueError("must be one of enum values ('mean', 'percentile')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.event_default:
            _dict['eventDefault'] = self.event_default.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "_id": obj.get("_id"),
            "_versionId": obj.get("_versionId"),
            "key": obj.get("key"),
            "name": obj.get("name"),
            "kind": obj.get("kind"),
            "_attachedFlagCount": obj.get("_attachedFlagCount"),
            "_links": dict(
            ...
            "_site": Link.from_dict(obj["_site"]) if obj.get("_site") is not None else None,
            "_access": Access.from_dict(obj["_access"]) if obj.get("_access") is not None else None,
            "tags": obj.get("tags"),
            "_creationDate": obj.get("_creationDate"),
            "lastModified": Modification.from_dict(obj["lastModified"]) if obj.get("lastModified") is not None else None,
            "maintainerId": obj.get("maintainerId"),
            "_maintainer": MemberSummary.from_dict(obj["_maintainer"]) if obj.get("_maintainer") is not None else None,
            "description": obj.get("description"),
            "isNumeric": obj.get("isNumeric"),
            "successCriteria": obj.get("successCriteria"),
            "unit": obj.get("unit"),
            "eventKey": obj.get("eventKey"),
            "randomizationUnits": obj.get("randomizationUnits"),
            "unitAggregationType": obj.get("unitAggregationType"),
            ...
            "metricGroups": [DependentMetricGroupRep.from_dict(_item) for _item in obj["metricGroups"]] if obj.get("metricGroups") is not None else None,
            "isActive": obj.get("isActive"),
            "_attachedFeatures": [FlagListingRep.from_dict(_item) for _item in obj["_attachedFeatures"]] if obj.get("_attachedFeatures") is not None else None,
