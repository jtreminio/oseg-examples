...
class AuditLogEntryRep(BaseModel):
    """
    AuditLogEntryRep
    """ # noqa: E501
    links: Dict[str, Link] = Field(description="The location and content type of related resources", alias="_links")
    id: StrictStr = Field(description="The ID of the audit log entry", alias="_id")
    account_id: StrictStr = Field(description="The ID of the account to which this audit log entry belongs", alias="_accountId")
    var_date: StrictInt = Field(alias="date")
    accesses: List[ResourceAccess] = Field(description="Details on the actions performed and resources acted on in this audit log entry")
    kind: StrictStr
    name: StrictStr = Field(description="The name of the resource this audit log entry refers to")
    description: StrictStr = Field(description="Description of the change recorded in the audit log entry")
    short_description: StrictStr = Field(description="Shorter version of the change recorded in the audit log entry", alias="shortDescription")
    comment: Optional[StrictStr] = Field(default=None, description="Optional comment for the audit log entry")
    subject: Optional[SubjectDataRep] = None
    member: Optional[MemberDataRep] = None
    token: Optional[TokenSummary] = None
    app: Optional[AuthorizedAppDataRep] = None
    title_verb: Optional[StrictStr] = Field(default=None, description="The action and resource recorded in this audit log entry", alias="titleVerb")
    title: Optional[StrictStr] = Field(default=None, description="A description of what occurred, in the format <code>member</code> <code>titleVerb</code> <code>target</code>")
    target: Optional[TargetResourceRep] = None
    parent: Optional[ParentResourceRep] = None
    delta: Optional[Any] = Field(default=None, description="If the audit log entry has been updated, this is the JSON patch body that was used in the request to update the entity")
    trigger_body: Optional[Any] = Field(default=None, description="A JSON representation of the external trigger for this audit log entry, if any", alias="triggerBody")
    merge: Optional[Any] = Field(default=None, description="A JSON representation of the merge information for this audit log entry, if any")
    previous_version: Optional[Any] = Field(default=None, description="If the audit log entry has been updated, this is a JSON representation of the previous version of the entity", alias="previousVersion")
    current_version: Optional[Any] = Field(default=None, description="If the audit log entry has been updated, this is a JSON representation of the current version of the entity", alias="currentVersion")
    subentries: Optional[List[AuditLogEntryListingRep]] = None
    __properties: ClassVar[List[str]] = ["_links", "_id", "_accountId", "date", "accesses", "kind", "name", "description", "shortDescription", "comment", "subject", "member", "token", "app", "titleVerb", "title", "target", "parent", "delta", "triggerBody", "merge", "previousVersion", "currentVersion", "subentries"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if trigger_body (nullable) is None
        # and model_fields_set contains the field
        if self.trigger_body is None and "trigger_body" in self.model_fields_set:
            _dict['triggerBody'] = None

        # set to None if merge (nullable) is None
        # and model_fields_set contains the field
        if self.merge is None and "merge" in self.model_fields_set:
            _dict['merge'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "_id": obj.get("_id"),
            "_accountId": obj.get("_accountId"),
            "date": obj.get("date"),
            "accesses": [ResourceAccess.from_dict(_item) for _item in obj["accesses"]] if obj.get("accesses") is not None else None,
            "kind": obj.get("kind"),
            "name": obj.get("name"),
            "description": obj.get("description"),
            "shortDescription": obj.get("shortDescription"),
            "comment": obj.get("comment"),
            "subject": SubjectDataRep.from_dict(obj["subject"]) if obj.get("subject") is not None else None,
            "member": MemberDataRep.from_dict(obj["member"]) if obj.get("member") is not None else None,
            "token": TokenSummary.from_dict(obj["token"]) if obj.get("token") is not None else None,
            "app": AuthorizedAppDataRep.from_dict(obj["app"]) if obj.get("app") is not None else None,
            "titleVerb": obj.get("titleVerb"),
            "title": obj.get("title"),
            "target": TargetResourceRep.from_dict(obj["target"]) if obj.get("target") is not None else None,
            "parent": ParentResourceRep.from_dict(obj["parent"]) if obj.get("parent") is not None else None,
            "delta": obj.get("delta"),
            "triggerBody": obj.get("triggerBody"),
            "merge": obj.get("merge"),
            "previousVersion": obj.get("previousVersion"),
            "currentVersion": obj.get("currentVersion"),
            "subentries": [AuditLogEntryListingRep.from_dict(_item) for _item in obj["subentries"]] if obj.get("subentries") is not None else None
        })
        return _obj
