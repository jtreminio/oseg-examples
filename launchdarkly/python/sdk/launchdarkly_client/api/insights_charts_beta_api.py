...
class InsightsChartsBetaApi:
    ...
    @validate_call
    def get_deployment_frequency_chart(
        self,
        project_key: Annotated[Optional[StrictStr], Field(description="The project key")] = None,
        environment_key: Annotated[Optional[StrictStr], Field(description="The environment key")] = None,
        application_key: Annotated[Optional[StrictStr], Field(description="Comma separated list of application keys")] = None,
        var_from: Annotated[Optional[datetime], Field(description="Unix timestamp in milliseconds. Default value is 7 days ago.")] = None,
        to: Annotated[Optional[datetime], Field(description="Unix timestamp in milliseconds. Default value is now.")] = None,
        bucket_type: Annotated[Optional[StrictStr], Field(description="Specify type of bucket. Options: `rolling`, `hour`, `day`. Default: `rolling`.")] = None,
        bucket_ms: Annotated[Optional[StrictInt], Field(description="Duration of intervals for x-axis in milliseconds. Default value is one day (`86400000` milliseconds).")] = None,
        group_by: Annotated[Optional[StrictStr], Field(description="Options: `application`, `kind`")] = None,
        expand: Annotated[Optional[StrictStr], Field(description="Options: `metrics`")] = None,
        ...
        :param application_key: Comma separated list of application keys
        :type application_key: str
        :param var_from: Unix timestamp in milliseconds. Default value is 7 days ago.
        :type var_from: datetime
        :param to: Unix timestamp in milliseconds. Default value is now.
        :type to: datetime
        :param bucket_type: Specify type of bucket. Options: `rolling`, `hour`, `day`. Default: `rolling`.
        :type bucket_type: str
        :param bucket_ms: Duration of intervals for x-axis in milliseconds. Default value is one day (`86400000` milliseconds).
        :type bucket_ms: int
        :param group_by: Options: `application`, `kind`
        :type group_by: str
        :param expand: Options: `metrics`
        :type expand: str
        ...
        _param = self._get_deployment_frequency_chart_serialize(
    ...
    @validate_call
    def get_deployment_frequency_chart_with_http_info(
        self,
        project_key: Annotated[Optional[StrictStr], Field(description="The project key")] = None,
        environment_key: Annotated[Optional[StrictStr], Field(description="The environment key")] = None,
        application_key: Annotated[Optional[StrictStr], Field(description="Comma separated list of application keys")] = None,
    ...
    @validate_call
    def get_deployment_frequency_chart_without_preload_content(
        self,
        project_key: Annotated[Optional[StrictStr], Field(description="The project key")] = None,
        environment_key: Annotated[Optional[StrictStr], Field(description="The environment key")] = None,
        application_key: Annotated[Optional[StrictStr], Field(description="Comma separated list of application keys")] = None,
    ...
    def _get_deployment_frequency_chart_serialize(
        self,
        project_key,
        environment_key,
        application_key,
        ...
        if bucket_ms is not None:
            ...
            _query_params.append(('bucketMs', bucket_ms))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/engineering-insights/charts/deployments/frequency',
    ...
    def get_flag_status_chart(
        ...
        _param = self._get_flag_status_chart_serialize(
            project_key=project_key,
            environment_key=environment_key,
            application_key=application_key,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_flag_status_chart_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        application_key: Annotated[Optional[StrictStr], Field(description="Comma separated list of application keys")] = None,
    ...
    @validate_call
    def get_flag_status_chart_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        application_key: Annotated[Optional[StrictStr], Field(description="Comma separated list of application keys")] = None,
    ...
    def _get_flag_status_chart_serialize(
        self,
        project_key,
        environment_key,
        application_key,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/engineering-insights/charts/flags/status',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_lead_time_chart(
        ...
        environment_key: Annotated[Optional[StrictStr], Field(description="The environment key")] = None,
        application_key: Annotated[Optional[StrictStr], Field(description="Comma separated list of application keys")] = None,
        var_from: Annotated[Optional[StrictInt], Field(description="Unix timestamp in milliseconds. Default value is 7 days ago.")] = None,
        to: Annotated[Optional[StrictInt], Field(description="Unix timestamp in milliseconds. Default value is now.")] = None,
        bucket_type: Annotated[Optional[StrictStr], Field(description="Specify type of bucket. Options: `rolling`, `hour`, `day`. Default: `rolling`.")] = None,
        bucket_ms: Annotated[Optional[StrictInt], Field(description="Duration of intervals for x-axis in milliseconds. Default value is one day (`86400000` milliseconds).")] = None,
        group_by: Annotated[Optional[StrictStr], Field(description="Options: `application`, `stage`. Default: `stage`.")] = None,
        expand: Annotated[Optional[StrictStr], Field(description="Options: `metrics`, `percentiles`.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param bucket_ms: Duration of intervals for x-axis in milliseconds. Default value is one day (`86400000` milliseconds).
        :type bucket_ms: int
        :param group_by: Options: `application`, `stage`. Default: `stage`.
        :type group_by: str
        :param expand: Options: `metrics`, `percentiles`.
        :type expand: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_lead_time_chart_serialize(
            project_key=project_key,
            environment_key=environment_key,
            application_key=application_key,
            var_from=var_from,
    ...
    @validate_call
    def get_lead_time_chart_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[Optional[StrictStr], Field(description="The environment key")] = None,
        application_key: Annotated[Optional[StrictStr], Field(description="Comma separated list of application keys")] = None,
    ...
    @validate_call
    def get_lead_time_chart_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[Optional[StrictStr], Field(description="The environment key")] = None,
        application_key: Annotated[Optional[StrictStr], Field(description="Comma separated list of application keys")] = None,
    ...
    def _get_lead_time_chart_serialize(
        self,
        project_key,
        environment_key,
        application_key,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/engineering-insights/charts/lead-time',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_release_frequency_chart(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        application_key: Annotated[Optional[StrictStr], Field(description="Comma separated list of application keys")] = None,
        has_experiments: Annotated[Optional[StrictBool], Field(description="Filter events to those associated with an experiment (`true`) or without an experiment (`false`)")] = None,
        var_global: Annotated[Optional[StrictStr], Field(description="Filter to include or exclude global events. Default value is `include`. Options: `include`, `exclude`")] = None,
        group_by: Annotated[Optional[StrictStr], Field(description="Property to group results by. Options: `impact`")] = None,
        var_from: Annotated[Optional[datetime], Field(description="Unix timestamp in milliseconds. Default value is 7 days ago.")] = None,
        to: Annotated[Optional[datetime], Field(description="Unix timestamp in milliseconds. Default value is now.")] = None,
        bucket_type: Annotated[Optional[StrictStr], Field(description="Specify type of bucket. Options: `rolling`, `hour`, `day`. Default: `rolling`.")] = None,
        bucket_ms: Annotated[Optional[StrictInt], Field(description="Duration of intervals for x-axis in milliseconds. Default value is one day (`86400000` milliseconds).")] = None,
        ...
        :param application_key: Comma separated list of application keys
        :type application_key: str
        :param has_experiments: Filter events to those associated with an experiment (`true`) or without an experiment (`false`)
        :type has_experiments: bool
        :param var_global: Filter to include or exclude global events. Default value is `include`. Options: `include`, `exclude`
        :type var_global: str
        :param group_by: Property to group results by. Options: `impact`
        :type group_by: str
        :param var_from: Unix timestamp in milliseconds. Default value is 7 days ago.
        :type var_from: datetime
        :param to: Unix timestamp in milliseconds. Default value is now.
        ...
        _param = self._get_release_frequency_chart_serialize(
            project_key=project_key,
            environment_key=environment_key,
            application_key=application_key,
    ...
    @validate_call
    def get_release_frequency_chart_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        application_key: Annotated[Optional[StrictStr], Field(description="Comma separated list of application keys")] = None,
    ...
    @validate_call
    def get_release_frequency_chart_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        application_key: Annotated[Optional[StrictStr], Field(description="Comma separated list of application keys")] = None,
    ...
    def _get_release_frequency_chart_serialize(
        self,
        project_key,
        environment_key,
        application_key,
        ...
        if has_experiments is not None:
            ...
            _query_params.append(('hasExperiments', has_experiments))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/engineering-insights/charts/releases/frequency',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_stale_flags_chart(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        application_key: Annotated[Optional[StrictStr], Field(description="Comma separated list of application keys")] = None,
        group_by: Annotated[Optional[StrictStr], Field(description="Property to group results by. Options: `maintainer`")] = None,
        maintainer_id: Annotated[Optional[StrictStr], Field(description="Comma-separated list of individual maintainers to filter results.")] = None,
        maintainer_team_key: Annotated[Optional[StrictStr], Field(description="Comma-separated list of team maintainer keys to filter results.")] = None,
        expand: Annotated[Optional[StrictStr], Field(description="Options: `metrics`")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param application_key: Comma separated list of application keys
        :type application_key: str
        :param group_by: Property to group results by. Options: `maintainer`
        :type group_by: str
        :param maintainer_id: Comma-separated list of individual maintainers to filter results.
        :type maintainer_id: str
        :param maintainer_team_key: Comma-separated list of team maintainer keys to filter results.
        :type maintainer_team_key: str
        :param expand: Options: `metrics`
        :type expand: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._get_stale_flags_chart_serialize(
            project_key=project_key,
            environment_key=environment_key,
            application_key=application_key,
            group_by=group_by,
    ...
    @validate_call
    def get_stale_flags_chart_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        application_key: Annotated[Optional[StrictStr], Field(description="Comma separated list of application keys")] = None,
    ...
    @validate_call
    def get_stale_flags_chart_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        application_key: Annotated[Optional[StrictStr], Field(description="Comma separated list of application keys")] = None,
    ...
    def _get_stale_flags_chart_serialize(
        self,
        project_key,
        environment_key,
        application_key,
        ...
        if maintainer_id is not None:
            ...
            _query_params.append(('maintainerId', maintainer_id))
            
        if maintainer_team_key is not None:
            
            _query_params.append(('maintainerTeamKey', maintainer_team_key))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/engineering-insights/charts/flags/stale',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
