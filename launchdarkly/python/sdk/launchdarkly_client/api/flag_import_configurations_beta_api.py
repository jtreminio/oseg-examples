...
class FlagImportConfigurationsBetaApi:
    ...
    @validate_call
    def create_flag_import_configuration(
        self,
        ...
        :param flag_import_configuration_post: (required)
        :type flag_import_configuration_post: FlagImportConfigurationPost
        ...
        _param = self._create_flag_import_configuration_serialize(
    ...
    @validate_call
    def create_flag_import_configuration_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        integration_key: Annotated[StrictStr, Field(description="The integration key")],
        flag_import_configuration_post: FlagImportConfigurationPost,
    ...
    @validate_call
    def create_flag_import_configuration_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        integration_key: Annotated[StrictStr, Field(description="The integration key")],
        flag_import_configuration_post: FlagImportConfigurationPost,
    ...
    def _create_flag_import_configuration_serialize(
        self,
        project_key,
        integration_key,
        ...
        if flag_import_configuration_post is not None:
            _body_params = flag_import_configuration_post
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/integration-capabilities/flag-import/{projectKey}/{integrationKey}',
    ...
    @validate_call
    def delete_flag_import_configuration(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        integration_key: Annotated[StrictStr, Field(description="The integration key")],
        ...
        _param = self._delete_flag_import_configuration_serialize(
            project_key=project_key,
            integration_key=integration_key,
    ...
    @validate_call
    def delete_flag_import_configuration_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        integration_key: Annotated[StrictStr, Field(description="The integration key")],
        integration_id: Annotated[StrictStr, Field(description="The integration ID")],
    ...
    @validate_call
    def delete_flag_import_configuration_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        integration_key: Annotated[StrictStr, Field(description="The integration key")],
        integration_id: Annotated[StrictStr, Field(description="The integration ID")],
    ...
    def _delete_flag_import_configuration_serialize(
        self,
        project_key,
        integration_key,
        integration_id,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v2/integration-capabilities/flag-import/{projectKey}/{integrationKey}/{integrationId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_flag_import_configuration(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        integration_key: Annotated[StrictStr, Field(description="The integration key, for example, `split`")],
        integration_id: Annotated[StrictStr, Field(description="The integration ID")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param project_key: The project key (required)
        :type project_key: str
        :param integration_key: The integration key, for example, `split` (required)
        :type integration_key: str
        :param integration_id: The integration ID (required)
        :type integration_id: str
        :param _request_timeout: timeout setting for this request. If one
        ...
        _param = self._get_flag_import_configuration_serialize(
            project_key=project_key,
            integration_key=integration_key,
            integration_id=integration_id,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_flag_import_configuration_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        integration_key: Annotated[StrictStr, Field(description="The integration key, for example, `split`")],
        integration_id: Annotated[StrictStr, Field(description="The integration ID")],
    ...
    @validate_call
    def get_flag_import_configuration_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        integration_key: Annotated[StrictStr, Field(description="The integration key, for example, `split`")],
        integration_id: Annotated[StrictStr, Field(description="The integration ID")],
    ...
    def _get_flag_import_configuration_serialize(
        self,
        project_key,
        integration_key,
        integration_id,
    ...
    @validate_call
    def get_flag_import_configurations(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._get_flag_import_configurations_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "FlagImportIntegrationCollection",
            '400': "InvalidRequestErrorRep",
            '401': "UnauthorizedErrorRep",
            '403': "ForbiddenErrorRep",
            '404': "NotFoundErrorRep",
    ...
    @validate_call
    def get_flag_import_configurations_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_flag_import_configurations_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_flag_import_configurations_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/integration-capabilities/flag-import',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def patch_flag_import_configuration(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        integration_key: Annotated[StrictStr, Field(description="The integration key")],
        integration_id: Annotated[StrictStr, Field(description="The integration ID")],
        ...
        _param = self._patch_flag_import_configuration_serialize(
            project_key=project_key,
            integration_key=integration_key,
            integration_id=integration_id,
    ...
    @validate_call
    def patch_flag_import_configuration_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        integration_key: Annotated[StrictStr, Field(description="The integration key")],
        integration_id: Annotated[StrictStr, Field(description="The integration ID")],
    ...
    @validate_call
    def patch_flag_import_configuration_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        integration_key: Annotated[StrictStr, Field(description="The integration key")],
        integration_id: Annotated[StrictStr, Field(description="The integration ID")],
    ...
    def _patch_flag_import_configuration_serialize(
        self,
        project_key,
        integration_key,
        integration_id,
    ...
    def trigger_flag_import_job(
        ...
        _param = self._trigger_flag_import_job_serialize(
            project_key=project_key,
            integration_key=integration_key,
            integration_id=integration_id,
            _request_auth=_request_auth,
    ...
    @validate_call
    def trigger_flag_import_job_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        integration_key: Annotated[StrictStr, Field(description="The integration key")],
        integration_id: Annotated[StrictStr, Field(description="The integration ID")],
    ...
    @validate_call
    def trigger_flag_import_job_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        integration_key: Annotated[StrictStr, Field(description="The integration key")],
        integration_id: Annotated[StrictStr, Field(description="The integration ID")],
    ...
    def _trigger_flag_import_job_serialize(
        self,
        project_key,
        integration_key,
        integration_id,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/integration-capabilities/flag-import/{projectKey}/{integrationKey}/{integrationId}/trigger',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
