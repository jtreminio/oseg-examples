...
class ContextSettingsApi:
    ...
    def put_context_flag_setting(
        ...
        context_kind: Annotated[StrictStr, Field(description="The context kind")],
        ...
        :param context_kind: The context kind (required)
        ...
        _param = self._put_context_flag_setting_serialize(
    ...
    @validate_call
    def put_context_flag_setting_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        context_kind: Annotated[StrictStr, Field(description="The context kind")],
    ...
    @validate_call
    def put_context_flag_setting_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        context_kind: Annotated[StrictStr, Field(description="The context kind")],
    ...
    def _put_context_flag_setting_serialize(
        self,
        project_key,
        environment_key,
        context_kind,
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/api/v2/projects/{projectKey}/environments/{environmentKey}/contexts/{contextKind}/{contextKey}/flags/{featureFlagKey}',
