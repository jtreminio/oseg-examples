...
class OAuth2ClientsApi:
    ...
    def create_o_auth2_client(
        ...
        :param oauth_client_post: (required)
        :type oauth_client_post: OauthClientPost
    ...
    def _create_o_auth2_client_serialize(
        ...
        if oauth_client_post is not None:
            _body_params = oauth_client_post
    ...
    def _delete_o_auth_client_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v2/oauth/clients/{clientId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def patch_o_auth_client(
        ...
        _param = self._patch_o_auth_client_serialize(
            client_id=client_id,
    ...
    @validate_call
    def patch_o_auth_client_without_preload_content(
        self,
        client_id: Annotated[StrictStr, Field(description="The client ID")],
        patch_operation: List[PatchOperation],
        _request_timeout: Union[
    ...
    def _patch_o_auth_client_serialize(
        self,
        client_id,
        patch_operation,
        _request_auth,
