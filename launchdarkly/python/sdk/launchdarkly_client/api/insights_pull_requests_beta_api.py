...
class InsightsPullRequestsBetaApi:
    ...
    def get_pull_requests(
        ...
        environment_key: Annotated[Optional[StrictStr], Field(description="Required if you are using the <code>sort</code> parameter's <code>leadTime</code> option to sort pull requests.")] = None,
        application_key: Annotated[Optional[StrictStr], Field(description="Filter the results to pull requests deployed to a comma separated list of applications")] = None,
        status: Annotated[Optional[StrictStr], Field(description="Filter results to pull requests with the given status. Options: `open`, `merged`, `closed`, `deployed`.")] = None,
        query: Annotated[Optional[StrictStr], Field(description="Filter list of pull requests by title or author")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="The number of pull requests to return. Default is 20. Maximum allowed is 100.")] = None,
        expand: Annotated[Optional[StrictStr], Field(description="Expand properties in response. Options: `deployments`, `flagReferences`, `leadTime`.")] = None,
        sort: Annotated[Optional[StrictStr], Field(description="Sort results. Requires the `environmentKey` to be set. Options: `leadTime` (asc) and `-leadTime` (desc). When query option is excluded, default sort is by created or merged date.")] = None,
        ...
        :param environment_key: Required if you are using the <code>sort</code> parameter's <code>leadTime</code> option to sort pull requests.
        :type environment_key: str
        :param application_key: Filter the results to pull requests deployed to a comma separated list of applications
        :type application_key: str
        :param status: Filter results to pull requests with the given status. Options: `open`, `merged`, `closed`, `deployed`.
        :type status: str
        :param query: Filter list of pull requests by title or author
        :type query: str
        :param limit: The number of pull requests to return. Default is 20. Maximum allowed is 100.
        :type limit: int
        :param expand: Expand properties in response. Options: `deployments`, `flagReferences`, `leadTime`.
        :type expand: str
        :param sort: Sort results. Requires the `environmentKey` to be set. Options: `leadTime` (asc) and `-leadTime` (desc). When query option is excluded, default sort is by created or merged date.
        :type sort: str
    ...
    def _get_pull_requests_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/engineering-insights/pull-requests',
