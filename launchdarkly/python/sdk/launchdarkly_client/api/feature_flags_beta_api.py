...
class FeatureFlagsBetaApi:
    ...
    def get_dependent_flags(
        ...
        _param = self._get_dependent_flags_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "MultiEnvironmentDependentFlags",
    ...
    @validate_call
    def get_dependent_flags_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        feature_flag_key: Annotated[StrictStr, Field(description="The feature flag key")],
        _request_timeout: Union[
    ...
    @validate_call
    def get_dependent_flags_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        feature_flag_key: Annotated[StrictStr, Field(description="The feature flag key")],
        _request_timeout: Union[
    ...
    def _get_dependent_flags_serialize(
        self,
        project_key,
        feature_flag_key,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/flags/{projectKey}/{featureFlagKey}/dependent-flags',
    ...
    def get_dependent_flags_by_env(
        ...
        _param = self._get_dependent_flags_by_env_serialize(
            project_key=project_key,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "DependentFlagsByEnvironment",
            '401': "UnauthorizedErrorRep",
            '403': "ForbiddenErrorRep",
            '404': "NotFoundErrorRep",
            '429': "RateLimitedErrorRep",
    ...
    @validate_call
    def get_dependent_flags_by_env_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        feature_flag_key: Annotated[StrictStr, Field(description="The feature flag key")],
    ...
    @validate_call
    def get_dependent_flags_by_env_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        feature_flag_key: Annotated[StrictStr, Field(description="The feature flag key")],
    ...
    def _get_dependent_flags_by_env_serialize(
        self,
        project_key,
        environment_key,
        feature_flag_key,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/flags/{projectKey}/{environmentKey}/{featureFlagKey}/dependent-flags',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
