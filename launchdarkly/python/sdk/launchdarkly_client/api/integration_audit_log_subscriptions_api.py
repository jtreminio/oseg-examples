...
class IntegrationAuditLogSubscriptionsApi:
    ...
    def create_subscription(
        ...
        :param subscription_post: (required)
        :type subscription_post: SubscriptionPost
    ...
    def _create_subscription_serialize(
        ...
        if subscription_post is not None:
            _body_params = subscription_post
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/integrations/{integrationKey}',
    ...
    def _delete_subscription_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v2/integrations/{integrationKey}/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_subscription(
        self,
        integration_key: Annotated[StrictStr, Field(description="The integration key")],
        id: Annotated[StrictStr, Field(description="The ID of the audit log subscription")],
