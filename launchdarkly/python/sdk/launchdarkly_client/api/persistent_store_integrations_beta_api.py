...
class PersistentStoreIntegrationsBetaApi:
    ...
    @validate_call
    def create_big_segment_store_integration(
        self,
        ...
        integration_key: Annotated[StrictStr, Field(description="The integration key, either `redis` or `dynamodb`")],
        ...
        :param integration_key: The integration key, either `redis` or `dynamodb` (required)
        ...
        _param = self._create_big_segment_store_integration_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "BigSegmentStoreIntegration",
    ...
    @validate_call
    def create_big_segment_store_integration_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        integration_key: Annotated[StrictStr, Field(description="The integration key, either `redis` or `dynamodb`")],
    ...
    @validate_call
    def create_big_segment_store_integration_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        integration_key: Annotated[StrictStr, Field(description="The integration key, either `redis` or `dynamodb`")],
    ...
    def _create_big_segment_store_integration_serialize(
        self,
        project_key,
        environment_key,
        integration_key,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/integration-capabilities/big-segment-store/{projectKey}/{environmentKey}/{integrationKey}',
    ...
    def delete_big_segment_store_integration(
        ...
        _param = self._delete_big_segment_store_integration_serialize(
            project_key=project_key,
            environment_key=environment_key,
            integration_key=integration_key,
    ...
    @validate_call
    def delete_big_segment_store_integration_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        integration_key: Annotated[StrictStr, Field(description="The integration key, either `redis` or `dynamodb`")],
    ...
    @validate_call
    def delete_big_segment_store_integration_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        integration_key: Annotated[StrictStr, Field(description="The integration key, either `redis` or `dynamodb`")],
    ...
    def _delete_big_segment_store_integration_serialize(
        self,
        project_key,
        environment_key,
        integration_key,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v2/integration-capabilities/big-segment-store/{projectKey}/{environmentKey}/{integrationKey}/{integrationId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_big_segment_store_integration(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        integration_key: Annotated[StrictStr, Field(description="The integration key, either `redis` or `dynamodb`")],
        ...
        _param = self._get_big_segment_store_integration_serialize(
            project_key=project_key,
            environment_key=environment_key,
            integration_key=integration_key,
            integration_id=integration_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "BigSegmentStoreIntegration",
            '401': "UnauthorizedErrorRep",
            '403': "ForbiddenErrorRep",
            '404': "NotFoundErrorRep",
            '429': "RateLimitedErrorRep",
    ...
    @validate_call
    def get_big_segment_store_integration_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        integration_key: Annotated[StrictStr, Field(description="The integration key, either `redis` or `dynamodb`")],
    ...
    @validate_call
    def get_big_segment_store_integration_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        integration_key: Annotated[StrictStr, Field(description="The integration key, either `redis` or `dynamodb`")],
    ...
    def _get_big_segment_store_integration_serialize(
        self,
        project_key,
        environment_key,
        integration_key,
    ...
    @validate_call
    def get_big_segment_store_integrations(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._get_big_segment_store_integrations_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "BigSegmentStoreIntegrationCollection",
            '401': "UnauthorizedErrorRep",
            '403': "ForbiddenErrorRep",
            '404': "NotFoundErrorRep",
            '429': "RateLimitedErrorRep",
    ...
    @validate_call
    def get_big_segment_store_integrations_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_big_segment_store_integrations_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_big_segment_store_integrations_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/integration-capabilities/big-segment-store',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def patch_big_segment_store_integration(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        integration_key: Annotated[StrictStr, Field(description="The integration key, either `redis` or `dynamodb`")],
        ...
        _param = self._patch_big_segment_store_integration_serialize(
            project_key=project_key,
            environment_key=environment_key,
            integration_key=integration_key,
            integration_id=integration_id,
    ...
    @validate_call
    def patch_big_segment_store_integration_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        integration_key: Annotated[StrictStr, Field(description="The integration key, either `redis` or `dynamodb`")],
    ...
    @validate_call
    def patch_big_segment_store_integration_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        integration_key: Annotated[StrictStr, Field(description="The integration key, either `redis` or `dynamodb`")],
    ...
    def _patch_big_segment_store_integration_serialize(
        self,
        project_key,
        environment_key,
        integration_key,
