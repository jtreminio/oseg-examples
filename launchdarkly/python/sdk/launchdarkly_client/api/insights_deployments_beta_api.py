...
class InsightsDeploymentsBetaApi:
    ...
    def create_deployment_event(
        ...
        :param post_deployment_event_input: (required)
        :type post_deployment_event_input: PostDeploymentEventInput
        ...
        _param = self._create_deployment_event_serialize(
    ...
    @validate_call
    def create_deployment_event_with_http_info(
        self,
        post_deployment_event_input: PostDeploymentEventInput,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def create_deployment_event_without_preload_content(
        self,
        post_deployment_event_input: PostDeploymentEventInput,
        _request_timeout: Union[
            None,
    ...
    def _create_deployment_event_serialize(
        self,
        ...
        if post_deployment_event_input is not None:
            _body_params = post_deployment_event_input
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/engineering-insights/deployment-events',
    ...
    def get_deployment(
        ...
        expand: Annotated[Optional[StrictStr], Field(description="Expand properties in response. Options: `pullRequests`, `flagReferences`")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def _get_deployment_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/engineering-insights/deployments/{deploymentID}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_deployments(
        ...
        kind: Annotated[Optional[StrictStr], Field(description="The deployment kind")] = None,
        status: Annotated[Optional[StrictStr], Field(description="The deployment status")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def _get_deployments_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/engineering-insights/deployments',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_deployment(
        ...
        _param = self._update_deployment_serialize(
            deployment_id=deployment_id,
    ...
    @validate_call
    def update_deployment_without_preload_content(
        self,
        deployment_id: Annotated[StrictStr, Field(description="The deployment ID")],
        patch_operation: List[PatchOperation],
        _request_timeout: Union[
    ...
    def _update_deployment_serialize(
        self,
        deployment_id,
        patch_operation,
        _request_auth,
