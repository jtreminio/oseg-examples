...
class LayersApi:
    ...
    def create_layer(
        ...
        :param layer_post: (required)
        :type layer_post: LayerPost
    ...
    def _create_layer_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/projects/{projectKey}/layers',
    ...
    def get_layers(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        filter: Annotated[Optional[StrictStr], Field(description="A comma-separated list of filters. This endpoint only accepts filtering by `experimentKey`. The filter returns layers which include that experiment for the selected environment(s). For example: `filter=reservations.experimentKey contains expKey`.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    @validate_call
    def get_layers_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        filter: Annotated[Optional[StrictStr], Field(description="A comma-separated list of filters. This endpoint only accepts filtering by `experimentKey`. The filter returns layers which include that experiment for the selected environment(s). For example: `filter=reservations.experimentKey contains expKey`.")] = None,
        _request_timeout: Union[
    ...
    def update_layer(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        layer_key: Annotated[StrictStr, Field(description="The layer key")],
        ...
        :param project_key: The project key (required)
        :type project_key: str
        :param layer_key: The layer key (required)
        :type layer_key: str
        :param layer_patch_input: (required)
        :type layer_patch_input: LayerPatchInput
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _update_layer_serialize(
        ...
        if layer_key is not None:
            _path_params['layerKey'] = layer_key
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        if layer_patch_input is not None:
            _body_params = layer_patch_input
        ...
        return self.api_client.param_serialize(
            method='PATCH',
            resource_path='/api/v2/projects/{projectKey}/layers/{layerKey}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
