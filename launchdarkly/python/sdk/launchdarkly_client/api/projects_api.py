...
class ProjectsApi:
    ...
    def _delete_project_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v2/projects/{projectKey}',
    ...
    def get_flag_defaults_by_project(
        ...
        _param = self._get_flag_defaults_by_project_serialize(
            project_key=project_key,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_flag_defaults_by_project_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_flag_defaults_by_project_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        _request_timeout: Union[
            None,
    ...
    def _get_flag_defaults_by_project_serialize(
        self,
        project_key,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/projects/{projectKey}/flag-defaults',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_projects(
        self,
        limit: Annotated[Optional[StrictInt], Field(description="The number of projects to return in the response. Defaults to 20.")] = None,
    ...
    def patch_flag_defaults_by_project(
        ...
        _param = self._patch_flag_defaults_by_project_serialize(
            project_key=project_key,
    ...
    @validate_call
    def patch_flag_defaults_by_project_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        patch_operation: List[PatchOperation],
        _request_timeout: Union[
    ...
    @validate_call
    def patch_flag_defaults_by_project_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        patch_operation: List[PatchOperation],
        _request_timeout: Union[
    ...
    def _patch_flag_defaults_by_project_serialize(
        self,
        project_key,
        patch_operation,
        _request_auth,
    ...
    def put_flag_defaults_by_project(
        ...
        :param project_key: The project key (required)
        :type project_key: str
        :param upsert_flag_defaults_payload: (required)
        :type upsert_flag_defaults_payload: UpsertFlagDefaultsPayload
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._put_flag_defaults_by_project_serialize(
            project_key=project_key,
    ...
    @validate_call
    def put_flag_defaults_by_project_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        upsert_flag_defaults_payload: UpsertFlagDefaultsPayload,
        _request_timeout: Union[
    ...
    @validate_call
    def put_flag_defaults_by_project_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        upsert_flag_defaults_payload: UpsertFlagDefaultsPayload,
        _request_timeout: Union[
    ...
    def _put_flag_defaults_by_project_serialize(
        self,
        project_key,
        ...
        # process the form parameters
        # process the body parameter
        if upsert_flag_defaults_payload is not None:
            _body_params = upsert_flag_defaults_payload
