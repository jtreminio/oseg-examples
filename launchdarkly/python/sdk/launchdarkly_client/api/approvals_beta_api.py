...
class ApprovalsBetaApi:
    ...
    @validate_call
    def patch_approval_request(
        self,
        id: Annotated[StrictStr, Field(description="The approval ID")],
        ...
        _param = self._patch_approval_request_serialize(
            id=id,
    ...
    @validate_call
    def patch_approval_request_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The approval ID")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def patch_approval_request_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The approval ID")],
        _request_timeout: Union[
            None,
    ...
    def _patch_approval_request_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def patch_flag_config_approval_request(
        self,
        ...
        _param = self._patch_flag_config_approval_request_serialize(
    ...
    @validate_call
    def patch_flag_config_approval_request_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        feature_flag_key: Annotated[StrictStr, Field(description="The feature flag key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
    ...
    @validate_call
    def patch_flag_config_approval_request_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        feature_flag_key: Annotated[StrictStr, Field(description="The feature flag key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
    ...
    def _patch_flag_config_approval_request_serialize(
        self,
        project_key,
        feature_flag_key,
        environment_key,
