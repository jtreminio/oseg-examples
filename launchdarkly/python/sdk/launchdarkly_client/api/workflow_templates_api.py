...
class WorkflowTemplatesApi:
    ...
    def create_workflow_template(
        ...
        :param create_workflow_template_input: (required)
        :type create_workflow_template_input: CreateWorkflowTemplateInput
    ...
    def _create_workflow_template_serialize(
        ...
        if create_workflow_template_input is not None:
            _body_params = create_workflow_template_input
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/templates',
    ...
    def delete_workflow_template(
        self,
        template_key: Annotated[StrictStr, Field(description="The template key")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param template_key: The template key (required)
    ...
    def _delete_workflow_template_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v2/templates/{templateKey}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_workflow_templates(
        self,
        summary: Annotated[Optional[StrictBool], Field(description="Whether the entire template object or just a summary should be returned")] = None,
        search: Annotated[Optional[StrictStr], Field(description="The substring in either the name or description of a template")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "WorkflowTemplatesListingOutputRep",
            '401': "UnauthorizedErrorRep",
            '404': "NotFoundErrorRep",
            '429': "RateLimitedErrorRep",
        }
