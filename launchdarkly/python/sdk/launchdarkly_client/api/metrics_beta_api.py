...
class MetricsBetaApi:
    ...
    def create_metric_group(
        ...
        :param metric_group_post: (required)
        :type metric_group_post: MetricGroupPost
        ...
        _param = self._create_metric_group_serialize(
    ...
    @validate_call
    def create_metric_group_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        metric_group_post: MetricGroupPost,
        _request_timeout: Union[
    ...
    @validate_call
    def create_metric_group_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        metric_group_post: MetricGroupPost,
        _request_timeout: Union[
    ...
    def _create_metric_group_serialize(
        self,
        project_key,
        metric_group_post,
        _request_auth,
        ...
        if metric_group_post is not None:
            _body_params = metric_group_post
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/projects/{projectKey}/metric-groups',
    ...
    def delete_metric_group(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        metric_group_key: Annotated[StrictStr, Field(description="The metric group key")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param project_key: The project key (required)
        :type project_key: str
        :param metric_group_key: The metric group key (required)
        :type metric_group_key: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._delete_metric_group_serialize(
            project_key=project_key,
    ...
    @validate_call
    def delete_metric_group_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        metric_group_key: Annotated[StrictStr, Field(description="The metric group key")],
        _request_timeout: Union[
    ...
    @validate_call
    def delete_metric_group_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        metric_group_key: Annotated[StrictStr, Field(description="The metric group key")],
        _request_timeout: Union[
    ...
    def _delete_metric_group_serialize(
        self,
        project_key,
        metric_group_key,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v2/projects/{projectKey}/metric-groups/{metricGroupKey}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_metric_group(
        ...
        _param = self._get_metric_group_serialize(
            project_key=project_key,
            metric_group_key=metric_group_key,
            expand=expand,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_metric_group_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        metric_group_key: Annotated[StrictStr, Field(description="The metric group key")],
        expand: Annotated[Optional[StrictStr], Field(description="A comma-separated list of properties that can reveal additional information in the response.")] = None,
    ...
    @validate_call
    def get_metric_group_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        metric_group_key: Annotated[StrictStr, Field(description="The metric group key")],
        expand: Annotated[Optional[StrictStr], Field(description="A comma-separated list of properties that can reveal additional information in the response.")] = None,
    ...
    def _get_metric_group_serialize(
        self,
        project_key,
        metric_group_key,
        expand,
    ...
    def get_metric_groups(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        filter: Annotated[Optional[StrictStr], Field(description="Accepts filter by `experimentStatus` and `query`. Example: `filter=experimentStatus equals 'running' and query equals 'test'`.")] = None,
        expand: Annotated[Optional[StrictStr], Field(description="A comma-separated list of properties that can reveal additional information in the response.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="The number of metric groups to return in the response. Defaults to 20. Maximum limit is 50.")] = None,
        ...
        _param = self._get_metric_groups_serialize(
            project_key=project_key,
            filter=filter,
            expand=expand,
            limit=limit,
    ...
    @validate_call
    def get_metric_groups_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        filter: Annotated[Optional[StrictStr], Field(description="Accepts filter by `experimentStatus` and `query`. Example: `filter=experimentStatus equals 'running' and query equals 'test'`.")] = None,
        expand: Annotated[Optional[StrictStr], Field(description="A comma-separated list of properties that can reveal additional information in the response.")] = None,
    ...
    @validate_call
    def get_metric_groups_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        filter: Annotated[Optional[StrictStr], Field(description="Accepts filter by `experimentStatus` and `query`. Example: `filter=experimentStatus equals 'running' and query equals 'test'`.")] = None,
        expand: Annotated[Optional[StrictStr], Field(description="A comma-separated list of properties that can reveal additional information in the response.")] = None,
    ...
    def _get_metric_groups_serialize(
        self,
        project_key,
        filter,
        expand,
    ...
    def patch_metric_group(
        ...
        _param = self._patch_metric_group_serialize(
            project_key=project_key,
            metric_group_key=metric_group_key,
    ...
    @validate_call
    def patch_metric_group_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        metric_group_key: Annotated[StrictStr, Field(description="The metric group key")],
        patch_operation: List[PatchOperation],
    ...
    @validate_call
    def patch_metric_group_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        metric_group_key: Annotated[StrictStr, Field(description="The metric group key")],
        patch_operation: List[PatchOperation],
    ...
    def _patch_metric_group_serialize(
        self,
        project_key,
        metric_group_key,
        patch_operation,
