...
class WorkflowsApi:
    ...
    def _delete_workflow_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/workflows/{workflowId}',
    ...
    def get_custom_workflow(
        ...
        _param = self._get_custom_workflow_serialize(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            environment_key=environment_key,
            workflow_id=workflow_id,
    ...
    @validate_call
    def get_custom_workflow_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        feature_flag_key: Annotated[StrictStr, Field(description="The feature flag key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
    ...
    @validate_call
    def get_custom_workflow_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        feature_flag_key: Annotated[StrictStr, Field(description="The feature flag key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
    ...
    def _get_custom_workflow_serialize(
        self,
        project_key,
        feature_flag_key,
        environment_key,
    ...
    def get_workflows(
        ...
        feature_flag_key: Annotated[StrictStr, Field(description="The feature flag key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        status: Annotated[Optional[StrictStr], Field(description="Filter results by workflow status. Valid status filters are `active`, `completed`, and `failed`.")] = None,
        sort: Annotated[Optional[StrictStr], Field(description="A field to sort the items by. Prefix field by a dash ( - ) to sort in descending order. This endpoint supports sorting by `creationDate` or `stopDate`.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="The maximum number of workflows to return. Defaults to 20.")] = None,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CustomWorkflowsListingOutput",
            '401': "UnauthorizedErrorRep",
            '403': "ForbiddenErrorRep",
            '404': "NotFoundErrorRep",
            '429': "RateLimitedErrorRep",
    ...
    def _get_workflows_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/workflows',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def post_workflow(
        ...
        template_key: Annotated[Optional[StrictStr], Field(description="The template key to apply as a starting point for the new workflow")] = None,
        dry_run: Annotated[Optional[StrictBool], Field(description="Whether to call the endpoint in dry-run mode")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param environment_key: The environment key (required)
        :type environment_key: str
        :param custom_workflow_input: (required)
        :type custom_workflow_input: CustomWorkflowInput
        :param template_key: The template key to apply as a starting point for the new workflow
        :type template_key: str
        :param dry_run: Whether to call the endpoint in dry-run mode
        :type dry_run: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._post_workflow_serialize(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            environment_key=environment_key,
    ...
    @validate_call
    def post_workflow_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        feature_flag_key: Annotated[StrictStr, Field(description="The feature flag key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
    ...
    @validate_call
    def post_workflow_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        feature_flag_key: Annotated[StrictStr, Field(description="The feature flag key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
    ...
    def _post_workflow_serialize(
        ...
        if template_key is not None:
            ...
            _query_params.append(('templateKey', template_key))
        ...
        # process the form parameters
        # process the body parameter
        if custom_workflow_input is not None:
            _body_params = custom_workflow_input
