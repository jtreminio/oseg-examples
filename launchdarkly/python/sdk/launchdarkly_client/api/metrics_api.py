...
class MetricsApi:
    ...
    def _delete_metric_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v2/metrics/{projectKey}/{metricKey}',
    ...
    def get_metrics(
        ...
        filter: Annotated[Optional[StrictStr], Field(description="A comma-separated list of filters. This endpoint only accepts filtering by `tags`. To learn more about the filter syntax, read the 'Filtering metrics' section above.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def _get_metrics_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/metrics/{projectKey}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def patch_metric(
        ...
        _param = self._patch_metric_serialize(
            project_key=project_key,
            metric_key=metric_key,
    ...
    @validate_call
    def patch_metric_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        metric_key: Annotated[StrictStr, Field(description="The metric key")],
        patch_operation: List[PatchOperation],
    ...
    @validate_call
    def patch_metric_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        metric_key: Annotated[StrictStr, Field(description="The metric key")],
        patch_operation: List[PatchOperation],
    ...
    def post_metric(
        ...
        :param project_key: The project key (required)
        :type project_key: str
        :param metric_post: (required)
        :type metric_post: MetricPost
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_metric_serialize(
            project_key=project_key,
    ...
    @validate_call
    def post_metric_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        metric_post: MetricPost,
        _request_timeout: Union[
    ...
    @validate_call
    def post_metric_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        metric_post: MetricPost,
        _request_timeout: Union[
    ...
    def _post_metric_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if metric_post is not None:
            _body_params = metric_post
