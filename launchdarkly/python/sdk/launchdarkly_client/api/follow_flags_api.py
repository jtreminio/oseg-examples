...
class FollowFlagsApi:
    ...
    def delete_flag_follower(
        ...
        member_id: Annotated[StrictStr, Field(description="The memberId of the member to remove as a follower of the flag. Reader roles can only remove themselves.")],
        ...
        :param member_id: The memberId of the member to remove as a follower of the flag. Reader roles can only remove themselves. (required)
        :type member_id: str
        ...
        _param = self._delete_flag_follower_serialize(
    ...
    @validate_call
    def delete_flag_follower_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        feature_flag_key: Annotated[StrictStr, Field(description="The feature flag key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
    ...
    @validate_call
    def delete_flag_follower_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        feature_flag_key: Annotated[StrictStr, Field(description="The feature flag key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
    ...
    def _delete_flag_follower_serialize(
        self,
        project_key,
        feature_flag_key,
        environment_key,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/followers/{memberId}',
    ...
    def get_flag_followers(
        ...
        _param = self._get_flag_followers_serialize(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            environment_key=environment_key,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_flag_followers_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        feature_flag_key: Annotated[StrictStr, Field(description="The feature flag key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
    ...
    @validate_call
    def get_flag_followers_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        feature_flag_key: Annotated[StrictStr, Field(description="The feature flag key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
    ...
    def _get_flag_followers_serialize(
        self,
        project_key,
        feature_flag_key,
        environment_key,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/followers',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_followers_by_proj_env(
        ...
        _param = self._get_followers_by_proj_env_serialize(
            project_key=project_key,
            environment_key=environment_key,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "FlagFollowersByProjEnvGetRep",
            '400': "InvalidRequestErrorRep",
            '401': "UnauthorizedErrorRep",
            '403': "ForbiddenErrorRep",
            '404': "NotFoundErrorRep",
    ...
    @validate_call
    def get_followers_by_proj_env_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        _request_timeout: Union[
    ...
    @validate_call
    def get_followers_by_proj_env_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        _request_timeout: Union[
    ...
    def _get_followers_by_proj_env_serialize(
        self,
        project_key,
        environment_key,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/projects/{projectKey}/environments/{environmentKey}/followers',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def put_flag_follower(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        feature_flag_key: Annotated[StrictStr, Field(description="The feature flag key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        member_id: Annotated[StrictStr, Field(description="The memberId of the member to add as a follower of the flag. Reader roles can only add themselves.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param environment_key: The environment key (required)
        :type environment_key: str
        :param member_id: The memberId of the member to add as a follower of the flag. Reader roles can only add themselves. (required)
        :type member_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._put_flag_follower_serialize(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            environment_key=environment_key,
            member_id=member_id,
    ...
    @validate_call
    def put_flag_follower_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        feature_flag_key: Annotated[StrictStr, Field(description="The feature flag key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
    ...
    @validate_call
    def put_flag_follower_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        feature_flag_key: Annotated[StrictStr, Field(description="The feature flag key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
    ...
    def _put_flag_follower_serialize(
        self,
        project_key,
        feature_flag_key,
        environment_key,
