...
class AccessTokensApi:
    ...
    def delete_token(
        self,
        id: Annotated[StrictStr, Field(description="The ID of the access token to update")],
    ...
    def _delete_token_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v2/tokens/{id}',
    ...
    def get_token(
        self,
        id: Annotated[StrictStr, Field(description="The ID of the access token")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def get_tokens(
        self,
        show_all: Annotated[Optional[StrictBool], Field(description="If set to true, and the authentication access token has the 'Admin' role, personal access tokens for all members will be retrieved.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="The number of access tokens to return in the response. Defaults to 25.")] = None,
    ...
    def post_token(
        ...
        :param access_token_post: (required)
        :type access_token_post: AccessTokenPost
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _post_token_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if access_token_post is not None:
            _body_params = access_token_post
    ...
    def reset_token(
        self,
        id: Annotated[StrictStr, Field(description="The ID of the access token to update")],
        expiry: Annotated[Optional[StrictInt], Field(description="An expiration time for the old token key, expressed as a Unix epoch time in milliseconds. By default, the token will expire immediately.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._reset_token_serialize(
            id=id,
            expiry=expiry,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def reset_token_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The ID of the access token to update")],
        expiry: Annotated[Optional[StrictInt], Field(description="An expiration time for the old token key, expressed as a Unix epoch time in milliseconds. By default, the token will expire immediately.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def reset_token_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The ID of the access token to update")],
        expiry: Annotated[Optional[StrictInt], Field(description="An expiration time for the old token key, expressed as a Unix epoch time in milliseconds. By default, the token will expire immediately.")] = None,
        _request_timeout: Union[
    ...
    def _reset_token_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/tokens/{id}/reset',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
