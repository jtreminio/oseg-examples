...
class FlagTriggersApi:
    ...
    def create_trigger_workflow(
        ...
        :param trigger_post: (required)
        :type trigger_post: TriggerPost
        ...
        _param = self._create_trigger_workflow_serialize(
    ...
    @validate_call
    def create_trigger_workflow_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        feature_flag_key: Annotated[StrictStr, Field(description="The feature flag key")],
    ...
    @validate_call
    def create_trigger_workflow_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        feature_flag_key: Annotated[StrictStr, Field(description="The feature flag key")],
    ...
    def _create_trigger_workflow_serialize(
        self,
        project_key,
        environment_key,
        feature_flag_key,
        ...
        if trigger_post is not None:
            _body_params = trigger_post
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/flags/{projectKey}/{featureFlagKey}/triggers/{environmentKey}',
    ...
    def delete_trigger_workflow(
        ...
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        feature_flag_key: Annotated[StrictStr, Field(description="The feature flag key")],
        id: Annotated[StrictStr, Field(description="The flag trigger ID")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._delete_trigger_workflow_serialize(
            project_key=project_key,
            environment_key=environment_key,
            feature_flag_key=feature_flag_key,
            id=id,
    ...
    @validate_call
    def delete_trigger_workflow_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        feature_flag_key: Annotated[StrictStr, Field(description="The feature flag key")],
    ...
    @validate_call
    def delete_trigger_workflow_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        feature_flag_key: Annotated[StrictStr, Field(description="The feature flag key")],
    ...
    def _delete_trigger_workflow_serialize(
        self,
        project_key,
        environment_key,
        feature_flag_key,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v2/flags/{projectKey}/{featureFlagKey}/triggers/{environmentKey}/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_trigger_workflow_by_id(
        ...
        _param = self._get_trigger_workflow_by_id_serialize(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            environment_key=environment_key,
            id=id,
    ...
    @validate_call
    def get_trigger_workflow_by_id_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        feature_flag_key: Annotated[StrictStr, Field(description="The feature flag key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
    ...
    @validate_call
    def get_trigger_workflow_by_id_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        feature_flag_key: Annotated[StrictStr, Field(description="The feature flag key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
    ...
    def _get_trigger_workflow_by_id_serialize(
        self,
        project_key,
        feature_flag_key,
        environment_key,
    ...
    def get_trigger_workflows(
        ...
        _param = self._get_trigger_workflows_serialize(
            project_key=project_key,
            environment_key=environment_key,
            feature_flag_key=feature_flag_key,
            _request_auth=_request_auth,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "TriggerWorkflowCollectionRep",
            '401': "UnauthorizedErrorRep",
            '403': "ForbiddenErrorRep",
            '429': "RateLimitedErrorRep",
        }
    ...
    @validate_call
    def get_trigger_workflows_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        feature_flag_key: Annotated[StrictStr, Field(description="The feature flag key")],
    ...
    @validate_call
    def get_trigger_workflows_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        feature_flag_key: Annotated[StrictStr, Field(description="The feature flag key")],
    ...
    def _get_trigger_workflows_serialize(
        self,
        project_key,
        environment_key,
        feature_flag_key,
    ...
    def patch_trigger_workflow(
        ...
        :param id: The flag trigger ID (required)
        :type id: str
        :param flag_trigger_input: (required)
        :type flag_trigger_input: FlagTriggerInput
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._patch_trigger_workflow_serialize(
            project_key=project_key,
            environment_key=environment_key,
            feature_flag_key=feature_flag_key,
            id=id,
    ...
    @validate_call
    def patch_trigger_workflow_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        feature_flag_key: Annotated[StrictStr, Field(description="The feature flag key")],
    ...
    @validate_call
    def patch_trigger_workflow_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        feature_flag_key: Annotated[StrictStr, Field(description="The feature flag key")],
    ...
    def _patch_trigger_workflow_serialize(
        self,
        project_key,
        environment_key,
        feature_flag_key,
        ...
        # process the form parameters
        # process the body parameter
        if flag_trigger_input is not None:
            _body_params = flag_trigger_input
