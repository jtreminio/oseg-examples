...
class UserSettingsApi:
    ...
    def get_expiring_flags_for_user(
        ...
        """(Deprecated) Get expiring dates on flags for user
        ...
        """ # noqa: E501
        warnings.warn("GET /api/v2/users/{projectKey}/{userKey}/expiring-user-targets/{environmentKey} is deprecated.", DeprecationWarning)

        _param = self._get_expiring_flags_for_user_serialize(
    ...
    @validate_call
    def get_expiring_flags_for_user_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        user_key: Annotated[StrictStr, Field(description="The user key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
    ...
    @validate_call
    def get_expiring_flags_for_user_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        user_key: Annotated[StrictStr, Field(description="The user key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
    ...
    def _get_expiring_flags_for_user_serialize(
        self,
        project_key,
        user_key,
        environment_key,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/users/{projectKey}/{userKey}/expiring-user-targets/{environmentKey}',
    ...
    def get_user_flag_setting(
        ...
        """(Deprecated) Get flag setting for user
        ...
        :return: Returns the result object.
        """ # noqa: E501
        warnings.warn("GET /api/v2/users/{projectKey}/{environmentKey}/{userKey}/flags/{featureFlagKey} is deprecated.", DeprecationWarning)

        _param = self._get_user_flag_setting_serialize(
            project_key=project_key,
            environment_key=environment_key,
            user_key=user_key,
    ...
    @validate_call
    def get_user_flag_setting_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        user_key: Annotated[StrictStr, Field(description="The user key")],
    ...
    @validate_call
    def get_user_flag_setting_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        user_key: Annotated[StrictStr, Field(description="The user key")],
    ...
    def _get_user_flag_setting_serialize(
        self,
        project_key,
        environment_key,
        user_key,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/users/{projectKey}/{environmentKey}/{userKey}/flags/{featureFlagKey}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_user_flag_settings(
        ...
        """(Deprecated) List flag settings for user
        ...
        :return: Returns the result object.
        """ # noqa: E501
        warnings.warn("GET /api/v2/users/{projectKey}/{environmentKey}/{userKey}/flags is deprecated.", DeprecationWarning)

        _param = self._get_user_flag_settings_serialize(
            project_key=project_key,
            environment_key=environment_key,
            user_key=user_key,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_user_flag_settings_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        user_key: Annotated[StrictStr, Field(description="The user key")],
    ...
    @validate_call
    def get_user_flag_settings_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        user_key: Annotated[StrictStr, Field(description="The user key")],
    ...
    def _get_user_flag_settings_serialize(
        self,
        project_key,
        environment_key,
        user_key,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/users/{projectKey}/{environmentKey}/{userKey}/flags',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def patch_expiring_flags_for_user(
        ...
        """(Deprecated) Update expiring user target for flags
        ...
        :param environment_key: The environment key (required)
        :type environment_key: str
        :param patch_users_request: (required)
        :type patch_users_request: PatchUsersRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        :return: Returns the result object.
        """ # noqa: E501
        warnings.warn("PATCH /api/v2/users/{projectKey}/{userKey}/expiring-user-targets/{environmentKey} is deprecated.", DeprecationWarning)

        _param = self._patch_expiring_flags_for_user_serialize(
            project_key=project_key,
            user_key=user_key,
            environment_key=environment_key,
    ...
    @validate_call
    def patch_expiring_flags_for_user_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        user_key: Annotated[StrictStr, Field(description="The user key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
    ...
    @validate_call
    def patch_expiring_flags_for_user_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        user_key: Annotated[StrictStr, Field(description="The user key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
    ...
    def _patch_expiring_flags_for_user_serialize(
        self,
        project_key,
        user_key,
        environment_key,
        ...
        # process the form parameters
        # process the body parameter
        if patch_users_request is not None:
            _body_params = patch_users_request
    ...
    def put_flag_setting(
        ...
        """(Deprecated) Update flag settings for user
        ...
        :param feature_flag_key: The feature flag key (required)
        :type feature_flag_key: str
        :param value_put: (required)
        :type value_put: ValuePut
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        :return: Returns the result object.
        """ # noqa: E501
        warnings.warn("PUT /api/v2/users/{projectKey}/{environmentKey}/{userKey}/flags/{featureFlagKey} is deprecated.", DeprecationWarning)

        _param = self._put_flag_setting_serialize(
            project_key=project_key,
            environment_key=environment_key,
            user_key=user_key,
            feature_flag_key=feature_flag_key,
    ...
    @validate_call
    def put_flag_setting_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        user_key: Annotated[StrictStr, Field(description="The user key")],
    ...
    @validate_call
    def put_flag_setting_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        user_key: Annotated[StrictStr, Field(description="The user key")],
    ...
    def _put_flag_setting_serialize(
        self,
        project_key,
        environment_key,
        user_key,
        ...
        # process the form parameters
        # process the body parameter
        if value_put is not None:
            _body_params = value_put
