...
class RelayProxyConfigurationsApi:
    ...
    def delete_relay_auto_config(
        self,
        id: Annotated[StrictStr, Field(description="The relay auto config id")],
        ...
        _param = self._delete_relay_auto_config_serialize(
            id=id,
    ...
    @validate_call
    def delete_relay_auto_config_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The relay auto config id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_relay_auto_config_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The relay auto config id")],
        _request_timeout: Union[
            None,
    ...
    def _delete_relay_auto_config_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v2/account/relay-auto-configs/{id}',
    ...
    def get_relay_proxy_config(
        ...
        _param = self._get_relay_proxy_config_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_relay_proxy_config_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The relay auto config id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_relay_proxy_config_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The relay auto config id")],
        _request_timeout: Union[
            None,
    ...
    def _get_relay_proxy_config_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def get_relay_proxy_configs(
        ...
        _param = self._get_relay_proxy_configs_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RelayAutoConfigCollectionRep",
            '401': "UnauthorizedErrorRep",
            '403': "ForbiddenErrorRep",
            '429': "RateLimitedErrorRep",
        }
    ...
    @validate_call
    def get_relay_proxy_configs_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_relay_proxy_configs_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_relay_proxy_configs_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/account/relay-auto-configs',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def patch_relay_auto_config(
        ...
        _param = self._patch_relay_auto_config_serialize(
            id=id,
    ...
    @validate_call
    def patch_relay_auto_config_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The relay auto config id")],
        patch_with_comment: PatchWithComment,
        _request_timeout: Union[
    ...
    @validate_call
    def patch_relay_auto_config_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The relay auto config id")],
        patch_with_comment: PatchWithComment,
        _request_timeout: Union[
    ...
    def _patch_relay_auto_config_serialize(
        self,
        id,
        patch_with_comment,
        _request_auth,
    ...
    def post_relay_auto_config(
        ...
        :param relay_auto_config_post: (required)
        :type relay_auto_config_post: RelayAutoConfigPost
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_relay_auto_config_serialize(
    ...
    @validate_call
    def post_relay_auto_config_with_http_info(
        self,
        relay_auto_config_post: RelayAutoConfigPost,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def post_relay_auto_config_without_preload_content(
        self,
        relay_auto_config_post: RelayAutoConfigPost,
        _request_timeout: Union[
            None,
    ...
    def _post_relay_auto_config_serialize(
        self,
        ...
        # process the form parameters
        # process the body parameter
        if relay_auto_config_post is not None:
            _body_params = relay_auto_config_post
    ...
    def reset_relay_auto_config(
        self,
        id: Annotated[StrictStr, Field(description="The Relay Proxy configuration ID")],
        expiry: Annotated[Optional[StrictInt], Field(description="An expiration time for the old Relay Proxy configuration key, expressed as a Unix epoch time in milliseconds. By default, the Relay Proxy configuration will expire immediately.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._reset_relay_auto_config_serialize(
            id=id,
            expiry=expiry,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def reset_relay_auto_config_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The Relay Proxy configuration ID")],
        expiry: Annotated[Optional[StrictInt], Field(description="An expiration time for the old Relay Proxy configuration key, expressed as a Unix epoch time in milliseconds. By default, the Relay Proxy configuration will expire immediately.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def reset_relay_auto_config_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The Relay Proxy configuration ID")],
        expiry: Annotated[Optional[StrictInt], Field(description="An expiration time for the old Relay Proxy configuration key, expressed as a Unix epoch time in milliseconds. By default, the Relay Proxy configuration will expire immediately.")] = None,
        _request_timeout: Union[
    ...
    def _reset_relay_auto_config_serialize(
        self,
        id,
        expiry,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/account/relay-auto-configs/{id}/reset',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
