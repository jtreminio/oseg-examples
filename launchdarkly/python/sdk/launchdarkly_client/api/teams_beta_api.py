...
class TeamsBetaApi:
    ...
    def patch_teams(
        ...
        :param teams_patch_input: (required)
        :type teams_patch_input: TeamsPatchInput
        ...
        _param = self._patch_teams_serialize(
    ...
    @validate_call
    def patch_teams_with_http_info(
        self,
        teams_patch_input: TeamsPatchInput,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def patch_teams_without_preload_content(
        self,
        teams_patch_input: TeamsPatchInput,
        _request_timeout: Union[
            None,
    ...
    def _patch_teams_serialize(
        ...
        if teams_patch_input is not None:
            _body_params = teams_patch_input
