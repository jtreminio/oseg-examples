...
class ApplicationsBetaApi:
    ...
    def delete_application(
        self,
        application_key: Annotated[StrictStr, Field(description="The application key")],
        ...
        :param application_key: The application key (required)
    ...
    def _delete_application_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v2/applications/{applicationKey}',
    ...
    def delete_application_version(
        self,
        application_key: Annotated[StrictStr, Field(description="The application key")],
        version_key: Annotated[StrictStr, Field(description="The application version key")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param application_key: The application key (required)
        :type application_key: str
        :param version_key: The application version key (required)
        ...
        _param = self._delete_application_version_serialize(
            application_key=application_key,
    ...
    @validate_call
    def delete_application_version_with_http_info(
        self,
        application_key: Annotated[StrictStr, Field(description="The application key")],
        version_key: Annotated[StrictStr, Field(description="The application version key")],
        _request_timeout: Union[
    ...
    @validate_call
    def delete_application_version_without_preload_content(
        self,
        application_key: Annotated[StrictStr, Field(description="The application key")],
        version_key: Annotated[StrictStr, Field(description="The application version key")],
        _request_timeout: Union[
    ...
    def _delete_application_version_serialize(
        self,
        application_key,
        version_key,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v2/applications/{applicationKey}/versions/{versionKey}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_application(
        self,
        application_key: Annotated[StrictStr, Field(description="The application key")],
        expand: Annotated[Optional[StrictStr], Field(description="A comma-separated list of properties that can reveal additional information in the response. Options: `flags`.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def get_application_versions(
        self,
        application_key: Annotated[StrictStr, Field(description="The application key")],
        filter: Annotated[Optional[StrictStr], Field(description="Accepts filter by `key`, `name`, `supported`, and `autoAdded`. To learn more about the filter syntax, read [Filtering applications and application versions](/tag/Applications-(beta)#filtering-contexts-and-context-instances).")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="The number of versions to return. Defaults to 50.")] = None,
        ...
        sort: Annotated[Optional[StrictStr], Field(description="Accepts sorting order and fields. Fields can be comma separated. Possible fields are `creationDate`, `name`. Examples: `sort=name` sort by names ascending, `sort=-name,creationDate` sort by names descending and creationDate ascending.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ApplicationVersionsCollectionRep",
            '400': "InvalidRequestErrorRep",
            '401': "UnauthorizedErrorRep",
            '403': "ForbiddenErrorRep",
            '404': "NotFoundErrorRep",
    ...
    def _get_application_versions_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/applications/{applicationKey}/versions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_applications(
        self,
        filter: Annotated[Optional[StrictStr], Field(description="Accepts filter by `key`, `name`, `kind`, and `autoAdded`. To learn more about the filter syntax, read [Filtering applications and application versions](/tag/Applications-(beta)#filtering-contexts-and-context-instances).")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="The number of applications to return. Defaults to 10.")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="Where to start in the list. Use this with pagination. For example, an offset of 10 skips the first ten items and then returns the next items in the list, up to the query `limit`.")] = None,
        sort: Annotated[Optional[StrictStr], Field(description="Accepts sorting order and fields. Fields can be comma separated. Possible fields are `creationDate`, `name`. Examples: `sort=name` sort by names ascending, `sort=-name,creationDate` sort by names descending and creationDate ascending.")] = None,
        expand: Annotated[Optional[StrictStr], Field(description="A comma-separated list of properties that can reveal additional information in the response. Options: `flags`.")] = None,
        _request_timeout: Union[
    ...
    def patch_application(
        ...
        _param = self._patch_application_serialize(
            application_key=application_key,
    ...
    @validate_call
    def patch_application_with_http_info(
        self,
        application_key: Annotated[StrictStr, Field(description="The application key")],
        patch_operation: List[PatchOperation],
        _request_timeout: Union[
    ...
    @validate_call
    def patch_application_without_preload_content(
        self,
        application_key: Annotated[StrictStr, Field(description="The application key")],
        patch_operation: List[PatchOperation],
        _request_timeout: Union[
    ...
    def _patch_application_serialize(
        self,
        application_key,
        patch_operation,
        _request_auth,
    ...
    def patch_application_version(
        ...
        _param = self._patch_application_version_serialize(
            application_key=application_key,
            version_key=version_key,
            patch_operation=patch_operation,
            _request_auth=_request_auth,
    ...
    @validate_call
    def patch_application_version_with_http_info(
        self,
        application_key: Annotated[StrictStr, Field(description="The application key")],
        version_key: Annotated[StrictStr, Field(description="The application version key")],
        patch_operation: List[PatchOperation],
    ...
    @validate_call
    def patch_application_version_without_preload_content(
        self,
        application_key: Annotated[StrictStr, Field(description="The application key")],
        version_key: Annotated[StrictStr, Field(description="The application version key")],
        patch_operation: List[PatchOperation],
    ...
    def _patch_application_version_serialize(
        self,
        application_key,
        version_key,
        patch_operation,
