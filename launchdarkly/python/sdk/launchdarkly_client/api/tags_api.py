...
class TagsApi:
    ...
    def get_tags(
        self,
        kind: Annotated[Optional[List[StrictStr]], Field(description="Fetch tags associated with the specified resource type. Options are `flag`, `project`, `environment`, `segment`, `metric`. Returns all types by default.")] = None,
        ...
        offset: Annotated[Optional[StrictInt], Field(description="The index of the first tag to return. Default is 0.")] = None,
        as_of: Annotated[Optional[StrictStr], Field(description="The time to retrieve tags as of. Default is the current time.")] = None,
        ...
        :type offset: int
        :param as_of: The time to retrieve tags as of. Default is the current time.
        :type as_of: str
