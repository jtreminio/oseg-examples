...
class DataExportDestinationsApi:
    ...
    def delete_destination(
        ...
        id: Annotated[StrictStr, Field(description="The Data Export destination ID")],
    ...
    def _delete_destination_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v2/destinations/{projectKey}/{environmentKey}/{id}',
    ...
    def _get_destinations_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/destinations',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def patch_destination(
        ...
        _param = self._patch_destination_serialize(
            project_key=project_key,
            environment_key=environment_key,
            id=id,
    ...
    @validate_call
    def patch_destination_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        id: Annotated[StrictStr, Field(description="The Data Export destination ID")],
    ...
    @validate_call
    def patch_destination_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        id: Annotated[StrictStr, Field(description="The Data Export destination ID")],
    ...
    def _patch_destination_serialize(
        self,
        project_key,
        environment_key,
        id,
    ...
    def post_destination(
        ...
        :param environment_key: The environment key (required)
        :type environment_key: str
        :param destination_post: (required)
        :type destination_post: DestinationPost
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_destination_serialize(
            project_key=project_key,
            environment_key=environment_key,
    ...
    @validate_call
    def post_destination_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        destination_post: DestinationPost,
    ...
    @validate_call
    def post_destination_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        destination_post: DestinationPost,
    ...
    def _post_destination_serialize(
        self,
        project_key,
        environment_key,
        destination_post,
        ...
        # process the form parameters
        # process the body parameter
        if destination_post is not None:
            _body_params = destination_post
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/destinations/{projectKey}/{environmentKey}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
