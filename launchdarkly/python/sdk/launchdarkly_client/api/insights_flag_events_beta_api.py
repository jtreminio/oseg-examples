...
class InsightsFlagEventsBetaApi:
    ...
    def get_flag_events(
        ...
        query: Annotated[Optional[StrictStr], Field(description="Filter events by flag key")] = None,
        impact_size: Annotated[Optional[StrictStr], Field(description="Filter events by impact size. A small impact created a less than 20% change in the proportion of end users receiving one or more flag variations. A medium impact created between a 20%-80% change. A large impact created a more than 80% change. Options: `none`, `small`, `medium`, `large`")] = None,
        ...
        expand: Annotated[Optional[StrictStr], Field(description="Expand properties in response. Options: `experiments`")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="The number of deployments to return. Default is 20. Maximum allowed is 100.")] = None,
        ...
        after: Annotated[Optional[StrictStr], Field(description="Identifier used for pagination")] = None,
        before: Annotated[Optional[StrictStr], Field(description="Identifier used for pagination")] = None,
        ...
        :param query: Filter events by flag key
        :type query: str
        :param impact_size: Filter events by impact size. A small impact created a less than 20% change in the proportion of end users receiving one or more flag variations. A medium impact created between a 20%-80% change. A large impact created a more than 80% change. Options: `none`, `small`, `medium`, `large`
        :type impact_size: str
        ...
        :type var_global: str
        :param expand: Expand properties in response. Options: `experiments`
        :type expand: str
        ...
        _param = self._get_flag_events_serialize(
    ...
    @validate_call
    def get_flag_events_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        application_key: Annotated[Optional[StrictStr], Field(description="Comma separated list of application keys")] = None,
    ...
    @validate_call
    def get_flag_events_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        application_key: Annotated[Optional[StrictStr], Field(description="Comma separated list of application keys")] = None,
    ...
    def _get_flag_events_serialize(
        self,
        project_key,
        environment_key,
        application_key,
        ...
        if impact_size is not None:
            ...
            _query_params.append(('impactSize', impact_size))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/engineering-insights/flag-events',
