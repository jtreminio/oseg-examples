...
class HoldoutsBetaApi:
    ...
    def get_all_holdouts(
        ...
        limit: Annotated[Optional[StrictInt], Field(description="The number of holdouts to return in the response. Defaults to 20")] = None,
        ...
        _param = self._get_all_holdouts_serialize(
    ...
    @validate_call
    def get_all_holdouts_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        limit: Annotated[Optional[StrictInt], Field(description="The number of holdouts to return in the response. Defaults to 20")] = None,
    ...
    @validate_call
    def get_all_holdouts_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        limit: Annotated[Optional[StrictInt], Field(description="The number of holdouts to return in the response. Defaults to 20")] = None,
    ...
    def _get_all_holdouts_serialize(
        self,
        project_key,
        environment_key,
        limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/projects/{projectKey}/environments/{environmentKey}/holdouts',
    ...
    def get_holdout(
        ...
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        holdout_key: Annotated[StrictStr, Field(description="The holdout experiment key")],
        expand: Annotated[Optional[StrictStr], Field(description="A comma-separated list of properties that can reveal additional information in the response. Supported fields are explained above. Holdout experiment expansion fields have no prefix. Related experiment expansion fields have `rel-` as a prefix.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param environment_key: The environment key (required)
        :type environment_key: str
        :param holdout_key: The holdout experiment key (required)
        :type holdout_key: str
        ...
        _param = self._get_holdout_serialize(
            project_key=project_key,
            environment_key=environment_key,
    ...
    @validate_call
    def get_holdout_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        holdout_key: Annotated[StrictStr, Field(description="The holdout experiment key")],
    ...
    @validate_call
    def get_holdout_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        holdout_key: Annotated[StrictStr, Field(description="The holdout experiment key")],
    ...
    def _get_holdout_serialize(
        ...
        if holdout_key is not None:
            _path_params['holdoutKey'] = holdout_key
        # process the query parameters
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/projects/{projectKey}/environments/{environmentKey}/holdouts/{holdoutKey}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_holdout_by_id(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        holdout_id: Annotated[StrictStr, Field(description="The holdout experiment ID")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param environment_key: The environment key (required)
        :type environment_key: str
        :param holdout_id: The holdout experiment ID (required)
        :type holdout_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_holdout_by_id_serialize(
            project_key=project_key,
            environment_key=environment_key,
    ...
    @validate_call
    def get_holdout_by_id_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        holdout_id: Annotated[StrictStr, Field(description="The holdout experiment ID")],
    ...
    @validate_call
    def get_holdout_by_id_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        holdout_id: Annotated[StrictStr, Field(description="The holdout experiment ID")],
    ...
    def _get_holdout_by_id_serialize(
        self,
        project_key,
        environment_key,
        holdout_id,
        ...
        if holdout_id is not None:
            _path_params['holdoutId'] = holdout_id
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/projects/{projectKey}/environments/{environmentKey}/holdouts/id/{holdoutId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def patch_holdout(
        ...
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        holdout_key: Annotated[StrictStr, Field(description="The holdout key")],
        ...
        :param environment_key: The environment key (required)
        :type environment_key: str
        :param holdout_key: The holdout key (required)
        :type holdout_key: str
        :param holdout_patch_input: (required)
        :type holdout_patch_input: HoldoutPatchInput
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._patch_holdout_serialize(
            project_key=project_key,
            environment_key=environment_key,
            holdout_key=holdout_key,
    ...
    @validate_call
    def patch_holdout_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        holdout_key: Annotated[StrictStr, Field(description="The holdout key")],
    ...
    @validate_call
    def patch_holdout_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        holdout_key: Annotated[StrictStr, Field(description="The holdout key")],
    ...
    def _patch_holdout_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if holdout_patch_input is not None:
            _body_params = holdout_patch_input
    ...
    def post_holdout(
        ...
        :param environment_key: The environment key (required)
        :type environment_key: str
        :param holdout_post_request: (required)
        :type holdout_post_request: HoldoutPostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_holdout_serialize(
            project_key=project_key,
            environment_key=environment_key,
    ...
    @validate_call
    def post_holdout_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        holdout_post_request: HoldoutPostRequest,
    ...
    @validate_call
    def post_holdout_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        holdout_post_request: HoldoutPostRequest,
    ...
    def _post_holdout_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if holdout_post_request is not None:
            _body_params = holdout_post_request
