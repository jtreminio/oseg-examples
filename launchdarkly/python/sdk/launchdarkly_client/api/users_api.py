...
class UsersApi:
    ...
    def delete_user(
        ...
        """ # noqa: E501
        warnings.warn("DELETE /api/v2/users/{projectKey}/{environmentKey}/{userKey} is deprecated.", DeprecationWarning)
    ...
    def _delete_user_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v2/users/{projectKey}/{environmentKey}/{userKey}',
    ...
    def get_search_users(
        ...
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        q: Annotated[Optional[StrictStr], Field(description="Full-text search for users based on name, first name, last name, e-mail address, or key")] = None,
        ...
        offset: Annotated[Optional[StrictInt], Field(description="Deprecated, use `searchAfter` instead. Specifies the first item to return in the collection.")] = None,
        after: Annotated[Optional[StrictInt], Field(description="A Unix epoch time in milliseconds specifying the maximum last time a user requested a feature flag from LaunchDarkly")] = None,
        sort: Annotated[Optional[StrictStr], Field(description="Specifies a field by which to sort. LaunchDarkly supports the `userKey` and `lastSeen` fields. Fields prefixed by a dash ( - ) sort in descending order.")] = None,
        search_after: Annotated[Optional[StrictStr], Field(description="Limits results to users with sort values after the value you specify. You can use this for pagination, but we recommend using the `next` link we provide instead.")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="A comma-separated list of user attribute filters. Each filter is in the form of attributeKey:attributeValue")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param environment_key: The environment key (required)
        :type environment_key: str
        :param q: Full-text search for users based on name, first name, last name, e-mail address, or key
        :type q: str
        :param limit: Specifies the maximum number of items in the collection to return (max: 50, default: 20)
        :type limit: int
        :param offset: Deprecated, use `searchAfter` instead. Specifies the first item to return in the collection.
        :type offset: int
        :param after: A Unix epoch time in milliseconds specifying the maximum last time a user requested a feature flag from LaunchDarkly
        :type after: int
        :param sort: Specifies a field by which to sort. LaunchDarkly supports the `userKey` and `lastSeen` fields. Fields prefixed by a dash ( - ) sort in descending order.
        :type sort: str
        :param search_after: Limits results to users with sort values after the value you specify. You can use this for pagination, but we recommend using the `next` link we provide instead.
        :type search_after: str
        :param filter: A comma-separated list of user attribute filters. Each filter is in the form of attributeKey:attributeValue
        :type filter: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        :return: Returns the result object.
        """ # noqa: E501
        warnings.warn("GET /api/v2/user-search/{projectKey}/{environmentKey} is deprecated.", DeprecationWarning)
    ...
    def _get_search_users_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/user-search/{projectKey}/{environmentKey}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_user(
        ...
        :return: Returns the result object.
        """ # noqa: E501
        warnings.warn("GET /api/v2/users/{projectKey}/{environmentKey}/{userKey} is deprecated.", DeprecationWarning)
    ...
    def get_users(
        ...
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        limit: Annotated[Optional[StrictInt], Field(description="The number of elements to return per page")] = None,
        search_after: Annotated[Optional[StrictStr], Field(description="Limits results to users with sort values after the value you specify. You can use this for pagination, but we recommend using the `next` link we provide instead.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param environment_key: The environment key (required)
        :type environment_key: str
        :param limit: The number of elements to return per page
        :type limit: int
        :param search_after: Limits results to users with sort values after the value you specify. You can use this for pagination, but we recommend using the `next` link we provide instead.
        :type search_after: str
        :param _request_timeout: timeout setting for this request. If one
        ...
        :return: Returns the result object.
        """ # noqa: E501
        warnings.warn("GET /api/v2/users/{projectKey}/{environmentKey} is deprecated.", DeprecationWarning)
    ...
    def _get_users_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/users/{projectKey}/{environmentKey}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
