...
class AuditLogApi:
    ...
    def get_audit_log_entries(
        self,
        before: Annotated[Optional[StrictInt], Field(description="A timestamp filter, expressed as a Unix epoch time in milliseconds.  All entries this returns occurred before the timestamp.")] = None,
        after: Annotated[Optional[StrictInt], Field(description="A timestamp filter, expressed as a Unix epoch time in milliseconds. All entries this returns occurred after the timestamp.")] = None,
        q: Annotated[Optional[StrictStr], Field(description="Text to search for. You can search for the full or partial name of the resource.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="A limit on the number of audit log entries that return. Set between 1 and 20. The default is 10.")] = None,
        spec: Annotated[Optional[StrictStr], Field(description="A resource specifier that lets you filter audit log listings by resource")] = None,
        ...
        _param = self._get_audit_log_entries_serialize(
            before=before,
            after=after,
            q=q,
            limit=limit,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "AuditLogEntryListingRepCollection",
    ...
    @validate_call
    def get_audit_log_entries_with_http_info(
        self,
        before: Annotated[Optional[StrictInt], Field(description="A timestamp filter, expressed as a Unix epoch time in milliseconds.  All entries this returns occurred before the timestamp.")] = None,
        after: Annotated[Optional[StrictInt], Field(description="A timestamp filter, expressed as a Unix epoch time in milliseconds. All entries this returns occurred after the timestamp.")] = None,
        q: Annotated[Optional[StrictStr], Field(description="Text to search for. You can search for the full or partial name of the resource.")] = None,
    ...
    @validate_call
    def get_audit_log_entries_without_preload_content(
        self,
        before: Annotated[Optional[StrictInt], Field(description="A timestamp filter, expressed as a Unix epoch time in milliseconds.  All entries this returns occurred before the timestamp.")] = None,
        after: Annotated[Optional[StrictInt], Field(description="A timestamp filter, expressed as a Unix epoch time in milliseconds. All entries this returns occurred after the timestamp.")] = None,
        q: Annotated[Optional[StrictStr], Field(description="Text to search for. You can search for the full or partial name of the resource.")] = None,
    ...
    def _get_audit_log_entries_serialize(
        self,
        before,
        after,
        q,
        ...
        if spec is not None:
            ...
            _query_params.append(('spec', spec))
    ...
    def get_audit_log_entry(
        self,
        id: Annotated[StrictStr, Field(description="The ID of the audit log entry")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._get_audit_log_entry_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_audit_log_entry_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The ID of the audit log entry")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_audit_log_entry_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The ID of the audit log entry")],
        _request_timeout: Union[
            None,
    ...
    def _get_audit_log_entry_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/auditlog/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def post_audit_log_entries(
        self,
        before: Annotated[Optional[StrictInt], Field(description="A timestamp filter, expressed as a Unix epoch time in milliseconds.  All entries returned occurred before the timestamp.")] = None,
        after: Annotated[Optional[StrictInt], Field(description="A timestamp filter, expressed as a Unix epoch time in milliseconds. All entries returned occurred after the timestamp.")] = None,
        q: Annotated[Optional[StrictStr], Field(description="Text to search for. You can search for the full or partial name of the resource.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="A limit on the number of audit log entries that return. Set between 1 and 20. The default is 10.")] = None,
        statement_post: Optional[List[StatementPost]] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param before: A timestamp filter, expressed as a Unix epoch time in milliseconds.  All entries returned occurred before the timestamp.
        :type before: int
        :param after: A timestamp filter, expressed as a Unix epoch time in milliseconds. All entries returned occurred after the timestamp.
        :type after: int
        :param q: Text to search for. You can search for the full or partial name of the resource.
        :type q: str
        :param limit: A limit on the number of audit log entries that return. Set between 1 and 20. The default is 10.
        ...
        :type statement_post: List[StatementPost]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_audit_log_entries_serialize(
            before=before,
            after=after,
            q=q,
            limit=limit,
    ...
    @validate_call
    def post_audit_log_entries_with_http_info(
        self,
        before: Annotated[Optional[StrictInt], Field(description="A timestamp filter, expressed as a Unix epoch time in milliseconds.  All entries returned occurred before the timestamp.")] = None,
        after: Annotated[Optional[StrictInt], Field(description="A timestamp filter, expressed as a Unix epoch time in milliseconds. All entries returned occurred after the timestamp.")] = None,
        q: Annotated[Optional[StrictStr], Field(description="Text to search for. You can search for the full or partial name of the resource.")] = None,
    ...
    @validate_call
    def post_audit_log_entries_without_preload_content(
        self,
        before: Annotated[Optional[StrictInt], Field(description="A timestamp filter, expressed as a Unix epoch time in milliseconds.  All entries returned occurred before the timestamp.")] = None,
        after: Annotated[Optional[StrictInt], Field(description="A timestamp filter, expressed as a Unix epoch time in milliseconds. All entries returned occurred after the timestamp.")] = None,
        q: Annotated[Optional[StrictStr], Field(description="Text to search for. You can search for the full or partial name of the resource.")] = None,
    ...
    def _post_audit_log_entries_serialize(
        self,
        before,
        after,
        q,
        ...
        # process the form parameters
        # process the body parameter
        if statement_post is not None:
            _body_params = statement_post
