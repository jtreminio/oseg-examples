...
class AccountMembersApi:
    ...
    def delete_member(
        self,
        id: Annotated[StrictStr, Field(description="The member ID")],
    ...
    def _delete_member_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v2/members/{id}',
    ...
    def get_members(
        self,
        limit: Annotated[Optional[StrictInt], Field(description="The number of members to return in the response. Defaults to 20.")] = None,
    ...
    def post_member_teams(
        ...
        :param id: The member ID (required)
        :type id: str
        :param member_teams_post_input: (required)
        :type member_teams_post_input: MemberTeamsPostInput
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_member_teams_serialize(
            id=id,
    ...
    @validate_call
    def post_member_teams_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The member ID")],
        member_teams_post_input: MemberTeamsPostInput,
        _request_timeout: Union[
    ...
    @validate_call
    def post_member_teams_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The member ID")],
        member_teams_post_input: MemberTeamsPostInput,
        _request_timeout: Union[
    ...
    def _post_member_teams_serialize(
        self,
        id,
        ...
        # process the form parameters
        # process the body parameter
        if member_teams_post_input is not None:
            _body_params = member_teams_post_input
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/members/{id}/teams',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def post_members(
        self,
        new_member_form: List[NewMemberForm],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param new_member_form: (required)
        :type new_member_form: List[NewMemberForm]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _post_members_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if new_member_form is not None:
            _body_params = new_member_form
