...
class CodeReferencesApi:
    ...
    def delete_branches(
        self,
        repo: Annotated[StrictStr, Field(description="The repository name to delete branches for.")],
        ...
        _param = self._delete_branches_serialize(
            repo=repo,
    ...
    @validate_call
    def delete_branches_with_http_info(
        self,
        repo: Annotated[StrictStr, Field(description="The repository name to delete branches for.")],
        request_body: List[StrictStr],
        _request_timeout: Union[
    ...
    @validate_call
    def delete_branches_without_preload_content(
        self,
        repo: Annotated[StrictStr, Field(description="The repository name to delete branches for.")],
        request_body: List[StrictStr],
        _request_timeout: Union[
    ...
    def _delete_branches_serialize(
        self,
        repo,
        request_body,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/code-refs/repositories/{repo}/branch-delete-tasks',
    ...
    def _delete_repository_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v2/code-refs/repositories/{repo}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_branch(
        self,
        repo: Annotated[StrictStr, Field(description="The repository name")],
        branch: Annotated[StrictStr, Field(description="The url-encoded branch name")],
        proj_key: Annotated[Optional[StrictStr], Field(description="Filter results to a specific project")] = None,
        flag_key: Annotated[Optional[StrictStr], Field(description="Filter results to a specific flag key")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type branch: str
        :param proj_key: Filter results to a specific project
        :type proj_key: str
        :param flag_key: Filter results to a specific flag key
        :type flag_key: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def _get_branch_serialize(
        ...
        if proj_key is not None:
            ...
            _query_params.append(('projKey', proj_key))
            
        if flag_key is not None:
            
            _query_params.append(('flagKey', flag_key))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/code-refs/repositories/{repo}/branches/{branch}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_branches_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/code-refs/repositories/{repo}/branches',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_extinctions(
        self,
        repo_name: Annotated[Optional[StrictStr], Field(description="Filter results to a specific repository")] = None,
        branch_name: Annotated[Optional[StrictStr], Field(description="Filter results to a specific branch. By default, only the default branch will be queried for extinctions.")] = None,
        proj_key: Annotated[Optional[StrictStr], Field(description="Filter results to a specific project")] = None,
        flag_key: Annotated[Optional[StrictStr], Field(description="Filter results to a specific flag key")] = None,
        var_from: Annotated[Optional[StrictInt], Field(description="Filter results to a specific timeframe based on commit time, expressed as a Unix epoch time in milliseconds. Must be used with `to`.")] = None,
        to: Annotated[Optional[StrictInt], Field(description="Filter results to a specific timeframe based on commit time, expressed as a Unix epoch time in milliseconds. Must be used with `from`.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param repo_name: Filter results to a specific repository
        :type repo_name: str
        :param branch_name: Filter results to a specific branch. By default, only the default branch will be queried for extinctions.
        :type branch_name: str
        :param proj_key: Filter results to a specific project
        :type proj_key: str
        :param flag_key: Filter results to a specific flag key
        :type flag_key: str
        :param var_from: Filter results to a specific timeframe based on commit time, expressed as a Unix epoch time in milliseconds. Must be used with `to`.
        :type var_from: int
        ...
        _param = self._get_extinctions_serialize(
            repo_name=repo_name,
    ...
    @validate_call
    def get_extinctions_with_http_info(
        self,
        repo_name: Annotated[Optional[StrictStr], Field(description="Filter results to a specific repository")] = None,
        branch_name: Annotated[Optional[StrictStr], Field(description="Filter results to a specific branch. By default, only the default branch will be queried for extinctions.")] = None,
        proj_key: Annotated[Optional[StrictStr], Field(description="Filter results to a specific project")] = None,
    ...
    @validate_call
    def get_extinctions_without_preload_content(
        self,
        repo_name: Annotated[Optional[StrictStr], Field(description="Filter results to a specific repository")] = None,
        branch_name: Annotated[Optional[StrictStr], Field(description="Filter results to a specific branch. By default, only the default branch will be queried for extinctions.")] = None,
        proj_key: Annotated[Optional[StrictStr], Field(description="Filter results to a specific project")] = None,
    ...
    def _get_extinctions_serialize(
        self,
        repo_name,
        branch_name,
        proj_key,
        ...
        if repo_name is not None:
            ...
            _query_params.append(('repoName', repo_name))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/code-refs/extinctions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_repositories(
        self,
        with_branches: Annotated[Optional[StrictStr], Field(description="If set to any value, the endpoint returns repositories with associated branch data")] = None,
        with_references_for_default_branch: Annotated[Optional[StrictStr], Field(description="If set to any value, the endpoint returns repositories with associated branch data, as well as code references for the default git branch")] = None,
        proj_key: Annotated[Optional[StrictStr], Field(description="A LaunchDarkly project key. If provided, this filters code reference results to the specified project.")] = None,
        flag_key: Annotated[Optional[StrictStr], Field(description="If set to any value, the endpoint returns repositories with associated branch data, as well as code references for the default git branch")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param with_branches: If set to any value, the endpoint returns repositories with associated branch data
        :type with_branches: str
        :param with_references_for_default_branch: If set to any value, the endpoint returns repositories with associated branch data, as well as code references for the default git branch
        :type with_references_for_default_branch: str
        :param proj_key: A LaunchDarkly project key. If provided, this filters code reference results to the specified project.
        :type proj_key: str
        :param flag_key: If set to any value, the endpoint returns repositories with associated branch data, as well as code references for the default git branch
        :type flag_key: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def _get_repositories_serialize(
        ...
        if with_branches is not None:
            ...
            _query_params.append(('withBranches', with_branches))
            
        if with_references_for_default_branch is not None:
            
            _query_params.append(('withReferencesForDefaultBranch', with_references_for_default_branch))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/code-refs/repositories',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_root_statistic(
        ...
        _param = self._get_root_statistic_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def get_root_statistic_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_root_statistic_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_root_statistic_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/code-refs/statistics',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_statistics_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/code-refs/statistics/{projectKey}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def post_extinction(
        ...
        :type extinction: List[Extinction]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_extinction_serialize(
            repo=repo,
            branch=branch,
    ...
    @validate_call
    def post_extinction_with_http_info(
        self,
        repo: Annotated[StrictStr, Field(description="The repository name")],
        branch: Annotated[StrictStr, Field(description="The URL-encoded branch name")],
        extinction: List[Extinction],
    ...
    @validate_call
    def post_extinction_without_preload_content(
        self,
        repo: Annotated[StrictStr, Field(description="The repository name")],
        branch: Annotated[StrictStr, Field(description="The URL-encoded branch name")],
        extinction: List[Extinction],
    ...
    def _post_extinction_serialize(
        self,
        repo,
        branch,
        extinction,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/code-refs/repositories/{repo}/branches/{branch}/extinction-events',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def post_repository(
        ...
        :param repository_post: (required)
        :type repository_post: RepositoryPost
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_repository_serialize(
    ...
    @validate_call
    def post_repository_with_http_info(
        self,
        repository_post: RepositoryPost,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def post_repository_without_preload_content(
        self,
        repository_post: RepositoryPost,
        _request_timeout: Union[
            None,
    ...
    def _post_repository_serialize(
        self,
        repository_post,
        _request_auth,
        _content_type,
        ...
        # process the form parameters
        # process the body parameter
        if repository_post is not None:
            _body_params = repository_post
    ...
    def put_branch(
        ...
        :param branch: The URL-encoded branch name (required)
        :type branch: str
        :param put_branch: (required)
        :type put_branch: PutBranch
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._put_branch_serialize(
            repo=repo,
            branch=branch,
    ...
    @validate_call
    def put_branch_without_preload_content(
        self,
        repo: Annotated[StrictStr, Field(description="The repository name")],
        branch: Annotated[StrictStr, Field(description="The URL-encoded branch name")],
        put_branch: PutBranch,
    ...
    def _put_branch_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if put_branch is not None:
            _body_params = put_branch
