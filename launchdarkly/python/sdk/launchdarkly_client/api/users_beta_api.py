...
class UsersBetaApi:
    ...
    def get_user_attribute_names(
        ...
        """(Deprecated) Get user attribute names
        ...
        """ # noqa: E501
        warnings.warn("GET /api/v2/user-attributes/{projectKey}/{environmentKey} is deprecated.", DeprecationWarning)

        _param = self._get_user_attribute_names_serialize(
    ...
    @validate_call
    def get_user_attribute_names_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        _request_timeout: Union[
    ...
    @validate_call
    def get_user_attribute_names_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        _request_timeout: Union[
    ...
    def _get_user_attribute_names_serialize(
        self,
        project_key,
        environment_key,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/user-attributes/{projectKey}/{environmentKey}',
