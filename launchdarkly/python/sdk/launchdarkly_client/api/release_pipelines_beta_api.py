...
class ReleasePipelinesBetaApi:
    ...
    @validate_call
    def delete_release_pipeline(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        pipeline_key: Annotated[StrictStr, Field(description="The release pipeline key")],
        ...
        :param pipeline_key: The release pipeline key (required)
        ...
        _param = self._delete_release_pipeline_serialize(
    ...
    @validate_call
    def delete_release_pipeline_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        pipeline_key: Annotated[StrictStr, Field(description="The release pipeline key")],
        _request_timeout: Union[
    ...
    @validate_call
    def delete_release_pipeline_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        pipeline_key: Annotated[StrictStr, Field(description="The release pipeline key")],
        _request_timeout: Union[
    ...
    def _delete_release_pipeline_serialize(
        self,
        project_key,
        pipeline_key,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v2/projects/{projectKey}/release-pipelines/{pipelineKey}',
    ...
    def get_all_release_pipelines(
        ...
        limit: Annotated[Optional[StrictInt], Field(description="The maximum number of items to return. Defaults to 20.")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="Where to start in the list. Defaults to 0. Use this with pagination. For example, an offset of 10 skips the first ten items and then returns the next items in the list, up to the query `limit`.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._get_all_release_pipelines_serialize(
            project_key=project_key,
            filter=filter,
            limit=limit,
            offset=offset,
    ...
    @validate_call
    def get_all_release_pipelines_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        filter: Annotated[Optional[StrictStr], Field(description="A comma-separated list of filters. Each filter is of the form field:value. Read the endpoint description for a full list of available filter fields.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="The maximum number of items to return. Defaults to 20.")] = None,
    ...
    @validate_call
    def get_all_release_pipelines_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        filter: Annotated[Optional[StrictStr], Field(description="A comma-separated list of filters. Each filter is of the form field:value. Read the endpoint description for a full list of available filter fields.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="The maximum number of items to return. Defaults to 20.")] = None,
    ...
    def _get_all_release_pipelines_serialize(
        self,
        project_key,
        filter,
        limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/projects/{projectKey}/release-pipelines',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_all_release_progressions_for_release_pipeline(
        ...
        :param project_key: The project key (required)
        :type project_key: str
        :param pipeline_key: The pipeline key (required)
        :type pipeline_key: str
        ...
        _param = self._get_all_release_progressions_for_release_pipeline_serialize(
            project_key=project_key,
            pipeline_key=pipeline_key,
            filter=filter,
            limit=limit,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ReleaseProgressionCollection",
            '404': "NotFoundErrorRep",
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def get_all_release_progressions_for_release_pipeline_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        pipeline_key: Annotated[StrictStr, Field(description="The pipeline key")],
        filter: Annotated[Optional[StrictStr], Field(description="Accepts filter by `status` and `activePhaseId`. `status` can take a value of `completed` or `active`. `activePhaseId` takes a UUID and will filter results down to releases active on the specified phase. Providing `status equals completed` along with an `activePhaseId` filter will return an error as they are disjoint sets of data. The combination of `status equals active` and `activePhaseId` will return the same results as `activePhaseId` alone.")] = None,
    ...
    @validate_call
    def get_all_release_progressions_for_release_pipeline_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        pipeline_key: Annotated[StrictStr, Field(description="The pipeline key")],
        filter: Annotated[Optional[StrictStr], Field(description="Accepts filter by `status` and `activePhaseId`. `status` can take a value of `completed` or `active`. `activePhaseId` takes a UUID and will filter results down to releases active on the specified phase. Providing `status equals completed` along with an `activePhaseId` filter will return an error as they are disjoint sets of data. The combination of `status equals active` and `activePhaseId` will return the same results as `activePhaseId` alone.")] = None,
    ...
    def _get_all_release_progressions_for_release_pipeline_serialize(
        self,
        project_key,
        pipeline_key,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/projects/{projectKey}/release-pipelines/{pipelineKey}/releases',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_release_pipeline_by_key(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        pipeline_key: Annotated[StrictStr, Field(description="The release pipeline key")],
        _request_timeout: Union[
        ...
        _param = self._get_release_pipeline_by_key_serialize(
            project_key=project_key,
            pipeline_key=pipeline_key,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_release_pipeline_by_key_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        pipeline_key: Annotated[StrictStr, Field(description="The release pipeline key")],
        _request_timeout: Union[
    ...
    @validate_call
    def get_release_pipeline_by_key_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        pipeline_key: Annotated[StrictStr, Field(description="The release pipeline key")],
        _request_timeout: Union[
    ...
    def _get_release_pipeline_by_key_serialize(
        self,
        project_key,
        pipeline_key,
        _request_auth,
    ...
    def post_release_pipeline(
        ...
        :param project_key: The project key (required)
        :type project_key: str
        :param create_release_pipeline_input: (required)
        :type create_release_pipeline_input: CreateReleasePipelineInput
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_release_pipeline_serialize(
            project_key=project_key,
    ...
    @validate_call
    def post_release_pipeline_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        create_release_pipeline_input: CreateReleasePipelineInput,
        _request_timeout: Union[
    ...
    @validate_call
    def post_release_pipeline_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        create_release_pipeline_input: CreateReleasePipelineInput,
        _request_timeout: Union[
    ...
    def _post_release_pipeline_serialize(
        self,
        project_key,
        ...
        # process the form parameters
        # process the body parameter
        if create_release_pipeline_input is not None:
            _body_params = create_release_pipeline_input
    ...
    def put_release_pipeline(
        ...
        :param pipeline_key: The release pipeline key (required)
        :type pipeline_key: str
        :param update_release_pipeline_input: (required)
        :type update_release_pipeline_input: UpdateReleasePipelineInput
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._put_release_pipeline_serialize(
            project_key=project_key,
            pipeline_key=pipeline_key,
    ...
    @validate_call
    def put_release_pipeline_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        pipeline_key: Annotated[StrictStr, Field(description="The release pipeline key")],
        update_release_pipeline_input: UpdateReleasePipelineInput,
    ...
    @validate_call
    def put_release_pipeline_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        pipeline_key: Annotated[StrictStr, Field(description="The release pipeline key")],
        update_release_pipeline_input: UpdateReleasePipelineInput,
    ...
    def _put_release_pipeline_serialize(
        self,
        project_key,
        pipeline_key,
        ...
        # process the form parameters
        # process the body parameter
        if update_release_pipeline_input is not None:
            _body_params = update_release_pipeline_input
