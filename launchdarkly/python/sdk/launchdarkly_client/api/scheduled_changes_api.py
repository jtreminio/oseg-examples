...
class ScheduledChangesApi:
    ...
    def delete_flag_config_scheduled_changes(
        ...
        id: Annotated[StrictStr, Field(description="The scheduled change id")],
        ...
        _param = self._delete_flag_config_scheduled_changes_serialize(
    ...
    @validate_call
    def delete_flag_config_scheduled_changes_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        feature_flag_key: Annotated[StrictStr, Field(description="The feature flag key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
    ...
    @validate_call
    def delete_flag_config_scheduled_changes_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        feature_flag_key: Annotated[StrictStr, Field(description="The feature flag key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
    ...
    def _delete_flag_config_scheduled_changes_serialize(
        self,
        project_key,
        feature_flag_key,
        environment_key,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/scheduled-changes/{id}',
    ...
    def get_feature_flag_scheduled_change(
        ...
        _param = self._get_feature_flag_scheduled_change_serialize(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            environment_key=environment_key,
            id=id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "FeatureFlagScheduledChange",
            '401': "UnauthorizedErrorRep",
            '404': "NotFoundErrorRep",
            '429': "RateLimitedErrorRep",
        }
    ...
    @validate_call
    def get_feature_flag_scheduled_change_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        feature_flag_key: Annotated[StrictStr, Field(description="The feature flag key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
    ...
    @validate_call
    def get_feature_flag_scheduled_change_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        feature_flag_key: Annotated[StrictStr, Field(description="The feature flag key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
    ...
    def _get_feature_flag_scheduled_change_serialize(
        self,
        project_key,
        feature_flag_key,
        environment_key,
    ...
    def get_flag_config_scheduled_changes(
        ...
        _param = self._get_flag_config_scheduled_changes_serialize(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            environment_key=environment_key,
            _request_auth=_request_auth,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "FeatureFlagScheduledChanges",
    ...
    @validate_call
    def get_flag_config_scheduled_changes_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        feature_flag_key: Annotated[StrictStr, Field(description="The feature flag key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
    ...
    @validate_call
    def get_flag_config_scheduled_changes_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        feature_flag_key: Annotated[StrictStr, Field(description="The feature flag key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
    ...
    def _get_flag_config_scheduled_changes_serialize(
        self,
        project_key,
        feature_flag_key,
        environment_key,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/scheduled-changes',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def patch_flag_config_scheduled_change(
        ...
        ignore_conflicts: Annotated[Optional[StrictBool], Field(description="Whether to succeed (`true`) or fail (`false`) when these new instructions conflict with existing scheduled changes")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: The scheduled change ID (required)
        :type id: str
        :param flag_scheduled_changes_input: (required)
        :type flag_scheduled_changes_input: FlagScheduledChangesInput
        :param ignore_conflicts: Whether to succeed (`true`) or fail (`false`) when these new instructions conflict with existing scheduled changes
        ...
        _param = self._patch_flag_config_scheduled_change_serialize(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            environment_key=environment_key,
            id=id,
    ...
    @validate_call
    def patch_flag_config_scheduled_change_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        feature_flag_key: Annotated[StrictStr, Field(description="The feature flag key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
    ...
    @validate_call
    def patch_flag_config_scheduled_change_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        feature_flag_key: Annotated[StrictStr, Field(description="The feature flag key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
    ...
    def _patch_flag_config_scheduled_change_serialize(
        self,
        project_key,
        feature_flag_key,
        environment_key,
        ...
        # process the form parameters
        # process the body parameter
        if flag_scheduled_changes_input is not None:
            _body_params = flag_scheduled_changes_input
    ...
    def post_flag_config_scheduled_changes(
        ...
        ignore_conflicts: Annotated[Optional[StrictBool], Field(description="Whether to succeed (`true`) or fail (`false`) when these instructions conflict with existing scheduled changes")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param environment_key: The environment key (required)
        :type environment_key: str
        :param post_flag_scheduled_changes_input: (required)
        :type post_flag_scheduled_changes_input: PostFlagScheduledChangesInput
        :param ignore_conflicts: Whether to succeed (`true`) or fail (`false`) when these instructions conflict with existing scheduled changes
        :type ignore_conflicts: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._post_flag_config_scheduled_changes_serialize(
            project_key=project_key,
            feature_flag_key=feature_flag_key,
            environment_key=environment_key,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "FeatureFlagScheduledChange",
            '400': "InvalidRequestErrorRep",
            '401': "UnauthorizedErrorRep",
            '403': "ForbiddenErrorRep",
            '404': "NotFoundErrorRep",
    ...
    @validate_call
    def post_flag_config_scheduled_changes_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        feature_flag_key: Annotated[StrictStr, Field(description="The feature flag key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
    ...
    @validate_call
    def post_flag_config_scheduled_changes_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        feature_flag_key: Annotated[StrictStr, Field(description="The feature flag key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
    ...
    def _post_flag_config_scheduled_changes_serialize(
        self,
        project_key,
        feature_flag_key,
        environment_key,
        ...
        # process the form parameters
        # process the body parameter
        if post_flag_scheduled_changes_input is not None:
            _body_params = post_flag_scheduled_changes_input
