...
class InsightsRepositoriesBetaApi:
    ...
    def associate_repositories_and_projects(
        ...
        :param insights_repository_project_mappings: (required)
        :type insights_repository_project_mappings: InsightsRepositoryProjectMappings
        ...
        _param = self._associate_repositories_and_projects_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "InsightsRepositoryProjectCollection",
    ...
    @validate_call
    def associate_repositories_and_projects_with_http_info(
        self,
        insights_repository_project_mappings: InsightsRepositoryProjectMappings,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def associate_repositories_and_projects_without_preload_content(
        self,
        insights_repository_project_mappings: InsightsRepositoryProjectMappings,
        _request_timeout: Union[
            None,
    ...
    def _associate_repositories_and_projects_serialize(
        self,
        ...
        if insights_repository_project_mappings is not None:
            _body_params = insights_repository_project_mappings
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/api/v2/engineering-insights/repositories/projects',
    ...
    def delete_repository_project(
        self,
        repository_key: Annotated[StrictStr, Field(description="The repository key")],
        ...
        :param repository_key: The repository key (required)
        :type repository_key: str
        ...
        _param = self._delete_repository_project_serialize(
    ...
    @validate_call
    def delete_repository_project_with_http_info(
        self,
        repository_key: Annotated[StrictStr, Field(description="The repository key")],
        project_key: Annotated[StrictStr, Field(description="The project key")],
        _request_timeout: Union[
    ...
    @validate_call
    def delete_repository_project_without_preload_content(
        self,
        repository_key: Annotated[StrictStr, Field(description="The repository key")],
        project_key: Annotated[StrictStr, Field(description="The project key")],
        _request_timeout: Union[
    ...
    def _delete_repository_project_serialize(
        self,
        repository_key,
        project_key,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v2/engineering-insights/repositories/{repositoryKey}/projects/{projectKey}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_insights_repositories(
        self,
        expand: Annotated[Optional[StrictStr], Field(description="Expand properties in response. Options: `projects`")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._get_insights_repositories_serialize(
            expand=expand,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "InsightsRepositoryCollection",
            '400': "ValidationFailedErrorRep",
            '401': "UnauthorizedErrorRep",
            '403': "ForbiddenErrorRep",
            '404': "NotFoundErrorRep",
    ...
    @validate_call
    def get_insights_repositories_with_http_info(
        self,
        expand: Annotated[Optional[StrictStr], Field(description="Expand properties in response. Options: `projects`")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_insights_repositories_without_preload_content(
        self,
        expand: Annotated[Optional[StrictStr], Field(description="Expand properties in response. Options: `projects`")] = None,
        _request_timeout: Union[
            None,
    ...
    def _get_insights_repositories_serialize(
        self,
        expand,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/engineering-insights/repositories',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
