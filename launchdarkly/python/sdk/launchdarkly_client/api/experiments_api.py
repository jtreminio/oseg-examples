...
class ExperimentsApi:
    ...
    def get_experiment_results(
        ...
        iteration_id: Annotated[Optional[StrictStr], Field(description="The iteration ID")] = None,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ExperimentBayesianResultsRep",
            '400': "InvalidRequestErrorRep",
            '401': "UnauthorizedErrorRep",
            '403': "ForbiddenErrorRep",
            '404': "NotFoundErrorRep",
    ...
    def _get_experiment_results_serialize(
        ...
        if iteration_id is not None:
            ...
            _query_params.append(('iterationId', iteration_id))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/projects/{projectKey}/environments/{environmentKey}/experiments/{experimentKey}/metrics/{metricKey}/results',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_experiment_results_for_metric_group(
        ...
        _param = self._get_experiment_results_for_metric_group_serialize(
            project_key=project_key,
            environment_key=environment_key,
            experiment_key=experiment_key,
    ...
    @validate_call
    def get_experiment_results_for_metric_group_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        experiment_key: Annotated[StrictStr, Field(description="The experiment key")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[MetricGroupResultsRep]:
        """Get experiment results for metric group
    ...
    @validate_call
    def get_experiment_results_for_metric_group_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        experiment_key: Annotated[StrictStr, Field(description="The experiment key")],
    ...
    def _get_experiment_results_for_metric_group_serialize(
        self,
        project_key,
        environment_key,
        experiment_key,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/projects/{projectKey}/environments/{environmentKey}/experiments/{experimentKey}/metric-groups/{metricGroupKey}/results',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
