...
class InsightsScoresBetaApi:
    ...
    def create_insight_group(
        ...
        :param post_insight_group_params: (required)
        :type post_insight_group_params: PostInsightGroupParams
        ...
        _param = self._create_insight_group_serialize(
    ...
    @validate_call
    def create_insight_group_with_http_info(
        self,
        post_insight_group_params: PostInsightGroupParams,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def create_insight_group_without_preload_content(
        self,
        post_insight_group_params: PostInsightGroupParams,
        _request_timeout: Union[
            None,
    ...
    def _create_insight_group_serialize(
        self,
        ...
        if post_insight_group_params is not None:
            _body_params = post_insight_group_params
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/engineering-insights/insights/group',
    ...
    def delete_insight_group(
        self,
        insight_group_key: Annotated[StrictStr, Field(description="The insight group key")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param insight_group_key: The insight group key (required)
        :type insight_group_key: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._delete_insight_group_serialize(
    ...
    @validate_call
    def delete_insight_group_with_http_info(
        self,
        insight_group_key: Annotated[StrictStr, Field(description="The insight group key")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_insight_group_without_preload_content(
        self,
        insight_group_key: Annotated[StrictStr, Field(description="The insight group key")],
        _request_timeout: Union[
            None,
    ...
    def _delete_insight_group_serialize(
        self,
        insight_group_key,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v2/engineering-insights/insights/groups/{insightGroupKey}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_insight_group(
        self,
        insight_group_key: Annotated[StrictStr, Field(description="The insight group key")],
        expand: Annotated[Optional[StrictStr], Field(description="Options: `scores`, `environment`")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._get_insight_group_serialize(
            insight_group_key=insight_group_key,
            expand=expand,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_insight_group_with_http_info(
        self,
        insight_group_key: Annotated[StrictStr, Field(description="The insight group key")],
        expand: Annotated[Optional[StrictStr], Field(description="Options: `scores`, `environment`")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def get_insight_group_without_preload_content(
        self,
        insight_group_key: Annotated[StrictStr, Field(description="The insight group key")],
        expand: Annotated[Optional[StrictStr], Field(description="Options: `scores`, `environment`")] = None,
        _request_timeout: Union[
    ...
    def _get_insight_group_serialize(
        self,
        insight_group_key,
        expand,
        _request_auth,
    ...
    @validate_call
    def get_insight_groups(
        self,
        limit: Annotated[Optional[StrictInt], Field(description="The number of insight groups to return. Default is 20. Must be between 1 and 20 inclusive.")] = None,
        ...
        sort: Annotated[Optional[StrictStr], Field(description="Sort flag list by field. Prefix field with <code>-</code> to sort in descending order. Allowed fields: name")] = None,
        query: Annotated[Optional[StrictStr], Field(description="Filter list of insights groups by name.")] = None,
        expand: Annotated[Optional[StrictStr], Field(description="Options: `scores`, `environment`, `metadata`")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._get_insight_groups_serialize(
            limit=limit,
            offset=offset,
            sort=sort,
            query=query,
    ...
    @validate_call
    def get_insight_groups_with_http_info(
        self,
        limit: Annotated[Optional[StrictInt], Field(description="The number of insight groups to return. Default is 20. Must be between 1 and 20 inclusive.")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="Where to start in the list. Use this with pagination. For example, an offset of 10 skips the first ten items and then returns the next items in the list, up to the query `limit`.")] = None,
        sort: Annotated[Optional[StrictStr], Field(description="Sort flag list by field. Prefix field with <code>-</code> to sort in descending order. Allowed fields: name")] = None,
    ...
    @validate_call
    def get_insight_groups_without_preload_content(
        self,
        limit: Annotated[Optional[StrictInt], Field(description="The number of insight groups to return. Default is 20. Must be between 1 and 20 inclusive.")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="Where to start in the list. Use this with pagination. For example, an offset of 10 skips the first ten items and then returns the next items in the list, up to the query `limit`.")] = None,
        sort: Annotated[Optional[StrictStr], Field(description="Sort flag list by field. Prefix field with <code>-</code> to sort in descending order. Allowed fields: name")] = None,
    ...
    def _get_insight_groups_serialize(
        self,
        limit,
        offset,
        sort,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/engineering-insights/insights/groups',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_insights_scores(
        ...
        _param = self._get_insights_scores_serialize(
    ...
    @validate_call
    def get_insights_scores_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        application_key: Annotated[Optional[StrictStr], Field(description="Comma separated list of application keys")] = None,
    ...
    @validate_call
    def get_insights_scores_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        application_key: Annotated[Optional[StrictStr], Field(description="Comma separated list of application keys")] = None,
    ...
    def _get_insights_scores_serialize(
        self,
        project_key,
        environment_key,
        application_key,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/engineering-insights/insights/scores',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def patch_insight_group(
        ...
        _param = self._patch_insight_group_serialize(
            insight_group_key=insight_group_key,
    ...
    @validate_call
    def patch_insight_group_with_http_info(
        self,
        insight_group_key: Annotated[StrictStr, Field(description="The insight group key")],
        patch_operation: List[PatchOperation],
        _request_timeout: Union[
    ...
    @validate_call
    def patch_insight_group_without_preload_content(
        self,
        insight_group_key: Annotated[StrictStr, Field(description="The insight group key")],
        patch_operation: List[PatchOperation],
        _request_timeout: Union[
    ...
    def _patch_insight_group_serialize(
        self,
        insight_group_key,
        patch_operation,
        _request_auth,
