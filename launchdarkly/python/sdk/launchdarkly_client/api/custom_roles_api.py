...
class CustomRolesApi:
    ...
    def delete_custom_role(
        self,
        custom_role_key: Annotated[StrictStr, Field(description="The custom role key")],
        ...
        :param custom_role_key: The custom role key (required)
    ...
    def _delete_custom_role_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v2/roles/{customRoleKey}',
    ...
    def get_custom_role(
        self,
        custom_role_key: Annotated[StrictStr, Field(description="The custom role key or ID")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param custom_role_key: The custom role key or ID (required)
        :type custom_role_key: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_custom_role_serialize(
            custom_role_key=custom_role_key,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_custom_role_with_http_info(
        self,
        custom_role_key: Annotated[StrictStr, Field(description="The custom role key or ID")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_custom_role_without_preload_content(
        self,
        custom_role_key: Annotated[StrictStr, Field(description="The custom role key or ID")],
        _request_timeout: Union[
            None,
    ...
    def _get_custom_role_serialize(
        self,
        custom_role_key,
        _request_auth,
        _content_type,
    ...
    def get_custom_roles(
        self,
        limit: Annotated[Optional[StrictInt], Field(description="The maximum number of custom roles to return. Defaults to 20.")] = None,
    ...
    def patch_custom_role(
        ...
        _param = self._patch_custom_role_serialize(
            custom_role_key=custom_role_key,
    ...
    @validate_call
    def patch_custom_role_with_http_info(
        self,
        custom_role_key: Annotated[StrictStr, Field(description="The custom role key")],
        patch_with_comment: PatchWithComment,
        _request_timeout: Union[
    ...
    @validate_call
    def patch_custom_role_without_preload_content(
        self,
        custom_role_key: Annotated[StrictStr, Field(description="The custom role key")],
        patch_with_comment: PatchWithComment,
        _request_timeout: Union[
    ...
    def _patch_custom_role_serialize(
        self,
        custom_role_key,
        patch_with_comment,
        _request_auth,
    ...
    def post_custom_role(
        ...
        :param custom_role_post: (required)
        :type custom_role_post: CustomRolePost
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_custom_role_serialize(
    ...
    @validate_call
    def post_custom_role_with_http_info(
        self,
        custom_role_post: CustomRolePost,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def post_custom_role_without_preload_content(
        self,
        custom_role_post: CustomRolePost,
        _request_timeout: Union[
            None,
    ...
    def _post_custom_role_serialize(
        self,
        custom_role_post,
        _request_auth,
        _content_type,
        ...
        # process the form parameters
        # process the body parameter
        if custom_role_post is not None:
            _body_params = custom_role_post
