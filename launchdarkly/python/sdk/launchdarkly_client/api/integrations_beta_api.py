...
class IntegrationsBetaApi:
    ...
    def create_integration_configuration(
        ...
        :param integration_configuration_post: (required)
        :type integration_configuration_post: IntegrationConfigurationPost
        ...
        _param = self._create_integration_configuration_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "IntegrationConfigurationsRep",
    ...
    @validate_call
    def create_integration_configuration_with_http_info(
        self,
        integration_key: Annotated[StrictStr, Field(description="The integration key")],
        integration_configuration_post: IntegrationConfigurationPost,
        _request_timeout: Union[
    ...
    @validate_call
    def create_integration_configuration_without_preload_content(
        self,
        integration_key: Annotated[StrictStr, Field(description="The integration key")],
        integration_configuration_post: IntegrationConfigurationPost,
        _request_timeout: Union[
    ...
    def _create_integration_configuration_serialize(
        self,
        integration_key,
        ...
        if integration_configuration_post is not None:
            _body_params = integration_configuration_post
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/integration-configurations/keys/{integrationKey}',
    ...
    def delete_integration_configuration(
        self,
        integration_configuration_id: Annotated[StrictStr, Field(description="The ID of the integration configuration to be deleted")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param integration_configuration_id: The ID of the integration configuration to be deleted (required)
        :type integration_configuration_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._delete_integration_configuration_serialize(
    ...
    @validate_call
    def delete_integration_configuration_with_http_info(
        self,
        integration_configuration_id: Annotated[StrictStr, Field(description="The ID of the integration configuration to be deleted")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_integration_configuration_without_preload_content(
        self,
        integration_configuration_id: Annotated[StrictStr, Field(description="The ID of the integration configuration to be deleted")],
        _request_timeout: Union[
            None,
    ...
    def _delete_integration_configuration_serialize(
        self,
        ...
        if integration_configuration_id is not None:
            _path_params['integrationConfigurationId'] = integration_configuration_id
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v2/integration-configurations/{integrationConfigurationId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_all_integration_configurations(
        self,
        integration_key: Annotated[StrictStr, Field(description="Integration key")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param integration_key: Integration key (required)
        :type integration_key: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_all_integration_configurations_serialize(
            integration_key=integration_key,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "IntegrationConfigurationCollectionRep",
            '400': "InvalidRequestErrorRep",
            '401': "UnauthorizedErrorRep",
            '403': "ForbiddenErrorRep",
            '404': "NotFoundErrorRep",
    ...
    @validate_call
    def get_all_integration_configurations_with_http_info(
        self,
        integration_key: Annotated[StrictStr, Field(description="Integration key")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_all_integration_configurations_without_preload_content(
        self,
        integration_key: Annotated[StrictStr, Field(description="Integration key")],
        _request_timeout: Union[
            None,
    ...
    def _get_all_integration_configurations_serialize(
        self,
        integration_key,
        _request_auth,
        _content_type,
    ...
    def get_integration_configuration(
        self,
        integration_configuration_id: Annotated[StrictStr, Field(description="Integration configuration ID")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param integration_configuration_id: Integration configuration ID (required)
        :type integration_configuration_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_integration_configuration_serialize(
            integration_configuration_id=integration_configuration_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "IntegrationConfigurationsRep",
            '400': "InvalidRequestErrorRep",
            '401': "UnauthorizedErrorRep",
            '403': "ForbiddenErrorRep",
            '404': "NotFoundErrorRep",
    ...
    @validate_call
    def get_integration_configuration_with_http_info(
        self,
        integration_configuration_id: Annotated[StrictStr, Field(description="Integration configuration ID")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_integration_configuration_without_preload_content(
        self,
        integration_configuration_id: Annotated[StrictStr, Field(description="Integration configuration ID")],
        _request_timeout: Union[
            None,
    ...
    def _get_integration_configuration_serialize(
        self,
        integration_configuration_id,
        _request_auth,
        _content_type,
    ...
    def update_integration_configuration(
        self,
        integration_configuration_id: Annotated[StrictStr, Field(description="The ID of the integration configuration")],
        ...
        :param integration_configuration_id: The ID of the integration configuration (required)
        :type integration_configuration_id: str
        ...
        _param = self._update_integration_configuration_serialize(
            integration_configuration_id=integration_configuration_id,
    ...
    @validate_call
    def update_integration_configuration_with_http_info(
        self,
        integration_configuration_id: Annotated[StrictStr, Field(description="The ID of the integration configuration")],
        patch_operation: List[PatchOperation],
        _request_timeout: Union[
    ...
    @validate_call
    def update_integration_configuration_without_preload_content(
        self,
        integration_configuration_id: Annotated[StrictStr, Field(description="The ID of the integration configuration")],
        patch_operation: List[PatchOperation],
        _request_timeout: Union[
    ...
    def _update_integration_configuration_serialize(
        self,
        integration_configuration_id,
        patch_operation,
        _request_auth,
