...
class SegmentsApi:
    ...
    def get_segments(
        ...
        filter: Annotated[Optional[StrictStr], Field(description="Accepts filter by `excludedKeys`, `external`, `includedKeys`, `query`, `tags`, `unbounded`. To learn more about the filter syntax, read the  'Filtering segments' section above.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
