...
class EnvironmentsApi:
    ...
    def _delete_environment_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v2/projects/{projectKey}/environments/{environmentKey}',
    ...
    def get_environments_by_project(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        limit: Annotated[Optional[StrictInt], Field(description="The number of environments to return in the response. Defaults to 20.")] = None,
        ...
        filter: Annotated[Optional[StrictStr], Field(description="A comma-separated list of filters. Each filter is of the form `field:value`.")] = None,
        ...
        _param = self._get_environments_by_project_serialize(
            project_key=project_key,
            limit=limit,
            offset=offset,
            filter=filter,
    ...
    @validate_call
    def get_environments_by_project_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        limit: Annotated[Optional[StrictInt], Field(description="The number of environments to return in the response. Defaults to 20.")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="Where to start in the list. This is for use with pagination. For example, an offset of 10 skips the first ten items and then returns the next items in the list, up to the query `limit`.")] = None,
    ...
    @validate_call
    def get_environments_by_project_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        limit: Annotated[Optional[StrictInt], Field(description="The number of environments to return in the response. Defaults to 20.")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="Where to start in the list. This is for use with pagination. For example, an offset of 10 skips the first ten items and then returns the next items in the list, up to the query `limit`.")] = None,
    ...
    def _get_environments_by_project_serialize(
        self,
        project_key,
        limit,
        offset,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/projects/{projectKey}/environments',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def patch_environment(
        ...
        _param = self._patch_environment_serialize(
            project_key=project_key,
            environment_key=environment_key,
    ...
    @validate_call
    def patch_environment_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        patch_operation: List[PatchOperation],
    ...
    @validate_call
    def patch_environment_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        patch_operation: List[PatchOperation],
    ...
    def _patch_environment_serialize(
        self,
        project_key,
        environment_key,
        patch_operation,
    ...
    def post_environment(
        ...
        :param project_key: The project key (required)
        :type project_key: str
        :param environment_post: (required)
        :type environment_post: EnvironmentPost
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_environment_serialize(
            project_key=project_key,
    ...
    @validate_call
    def post_environment_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_post: EnvironmentPost,
        _request_timeout: Union[
    ...
    @validate_call
    def post_environment_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_post: EnvironmentPost,
        _request_timeout: Union[
    ...
    def _post_environment_serialize(
        self,
        project_key,
        environment_post,
        _request_auth,
        ...
        # process the form parameters
        # process the body parameter
        if environment_post is not None:
            _body_params = environment_post
    ...
    def reset_environment_mobile_key(
        ...
        _param = self._reset_environment_mobile_key_serialize(
            project_key=project_key,
            environment_key=environment_key,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def reset_environment_mobile_key_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        _request_timeout: Union[
    ...
    @validate_call
    def reset_environment_mobile_key_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        _request_timeout: Union[
    ...
    def _reset_environment_mobile_key_serialize(
        self,
        project_key,
        environment_key,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/projects/{projectKey}/environments/{environmentKey}/mobileKey',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def reset_environment_sdk_key(
        ...
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        expiry: Annotated[Optional[StrictInt], Field(description="The time at which you want the old SDK key to expire, in UNIX milliseconds. By default, the key expires immediately. During the period between this call and the time when the old SDK key expires, both the old SDK key and the new SDK key will work.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._reset_environment_sdk_key_serialize(
            project_key=project_key,
            environment_key=environment_key,
            expiry=expiry,
            _request_auth=_request_auth,
    ...
    @validate_call
    def reset_environment_sdk_key_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        expiry: Annotated[Optional[StrictInt], Field(description="The time at which you want the old SDK key to expire, in UNIX milliseconds. By default, the key expires immediately. During the period between this call and the time when the old SDK key expires, both the old SDK key and the new SDK key will work.")] = None,
    ...
    @validate_call
    def reset_environment_sdk_key_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        environment_key: Annotated[StrictStr, Field(description="The environment key")],
        expiry: Annotated[Optional[StrictInt], Field(description="The time at which you want the old SDK key to expire, in UNIX milliseconds. By default, the key expires immediately. During the period between this call and the time when the old SDK key expires, both the old SDK key and the new SDK key will work.")] = None,
    ...
    def _reset_environment_sdk_key_serialize(
        self,
        project_key,
        environment_key,
        expiry,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/projects/{projectKey}/environments/{environmentKey}/apiKey',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
