...
class ReleasesBetaApi:
    ...
    @validate_call
    def create_release_for_flag(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        flag_key: Annotated[StrictStr, Field(description="The flag key")],
        ...
        :param flag_key: The flag key (required)
        :type flag_key: str
        :param create_release_input: (required)
        :type create_release_input: CreateReleaseInput
        ...
        _param = self._create_release_for_flag_serialize(
    ...
    @validate_call
    def create_release_for_flag_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        flag_key: Annotated[StrictStr, Field(description="The flag key")],
        create_release_input: CreateReleaseInput,
    ...
    @validate_call
    def create_release_for_flag_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        flag_key: Annotated[StrictStr, Field(description="The flag key")],
        create_release_input: CreateReleaseInput,
    ...
    def _create_release_for_flag_serialize(
        self,
        project_key,
        flag_key,
        ...
        if create_release_input is not None:
            _body_params = create_release_input
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/api/v2/projects/{projectKey}/flags/{flagKey}/release',
    ...
    @validate_call
    def delete_release_by_flag_key(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        flag_key: Annotated[StrictStr, Field(description="The flag key")],
        _request_timeout: Union[
        ...
        _param = self._delete_release_by_flag_key_serialize(
            project_key=project_key,
            flag_key=flag_key,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def delete_release_by_flag_key_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        flag_key: Annotated[StrictStr, Field(description="The flag key")],
        _request_timeout: Union[
    ...
    @validate_call
    def delete_release_by_flag_key_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        flag_key: Annotated[StrictStr, Field(description="The flag key")],
        _request_timeout: Union[
    ...
    def _delete_release_by_flag_key_serialize(
        self,
        project_key,
        flag_key,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v2/flags/{projectKey}/{flagKey}/release',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_release_by_flag_key(
        ...
        _param = self._get_release_by_flag_key_serialize(
            project_key=project_key,
            flag_key=flag_key,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_release_by_flag_key_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        flag_key: Annotated[StrictStr, Field(description="The flag key")],
        _request_timeout: Union[
    ...
    @validate_call
    def get_release_by_flag_key_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        flag_key: Annotated[StrictStr, Field(description="The flag key")],
        _request_timeout: Union[
    ...
    def _get_release_by_flag_key_serialize(
        self,
        project_key,
        flag_key,
        _request_auth,
    ...
    def patch_release_by_flag_key(
        ...
        _param = self._patch_release_by_flag_key_serialize(
            project_key=project_key,
            flag_key=flag_key,
    ...
    @validate_call
    def patch_release_by_flag_key_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        flag_key: Annotated[StrictStr, Field(description="The flag key")],
        patch_operation: List[PatchOperation],
    ...
    @validate_call
    def patch_release_by_flag_key_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        flag_key: Annotated[StrictStr, Field(description="The flag key")],
        patch_operation: List[PatchOperation],
    ...
    def _patch_release_by_flag_key_serialize(
        self,
        project_key,
        flag_key,
        patch_operation,
    ...
    def update_phase_status(
        ...
        project_key: Annotated[StrictStr, Field(description="The project key")],
        flag_key: Annotated[StrictStr, Field(description="The flag key")],
        phase_id: Annotated[StrictStr, Field(description="The phase ID")],
        ...
        :param flag_key: The flag key (required)
        :type flag_key: str
        :param phase_id: The phase ID (required)
        :type phase_id: str
        :param update_phase_status_input: (required)
        :type update_phase_status_input: UpdatePhaseStatusInput
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_phase_status_serialize(
            project_key=project_key,
            flag_key=flag_key,
            phase_id=phase_id,
    ...
    @validate_call
    def update_phase_status_with_http_info(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        flag_key: Annotated[StrictStr, Field(description="The flag key")],
        phase_id: Annotated[StrictStr, Field(description="The phase ID")],
    ...
    @validate_call
    def update_phase_status_without_preload_content(
        self,
        project_key: Annotated[StrictStr, Field(description="The project key")],
        flag_key: Annotated[StrictStr, Field(description="The flag key")],
        phase_id: Annotated[StrictStr, Field(description="The phase ID")],
    ...
    def _update_phase_status_serialize(
        self,
        project_key,
        flag_key,
        phase_id,
        ...
        if phase_id is not None:
            _path_params['phaseId'] = phase_id
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        if update_phase_status_input is not None:
            _body_params = update_phase_status_input
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/api/v2/projects/{projectKey}/flags/{flagKey}/release/phases/{phaseId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
