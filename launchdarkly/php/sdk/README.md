...
```php
<?php
require_once('/path/to/launchdarkly/client/vendor/autoload.php');
```
...
$config = LaunchDarkly\Client\Configuration::getDefaultConfiguration()->setApiKey('Authorization', 'YOUR_API_KEY');
// Uncomment below to setup prefix (e.g. Bearer) for API key, if needed
// $config = LaunchDarkly\Client\Configuration::getDefaultConfiguration()->setApiKeyPrefix('Authorization', 'Bearer');


$apiInstance = new LaunchDarkly\Client\Api\AIConfigsBetaApi(
