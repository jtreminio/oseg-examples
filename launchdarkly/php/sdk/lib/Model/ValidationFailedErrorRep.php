...
class ValidationFailedErrorRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'code' => 'string',
        'message' => 'string',
        'errors' => '\LaunchDarkly\Client\Model\FailureReasonRep[]'
    ];
    ...
    */
     ...
     * Gets errors
     *
     * @return \LaunchDarkly\Client\Model\FailureReasonRep[]
     */
     ...
     * Sets errors
     *
     * @param \LaunchDarkly\Client\Model\FailureReasonRep[] $errors List of validation errors
     *
     * @return self
     */
