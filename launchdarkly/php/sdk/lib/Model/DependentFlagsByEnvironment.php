...
class DependentFlagsByEnvironment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'items' => '\LaunchDarkly\Client\Model\DependentFlag[]',
    ...
    */
     ...
     * Gets items
     *
     * @return \LaunchDarkly\Client\Model\DependentFlag[]
     */
     ...
     * Sets items
     *
     * @param \LaunchDarkly\Client\Model\DependentFlag[] $items A list of dependent flags, which are flags that use the requested flag as a prerequisite
     *
     * @return self
     */
