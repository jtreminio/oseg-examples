...
class BayesianBetaBinomialStatsRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('prior_alpha', $data ?? [], null);
        $this->setIfExists('prior_beta', $data ?? [], null);
        $this->setIfExists('prior_mean', $data ?? [], null);
        $this->setIfExists('data_weight', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($prior_alpha)) {
            throw new \InvalidArgumentException('non-nullable prior_alpha cannot be null');
        }
    ...
    {
        if (is_null($prior_beta)) {
            throw new \InvalidArgumentException('non-nullable prior_beta cannot be null');
        }
    ...
    {
        if (is_null($prior_mean)) {
            throw new \InvalidArgumentException('non-nullable prior_mean cannot be null');
        }
    ...
    {
        if (is_null($data_weight)) {
            throw new \InvalidArgumentException('non-nullable data_weight cannot be null');
        }
