...
class PatchSegmentExpiringTargetInputRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'comment' => 'string',
        'instructions' => '\LaunchDarkly\Client\Model\PatchSegmentExpiringTargetInstruction[]'
    ];
    ...
    */
     ...
     * Gets instructions
     *
     * @return \LaunchDarkly\Client\Model\PatchSegmentExpiringTargetInstruction[]
     */
     ...
     * Sets instructions
     *
     * @param \LaunchDarkly\Client\Model\PatchSegmentExpiringTargetInstruction[] $instructions Semantic patch instructions for the desired changes to the resource
     *
     * @return self
     */
