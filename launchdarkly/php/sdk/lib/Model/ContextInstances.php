...
class ContextInstances implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'items' => '\LaunchDarkly\Client\Model\ContextInstanceRecord[]'
    ];
    ...
    */
     ...
     * Gets items
     *
     * @return \LaunchDarkly\Client\Model\ContextInstanceRecord[]
     */
     ...
     * Sets items
     *
     * @param \LaunchDarkly\Client\Model\ContextInstanceRecord[] $items A collection of context instances. Can include multiple versions of context instances that have the same <code>id</code>, but different <code>applicationId</code>s.
     *
     * @return self
     */
