...
class TeamProjects implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Gets items
     *
     * @return \LaunchDarkly\Client\Model\ProjectSummary[]|null
     */
     ...
     * Sets items
     *
     * @param \LaunchDarkly\Client\Model\ProjectSummary[]|null $items Details on each project where team members have write privileges on at least one resource type (e.g. flags)
     *
     * @return self
     */
