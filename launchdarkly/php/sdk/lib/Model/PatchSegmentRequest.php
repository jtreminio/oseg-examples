...
class PatchSegmentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'comment' => 'string',
        'instructions' => '\LaunchDarkly\Client\Model\PatchSegmentInstruction[]'
    ];
    ...
    */
     ...
     * Gets instructions
     *
     * @return \LaunchDarkly\Client\Model\PatchSegmentInstruction[]
     */
     ...
     * Sets instructions
     *
     * @param \LaunchDarkly\Client\Model\PatchSegmentInstruction[] $instructions Semantic patch instructions for the desired changes to the resource
     *
     * @return self
     */
