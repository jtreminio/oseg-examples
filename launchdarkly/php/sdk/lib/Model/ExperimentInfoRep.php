...
class ExperimentInfoRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'baseline_idx' => 'int',
        'items' => '\LaunchDarkly\Client\Model\LegacyExperimentRep[]'
    ];
    ...
    */
     ...
     * Gets items
     *
     * @return \LaunchDarkly\Client\Model\LegacyExperimentRep[]
     */
     ...
     * Sets items
     *
     * @param \LaunchDarkly\Client\Model\LegacyExperimentRep[] $items items
     *
     * @return self
     */
