...
class UserSegment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'included' => 'string[]',
        'excluded' => 'string[]',
        'included_contexts' => '\LaunchDarkly\Client\Model\SegmentTarget[]',
        'excluded_contexts' => '\LaunchDarkly\Client\Model\SegmentTarget[]',
        '_links' => 'array<string,\LaunchDarkly\Client\Model\Link>',
        'rules' => '\LaunchDarkly\Client\Model\UserSegmentRule[]',
        'version' => 'int',
        'deleted' => 'bool',
        '_access' => '\LaunchDarkly\Client\Model\Access',
        '_flags' => '\LaunchDarkly\Client\Model\FlagListingRep[]',
        'unbounded' => 'bool',
        'unbounded_context_kind' => 'string',
        'generation' => 'int',
        '_unbounded_metadata' => '\LaunchDarkly\Client\Model\SegmentMetadata',
        '_external' => 'string',
    ...
    */
     ...
     *
     * @return \LaunchDarkly\Client\Model\SegmentTarget[]|null
     */
     ...
     *
     * @param \LaunchDarkly\Client\Model\SegmentTarget[]|null $included_contexts included_contexts
     *
     * @return self
     */
     ...
     *
     * @param \LaunchDarkly\Client\Model\SegmentTarget[]|null $excluded_contexts excluded_contexts
     *
     * @return self
     */
     ...
     * Gets rules
     *
     * @return \LaunchDarkly\Client\Model\UserSegmentRule[]
     */
     ...
     * Sets rules
     *
     * @param \LaunchDarkly\Client\Model\UserSegmentRule[] $rules An array of the targeting rules for this segment.
     *
     * @return self
     */
     ...
     * Sets _flags
     *
     * @param \LaunchDarkly\Client\Model\FlagListingRep[]|null $_flags A list of flags targeting this segment. Only included when getting a single segment, using the <code>getSegment</code> endpoint.
     *
     * @return self
     */
     ...
     *
     * @return \LaunchDarkly\Client\Model\SegmentMetadata|null
     */
     ...
     *
     * @param \LaunchDarkly\Client\Model\SegmentMetadata|null $_unbounded_metadata _unbounded_metadata
     *
     * @return self
     */
