...
class MetricGroupPost implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'tags' => 'string[]',
        'metrics' => '\LaunchDarkly\Client\Model\MetricInMetricGroupInput[]'
    ];
    ...
    */
     ...
     * Gets metrics
     *
     * @return \LaunchDarkly\Client\Model\MetricInMetricGroupInput[]
     */
     ...
     * Sets metrics
     *
     * @param \LaunchDarkly\Client\Model\MetricInMetricGroupInput[] $metrics An ordered list of the metrics in this metric group
     *
     * @return self
     */
