...
class StatisticCollectionRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'flags' => 'array<string,\LaunchDarkly\Client\Model\StatisticRep[]>',
    ...
    */
     ...
     * Gets flags
     *
     * @return array<string,\LaunchDarkly\Client\Model\StatisticRep[]>
     */
     ...
     * Sets flags
     *
     * @param array<string,\LaunchDarkly\Client\Model\StatisticRep[]> $flags A map of flag keys to a list of code reference statistics for each code repository in which the flag key appears
     *
     * @return self
     */
