...
class MultiEnvironmentDependentFlag implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'name' => 'string',
        'key' => 'string',
        'environments' => '\LaunchDarkly\Client\Model\DependentFlagEnvironment[]'
    ];
    ...
    */
     ...
     * Gets environments
     *
     * @return \LaunchDarkly\Client\Model\DependentFlagEnvironment[]
     */
     ...
     * Sets environments
     *
     * @param \LaunchDarkly\Client\Model\DependentFlagEnvironment[] $environments A list of environments in which the dependent flag appears
     *
     * @return self
     */
