...
class Contexts implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'items' => '\LaunchDarkly\Client\Model\ContextRecord[]'
    ];
    ...
    */
     ...
     * Gets items
     *
     * @return \LaunchDarkly\Client\Model\ContextRecord[]
     */
     ...
     * Sets items
     *
     * @param \LaunchDarkly\Client\Model\ContextRecord[] $items A collection of contexts. Can include multiple versions of contexts that have the same <code>kind</code> and <code>key</code>, but different <code>applicationId</code>s.
     *
     * @return self
     */
