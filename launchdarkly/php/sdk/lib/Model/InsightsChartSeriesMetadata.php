...
class InsightsChartSeriesMetadata implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'name' => 'string',
        'count' => 'int',
        'bounds' => '\LaunchDarkly\Client\Model\InsightsChartBounds[]'
    ];
    ...
    */
     ...
     * Gets bounds
     *
     * @return \LaunchDarkly\Client\Model\InsightsChartBounds[]|null
     */
     ...
     * Sets bounds
     *
     * @param \LaunchDarkly\Client\Model\InsightsChartBounds[]|null $bounds Bounds for the series data
     *
     * @return self
     */
