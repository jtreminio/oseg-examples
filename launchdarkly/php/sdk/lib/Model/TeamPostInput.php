...
class TeamPostInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'member_ids' => 'string[]',
        'name' => 'string',
        'permission_grants' => '\LaunchDarkly\Client\Model\PermissionGrantInput[]',
    ...
    */
     ...
     *
     * @return \LaunchDarkly\Client\Model\PermissionGrantInput[]|null
     */
     ...
     *
     * @param \LaunchDarkly\Client\Model\PermissionGrantInput[]|null $permission_grants A list of permission grants. Permission grants allow access to a specific action, without having to create or update a custom role.
     *
     * @return self
     */
