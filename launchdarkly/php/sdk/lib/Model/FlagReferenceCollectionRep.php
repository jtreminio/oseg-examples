...
class FlagReferenceCollectionRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'total_count' => 'int',
        'items' => '\LaunchDarkly\Client\Model\FlagReferenceRep[]'
    ];
    ...
    */
     ...
     * Gets items
     *
     * @return \LaunchDarkly\Client\Model\FlagReferenceRep[]
     */
     ...
     * Sets items
     *
     * @param \LaunchDarkly\Client\Model\FlagReferenceRep[] $items A list of flag references
     *
     * @return self
     */
