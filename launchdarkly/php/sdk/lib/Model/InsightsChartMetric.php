...
class InsightsChartMetric implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'unit' => 'string',
        'modifier' => 'string',
        'tiers' => '\LaunchDarkly\Client\Model\InsightsMetricTierDefinition[]'
    ];
    ...
    */
     ...
     * Gets tiers
     *
     * @return \LaunchDarkly\Client\Model\InsightsMetricTierDefinition[]
     */
     ...
     * Sets tiers
     *
     * @param \LaunchDarkly\Client\Model\InsightsMetricTierDefinition[] $tiers Metric indicator tiers
     *
     * @return self
     */
