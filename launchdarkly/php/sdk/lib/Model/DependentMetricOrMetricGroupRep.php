...
class DependentMetricOrMetricGroupRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Gets metrics
     *
     * @return \LaunchDarkly\Client\Model\MetricInGroupRep[]|null
     */
     ...
     * Sets metrics
     *
     * @param \LaunchDarkly\Client\Model\MetricInGroupRep[]|null $metrics An ordered list of the metrics in this metric group
     *
     * @return self
     */
