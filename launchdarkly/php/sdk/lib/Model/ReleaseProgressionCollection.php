...
class ReleaseProgressionCollection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'active_count' => 'int',
        'completed_count' => 'int',
        'items' => '\LaunchDarkly\Client\Model\ReleaseProgression[]',
        'phases' => '\LaunchDarkly\Client\Model\PhaseInfo[]',
        'total_count' => 'int',
    ...
    */
     ...
     * Gets items
     *
     * @return \LaunchDarkly\Client\Model\ReleaseProgression[]
     */
     ...
     * Sets items
     *
     * @param \LaunchDarkly\Client\Model\ReleaseProgression[] $items A list of details for each release, across all flags, for this release pipeline
     *
     * @return self
     */
     ...
     * Gets phases
     *
     * @return \LaunchDarkly\Client\Model\PhaseInfo[]
     */
     ...
     * Sets phases
     *
     * @param \LaunchDarkly\Client\Model\PhaseInfo[] $phases A list of details for each phase, across all releases, for this release pipeline
     *
     * @return self
     */
