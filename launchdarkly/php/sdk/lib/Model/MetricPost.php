...
class MetricPost implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'kind' => 'string',
        'selector' => 'string',
        'urls' => '\LaunchDarkly\Client\Model\UrlPost[]',
        'is_active' => 'bool',
        'is_numeric' => 'bool',
        'unit' => 'string',
        'event_key' => 'string',
    ...
    */
     ...
     * Gets urls
     *
     * @return \LaunchDarkly\Client\Model\UrlPost[]|null
     */
     ...
     * Sets urls
     *
     * @param \LaunchDarkly\Client\Model\UrlPost[]|null $urls One or more target URLs. Required for click and pageview metrics only.
     *
     * @return self
     */
