...
class ReleasePipelineCollection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'items' => '\LaunchDarkly\Client\Model\ReleasePipeline[]',
        'total_count' => 'int'
    ];
    ...
    */
     ...
     * Gets items
     *
     * @return \LaunchDarkly\Client\Model\ReleasePipeline[]
     */
     ...
     * Sets items
     *
     * @param \LaunchDarkly\Client\Model\ReleasePipeline[] $items An array of release pipelines
     *
     * @return self
     */
