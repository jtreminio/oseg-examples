...
class StatisticsRoot implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'projects' => '\LaunchDarkly\Client\Model\Link[]',
    ...
    */
     ...
     * Sets projects
     *
     * @param \LaunchDarkly\Client\Model\Link[]|null $projects The location and content type of all projects that have code references
     *
     * @return self
     */
     ...
     * Sets self
     *
     * @param \LaunchDarkly\Client\Model\Link|null $self self
     *
     * @return self
     */
