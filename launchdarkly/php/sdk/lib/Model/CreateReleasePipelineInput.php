...
class CreateReleasePipelineInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'key' => 'string',
        'name' => 'string',
        'phases' => '\LaunchDarkly\Client\Model\CreatePhaseInput[]',
        'tags' => 'string[]',
    ...
    */
     ...
     * Gets phases
     *
     * @return \LaunchDarkly\Client\Model\CreatePhaseInput[]
     */
     ...
     * Sets phases
     *
     * @param \LaunchDarkly\Client\Model\CreatePhaseInput[] $phases A logical grouping of one or more environments that share attributes for rolling out changes
     *
     * @return self
     */
