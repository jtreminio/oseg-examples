...
class Rule implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        '_id' => 'string',
        'variation' => 'int',
        'rollout' => '\LaunchDarkly\Client\Model\Rollout',
        'clauses' => '\LaunchDarkly\Client\Model\Clause[]',
        'track_events' => 'bool',
        'description' => 'string',
        'ref' => 'string'
    ];
    ...
    */
     ...
     * Gets rollout
     *
     * @return \LaunchDarkly\Client\Model\Rollout|null
     */
     ...
     * Sets rollout
     *
     * @param \LaunchDarkly\Client\Model\Rollout|null $rollout rollout
     *
     * @return self
     */
     ...
     * Gets clauses
     *
     * @return \LaunchDarkly\Client\Model\Clause[]
     */
     ...
     * Sets clauses
     *
     * @param \LaunchDarkly\Client\Model\Clause[] $clauses An array of clauses used for individual targeting based on attributes
     *
     * @return self
     */
