...
class ExperimentBayesianResultsRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'treatment_results' => '\LaunchDarkly\Client\Model\TreatmentResultRep[]',
        'metric_seen' => '\LaunchDarkly\Client\Model\MetricSeen',
        'probability_of_mismatch' => 'float',
        'results' => '\LaunchDarkly\Client\Model\SlicedResultsRep[]'
    ];
    ...
    protected static array $openAPINullables = [
        '_links' => false,
        'treatment_results' => false,
        'metric_seen' => false,
        'probability_of_mismatch' => false,
        'results' => false
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('treatment_results', $data ?? [], null);
        $this->setIfExists('metric_seen', $data ?? [], null);
        $this->setIfExists('probability_of_mismatch', $data ?? [], null);
    ...
    */
     ...
     * Gets _links
     *
     * @return array<string,\LaunchDarkly\Client\Model\Link>|null
     */
     ...
     * Sets _links
     *
     * @param array<string,\LaunchDarkly\Client\Model\Link>|null $_links The location and content type of related resources
     *
     * @return self
     */
     ...
     *
     * @return \LaunchDarkly\Client\Model\TreatmentResultRep[]|null
     * @deprecated
     */
     ...
     *
     * @param \LaunchDarkly\Client\Model\TreatmentResultRep[]|null $treatment_results Deprecated, use <code>results</code> instead. Only populated when response does not contain results sliced by multiple attributes.
     *
     * @return self
     * @deprecated
     */
    ...
    {
        if (is_null($treatment_results)) {
            throw new \InvalidArgumentException('non-nullable treatment_results cannot be null');
        }
     ...
     * Gets metric_seen
     *
     * @return \LaunchDarkly\Client\Model\MetricSeen|null
     */
     ...
     * Sets metric_seen
     *
     * @param \LaunchDarkly\Client\Model\MetricSeen|null $metric_seen metric_seen
     *
     * @return self
     */
    public function setMetricSeen($metric_seen)
    {
        if (is_null($metric_seen)) {
            throw new \InvalidArgumentException('non-nullable metric_seen cannot be null');
        }
    ...
    {
        if (is_null($probability_of_mismatch)) {
            throw new \InvalidArgumentException('non-nullable probability_of_mismatch cannot be null');
        }
     ...
     * Gets results
     *
     * @return \LaunchDarkly\Client\Model\SlicedResultsRep[]|null
     */
     ...
     * Sets results
     *
     * @param \LaunchDarkly\Client\Model\SlicedResultsRep[]|null $results A list of attribute values and their corresponding treatment results
     *
     * @return self
     */
