...
class FeatureFlagStatusAcrossEnvironments implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'environments' => 'array<string,\LaunchDarkly\Client\Model\FeatureFlagStatus>',
        'key' => 'string',
    ...
    */
     ...
     * Gets environments
     *
     * @return array<string,\LaunchDarkly\Client\Model\FeatureFlagStatus>
     */
     ...
     * Sets environments
     *
     * @param array<string,\LaunchDarkly\Client\Model\FeatureFlagStatus> $environments Flag status for environment.
     *
     * @return self
     */
     ...
     * Sets _links
     *
     * @param array<string,\LaunchDarkly\Client\Model\Link> $_links _links
     *
     * @return self
     */
