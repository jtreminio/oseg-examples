...
class UserFlagSettings implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'items' => 'array<string,\LaunchDarkly\Client\Model\UserFlagSetting>',
    ...
    */
     ...
     * Gets items
     *
     * @return array<string,\LaunchDarkly\Client\Model\UserFlagSetting>
     */
     ...
     * Sets items
     *
     * @param array<string,\LaunchDarkly\Client\Model\UserFlagSetting> $items An array of flag settings for the user
     *
     * @return self
     */
