...
class ReleasePipeline implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'key' => 'string',
        'name' => 'string',
        'phases' => '\LaunchDarkly\Client\Model\Phase[]',
        'tags' => 'string[]',
        '_version' => 'int',
    ...
    */
     ...
     * Gets phases
     *
     * @return \LaunchDarkly\Client\Model\Phase[]
     */
     ...
     * Sets phases
     *
     * @param \LaunchDarkly\Client\Model\Phase[] $phases An ordered list of the release pipeline phases. Each phase is a logical grouping of one or more environments that share attributes for rolling out changes.
     *
     * @return self
     */
