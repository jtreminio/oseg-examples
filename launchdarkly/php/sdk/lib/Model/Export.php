...
class Export implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'size_bytes' => 'int',
        'size' => 'string',
        'initiator' => '\LaunchDarkly\Client\Model\InitiatorRep',
    ...
    */
     ...
     * Gets initiator
     *
     * @return \LaunchDarkly\Client\Model\InitiatorRep
     */
     ...
     * Sets initiator
     *
     * @param \LaunchDarkly\Client\Model\InitiatorRep $initiator initiator
     *
     * @return self
     */
     ...
     * Sets _links
     *
     * @param array<string,\LaunchDarkly\Client\Model\Link> $_links The location and content type of related resources, including the location of the exported file
     *
     * @return self
     */
