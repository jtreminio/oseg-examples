...
class RelayAutoConfigRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        '_id' => 'string',
        '_creator' => '\LaunchDarkly\Client\Model\MemberSummary',
    ...
    */
     ...
     * Sets _creator
     *
     * @param \LaunchDarkly\Client\Model\MemberSummary|null $_creator _creator
     *
     * @return self
     */
     ...
     * Sets policy
     *
     * @param \LaunchDarkly\Client\Model\Statement[] $policy A description of what environments and projects the Relay Proxy should include or exclude
     *
     * @return self
     */
