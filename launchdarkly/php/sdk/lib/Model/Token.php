...
class Token implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'owner_id' => 'string',
        'member_id' => 'string',
        '_member' => '\LaunchDarkly\Client\Model\MemberSummary',
        'name' => 'string',
        'description' => 'string',
        'creation_date' => 'int',
        'last_modified' => 'int',
        'custom_role_ids' => 'string[]',
        'inline_role' => '\LaunchDarkly\Client\Model\Statement[]',
        'role' => 'string',
        'token' => 'string',
        'service_token' => 'bool',
    ...
    */
     ...
     * Sets _member
     *
     * @param \LaunchDarkly\Client\Model\MemberSummary|null $_member _member
     *
     * @return self
     */
     ...
     * Sets inline_role
     *
     * @param \LaunchDarkly\Client\Model\Statement[]|null $inline_role An array of policy statements, with three attributes: effect, resources, actions. May be used in place of a built-in or custom role.
     *
     * @return self
     */
