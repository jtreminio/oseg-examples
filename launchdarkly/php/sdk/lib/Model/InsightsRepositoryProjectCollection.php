...
class InsightsRepositoryProjectCollection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'total_count' => 'int',
        'items' => '\LaunchDarkly\Client\Model\InsightsRepositoryProject[]',
    ...
    */
     ...
     * Gets items
     *
     * @return \LaunchDarkly\Client\Model\InsightsRepositoryProject[]
     */
     ...
     * Sets items
     *
     * @param \LaunchDarkly\Client\Model\InsightsRepositoryProject[] $items List of repository project associations
     *
     * @return self
     */
