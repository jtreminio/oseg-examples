...
class CreatePhaseInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'audiences' => '\LaunchDarkly\Client\Model\AudiencePost[]',
        'name' => 'string',
    ...
    */
     ...
     * Gets audiences
     *
     * @return \LaunchDarkly\Client\Model\AudiencePost[]
     */
     ...
     * Sets audiences
     *
     * @param \LaunchDarkly\Client\Model\AudiencePost[] $audiences An ordered list of the audiences for this release phase. Each audience corresponds to a LaunchDarkly environment.
     *
     * @return self
     */
