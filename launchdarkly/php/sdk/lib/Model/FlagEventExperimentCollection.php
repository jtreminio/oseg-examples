...
class FlagEventExperimentCollection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'total_count' => 'int',
        'items' => '\LaunchDarkly\Client\Model\FlagEventExperiment[]'
    ];
    ...
    */
     ...
     * Gets items
     *
     * @return \LaunchDarkly\Client\Model\FlagEventExperiment[]
     */
     ...
     * Sets items
     *
     * @param \LaunchDarkly\Client\Model\FlagEventExperiment[] $items A list of experiments
     *
     * @return self
     */
