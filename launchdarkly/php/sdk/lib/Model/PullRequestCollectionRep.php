...
class PullRequestCollectionRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'total_count' => 'int',
        'items' => '\LaunchDarkly\Client\Model\PullRequestRep[]',
    ...
    */
     ...
     * Gets items
     *
     * @return \LaunchDarkly\Client\Model\PullRequestRep[]
     */
     ...
     * Sets items
     *
     * @param \LaunchDarkly\Client\Model\PullRequestRep[] $items A list of pull requests
     *
     * @return self
     */
