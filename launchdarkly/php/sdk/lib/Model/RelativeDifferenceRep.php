...
class RelativeDifferenceRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('from_treatment_id', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($from_treatment_id)) {
            throw new \InvalidArgumentException('non-nullable from_treatment_id cannot be null');
        }
