...
class InsightsRepositoryCollection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'total_count' => 'int',
        'items' => '\LaunchDarkly\Client\Model\InsightsRepository[]',
    ...
    */
     ...
     * Gets items
     *
     * @return \LaunchDarkly\Client\Model\InsightsRepository[]
     */
     ...
     * Sets items
     *
     * @param \LaunchDarkly\Client\Model\InsightsRepository[] $items List of repositories
     *
     * @return self
     */
