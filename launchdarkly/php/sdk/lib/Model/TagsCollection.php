...
class TagsCollection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'items' => 'string[]',
        '_links' => 'array<string,\LaunchDarkly\Client\Model\TagsLink>',
        'total_count' => 'int'
    ];
    ...
    */
     ...
     * Gets _links
     *
     * @return array<string,\LaunchDarkly\Client\Model\TagsLink>
     */
     ...
     * Sets _links
     *
     * @param array<string,\LaunchDarkly\Client\Model\TagsLink> $_links _links
     *
     * @return self
     */
