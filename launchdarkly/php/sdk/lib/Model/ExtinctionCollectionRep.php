...
class ExtinctionCollectionRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'items' => 'array<string,\LaunchDarkly\Client\Model\Extinction[]>'
    ];
    ...
    */
     ...
     * Gets items
     *
     * @return array<string,\LaunchDarkly\Client\Model\Extinction[]>
     */
     ...
     * Sets items
     *
     * @param array<string,\LaunchDarkly\Client\Model\Extinction[]> $items An array of extinction events
     *
     * @return self
     */
