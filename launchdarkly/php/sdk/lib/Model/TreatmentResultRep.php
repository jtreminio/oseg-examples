...
namespace LaunchDarkly\Client\Model;
...
class TreatmentResultRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'data_mean' => 'float',
        'data_std_dev' => 'float',
        'credible_interval' => '\LaunchDarkly\Client\Model\CredibleIntervalRep',
        'p_best' => 'float',
        'relative_differences' => '\LaunchDarkly\Client\Model\RelativeDifferenceRep[]',
        'units' => 'int',
        'traffic' => 'int',
        'event_values_sum' => 'float',
        'distribution' => '\LaunchDarkly\Client\Model\Distribution',
        'correlation' => 'float',
        'standard_deviation_ratio' => 'float',
        'covariate_imbalance' => 'float',
        'variance_reduction' => 'float',
        'model' => 'string',
        'bayesian_normal' => '\LaunchDarkly\Client\Model\BayesianNormalStatsRep',
        'bayesian_beta' => '\LaunchDarkly\Client\Model\BayesianBetaBinomialStatsRep'
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'p_best' => false,
        'relative_differences' => false,
        'units' => false,
        'traffic' => false,
        'event_values_sum' => false,
        'distribution' => false,
        'correlation' => false,
        'standard_deviation_ratio' => false,
        'covariate_imbalance' => false,
        'variance_reduction' => false,
        'model' => false,
        'bayesian_normal' => false,
        'bayesian_beta' => false
    ];
    ...
    {
        $this->setIfExists('treatment_id', $data ?? [], null);
        $this->setIfExists('treatment_name', $data ?? [], null);
        $this->setIfExists('mean', $data ?? [], null);
        $this->setIfExists('data_mean', $data ?? [], null);
        $this->setIfExists('data_std_dev', $data ?? [], null);
        $this->setIfExists('credible_interval', $data ?? [], null);
        $this->setIfExists('p_best', $data ?? [], null);
        $this->setIfExists('relative_differences', $data ?? [], null);
        $this->setIfExists('units', $data ?? [], null);
        $this->setIfExists('traffic', $data ?? [], null);
        $this->setIfExists('event_values_sum', $data ?? [], null);
        $this->setIfExists('distribution', $data ?? [], null);
        $this->setIfExists('correlation', $data ?? [], null);
        $this->setIfExists('standard_deviation_ratio', $data ?? [], null);
        $this->setIfExists('covariate_imbalance', $data ?? [], null);
        $this->setIfExists('variance_reduction', $data ?? [], null);
        $this->setIfExists('model', $data ?? [], null);
        $this->setIfExists('bayesian_normal', $data ?? [], null);
        $this->setIfExists('bayesian_beta', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($treatment_id)) {
            throw new \InvalidArgumentException('non-nullable treatment_id cannot be null');
        }
    ...
    {
        if (is_null($treatment_name)) {
            throw new \InvalidArgumentException('non-nullable treatment_name cannot be null');
        }
    ...
    {
        if (is_null($data_mean)) {
            throw new \InvalidArgumentException('non-nullable data_mean cannot be null');
        }
    ...
    {
        if (is_null($data_std_dev)) {
            throw new \InvalidArgumentException('non-nullable data_std_dev cannot be null');
        }
     ...
     *
     * @return \LaunchDarkly\Client\Model\CredibleIntervalRep|null
     */
     ...
     *
     * @param \LaunchDarkly\Client\Model\CredibleIntervalRep|null $credible_interval credible_interval
     *
     * @return self
     */
    public function setCredibleInterval($credible_interval)
    {
        if (is_null($credible_interval)) {
            throw new \InvalidArgumentException('non-nullable credible_interval cannot be null');
        }
    ...
    {
        if (is_null($p_best)) {
            throw new \InvalidArgumentException('non-nullable p_best cannot be null');
        }
     ...
     *
     * @return \LaunchDarkly\Client\Model\RelativeDifferenceRep[]|null
     */
     ...
     *
     * @param \LaunchDarkly\Client\Model\RelativeDifferenceRep[]|null $relative_differences Estimates of the relative difference between this treatment's mean and the mean of each other treatment
     *
     * @return self
     */
    public function setRelativeDifferences($relative_differences)
    {
        if (is_null($relative_differences)) {
            throw new \InvalidArgumentException('non-nullable relative_differences cannot be null');
        }
    ...
    {
        if (is_null($event_values_sum)) {
            throw new \InvalidArgumentException('non-nullable event_values_sum cannot be null');
        }
     ...
     * Gets distribution
     *
     * @return \LaunchDarkly\Client\Model\Distribution|null
     */
     ...
     * Sets distribution
     *
     * @param \LaunchDarkly\Client\Model\Distribution|null $distribution distribution
     *
     * @return self
     */
    ...
    {
        if (is_null($standard_deviation_ratio)) {
            throw new \InvalidArgumentException('non-nullable standard_deviation_ratio cannot be null');
        }
    ...
    {
        if (is_null($covariate_imbalance)) {
            throw new \InvalidArgumentException('non-nullable covariate_imbalance cannot be null');
        }
    ...
    {
        if (is_null($variance_reduction)) {
            throw new \InvalidArgumentException('non-nullable variance_reduction cannot be null');
        }
     ...
     *
     * @return \LaunchDarkly\Client\Model\BayesianNormalStatsRep|null
     */
     ...
     *
     * @param \LaunchDarkly\Client\Model\BayesianNormalStatsRep|null $bayesian_normal bayesian_normal
     *
     * @return self
     */
    public function setBayesianNormal($bayesian_normal)
    {
        if (is_null($bayesian_normal)) {
            throw new \InvalidArgumentException('non-nullable bayesian_normal cannot be null');
        }
     ...
     * Gets bayesian_beta
     *
     * @return \LaunchDarkly\Client\Model\BayesianBetaBinomialStatsRep|null
     */
     ...
     * Sets bayesian_beta
     *
     * @param \LaunchDarkly\Client\Model\BayesianBetaBinomialStatsRep|null $bayesian_beta bayesian_beta
     *
     * @return self
     */
    public function setBayesianBeta($bayesian_beta)
    {
        if (is_null($bayesian_beta)) {
            throw new \InvalidArgumentException('non-nullable bayesian_beta cannot be null');
        }
