...
class ApplicationFlagCollectionRep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'items' => '\LaunchDarkly\Client\Model\FlagListingRep[]',
        'total_count' => 'int',
    ...
    */
     ...
     * Sets items
     *
     * @param \LaunchDarkly\Client\Model\FlagListingRep[]|null $items A list of the flags that have been evaluated by the application
     *
     * @return self
     */
