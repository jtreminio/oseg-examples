...
class Import implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'mode' => 'string',
        'status' => 'string',
        'files' => '\LaunchDarkly\Client\Model\FileRep[]',
    ...
    */
     ...
     * Gets files
     *
     * @return \LaunchDarkly\Client\Model\FileRep[]|null
     */
     ...
     * Sets files
     *
     * @param \LaunchDarkly\Client\Model\FileRep[]|null $files The imported files and their status
     *
     * @return self
     */
