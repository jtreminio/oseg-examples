...
class PatchUsersRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'comment' => 'string',
        'instructions' => '\LaunchDarkly\Client\Model\InstructionUserRequest[]'
    ];
    ...
    */
     ...
     * Gets instructions
     *
     * @return \LaunchDarkly\Client\Model\InstructionUserRequest[]
     */
     ...
     * Sets instructions
     *
     * @param \LaunchDarkly\Client\Model\InstructionUserRequest[] $instructions The instructions to perform when updating
     *
     * @return self
     */
