...
class ContextAttributeNamesCollection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'items' => '\LaunchDarkly\Client\Model\ContextAttributeNames[]'
    ];
    ...
    */
     ...
     * Gets items
     *
     * @return \LaunchDarkly\Client\Model\ContextAttributeNames[]
     */
     ...
     * Sets items
     *
     * @param \LaunchDarkly\Client\Model\ContextAttributeNames[] $items A collection of context attribute name data grouped by kind.
     *
     * @return self
     */
