...
class CustomWorkflowInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'name' => 'string',
        'description' => 'string',
        'stages' => '\LaunchDarkly\Client\Model\StageInput[]',
        'template_key' => 'string'
    ];
    ...
    */
     ...
     * Gets stages
     *
     * @return \LaunchDarkly\Client\Model\StageInput[]|null
     */
     ...
     * Sets stages
     *
     * @param \LaunchDarkly\Client\Model\StageInput[]|null $stages A list of the workflow stages
     *
     * @return self
     */
