...
class ExpiringTargetPatchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'items' => '\LaunchDarkly\Client\Model\ExpiringTarget[]',
    ...
    */
     ...
     * Gets items
     *
     * @return \LaunchDarkly\Client\Model\ExpiringTarget[]
     */
     ...
     * Sets items
     *
     * @param \LaunchDarkly\Client\Model\ExpiringTarget[] $items A list of the results from each instruction
     *
     * @return self
     */
     ...
     * Sets errors
     *
     * @param \LaunchDarkly\Client\Model\ExpiringTargetError[]|null $errors errors
     *
     * @return self
     */
