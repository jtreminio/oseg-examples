...
class CustomRolePost implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'key' => 'string',
        'description' => 'string',
        'policy' => '\LaunchDarkly\Client\Model\StatementPost[]',
    ...
    */
     ...
     * Gets policy
     *
     * @return \LaunchDarkly\Client\Model\StatementPost[]
     */
     ...
     * Sets policy
     *
     * @param \LaunchDarkly\Client\Model\StatementPost[] $policy policy
     *
     * @return self
     */
