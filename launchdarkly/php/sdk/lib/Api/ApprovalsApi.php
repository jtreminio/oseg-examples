...
class ApprovalsApi
{
     ...
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \LaunchDarkly\Client\Model\FlagConfigApprovalRequestResponse|\LaunchDarkly\Client\Model\UnauthorizedErrorRep|\LaunchDarkly\Client\Model\ForbiddenErrorRep|\LaunchDarkly\Client\Model\NotFoundErrorRep|\LaunchDarkly\Client\Model\RateLimitedErrorRep
     */
    ...
    public function getApprovalForFlagWithHttpInfo($project_key, $feature_flag_key, $environment_key, $id, string $contentType = self::contentTypes['getApprovalForFlag'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\LaunchDarkly\Client\Model\FlagConfigApprovalRequestResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\LaunchDarkly\Client\Model\FlagConfigApprovalRequestResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\LaunchDarkly\Client\Model\FlagConfigApprovalRequestResponse', []),
            ...
            $returnType = '\LaunchDarkly\Client\Model\FlagConfigApprovalRequestResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\LaunchDarkly\Client\Model\FlagConfigApprovalRequestResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \LaunchDarkly\Client\Model\ExpandableApprovalRequestResponse|\LaunchDarkly\Client\Model\InvalidRequestErrorRep|\LaunchDarkly\Client\Model\UnauthorizedErrorRep|\LaunchDarkly\Client\Model\ForbiddenErrorRep|\LaunchDarkly\Client\Model\NotFoundErrorRep|\LaunchDarkly\Client\Model\RateLimitedErrorRep
     */
     ...
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \LaunchDarkly\Client\Model\ExpandableApprovalRequestResponse|\LaunchDarkly\Client\Model\InvalidRequestErrorRep|\LaunchDarkly\Client\Model\UnauthorizedErrorRep|\LaunchDarkly\Client\Model\ForbiddenErrorRep|\LaunchDarkly\Client\Model\NotFoundErrorRep|\LaunchDarkly\Client\Model\RateLimitedErrorRep, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApprovalRequestWithHttpInfo($id, $expand = null, string $contentType = self::contentTypes['getApprovalRequest'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\LaunchDarkly\Client\Model\ExpandableApprovalRequestResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\LaunchDarkly\Client\Model\ExpandableApprovalRequestResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\LaunchDarkly\Client\Model\ExpandableApprovalRequestResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\LaunchDarkly\Client\Model\ExpandableApprovalRequestResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\LaunchDarkly\Client\Model\ExpandableApprovalRequestResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \LaunchDarkly\Client\Model\ExpandableApprovalRequestsResponse|\LaunchDarkly\Client\Model\InvalidRequestErrorRep|\LaunchDarkly\Client\Model\UnauthorizedErrorRep|\LaunchDarkly\Client\Model\ForbiddenErrorRep|\LaunchDarkly\Client\Model\RateLimitedErrorRep
     */
     ...
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \LaunchDarkly\Client\Model\ExpandableApprovalRequestsResponse|\LaunchDarkly\Client\Model\InvalidRequestErrorRep|\LaunchDarkly\Client\Model\UnauthorizedErrorRep|\LaunchDarkly\Client\Model\ForbiddenErrorRep|\LaunchDarkly\Client\Model\RateLimitedErrorRep, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApprovalRequestsWithHttpInfo($filter = null, $expand = null, $limit = null, $offset = null, string $contentType = self::contentTypes['getApprovalRequests'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\LaunchDarkly\Client\Model\ExpandableApprovalRequestsResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\LaunchDarkly\Client\Model\ExpandableApprovalRequestsResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\LaunchDarkly\Client\Model\ExpandableApprovalRequestsResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\LaunchDarkly\Client\Model\ExpandableApprovalRequestsResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\LaunchDarkly\Client\Model\ExpandableApprovalRequestsResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \LaunchDarkly\Client\Model\FlagConfigApprovalRequestsResponse|\LaunchDarkly\Client\Model\UnauthorizedErrorRep|\LaunchDarkly\Client\Model\ForbiddenErrorRep|\LaunchDarkly\Client\Model\NotFoundErrorRep|\LaunchDarkly\Client\Model\RateLimitedErrorRep
     */
     ...
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \LaunchDarkly\Client\Model\FlagConfigApprovalRequestsResponse|\LaunchDarkly\Client\Model\UnauthorizedErrorRep|\LaunchDarkly\Client\Model\ForbiddenErrorRep|\LaunchDarkly\Client\Model\NotFoundErrorRep|\LaunchDarkly\Client\Model\RateLimitedErrorRep, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApprovalsForFlagWithHttpInfo($project_key, $feature_flag_key, $environment_key, string $contentType = self::contentTypes['getApprovalsForFlag'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\LaunchDarkly\Client\Model\FlagConfigApprovalRequestsResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\LaunchDarkly\Client\Model\FlagConfigApprovalRequestsResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\LaunchDarkly\Client\Model\FlagConfigApprovalRequestsResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\LaunchDarkly\Client\Model\FlagConfigApprovalRequestsResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\LaunchDarkly\Client\Model\FlagConfigApprovalRequestsResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \LaunchDarkly\Client\Model\CreateApprovalRequestRequest $create_approval_request_request create_approval_request_request (required)
     ...
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \LaunchDarkly\Client\Model\ApprovalRequestResponse|\LaunchDarkly\Client\Model\InvalidRequestErrorRep|\LaunchDarkly\Client\Model\UnauthorizedErrorRep|\LaunchDarkly\Client\Model\ForbiddenErrorRep|\LaunchDarkly\Client\Model\RateLimitedErrorRep
     */
     ...
     * Create approval request
     *
     * @param  \LaunchDarkly\Client\Model\CreateApprovalRequestRequest $create_approval_request_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApprovalRequest'] to see the possible values for this operation
     *
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \LaunchDarkly\Client\Model\ApprovalRequestResponse|\LaunchDarkly\Client\Model\InvalidRequestErrorRep|\LaunchDarkly\Client\Model\UnauthorizedErrorRep|\LaunchDarkly\Client\Model\ForbiddenErrorRep|\LaunchDarkly\Client\Model\RateLimitedErrorRep, HTTP status code, HTTP response headers (array of strings)
     */
    public function postApprovalRequestWithHttpInfo($create_approval_request_request, string $contentType = self::contentTypes['postApprovalRequest'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\LaunchDarkly\Client\Model\ApprovalRequestResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\LaunchDarkly\Client\Model\ApprovalRequestResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\LaunchDarkly\Client\Model\ApprovalRequestResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\LaunchDarkly\Client\Model\ApprovalRequestResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\LaunchDarkly\Client\Model\ApprovalRequestResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $id The feature flag approval request ID (required)
     * @param  \LaunchDarkly\Client\Model\PostApprovalRequestApplyRequest $post_approval_request_apply_request post_approval_request_apply_request (required)
     ...
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \LaunchDarkly\Client\Model\ApprovalRequestResponse|\LaunchDarkly\Client\Model\InvalidRequestErrorRep|\LaunchDarkly\Client\Model\UnauthorizedErrorRep|\LaunchDarkly\Client\Model\ForbiddenErrorRep|\LaunchDarkly\Client\Model\NotFoundErrorRep|\LaunchDarkly\Client\Model\RateLimitedErrorRep
     */
     ...
     *
     * @param  string $id The feature flag approval request ID (required)
     * @param  \LaunchDarkly\Client\Model\PostApprovalRequestApplyRequest $post_approval_request_apply_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApprovalRequestApply'] to see the possible values for this operation
     *
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \LaunchDarkly\Client\Model\FlagConfigApprovalRequestResponse|\LaunchDarkly\Client\Model\InvalidRequestErrorRep|\LaunchDarkly\Client\Model\UnauthorizedErrorRep|\LaunchDarkly\Client\Model\ForbiddenErrorRep|\LaunchDarkly\Client\Model\NotFoundErrorRep|\LaunchDarkly\Client\Model\RateLimitedErrorRep
     */
     ...
     * @param  string $feature_flag_key The feature flag key (required)
     * @param  string $environment_key The environment key (required)
     * @param  \LaunchDarkly\Client\Model\CreateFlagConfigApprovalRequestRequest $create_flag_config_approval_request_request create_flag_config_approval_request_request (required)
     ...
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \LaunchDarkly\Client\Model\FlagConfigApprovalRequestResponse|\LaunchDarkly\Client\Model\InvalidRequestErrorRep|\LaunchDarkly\Client\Model\UnauthorizedErrorRep|\LaunchDarkly\Client\Model\ForbiddenErrorRep|\LaunchDarkly\Client\Model\RateLimitedErrorRep
     */
     ...
     * @param  string $feature_flag_key The feature flag key (required)
     * @param  string $environment_key The environment key (required)
     * @param  \LaunchDarkly\Client\Model\CreateFlagConfigApprovalRequestRequest $create_flag_config_approval_request_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApprovalRequestForFlag'] to see the possible values for this operation
     *
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     *
     * @param  string $id The approval request ID (required)
     * @param  \LaunchDarkly\Client\Model\PostApprovalRequestReviewRequest $post_approval_request_review_request post_approval_request_review_request (required)
     ...
     *
     * @param  string $id The approval request ID (required)
     * @param  \LaunchDarkly\Client\Model\PostApprovalRequestReviewRequest $post_approval_request_review_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postApprovalRequestReview'] to see the possible values for this operation
     *
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  \LaunchDarkly\Client\Model\CreateCopyFlagConfigApprovalRequestRequest $create_copy_flag_config_approval_request_request create_copy_flag_config_approval_request_request (required)
     ...
     * @param  string $feature_flag_key The feature flag key (required)
     * @param  string $environment_key The environment key for the target environment (required)
     * @param  \LaunchDarkly\Client\Model\CreateCopyFlagConfigApprovalRequestRequest $create_copy_flag_config_approval_request_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postFlagCopyConfigApprovalRequest'] to see the possible values for this operation
     *
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
