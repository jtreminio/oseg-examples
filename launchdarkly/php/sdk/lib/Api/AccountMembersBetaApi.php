...
class AccountMembersBetaApi
{
     ...
     *
     * @param  \LaunchDarkly\Client\Model\MembersPatchInput $members_patch_input members_patch_input (required)
     ...
     * @return \LaunchDarkly\Client\Model\BulkEditMembersRep|\LaunchDarkly\Client\Model\InvalidRequestErrorRep|\LaunchDarkly\Client\Model\UnauthorizedErrorRep|\LaunchDarkly\Client\Model\ForbiddenErrorRep|\LaunchDarkly\Client\Model\StatusConflictErrorRep|\LaunchDarkly\Client\Model\RateLimitedErrorRep
     */
    ...
    public function patchMembersWithHttpInfo($members_patch_input, string $contentType = self::contentTypes['patchMembers'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\LaunchDarkly\Client\Model\BulkEditMembersRep' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\LaunchDarkly\Client\Model\BulkEditMembersRep' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\LaunchDarkly\Client\Model\BulkEditMembersRep', []),
            ...
            $returnType = '\LaunchDarkly\Client\Model\BulkEditMembersRep';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\LaunchDarkly\Client\Model\BulkEditMembersRep',
