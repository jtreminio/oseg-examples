...
class SegmentsApi
{
     ...
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \LaunchDarkly\Client\Model\Export|\LaunchDarkly\Client\Model\InvalidRequestErrorRep|\LaunchDarkly\Client\Model\NotFoundErrorRep|\LaunchDarkly\Client\Model\RateLimitedErrorRep
     */
     ...
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \LaunchDarkly\Client\Model\Export|\LaunchDarkly\Client\Model\InvalidRequestErrorRep|\LaunchDarkly\Client\Model\NotFoundErrorRep|\LaunchDarkly\Client\Model\RateLimitedErrorRep, HTTP status code, HTTP response headers (array of strings)
     */
    public function getBigSegmentExportWithHttpInfo($project_key, $environment_key, $segment_key, $export_id, string $contentType = self::contentTypes['getBigSegmentExport'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\LaunchDarkly\Client\Model\Export' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\LaunchDarkly\Client\Model\Export' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\LaunchDarkly\Client\Model\Export', []),
            ...
            $returnType = '\LaunchDarkly\Client\Model\Export';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\LaunchDarkly\Client\Model\Export',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \LaunchDarkly\Client\Model\Import|\LaunchDarkly\Client\Model\InvalidRequestErrorRep|\LaunchDarkly\Client\Model\NotFoundErrorRep|\LaunchDarkly\Client\Model\RateLimitedErrorRep
     */
     ...
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \LaunchDarkly\Client\Model\Import|\LaunchDarkly\Client\Model\InvalidRequestErrorRep|\LaunchDarkly\Client\Model\NotFoundErrorRep|\LaunchDarkly\Client\Model\RateLimitedErrorRep, HTTP status code, HTTP response headers (array of strings)
     */
    public function getBigSegmentImportWithHttpInfo($project_key, $environment_key, $segment_key, $import_id, string $contentType = self::contentTypes['getBigSegmentImport'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\LaunchDarkly\Client\Model\Import' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\LaunchDarkly\Client\Model\Import' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\LaunchDarkly\Client\Model\Import', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\LaunchDarkly\Client\Model\Import';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\LaunchDarkly\Client\Model\Import',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \LaunchDarkly\Client\Model\ContextInstanceSegmentMemberships|\LaunchDarkly\Client\Model\InvalidRequestErrorRep|\LaunchDarkly\Client\Model\UnauthorizedErrorRep|\LaunchDarkly\Client\Model\NotFoundErrorRep
     */
     ...
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \LaunchDarkly\Client\Model\ContextInstanceSegmentMemberships|\LaunchDarkly\Client\Model\InvalidRequestErrorRep|\LaunchDarkly\Client\Model\UnauthorizedErrorRep|\LaunchDarkly\Client\Model\NotFoundErrorRep, HTTP status code, HTTP response headers (array of strings)
     */
    public function getContextInstanceSegmentsMembershipByEnvWithHttpInfo($project_key, $environment_key, $request_body, string $contentType = self::contentTypes['getContextInstanceSegmentsMembershipByEnv'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\LaunchDarkly\Client\Model\ContextInstanceSegmentMemberships' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\LaunchDarkly\Client\Model\ContextInstanceSegmentMemberships' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\LaunchDarkly\Client\Model\ContextInstanceSegmentMemberships', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\LaunchDarkly\Client\Model\ContextInstanceSegmentMemberships';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\LaunchDarkly\Client\Model\ContextInstanceSegmentMemberships',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \LaunchDarkly\Client\Model\ExpiringTargetGetResponse|\LaunchDarkly\Client\Model\UnauthorizedErrorRep|\LaunchDarkly\Client\Model\NotFoundErrorRep|\LaunchDarkly\Client\Model\RateLimitedErrorRep
     */
     ...
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \LaunchDarkly\Client\Model\ExpiringTargetGetResponse|\LaunchDarkly\Client\Model\UnauthorizedErrorRep|\LaunchDarkly\Client\Model\NotFoundErrorRep|\LaunchDarkly\Client\Model\RateLimitedErrorRep, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \LaunchDarkly\Client\Model\ExpiringUserTargetGetResponse|\LaunchDarkly\Client\Model\UnauthorizedErrorRep|\LaunchDarkly\Client\Model\NotFoundErrorRep|\LaunchDarkly\Client\Model\RateLimitedErrorRep
     */
     ...
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \LaunchDarkly\Client\Model\ExpiringUserTargetGetResponse|\LaunchDarkly\Client\Model\UnauthorizedErrorRep|\LaunchDarkly\Client\Model\NotFoundErrorRep|\LaunchDarkly\Client\Model\RateLimitedErrorRep, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \LaunchDarkly\Client\Model\UserSegment|\LaunchDarkly\Client\Model\UnauthorizedErrorRep|\LaunchDarkly\Client\Model\NotFoundErrorRep|\LaunchDarkly\Client\Model\RateLimitedErrorRep
     */
     ...
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \LaunchDarkly\Client\Model\UserSegment|\LaunchDarkly\Client\Model\UnauthorizedErrorRep|\LaunchDarkly\Client\Model\NotFoundErrorRep|\LaunchDarkly\Client\Model\RateLimitedErrorRep, HTTP status code, HTTP response headers (array of strings)
     */
    public function getSegmentWithHttpInfo($project_key, $environment_key, $segment_key, string $contentType = self::contentTypes['getSegment'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\LaunchDarkly\Client\Model\UserSegment' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\LaunchDarkly\Client\Model\UserSegment' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\LaunchDarkly\Client\Model\UserSegment', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\LaunchDarkly\Client\Model\UserSegment';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\LaunchDarkly\Client\Model\UserSegment',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \LaunchDarkly\Client\Model\BigSegmentTarget|\LaunchDarkly\Client\Model\InvalidRequestErrorRep|\LaunchDarkly\Client\Model\UnauthorizedErrorRep|\LaunchDarkly\Client\Model\NotFoundErrorRep|\LaunchDarkly\Client\Model\RateLimitedErrorRep
     */
     ...
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \LaunchDarkly\Client\Model\BigSegmentTarget|\LaunchDarkly\Client\Model\InvalidRequestErrorRep|\LaunchDarkly\Client\Model\UnauthorizedErrorRep|\LaunchDarkly\Client\Model\NotFoundErrorRep|\LaunchDarkly\Client\Model\RateLimitedErrorRep, HTTP status code, HTTP response headers (array of strings)
     */
    public function getSegmentMembershipForContextWithHttpInfo($project_key, $environment_key, $segment_key, $context_key, string $contentType = self::contentTypes['getSegmentMembershipForContext'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\LaunchDarkly\Client\Model\BigSegmentTarget' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\LaunchDarkly\Client\Model\BigSegmentTarget' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\LaunchDarkly\Client\Model\BigSegmentTarget', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\LaunchDarkly\Client\Model\BigSegmentTarget';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\LaunchDarkly\Client\Model\BigSegmentTarget',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string|null $filter Accepts filter by &#x60;excludedKeys&#x60;, &#x60;external&#x60;, &#x60;includedKeys&#x60;, &#x60;query&#x60;, &#x60;tags&#x60;, &#x60;unbounded&#x60;. To learn more about the filter syntax, read the  &#39;Filtering segments&#39; section above. (optional)
     ...
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \LaunchDarkly\Client\Model\UserSegments|\LaunchDarkly\Client\Model\UnauthorizedErrorRep|\LaunchDarkly\Client\Model\NotFoundErrorRep
     */
     ...
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \LaunchDarkly\Client\Model\UserSegments|\LaunchDarkly\Client\Model\UnauthorizedErrorRep|\LaunchDarkly\Client\Model\NotFoundErrorRep, HTTP status code, HTTP response headers (array of strings)
     */
    public function getSegmentsWithHttpInfo($project_key, $environment_key, $limit = null, $offset = null, $sort = null, $filter = null, string $contentType = self::contentTypes['getSegments'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\LaunchDarkly\Client\Model\UserSegments' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\LaunchDarkly\Client\Model\UserSegments' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\LaunchDarkly\Client\Model\UserSegments', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\LaunchDarkly\Client\Model\UserSegments';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\LaunchDarkly\Client\Model\UserSegments',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $environment_key The environment key (required)
     * @param  string $segment_key The segment key (required)
     * @param  \LaunchDarkly\Client\Model\PatchSegmentExpiringTargetInputRep $patch_segment_expiring_target_input_rep patch_segment_expiring_target_input_rep (required)
     ...
     * @param  string $environment_key The environment key (required)
     * @param  string $segment_key The segment key (required)
     * @param  \LaunchDarkly\Client\Model\PatchSegmentExpiringTargetInputRep $patch_segment_expiring_target_input_rep (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['patchExpiringTargetsForSegment'] to see the possible values for this operation
     *
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $environment_key The environment key (required)
     * @param  string $segment_key The segment key (required)
     * @param  \LaunchDarkly\Client\Model\PatchSegmentRequest $patch_segment_request patch_segment_request (required)
     ...
     * @param  string $environment_key The environment key (required)
     * @param  string $segment_key The segment key (required)
     * @param  \LaunchDarkly\Client\Model\PatchSegmentRequest $patch_segment_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['patchExpiringUserTargetsForSegment'] to see the possible values for this operation
     *
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $project_key The project key (required)
     * @param  string $environment_key The environment key (required)
     * @param  \LaunchDarkly\Client\Model\SegmentBody $segment_body segment_body (required)
     ...
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \LaunchDarkly\Client\Model\UserSegment|\LaunchDarkly\Client\Model\InvalidRequestErrorRep|\LaunchDarkly\Client\Model\UnauthorizedErrorRep|\LaunchDarkly\Client\Model\ForbiddenErrorRep|\LaunchDarkly\Client\Model\NotFoundErrorRep|\LaunchDarkly\Client\Model\RateLimitedErrorRep
     */
     ...
     * @param  string $project_key The project key (required)
     * @param  string $environment_key The environment key (required)
     * @param  \LaunchDarkly\Client\Model\SegmentBody $segment_body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postSegment'] to see the possible values for this operation
     *
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $environment_key The environment key (required)
     * @param  string $segment_key The segment key (required)
     * @param  \LaunchDarkly\Client\Model\SegmentUserState $segment_user_state segment_user_state (required)
     ...
     * @param  string $environment_key The environment key (required)
     * @param  string $segment_key The segment key (required)
     * @param  \LaunchDarkly\Client\Model\SegmentUserState $segment_user_state (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateBigSegmentContextTargets'] to see the possible values for this operation
     *
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
