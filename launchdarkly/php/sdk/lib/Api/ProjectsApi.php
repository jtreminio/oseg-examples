...
class ProjectsApi
{
     ...
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \LaunchDarkly\Client\Model\FlagDefaultsRep|\LaunchDarkly\Client\Model\UnauthorizedErrorRep|\LaunchDarkly\Client\Model\ForbiddenErrorRep|\LaunchDarkly\Client\Model\NotFoundErrorRep
     */
     ...
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \LaunchDarkly\Client\Model\FlagDefaultsRep|\LaunchDarkly\Client\Model\UnauthorizedErrorRep|\LaunchDarkly\Client\Model\ForbiddenErrorRep|\LaunchDarkly\Client\Model\NotFoundErrorRep, HTTP status code, HTTP response headers (array of strings)
     */
    public function getFlagDefaultsByProjectWithHttpInfo($project_key, string $contentType = self::contentTypes['getFlagDefaultsByProject'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\LaunchDarkly\Client\Model\FlagDefaultsRep' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\LaunchDarkly\Client\Model\FlagDefaultsRep' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\LaunchDarkly\Client\Model\FlagDefaultsRep', []),
            ...
            $returnType = '\LaunchDarkly\Client\Model\FlagDefaultsRep';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\LaunchDarkly\Client\Model\FlagDefaultsRep',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \LaunchDarkly\Client\Model\Project|\LaunchDarkly\Client\Model\InvalidRequestErrorRep|\LaunchDarkly\Client\Model\UnauthorizedErrorRep|\LaunchDarkly\Client\Model\ForbiddenErrorRep|\LaunchDarkly\Client\Model\NotFoundErrorRep|\LaunchDarkly\Client\Model\RateLimitedErrorRep
     */
    ...
    public function getProjectWithHttpInfo($project_key, $expand = null, string $contentType = self::contentTypes['getProject'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\LaunchDarkly\Client\Model\Project' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\LaunchDarkly\Client\Model\Project' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\LaunchDarkly\Client\Model\Project', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\LaunchDarkly\Client\Model\Project';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\LaunchDarkly\Client\Model\Project',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \LaunchDarkly\Client\Model\Projects|\LaunchDarkly\Client\Model\InvalidRequestErrorRep|\LaunchDarkly\Client\Model\UnauthorizedErrorRep|\LaunchDarkly\Client\Model\ForbiddenErrorRep|\LaunchDarkly\Client\Model\RateLimitedErrorRep
     */
     ...
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \LaunchDarkly\Client\Model\Projects|\LaunchDarkly\Client\Model\InvalidRequestErrorRep|\LaunchDarkly\Client\Model\UnauthorizedErrorRep|\LaunchDarkly\Client\Model\ForbiddenErrorRep|\LaunchDarkly\Client\Model\RateLimitedErrorRep, HTTP status code, HTTP response headers (array of strings)
     */
    public function getProjectsWithHttpInfo($limit = null, $offset = null, $filter = null, $sort = null, $expand = null, string $contentType = self::contentTypes['getProjects'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\LaunchDarkly\Client\Model\Projects' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\LaunchDarkly\Client\Model\Projects' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\LaunchDarkly\Client\Model\Projects', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\LaunchDarkly\Client\Model\Projects';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\LaunchDarkly\Client\Model\Projects',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function patchFlagDefaultsByProjectWithHttpInfo($project_key, $patch_operation, string $contentType = self::contentTypes['patchFlagDefaultsByProject'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\LaunchDarkly\Client\Model\UpsertPayloadRep' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\LaunchDarkly\Client\Model\UpsertPayloadRep' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\LaunchDarkly\Client\Model\UpsertPayloadRep', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\LaunchDarkly\Client\Model\UpsertPayloadRep';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\LaunchDarkly\Client\Model\UpsertPayloadRep',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function patchProjectWithHttpInfo($project_key, $patch_operation, string $contentType = self::contentTypes['patchProject'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\LaunchDarkly\Client\Model\ProjectRep' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\LaunchDarkly\Client\Model\ProjectRep' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\LaunchDarkly\Client\Model\ProjectRep', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\LaunchDarkly\Client\Model\ProjectRep';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\LaunchDarkly\Client\Model\ProjectRep',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * Create project
     *
     * @param  \LaunchDarkly\Client\Model\ProjectPost $project_post project_post (required)
     ...
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \LaunchDarkly\Client\Model\ProjectRep|\LaunchDarkly\Client\Model\InvalidRequestErrorRep|\LaunchDarkly\Client\Model\UnauthorizedErrorRep|\LaunchDarkly\Client\Model\ForbiddenErrorRep|\LaunchDarkly\Client\Model\StatusConflictErrorRep|\LaunchDarkly\Client\Model\RateLimitedErrorRep
     */
     ...
     * Create project
     *
     * @param  \LaunchDarkly\Client\Model\ProjectPost $project_post (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postProject'] to see the possible values for this operation
     *
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     *
     * @param  string $project_key The project key (required)
     * @param  \LaunchDarkly\Client\Model\UpsertFlagDefaultsPayload $upsert_flag_defaults_payload upsert_flag_defaults_payload (required)
     ...
     *
     * @param  string $project_key The project key (required)
     * @param  \LaunchDarkly\Client\Model\UpsertFlagDefaultsPayload $upsert_flag_defaults_payload (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['putFlagDefaultsByProject'] to see the possible values for this operation
     *
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
