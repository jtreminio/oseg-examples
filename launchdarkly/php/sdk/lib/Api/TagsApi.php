...
class TagsApi
{
     ...
     * List tags
     *
     * @param  string[]|null $kind Fetch tags associated with the specified resource type. Options are &#x60;flag&#x60;, &#x60;project&#x60;, &#x60;environment&#x60;, &#x60;segment&#x60;, &#x60;metric&#x60;. Returns all types by default. (optional)
     ...
     * @return \LaunchDarkly\Client\Model\TagsCollection|\LaunchDarkly\Client\Model\Error|\LaunchDarkly\Client\Model\Error|\LaunchDarkly\Client\Model\Error|\LaunchDarkly\Client\Model\Error|\LaunchDarkly\Client\Model\Error
     */
     ...
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \LaunchDarkly\Client\Model\TagsCollection|\LaunchDarkly\Client\Model\Error|\LaunchDarkly\Client\Model\Error|\LaunchDarkly\Client\Model\Error|\LaunchDarkly\Client\Model\Error|\LaunchDarkly\Client\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTagsWithHttpInfo($kind = null, $pre = null, $archived = null, $limit = null, $offset = null, $as_of = null, string $contentType = self::contentTypes['getTags'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\LaunchDarkly\Client\Model\TagsCollection' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\LaunchDarkly\Client\Model\TagsCollection' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\LaunchDarkly\Client\Model\TagsCollection', []),
            ...
            $returnType = '\LaunchDarkly\Client\Model\TagsCollection';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\LaunchDarkly\Client\Model\TagsCollection',
