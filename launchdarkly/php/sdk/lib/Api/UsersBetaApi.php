...
class UsersBetaApi
{
     ...
     * @return \LaunchDarkly\Client\Model\UserAttributeNamesRep|\LaunchDarkly\Client\Model\InvalidRequestErrorRep|\LaunchDarkly\Client\Model\UnauthorizedErrorRep|\LaunchDarkly\Client\Model\ForbiddenErrorRep|\LaunchDarkly\Client\Model\NotFoundErrorRep
     * @deprecated
     */
    ...
    public function getUserAttributeNamesWithHttpInfo($project_key, $environment_key, string $contentType = self::contentTypes['getUserAttributeNames'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\LaunchDarkly\Client\Model\UserAttributeNamesRep' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\LaunchDarkly\Client\Model\UserAttributeNamesRep' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\LaunchDarkly\Client\Model\UserAttributeNamesRep', []),
            ...
            $returnType = '\LaunchDarkly\Client\Model\UserAttributeNamesRep';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\LaunchDarkly\Client\Model\UserAttributeNamesRep',
