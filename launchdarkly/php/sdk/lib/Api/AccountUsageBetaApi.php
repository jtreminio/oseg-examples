...
class AccountUsageBetaApi
{
     ...
     * @param  string|null $project_key A project key. If specified, &#x60;environmentKey&#x60; is required and results apply to the corresponding environment in this project. (optional)
     * @param  string|null $environment_key An environment key. If specified, &#x60;projectKey&#x60; is required and results apply to the corresponding environment in this project. (optional)
     ...
     * @return \LaunchDarkly\Client\Model\SeriesIntervalsRep|\LaunchDarkly\Client\Model\InvalidRequestErrorRep|\LaunchDarkly\Client\Model\UnauthorizedErrorRep|\LaunchDarkly\Client\Model\ForbiddenErrorRep|\LaunchDarkly\Client\Model\RateLimitedErrorRep|\LaunchDarkly\Client\Model\StatusServiceUnavailable
     */
    public function getDataExportEventsUsage($from = null, $to = null, $project_key = null, $environment_key = null, string $contentType = self::contentTypes['getDataExportEventsUsage'][0])
    {
        list($response) = $this->getDataExportEventsUsageWithHttpInfo($from, $to, $project_key, $environment_key, $contentType);
        return $response;
    }
    ...
    public function getDataExportEventsUsageWithHttpInfo($from = null, $to = null, $project_key = null, $environment_key = null, string $contentType = self::contentTypes['getDataExportEventsUsage'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\LaunchDarkly\Client\Model\SeriesIntervalsRep' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\LaunchDarkly\Client\Model\SeriesIntervalsRep' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\LaunchDarkly\Client\Model\SeriesIntervalsRep', []),
            ...
            $returnType = '\LaunchDarkly\Client\Model\SeriesIntervalsRep';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\LaunchDarkly\Client\Model\SeriesIntervalsRep',
     ...
     */
    public function getDataExportEventsUsageAsync($from = null, $to = null, $project_key = null, $environment_key = null, string $contentType = self::contentTypes['getDataExportEventsUsage'][0])
    {
        return $this->getDataExportEventsUsageAsyncWithHttpInfo($from, $to, $project_key, $environment_key, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDataExportEventsUsageAsyncWithHttpInfo($from = null, $to = null, $project_key = null, $environment_key = null, string $contentType = self::contentTypes['getDataExportEventsUsage'][0])
    {
        $returnType = '\LaunchDarkly\Client\Model\SeriesIntervalsRep';
        $request = $this->getDataExportEventsUsageRequest($from, $to, $project_key, $environment_key, $contentType);
     ...
     */
    public function getDataExportEventsUsageRequest($from = null, $to = null, $project_key = null, $environment_key = null, string $contentType = self::contentTypes['getDataExportEventsUsage'][0])
    {
     ...
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \LaunchDarkly\Client\Model\SeriesListRep|\LaunchDarkly\Client\Model\InvalidRequestErrorRep|\LaunchDarkly\Client\Model\UnauthorizedErrorRep|\LaunchDarkly\Client\Model\ForbiddenErrorRep|\LaunchDarkly\Client\Model\NotFoundErrorRep|\LaunchDarkly\Client\Model\RateLimitedErrorRep
     */
    ...
    public function getEvaluationsUsageWithHttpInfo($project_key, $environment_key, $feature_flag_key, $from = null, $to = null, $tz = null, string $contentType = self::contentTypes['getEvaluationsUsage'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\LaunchDarkly\Client\Model\SeriesListRep' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\LaunchDarkly\Client\Model\SeriesListRep' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\LaunchDarkly\Client\Model\SeriesListRep', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\LaunchDarkly\Client\Model\SeriesListRep';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\LaunchDarkly\Client\Model\SeriesListRep',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \LaunchDarkly\Client\Model\SeriesIntervalsRep|\LaunchDarkly\Client\Model\InvalidRequestErrorRep|\LaunchDarkly\Client\Model\UnauthorizedErrorRep|\LaunchDarkly\Client\Model\ForbiddenErrorRep|\LaunchDarkly\Client\Model\RateLimitedErrorRep|\LaunchDarkly\Client\Model\StatusServiceUnavailable
     */
    public function getExperimentationKeysUsage($from = null, $to = null, $project_key = null, $environment_key = null, string $contentType = self::contentTypes['getExperimentationKeysUsage'][0])
    {
        list($response) = $this->getExperimentationKeysUsageWithHttpInfo($from, $to, $project_key, $environment_key, $contentType);
        return $response;
    }
     ...
     * @return array of \LaunchDarkly\Client\Model\SeriesIntervalsRep|\LaunchDarkly\Client\Model\InvalidRequestErrorRep|\LaunchDarkly\Client\Model\UnauthorizedErrorRep|\LaunchDarkly\Client\Model\ForbiddenErrorRep|\LaunchDarkly\Client\Model\RateLimitedErrorRep|\LaunchDarkly\Client\Model\StatusServiceUnavailable, HTTP status code, HTTP response headers (array of strings)
     */
    public function getExperimentationKeysUsageWithHttpInfo($from = null, $to = null, $project_key = null, $environment_key = null, string $contentType = self::contentTypes['getExperimentationKeysUsage'][0])
    {
        $request = $this->getExperimentationKeysUsageRequest($from, $to, $project_key, $environment_key, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getExperimentationKeysUsageAsync($from = null, $to = null, $project_key = null, $environment_key = null, string $contentType = self::contentTypes['getExperimentationKeysUsage'][0])
    {
        return $this->getExperimentationKeysUsageAsyncWithHttpInfo($from, $to, $project_key, $environment_key, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getExperimentationKeysUsageAsyncWithHttpInfo($from = null, $to = null, $project_key = null, $environment_key = null, string $contentType = self::contentTypes['getExperimentationKeysUsage'][0])
    {
        $returnType = '\LaunchDarkly\Client\Model\SeriesIntervalsRep';
        $request = $this->getExperimentationKeysUsageRequest($from, $to, $project_key, $environment_key, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getExperimentationKeysUsageRequest($from = null, $to = null, $project_key = null, $environment_key = null, string $contentType = self::contentTypes['getExperimentationKeysUsage'][0])
    {
     ...
     * @param  string|null $project_key A project key. If specified, &#x60;environmentKey&#x60; is required and results apply to the corresponding environment in this project. (optional)
     * @param  string|null $environment_key An environment key. If specified, &#x60;projectKey&#x60; is required and results apply to the corresponding environment in this project. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getExperimentationUnitsUsage'] to see the possible values for this operation
     *
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \LaunchDarkly\Client\Model\SeriesIntervalsRep|\LaunchDarkly\Client\Model\InvalidRequestErrorRep|\LaunchDarkly\Client\Model\UnauthorizedErrorRep|\LaunchDarkly\Client\Model\ForbiddenErrorRep|\LaunchDarkly\Client\Model\RateLimitedErrorRep|\LaunchDarkly\Client\Model\StatusServiceUnavailable
     */
    public function getExperimentationUnitsUsage($from = null, $to = null, $project_key = null, $environment_key = null, string $contentType = self::contentTypes['getExperimentationUnitsUsage'][0])
    {
        list($response) = $this->getExperimentationUnitsUsageWithHttpInfo($from, $to, $project_key, $environment_key, $contentType);
        return $response;
    }
     ...
     * @return array of \LaunchDarkly\Client\Model\SeriesIntervalsRep|\LaunchDarkly\Client\Model\InvalidRequestErrorRep|\LaunchDarkly\Client\Model\UnauthorizedErrorRep|\LaunchDarkly\Client\Model\ForbiddenErrorRep|\LaunchDarkly\Client\Model\RateLimitedErrorRep|\LaunchDarkly\Client\Model\StatusServiceUnavailable, HTTP status code, HTTP response headers (array of strings)
     */
    public function getExperimentationUnitsUsageWithHttpInfo($from = null, $to = null, $project_key = null, $environment_key = null, string $contentType = self::contentTypes['getExperimentationUnitsUsage'][0])
    {
        $request = $this->getExperimentationUnitsUsageRequest($from, $to, $project_key, $environment_key, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getExperimentationUnitsUsageAsync($from = null, $to = null, $project_key = null, $environment_key = null, string $contentType = self::contentTypes['getExperimentationUnitsUsage'][0])
    {
        return $this->getExperimentationUnitsUsageAsyncWithHttpInfo($from, $to, $project_key, $environment_key, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getExperimentationUnitsUsageAsyncWithHttpInfo($from = null, $to = null, $project_key = null, $environment_key = null, string $contentType = self::contentTypes['getExperimentationUnitsUsage'][0])
    {
        $returnType = '\LaunchDarkly\Client\Model\SeriesIntervalsRep';
        $request = $this->getExperimentationUnitsUsageRequest($from, $to, $project_key, $environment_key, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getExperimentationUnitsUsageRequest($from = null, $to = null, $project_key = null, $environment_key = null, string $contentType = self::contentTypes['getExperimentationUnitsUsage'][0])
    {
     ...
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \LaunchDarkly\Client\Model\SdkListRep|\LaunchDarkly\Client\Model\InvalidRequestErrorRep|\LaunchDarkly\Client\Model\UnauthorizedErrorRep|\LaunchDarkly\Client\Model\ForbiddenErrorRep|\LaunchDarkly\Client\Model\RateLimitedErrorRep
     */
     ...
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \LaunchDarkly\Client\Model\SdkListRep|\LaunchDarkly\Client\Model\InvalidRequestErrorRep|\LaunchDarkly\Client\Model\UnauthorizedErrorRep|\LaunchDarkly\Client\Model\ForbiddenErrorRep|\LaunchDarkly\Client\Model\RateLimitedErrorRep, HTTP status code, HTTP response headers (array of strings)
     */
    public function getMauSdksByTypeWithHttpInfo($from = null, $to = null, $sdktype = null, string $contentType = self::contentTypes['getMauSdksByType'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\LaunchDarkly\Client\Model\SdkListRep' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\LaunchDarkly\Client\Model\SdkListRep' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\LaunchDarkly\Client\Model\SdkListRep', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\LaunchDarkly\Client\Model\SdkListRep';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\LaunchDarkly\Client\Model\SdkListRep',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \LaunchDarkly\Client\Model\SeriesListRep|\LaunchDarkly\Client\Model\InvalidRequestErrorRep|\LaunchDarkly\Client\Model\UnauthorizedErrorRep|\LaunchDarkly\Client\Model\ForbiddenErrorRep|\LaunchDarkly\Client\Model\RateLimitedErrorRep
     */
     ...
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \LaunchDarkly\Client\Model\SeriesListRep|\LaunchDarkly\Client\Model\InvalidRequestErrorRep|\LaunchDarkly\Client\Model\UnauthorizedErrorRep|\LaunchDarkly\Client\Model\ForbiddenErrorRep|\LaunchDarkly\Client\Model\RateLimitedErrorRep, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @param  string|null $project_key A project key. If specified, &#x60;environmentKey&#x60; is required and results apply to the corresponding environment in this project. (optional)
     * @param  string|null $environment_key An environment key. If specified, &#x60;projectKey&#x60; is required and results apply to the corresponding environment in this project. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getServiceConnectionUsage'] to see the possible values for this operation
     *
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \LaunchDarkly\Client\Model\SeriesIntervalsRep|\LaunchDarkly\Client\Model\InvalidRequestErrorRep|\LaunchDarkly\Client\Model\UnauthorizedErrorRep|\LaunchDarkly\Client\Model\ForbiddenErrorRep|\LaunchDarkly\Client\Model\RateLimitedErrorRep|\LaunchDarkly\Client\Model\StatusServiceUnavailable
     */
    public function getServiceConnectionUsage($from = null, $to = null, $project_key = null, $environment_key = null, string $contentType = self::contentTypes['getServiceConnectionUsage'][0])
    {
        list($response) = $this->getServiceConnectionUsageWithHttpInfo($from, $to, $project_key, $environment_key, $contentType);
        return $response;
    }
     ...
     * @return array of \LaunchDarkly\Client\Model\SeriesIntervalsRep|\LaunchDarkly\Client\Model\InvalidRequestErrorRep|\LaunchDarkly\Client\Model\UnauthorizedErrorRep|\LaunchDarkly\Client\Model\ForbiddenErrorRep|\LaunchDarkly\Client\Model\RateLimitedErrorRep|\LaunchDarkly\Client\Model\StatusServiceUnavailable, HTTP status code, HTTP response headers (array of strings)
     */
    public function getServiceConnectionUsageWithHttpInfo($from = null, $to = null, $project_key = null, $environment_key = null, string $contentType = self::contentTypes['getServiceConnectionUsage'][0])
    {
        $request = $this->getServiceConnectionUsageRequest($from, $to, $project_key, $environment_key, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getServiceConnectionUsageAsync($from = null, $to = null, $project_key = null, $environment_key = null, string $contentType = self::contentTypes['getServiceConnectionUsage'][0])
    {
        return $this->getServiceConnectionUsageAsyncWithHttpInfo($from, $to, $project_key, $environment_key, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getServiceConnectionUsageAsyncWithHttpInfo($from = null, $to = null, $project_key = null, $environment_key = null, string $contentType = self::contentTypes['getServiceConnectionUsage'][0])
    {
        $returnType = '\LaunchDarkly\Client\Model\SeriesIntervalsRep';
        $request = $this->getServiceConnectionUsageRequest($from, $to, $project_key, $environment_key, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getServiceConnectionUsageRequest($from = null, $to = null, $project_key = null, $environment_key = null, string $contentType = self::contentTypes['getServiceConnectionUsage'][0])
    {
     ...
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \LaunchDarkly\Client\Model\SdkVersionListRep|\LaunchDarkly\Client\Model\UnauthorizedErrorRep|\LaunchDarkly\Client\Model\ForbiddenErrorRep|\LaunchDarkly\Client\Model\RateLimitedErrorRep
     */
     ...
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \LaunchDarkly\Client\Model\SdkVersionListRep|\LaunchDarkly\Client\Model\UnauthorizedErrorRep|\LaunchDarkly\Client\Model\ForbiddenErrorRep|\LaunchDarkly\Client\Model\RateLimitedErrorRep, HTTP status code, HTTP response headers (array of strings)
     */
    public function getStreamUsageSdkversionWithHttpInfo($source, string $contentType = self::contentTypes['getStreamUsageSdkversion'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\LaunchDarkly\Client\Model\SdkVersionListRep' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\LaunchDarkly\Client\Model\SdkVersionListRep' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\LaunchDarkly\Client\Model\SdkVersionListRep', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\LaunchDarkly\Client\Model\SdkVersionListRep';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\LaunchDarkly\Client\Model\SdkVersionListRep',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
