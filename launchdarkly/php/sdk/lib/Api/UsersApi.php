...
class UsersApi
{
     ...
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \LaunchDarkly\Client\Model\Users|\LaunchDarkly\Client\Model\InvalidRequestErrorRep|\LaunchDarkly\Client\Model\UnauthorizedErrorRep|\LaunchDarkly\Client\Model\ForbiddenErrorRep|\LaunchDarkly\Client\Model\NotFoundErrorRep|\LaunchDarkly\Client\Model\RateLimitedErrorRep
     * @deprecated
     */
    ...
    public function getSearchUsersWithHttpInfo($project_key, $environment_key, $q = null, $limit = null, $offset = null, $after = null, $sort = null, $search_after = null, $filter = null, string $contentType = self::contentTypes['getSearchUsers'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\LaunchDarkly\Client\Model\Users' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\LaunchDarkly\Client\Model\Users' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\LaunchDarkly\Client\Model\Users', []),
            ...
            $returnType = '\LaunchDarkly\Client\Model\Users';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\LaunchDarkly\Client\Model\Users',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \LaunchDarkly\Client\Model\UserRecord|\LaunchDarkly\Client\Model\InvalidRequestErrorRep|\LaunchDarkly\Client\Model\UnauthorizedErrorRep|\LaunchDarkly\Client\Model\ForbiddenErrorRep|\LaunchDarkly\Client\Model\NotFoundErrorRep|\LaunchDarkly\Client\Model\RateLimitedErrorRep
     * @deprecated
     */
     ...
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \LaunchDarkly\Client\Model\UserRecord|\LaunchDarkly\Client\Model\InvalidRequestErrorRep|\LaunchDarkly\Client\Model\UnauthorizedErrorRep|\LaunchDarkly\Client\Model\ForbiddenErrorRep|\LaunchDarkly\Client\Model\NotFoundErrorRep|\LaunchDarkly\Client\Model\RateLimitedErrorRep, HTTP status code, HTTP response headers (array of strings)
     * @deprecated
     */
    public function getUserWithHttpInfo($project_key, $environment_key, $user_key, string $contentType = self::contentTypes['getUser'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\LaunchDarkly\Client\Model\UserRecord' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\LaunchDarkly\Client\Model\UserRecord' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\LaunchDarkly\Client\Model\UserRecord', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\LaunchDarkly\Client\Model\UserRecord';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\LaunchDarkly\Client\Model\UserRecord',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \LaunchDarkly\Client\Model\UsersRep|\LaunchDarkly\Client\Model\InvalidRequestErrorRep|\LaunchDarkly\Client\Model\UnauthorizedErrorRep|\LaunchDarkly\Client\Model\ForbiddenErrorRep|\LaunchDarkly\Client\Model\NotFoundErrorRep|\LaunchDarkly\Client\Model\RateLimitedErrorRep
     * @deprecated
     */
     ...
     * @throws \LaunchDarkly\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \LaunchDarkly\Client\Model\UsersRep|\LaunchDarkly\Client\Model\InvalidRequestErrorRep|\LaunchDarkly\Client\Model\UnauthorizedErrorRep|\LaunchDarkly\Client\Model\ForbiddenErrorRep|\LaunchDarkly\Client\Model\NotFoundErrorRep|\LaunchDarkly\Client\Model\RateLimitedErrorRep, HTTP status code, HTTP response headers (array of strings)
     * @deprecated
     */
    public function getUsersWithHttpInfo($project_key, $environment_key, $limit = null, $search_after = null, string $contentType = self::contentTypes['getUsers'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\LaunchDarkly\Client\Model\UsersRep' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\LaunchDarkly\Client\Model\UsersRep' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\LaunchDarkly\Client\Model\UsersRep', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\LaunchDarkly\Client\Model\UsersRep';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\LaunchDarkly\Client\Model\UsersRep',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
