...
export enum ReleasesBetaApiApiKeys {
    ApiKey,
}

export class ReleasesBetaApi {
    ...
    public setApiKey(key: ReleasesBetaApiApiKeys, value: string) {
        (this.authentications as any)[ReleasesBetaApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async createReleaseForFlag (projectKey: string, flagKey: string, createReleaseInput: CreateReleaseInput, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Release;  }> {
        const localVarPath = this.basePath + '/api/v2/projects/{projectKey}/flags/{flagKey}/release'
        ...
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling createReleaseForFlag.');
        }

        // verify required parameter 'flagKey' is not null or undefined
        if (flagKey === null || flagKey === undefined) {
            throw new Error('Required parameter flagKey was null or undefined when calling createReleaseForFlag.');
        }

        // verify required parameter 'createReleaseInput' is not null or undefined
        if (createReleaseInput === null || createReleaseInput === undefined) {
            throw new Error('Required parameter createReleaseInput was null or undefined when calling createReleaseForFlag.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(createReleaseInput, "CreateReleaseInput")
        };
     ...
     * @param flagKey The flag key
     */
    public async deleteReleaseByFlagKey (projectKey: string, flagKey: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/api/v2/flags/{projectKey}/{flagKey}/release'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'flagKey' + '}', encodeURIComponent(String(flagKey)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling deleteReleaseByFlagKey.');
        }

        // verify required parameter 'flagKey' is not null or undefined
        if (flagKey === null || flagKey === undefined) {
            throw new Error('Required parameter flagKey was null or undefined when calling deleteReleaseByFlagKey.');
        }
     ...
     * @param flagKey The flag key
     */
    public async getReleaseByFlagKey (projectKey: string, flagKey: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Release;  }> {
        const localVarPath = this.basePath + '/api/v2/flags/{projectKey}/{flagKey}/release'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'flagKey' + '}', encodeURIComponent(String(flagKey)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling getReleaseByFlagKey.');
        }

        // verify required parameter 'flagKey' is not null or undefined
        if (flagKey === null || flagKey === undefined) {
            throw new Error('Required parameter flagKey was null or undefined when calling getReleaseByFlagKey.');
        }
     ...
     */
    public async patchReleaseByFlagKey (projectKey: string, flagKey: string, patchOperation: Array<PatchOperation>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Release;  }> {
        const localVarPath = this.basePath + '/api/v2/flags/{projectKey}/{flagKey}/release'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'flagKey' + '}', encodeURIComponent(String(flagKey)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling patchReleaseByFlagKey.');
        }

        // verify required parameter 'flagKey' is not null or undefined
        if (flagKey === null || flagKey === undefined) {
            throw new Error('Required parameter flagKey was null or undefined when calling patchReleaseByFlagKey.');
        }

        // verify required parameter 'patchOperation' is not null or undefined
        if (patchOperation === null || patchOperation === undefined) {
            throw new Error('Required parameter patchOperation was null or undefined when calling patchReleaseByFlagKey.');
        }
     ...
     */
    public async updatePhaseStatus (projectKey: string, flagKey: string, phaseId: string, updatePhaseStatusInput: UpdatePhaseStatusInput, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Release;  }> {
        const localVarPath = this.basePath + '/api/v2/projects/{projectKey}/flags/{flagKey}/release/phases/{phaseId}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'flagKey' + '}', encodeURIComponent(String(flagKey)))
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling updatePhaseStatus.');
        }

        // verify required parameter 'flagKey' is not null or undefined
        if (flagKey === null || flagKey === undefined) {
            throw new Error('Required parameter flagKey was null or undefined when calling updatePhaseStatus.');
        }

        // verify required parameter 'phaseId' is not null or undefined
        if (phaseId === null || phaseId === undefined) {
            throw new Error('Required parameter phaseId was null or undefined when calling updatePhaseStatus.');
        }

        // verify required parameter 'updatePhaseStatusInput' is not null or undefined
        if (updatePhaseStatusInput === null || updatePhaseStatusInput === undefined) {
            throw new Error('Required parameter updatePhaseStatusInput was null or undefined when calling updatePhaseStatus.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(updatePhaseStatusInput, "UpdatePhaseStatusInput")
        };
