...
export enum AccountUsageBetaApiApiKeys {
    ApiKey,
}

export class AccountUsageBetaApi {
    ...
    public setApiKey(key: AccountUsageBetaApiApiKeys, value: string) {
        (this.authentications as any)[AccountUsageBetaApiApiKeys[key]].apiKey = value;
    }
     ...
     * @param from The series of data returned starts from this timestamp (Unix seconds). Defaults to the beginning of the current month.
     * @param to The series of data returned ends at this timestamp (Unix seconds). Defaults to the current time.
     * @param projectKey A project key. If specified, &#x60;environmentKey&#x60; is required and results apply to the corresponding environment in this project.
     * @param environmentKey An environment key. If specified, &#x60;projectKey&#x60; is required and results apply to the corresponding environment in this project.
     */
    public async getDataExportEventsUsage (from?: string, to?: string, projectKey?: string, environmentKey?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SeriesIntervalsRep;  }> {
        const localVarPath = this.basePath + '/api/v2/usage/data-export-events';
        ...
        if (environmentKey !== undefined) {
            localVarQueryParameters['environmentKey'] = ObjectSerializer.serialize(environmentKey, "string");
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: SeriesIntervalsRep;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "SeriesIntervalsRep");
     ...
     * @param from The series of data returned starts from this timestamp. Defaults to 30 days ago.
     ...
     */
    public async getEvaluationsUsage (projectKey: string, environmentKey: string, featureFlagKey: string, from?: string, to?: string, tz?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SeriesListRep;  }> {
        const localVarPath = this.basePath + '/api/v2/usage/evaluations/{projectKey}/{environmentKey}/{featureFlagKey}'
        ...
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling getEvaluationsUsage.');
        }

        // verify required parameter 'environmentKey' is not null or undefined
        if (environmentKey === null || environmentKey === undefined) {
            throw new Error('Required parameter environmentKey was null or undefined when calling getEvaluationsUsage.');
        }

        // verify required parameter 'featureFlagKey' is not null or undefined
        if (featureFlagKey === null || featureFlagKey === undefined) {
            throw new Error('Required parameter featureFlagKey was null or undefined when calling getEvaluationsUsage.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: SeriesListRep;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "SeriesListRep");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     * @param from The series of data returned starts from this timestamp. Defaults to 24 hours ago.
     * @param to The series of data returned ends at this timestamp. Defaults to the current time.
     */
    public async getEventsUsage (type: string, from?: string, to?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SeriesListRep;  }> {
        const localVarPath = this.basePath + '/api/v2/usage/events/{type}'
        ...
        if (type === null || type === undefined) {
            throw new Error('Required parameter type was null or undefined when calling getEventsUsage.');
        }
     ...
     * @param environmentKey An environment key. If specified, &#x60;projectKey&#x60; is required and results apply to the corresponding environment in this project.
     */
    public async getExperimentationKeysUsage (from?: string, to?: string, projectKey?: string, environmentKey?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SeriesIntervalsRep;  }> {
        const localVarPath = this.basePath + '/api/v2/usage/experimentation-keys';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        // give precedence to 'application/json'
     ...
     * @param environmentKey An environment key. If specified, &#x60;projectKey&#x60; is required and results apply to the corresponding environment in this project.
     */
    public async getExperimentationUnitsUsage (from?: string, to?: string, projectKey?: string, environmentKey?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SeriesIntervalsRep;  }> {
        const localVarPath = this.basePath + '/api/v2/usage/experimentation-units';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        // give precedence to 'application/json'
     ...
     * @param from The data returned starts from this timestamp. Defaults to seven days ago. The timestamp is in Unix milliseconds, for example, 1656694800000.
     ...
     */
    public async getMauSdksByType (from?: string, to?: string, sdktype?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SdkListRep;  }> {
        const localVarPath = this.basePath + '/api/v2/usage/mau/sdks';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        // give precedence to 'application/json'
        ...
        if (sdktype !== undefined) {
            localVarQueryParameters['sdktype'] = ObjectSerializer.serialize(sdktype, "string");
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: SdkListRep;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "SdkListRep");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     * @param aggregationType If specified, queries for rolling 30-day, month-to-date, or daily incremental counts. Default is rolling 30-day. Valid values: rolling_30d, month_to_date, daily_incremental
     * @param contextKind Filters results to the specified context kinds. Can be specified multiple times, one query parameter per context kind. If not set, queries for the user context kind.
     */
    public async getMauUsage (from?: string, to?: string, project?: string, environment?: string, sdktype?: string, sdk?: string, anonymous?: string, groupby?: string, aggregationType?: string, contextKind?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SeriesListRep;  }> {
        const localVarPath = this.basePath + '/api/v2/usage/mau';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        // give precedence to 'application/json'
        ...
        if (sdk !== undefined) {
            localVarQueryParameters['sdk'] = ObjectSerializer.serialize(sdk, "string");
        }

        if (anonymous !== undefined) {
            localVarQueryParameters['anonymous'] = ObjectSerializer.serialize(anonymous, "string");
        }
        ...
        if (aggregationType !== undefined) {
            localVarQueryParameters['aggregationType'] = ObjectSerializer.serialize(aggregationType, "string");
        }

        if (contextKind !== undefined) {
            localVarQueryParameters['contextKind'] = ObjectSerializer.serialize(contextKind, "string");
        }
     ...
     * @param to The series of data returned ends at this timestamp. Defaults to the current time.
     */
    public async getMauUsageByCategory (from?: string, to?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SeriesListRep;  }> {
        const localVarPath = this.basePath + '/api/v2/usage/mau/bycategory';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        // give precedence to 'application/json'
     ...
     * @param environmentKey An environment key. If specified, &#x60;projectKey&#x60; is required and results apply to the corresponding environment in this project.
     */
    public async getServiceConnectionUsage (from?: string, to?: string, projectKey?: string, environmentKey?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SeriesIntervalsRep;  }> {
        const localVarPath = this.basePath + '/api/v2/usage/service-connections';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        // give precedence to 'application/json'
     ...
     * @param tz The timezone to use for breaks between days when returning daily data.
     */
    public async getStreamUsage (source: string, from?: string, to?: string, tz?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SeriesListRep;  }> {
        const localVarPath = this.basePath + '/api/v2/usage/streams/{source}'
        ...
        if (source === null || source === undefined) {
            throw new Error('Required parameter source was null or undefined when calling getStreamUsage.');
        }
     ...
     */
    public async getStreamUsageBySdkVersion (source: string, from?: string, to?: string, tz?: string, sdk?: string, version?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SeriesListRep;  }> {
        const localVarPath = this.basePath + '/api/v2/usage/streams/{source}/bysdkversion'
            .replace('{' + 'source' + '}', encodeURIComponent(String(source)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        // verify required parameter 'source' is not null or undefined
        if (source === null || source === undefined) {
            throw new Error('Required parameter source was null or undefined when calling getStreamUsageBySdkVersion.');
        }
     ...
     * @param source The source of streaming connections to describe. Must be either &#x60;client&#x60; or &#x60;server&#x60;.
     */
    public async getStreamUsageSdkversion (source: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SdkVersionListRep;  }> {
        const localVarPath = this.basePath + '/api/v2/usage/streams/{source}/sdkversions'
            .replace('{' + 'source' + '}', encodeURIComponent(String(source)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        // verify required parameter 'source' is not null or undefined
        if (source === null || source === undefined) {
            throw new Error('Required parameter source was null or undefined when calling getStreamUsageSdkversion.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: SdkVersionListRep;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "SdkVersionListRep");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
