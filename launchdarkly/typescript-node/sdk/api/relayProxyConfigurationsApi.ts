...
export class RelayProxyConfigurationsApi {
     ...
     */
    public async deleteRelayAutoConfig (id: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/api/v2/account/relay-auto-configs/{id}'
        ...
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling deleteRelayAutoConfig.');
        }
     ...
     * @param id The relay auto config id
     */
    public async getRelayProxyConfig (id: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: RelayAutoConfigRep;  }> {
        const localVarPath = this.basePath + '/api/v2/account/relay-auto-configs/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: RelayAutoConfigRep;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "RelayAutoConfigRep");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     */
    public async getRelayProxyConfigs (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: RelayAutoConfigCollectionRep;  }> {
        const localVarPath = this.basePath + '/api/v2/account/relay-auto-configs';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        // give precedence to 'application/json'
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: RelayAutoConfigCollectionRep;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "RelayAutoConfigCollectionRep");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     */
    public async patchRelayAutoConfig (id: string, patchWithComment: PatchWithComment, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: RelayAutoConfigRep;  }> {
        const localVarPath = this.basePath + '/api/v2/account/relay-auto-configs/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling patchRelayAutoConfig.');
        }

        // verify required parameter 'patchWithComment' is not null or undefined
        if (patchWithComment === null || patchWithComment === undefined) {
            throw new Error('Required parameter patchWithComment was null or undefined when calling patchRelayAutoConfig.');
        }
     ...
     */
    public async postRelayAutoConfig (relayAutoConfigPost: RelayAutoConfigPost, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: RelayAutoConfigRep;  }> {
        const localVarPath = this.basePath + '/api/v2/account/relay-auto-configs';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        if (relayAutoConfigPost === null || relayAutoConfigPost === undefined) {
            throw new Error('Required parameter relayAutoConfigPost was null or undefined when calling postRelayAutoConfig.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(relayAutoConfigPost, "RelayAutoConfigPost")
        };
     ...
     */
    public async resetRelayAutoConfig (id: string, expiry?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: RelayAutoConfigRep;  }> {
        const localVarPath = this.basePath + '/api/v2/account/relay-auto-configs/{id}/reset'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling resetRelayAutoConfig.');
        }
