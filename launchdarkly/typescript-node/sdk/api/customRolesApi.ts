...
export class CustomRolesApi {
     ...
     */
    public async deleteCustomRole (customRoleKey: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/api/v2/roles/{customRoleKey}'
     ...
     */
    public async getCustomRole (customRoleKey: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CustomRole;  }> {
        const localVarPath = this.basePath + '/api/v2/roles/{customRoleKey}'
            .replace('{' + 'customRoleKey' + '}', encodeURIComponent(String(customRoleKey)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     * @param limit The maximum number of custom roles to return. Defaults to 20.
     ...
     */
    public async getCustomRoles (limit?: number, offset?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CustomRoles;  }> {
        const localVarPath = this.basePath + '/api/v2/roles';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        // give precedence to 'application/json'
     ...
     */
    public async patchCustomRole (customRoleKey: string, patchWithComment: PatchWithComment, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CustomRole;  }> {
        const localVarPath = this.basePath + '/api/v2/roles/{customRoleKey}'
            .replace('{' + 'customRoleKey' + '}', encodeURIComponent(String(customRoleKey)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        if (patchWithComment === null || patchWithComment === undefined) {
            throw new Error('Required parameter patchWithComment was null or undefined when calling patchCustomRole.');
        }
     ...
     */
    public async postCustomRole (customRolePost: CustomRolePost, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CustomRole;  }> {
        const localVarPath = this.basePath + '/api/v2/roles';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        if (customRolePost === null || customRolePost === undefined) {
            throw new Error('Required parameter customRolePost was null or undefined when calling postCustomRole.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(customRolePost, "CustomRolePost")
        };
