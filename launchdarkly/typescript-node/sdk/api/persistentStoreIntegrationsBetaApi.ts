...
export enum PersistentStoreIntegrationsBetaApiApiKeys {
    ApiKey,
}

export class PersistentStoreIntegrationsBetaApi {
    ...
    public setApiKey(key: PersistentStoreIntegrationsBetaApiApiKeys, value: string) {
        (this.authentications as any)[PersistentStoreIntegrationsBetaApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async createBigSegmentStoreIntegration (projectKey: string, environmentKey: string, integrationKey: string, integrationDeliveryConfigurationPost: IntegrationDeliveryConfigurationPost, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: BigSegmentStoreIntegration;  }> {
        const localVarPath = this.basePath + '/api/v2/integration-capabilities/big-segment-store/{projectKey}/{environmentKey}/{integrationKey}'
        ...
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling createBigSegmentStoreIntegration.');
        }

        // verify required parameter 'environmentKey' is not null or undefined
        if (environmentKey === null || environmentKey === undefined) {
            throw new Error('Required parameter environmentKey was null or undefined when calling createBigSegmentStoreIntegration.');
        }

        // verify required parameter 'integrationKey' is not null or undefined
        if (integrationKey === null || integrationKey === undefined) {
            throw new Error('Required parameter integrationKey was null or undefined when calling createBigSegmentStoreIntegration.');
        }
        ...
        if (integrationDeliveryConfigurationPost === null || integrationDeliveryConfigurationPost === undefined) {
            throw new Error('Required parameter integrationDeliveryConfigurationPost was null or undefined when calling createBigSegmentStoreIntegration.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: BigSegmentStoreIntegration;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "BigSegmentStoreIntegration");
     ...
     */
    public async deleteBigSegmentStoreIntegration (projectKey: string, environmentKey: string, integrationKey: string, integrationId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/api/v2/integration-capabilities/big-segment-store/{projectKey}/{environmentKey}/{integrationKey}/{integrationId}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'environmentKey' + '}', encodeURIComponent(String(environmentKey)))
            .replace('{' + 'integrationKey' + '}', encodeURIComponent(String(integrationKey)))
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling deleteBigSegmentStoreIntegration.');
        }

        // verify required parameter 'environmentKey' is not null or undefined
        if (environmentKey === null || environmentKey === undefined) {
            throw new Error('Required parameter environmentKey was null or undefined when calling deleteBigSegmentStoreIntegration.');
        }

        // verify required parameter 'integrationKey' is not null or undefined
        if (integrationKey === null || integrationKey === undefined) {
            throw new Error('Required parameter integrationKey was null or undefined when calling deleteBigSegmentStoreIntegration.');
        }

        // verify required parameter 'integrationId' is not null or undefined
        if (integrationId === null || integrationId === undefined) {
            throw new Error('Required parameter integrationId was null or undefined when calling deleteBigSegmentStoreIntegration.');
        }
     ...
     * @param integrationId The integration ID
     */
    public async getBigSegmentStoreIntegration (projectKey: string, environmentKey: string, integrationKey: string, integrationId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: BigSegmentStoreIntegration;  }> {
        const localVarPath = this.basePath + '/api/v2/integration-capabilities/big-segment-store/{projectKey}/{environmentKey}/{integrationKey}/{integrationId}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'environmentKey' + '}', encodeURIComponent(String(environmentKey)))
            .replace('{' + 'integrationKey' + '}', encodeURIComponent(String(integrationKey)))
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling getBigSegmentStoreIntegration.');
        }

        // verify required parameter 'environmentKey' is not null or undefined
        if (environmentKey === null || environmentKey === undefined) {
            throw new Error('Required parameter environmentKey was null or undefined when calling getBigSegmentStoreIntegration.');
        }

        // verify required parameter 'integrationKey' is not null or undefined
        if (integrationKey === null || integrationKey === undefined) {
            throw new Error('Required parameter integrationKey was null or undefined when calling getBigSegmentStoreIntegration.');
        }

        // verify required parameter 'integrationId' is not null or undefined
        if (integrationId === null || integrationId === undefined) {
            throw new Error('Required parameter integrationId was null or undefined when calling getBigSegmentStoreIntegration.');
        }
     ...
     */
    public async getBigSegmentStoreIntegrations (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: BigSegmentStoreIntegrationCollection;  }> {
        const localVarPath = this.basePath + '/api/v2/integration-capabilities/big-segment-store';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        // give precedence to 'application/json'
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: BigSegmentStoreIntegrationCollection;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "BigSegmentStoreIntegrationCollection");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     */
    public async patchBigSegmentStoreIntegration (projectKey: string, environmentKey: string, integrationKey: string, integrationId: string, patchOperation: Array<PatchOperation>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: BigSegmentStoreIntegration;  }> {
        const localVarPath = this.basePath + '/api/v2/integration-capabilities/big-segment-store/{projectKey}/{environmentKey}/{integrationKey}/{integrationId}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'environmentKey' + '}', encodeURIComponent(String(environmentKey)))
            .replace('{' + 'integrationKey' + '}', encodeURIComponent(String(integrationKey)))
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling patchBigSegmentStoreIntegration.');
        }

        // verify required parameter 'environmentKey' is not null or undefined
        if (environmentKey === null || environmentKey === undefined) {
            throw new Error('Required parameter environmentKey was null or undefined when calling patchBigSegmentStoreIntegration.');
        }

        // verify required parameter 'integrationKey' is not null or undefined
        if (integrationKey === null || integrationKey === undefined) {
            throw new Error('Required parameter integrationKey was null or undefined when calling patchBigSegmentStoreIntegration.');
        }

        // verify required parameter 'integrationId' is not null or undefined
        if (integrationId === null || integrationId === undefined) {
            throw new Error('Required parameter integrationId was null or undefined when calling patchBigSegmentStoreIntegration.');
        }

        // verify required parameter 'patchOperation' is not null or undefined
        if (patchOperation === null || patchOperation === undefined) {
            throw new Error('Required parameter patchOperation was null or undefined when calling patchBigSegmentStoreIntegration.');
        }
