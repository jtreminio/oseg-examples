...
export enum ApprovalsBetaApiApiKeys {
    ApiKey,
}

export class ApprovalsBetaApi {
    ...
    public setApiKey(key: ApprovalsBetaApiApiKeys, value: string) {
        (this.authentications as any)[ApprovalsBetaApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async patchApprovalRequest (id: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FlagConfigApprovalRequestResponse;  }> {
        ...
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling patchApprovalRequest.');
        }
     ...
     * @param id The approval ID
     */
    public async patchFlagConfigApprovalRequest (projectKey: string, featureFlagKey: string, environmentKey: string, id: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FlagConfigApprovalRequestResponse;  }> {
        ...
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling patchFlagConfigApprovalRequest.');
        }

        // verify required parameter 'featureFlagKey' is not null or undefined
        if (featureFlagKey === null || featureFlagKey === undefined) {
            throw new Error('Required parameter featureFlagKey was null or undefined when calling patchFlagConfigApprovalRequest.');
        }

        // verify required parameter 'environmentKey' is not null or undefined
        if (environmentKey === null || environmentKey === undefined) {
            throw new Error('Required parameter environmentKey was null or undefined when calling patchFlagConfigApprovalRequest.');
        }

        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling patchFlagConfigApprovalRequest.');
        }
