...
export enum IntegrationAuditLogSubscriptionsApiApiKeys {
    ApiKey,
}

export class IntegrationAuditLogSubscriptionsApi {
    ...
    public setApiKey(key: IntegrationAuditLogSubscriptionsApiApiKeys, value: string) {
        (this.authentications as any)[IntegrationAuditLogSubscriptionsApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async createSubscription (integrationKey: string, subscriptionPost: SubscriptionPost, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Integration;  }> {
        const localVarPath = this.basePath + '/api/v2/integrations/{integrationKey}'
        ...
        if (integrationKey === null || integrationKey === undefined) {
            throw new Error('Required parameter integrationKey was null or undefined when calling createSubscription.');
        }

        // verify required parameter 'subscriptionPost' is not null or undefined
        if (subscriptionPost === null || subscriptionPost === undefined) {
            throw new Error('Required parameter subscriptionPost was null or undefined when calling createSubscription.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(subscriptionPost, "SubscriptionPost")
        };
     ...
     */
    public async deleteSubscription (integrationKey: string, id: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/api/v2/integrations/{integrationKey}/{id}'
            .replace('{' + 'integrationKey' + '}', encodeURIComponent(String(integrationKey)))
        ...
        // verify required parameter 'integrationKey' is not null or undefined
        if (integrationKey === null || integrationKey === undefined) {
            throw new Error('Required parameter integrationKey was null or undefined when calling deleteSubscription.');
        }
     ...
     * @param id The subscription ID
     */
    public async getSubscriptionByID (integrationKey: string, id: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Integration;  }> {
        const localVarPath = this.basePath + '/api/v2/integrations/{integrationKey}/{id}'
            .replace('{' + 'integrationKey' + '}', encodeURIComponent(String(integrationKey)))
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'integrationKey' is not null or undefined
        if (integrationKey === null || integrationKey === undefined) {
            throw new Error('Required parameter integrationKey was null or undefined when calling getSubscriptionByID.');
        }
     ...
     * @param integrationKey The integration key
     */
    public async getSubscriptions (integrationKey: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Integrations;  }> {
        const localVarPath = this.basePath + '/api/v2/integrations/{integrationKey}'
            .replace('{' + 'integrationKey' + '}', encodeURIComponent(String(integrationKey)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'integrationKey' is not null or undefined
        if (integrationKey === null || integrationKey === undefined) {
            throw new Error('Required parameter integrationKey was null or undefined when calling getSubscriptions.');
        }
     ...
     */
    public async updateSubscription (integrationKey: string, id: string, patchOperation: Array<PatchOperation>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Integration;  }> {
        const localVarPath = this.basePath + '/api/v2/integrations/{integrationKey}/{id}'
            .replace('{' + 'integrationKey' + '}', encodeURIComponent(String(integrationKey)))
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'integrationKey' is not null or undefined
        if (integrationKey === null || integrationKey === undefined) {
            throw new Error('Required parameter integrationKey was null or undefined when calling updateSubscription.');
        }
        ...
        if (patchOperation === null || patchOperation === undefined) {
            throw new Error('Required parameter patchOperation was null or undefined when calling updateSubscription.');
        }
