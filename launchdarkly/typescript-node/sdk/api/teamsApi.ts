...
export class TeamsApi {
     ...
     */
    public async deleteTeam (teamKey: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/api/v2/teams/{teamKey}'
        ...
        if (teamKey === null || teamKey === undefined) {
            throw new Error('Required parameter teamKey was null or undefined when calling deleteTeam.');
        }
     ...
     */
    public async getTeam (teamKey: string, expand?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Team;  }> {
        const localVarPath = this.basePath + '/api/v2/teams/{teamKey}'
            .replace('{' + 'teamKey' + '}', encodeURIComponent(String(teamKey)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'teamKey' is not null or undefined
        if (teamKey === null || teamKey === undefined) {
            throw new Error('Required parameter teamKey was null or undefined when calling getTeam.');
        }
     ...
     */
    public async getTeamMaintainers (teamKey: string, limit?: number, offset?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TeamMaintainers;  }> {
        const localVarPath = this.basePath + '/api/v2/teams/{teamKey}/maintainers'
            .replace('{' + 'teamKey' + '}', encodeURIComponent(String(teamKey)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        // verify required parameter 'teamKey' is not null or undefined
        if (teamKey === null || teamKey === undefined) {
            throw new Error('Required parameter teamKey was null or undefined when calling getTeamMaintainers.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: TeamMaintainers;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "TeamMaintainers");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     * @param offset Where to start in the list. This is for use with pagination. For example, an offset of 10 skips the first ten items and then returns the next items in the list, up to the query &#x60;limit&#x60;.
     */
    public async getTeamRoles (teamKey: string, limit?: number, offset?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TeamCustomRoles;  }> {
        const localVarPath = this.basePath + '/api/v2/teams/{teamKey}/roles'
            .replace('{' + 'teamKey' + '}', encodeURIComponent(String(teamKey)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        // verify required parameter 'teamKey' is not null or undefined
        if (teamKey === null || teamKey === undefined) {
            throw new Error('Required parameter teamKey was null or undefined when calling getTeamRoles.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: TeamCustomRoles;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "TeamCustomRoles");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     * @param expand A comma-separated list of properties that can reveal additional information in the response.
     */
    public async getTeams (limit?: number, offset?: number, filter?: string, expand?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Teams;  }> {
        const localVarPath = this.basePath + '/api/v2/teams';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        // give precedence to 'application/json'
     ...
     */
    public async patchTeam (teamKey: string, teamPatchInput: TeamPatchInput, expand?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Team;  }> {
        const localVarPath = this.basePath + '/api/v2/teams/{teamKey}'
            .replace('{' + 'teamKey' + '}', encodeURIComponent(String(teamKey)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'teamKey' is not null or undefined
        if (teamKey === null || teamKey === undefined) {
            throw new Error('Required parameter teamKey was null or undefined when calling patchTeam.');
        }

        // verify required parameter 'teamPatchInput' is not null or undefined
        if (teamPatchInput === null || teamPatchInput === undefined) {
            throw new Error('Required parameter teamPatchInput was null or undefined when calling patchTeam.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(teamPatchInput, "TeamPatchInput")
        };
     ...
     * @param expand A comma-separated list of properties that can reveal additional information in the response. Supported fields are explained above.
     */
    public async postTeam (teamPostInput: TeamPostInput, expand?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Team;  }> {
        const localVarPath = this.basePath + '/api/v2/teams';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        if (teamPostInput === null || teamPostInput === undefined) {
            throw new Error('Required parameter teamPostInput was null or undefined when calling postTeam.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(teamPostInput, "TeamPostInput")
        };
     ...
     */
    public async postTeamMembers (teamKey: string, file?: RequestFile, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TeamImportsRep;  }> {
        const localVarPath = this.basePath + '/api/v2/teams/{teamKey}/members'
            .replace('{' + 'teamKey' + '}', encodeURIComponent(String(teamKey)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        // verify required parameter 'teamKey' is not null or undefined
        if (teamKey === null || teamKey === undefined) {
            throw new Error('Required parameter teamKey was null or undefined when calling postTeamMembers.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: TeamImportsRep;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "TeamImportsRep");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
