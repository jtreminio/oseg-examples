...
export class MetricsApi {
     ...
     */
    public async deleteMetric (projectKey: string, metricKey: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/api/v2/metrics/{projectKey}/{metricKey}'
        ...
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling deleteMetric.');
        }

        // verify required parameter 'metricKey' is not null or undefined
        if (metricKey === null || metricKey === undefined) {
            throw new Error('Required parameter metricKey was null or undefined when calling deleteMetric.');
        }
     ...
     * @param versionId The specific version ID of the metric
     */
    public async getMetric (projectKey: string, metricKey: string, expand?: string, versionId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: MetricRep;  }> {
        const localVarPath = this.basePath + '/api/v2/metrics/{projectKey}/{metricKey}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'metricKey' + '}', encodeURIComponent(String(metricKey)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling getMetric.');
        }

        // verify required parameter 'metricKey' is not null or undefined
        if (metricKey === null || metricKey === undefined) {
            throw new Error('Required parameter metricKey was null or undefined when calling getMetric.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: MetricRep;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "MetricRep");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     * @param projectKey The project key
     * @param expand A comma-separated list of properties that can reveal additional information in the response.
     * @param limit The number of metrics to return in the response. Defaults to 20. Maximum limit is 50.
     ...
     * @param filter A comma-separated list of filters. This endpoint only accepts filtering by &#x60;tags&#x60;. To learn more about the filter syntax, read the \&#39;Filtering metrics\&#39; section above.
     */
    public async getMetrics (projectKey: string, expand?: string, limit?: number, offset?: number, sort?: string, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: MetricCollectionRep;  }> {
        const localVarPath = this.basePath + '/api/v2/metrics/{projectKey}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling getMetrics.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: MetricCollectionRep;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "MetricCollectionRep");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     */
    public async patchMetric (projectKey: string, metricKey: string, patchOperation: Array<PatchOperation>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: MetricRep;  }> {
        const localVarPath = this.basePath + '/api/v2/metrics/{projectKey}/{metricKey}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'metricKey' + '}', encodeURIComponent(String(metricKey)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling patchMetric.');
        }

        // verify required parameter 'metricKey' is not null or undefined
        if (metricKey === null || metricKey === undefined) {
            throw new Error('Required parameter metricKey was null or undefined when calling patchMetric.');
        }

        // verify required parameter 'patchOperation' is not null or undefined
        if (patchOperation === null || patchOperation === undefined) {
            throw new Error('Required parameter patchOperation was null or undefined when calling patchMetric.');
        }
     ...
     * @param metricPost 
     */
    public async postMetric (projectKey: string, metricPost: MetricPost, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: MetricRep;  }> {
        const localVarPath = this.basePath + '/api/v2/metrics/{projectKey}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling postMetric.');
        }

        // verify required parameter 'metricPost' is not null or undefined
        if (metricPost === null || metricPost === undefined) {
            throw new Error('Required parameter metricPost was null or undefined when calling postMetric.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(metricPost, "MetricPost")
        };
