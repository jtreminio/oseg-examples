...
export enum InsightsRepositoriesBetaApiApiKeys {
    ApiKey,
}

export class InsightsRepositoriesBetaApi {
    ...
    public setApiKey(key: InsightsRepositoriesBetaApiApiKeys, value: string) {
        (this.authentications as any)[InsightsRepositoriesBetaApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async associateRepositoriesAndProjects (insightsRepositoryProjectMappings: InsightsRepositoryProjectMappings, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InsightsRepositoryProjectCollection;  }> {
        const localVarPath = this.basePath + '/api/v2/engineering-insights/repositories/projects';
        ...
        if (insightsRepositoryProjectMappings === null || insightsRepositoryProjectMappings === undefined) {
            throw new Error('Required parameter insightsRepositoryProjectMappings was null or undefined when calling associateRepositoriesAndProjects.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(insightsRepositoryProjectMappings, "InsightsRepositoryProjectMappings")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: InsightsRepositoryProjectCollection;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "InsightsRepositoryProjectCollection");
     ...
     */
    public async deleteRepositoryProject (repositoryKey: string, projectKey: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/api/v2/engineering-insights/repositories/{repositoryKey}/projects/{projectKey}'
        ...
        if (repositoryKey === null || repositoryKey === undefined) {
            throw new Error('Required parameter repositoryKey was null or undefined when calling deleteRepositoryProject.');
        }

        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling deleteRepositoryProject.');
        }
     ...
     * @param expand Expand properties in response. Options: &#x60;projects&#x60;
     */
    public async getInsightsRepositories (expand?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InsightsRepositoryCollection;  }> {
        const localVarPath = this.basePath + '/api/v2/engineering-insights/repositories';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        // give precedence to 'application/json'
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: InsightsRepositoryCollection;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "InsightsRepositoryCollection");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
