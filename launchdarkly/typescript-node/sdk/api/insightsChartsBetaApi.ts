...
export enum InsightsChartsBetaApiApiKeys {
    ApiKey,
}

export class InsightsChartsBetaApi {
    ...
    public setApiKey(key: InsightsChartsBetaApiApiKeys, value: string) {
        (this.authentications as any)[InsightsChartsBetaApiApiKeys[key]].apiKey = value;
    }
     ...
     * @param applicationKey Comma separated list of application keys
     * @param from Unix timestamp in milliseconds. Default value is 7 days ago.
     * @param to Unix timestamp in milliseconds. Default value is now.
     * @param bucketType Specify type of bucket. Options: &#x60;rolling&#x60;, &#x60;hour&#x60;, &#x60;day&#x60;. Default: &#x60;rolling&#x60;.
     * @param bucketMs Duration of intervals for x-axis in milliseconds. Default value is one day (&#x60;86400000&#x60; milliseconds).
     * @param groupBy Options: &#x60;application&#x60;, &#x60;kind&#x60;
     * @param expand Options: &#x60;metrics&#x60;
     */
    public async getDeploymentFrequencyChart (projectKey?: string, environmentKey?: string, applicationKey?: string, from?: Date, to?: Date, bucketType?: string, bucketMs?: number, groupBy?: string, expand?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InsightsChart;  }> {
        const localVarPath = this.basePath + '/api/v2/engineering-insights/charts/deployments/frequency';
        ...
        if (applicationKey !== undefined) {
            localVarQueryParameters['applicationKey'] = ObjectSerializer.serialize(applicationKey, "string");
        }
        ...
        if (bucketType !== undefined) {
            localVarQueryParameters['bucketType'] = ObjectSerializer.serialize(bucketType, "string");
        }

        if (bucketMs !== undefined) {
            localVarQueryParameters['bucketMs'] = ObjectSerializer.serialize(bucketMs, "number");
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: InsightsChart;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "InsightsChart");
     ...
     * @param applicationKey Comma separated list of application keys
     */
    public async getFlagStatusChart (projectKey: string, environmentKey: string, applicationKey?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InsightsChart;  }> {
        const localVarPath = this.basePath + '/api/v2/engineering-insights/charts/flags/status';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        // give precedence to 'application/json'
        ...
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling getFlagStatusChart.');
        }

        // verify required parameter 'environmentKey' is not null or undefined
        if (environmentKey === null || environmentKey === undefined) {
            throw new Error('Required parameter environmentKey was null or undefined when calling getFlagStatusChart.');
        }
     ...
     * @param bucketType Specify type of bucket. Options: &#x60;rolling&#x60;, &#x60;hour&#x60;, &#x60;day&#x60;. Default: &#x60;rolling&#x60;.
     * @param bucketMs Duration of intervals for x-axis in milliseconds. Default value is one day (&#x60;86400000&#x60; milliseconds).
     * @param groupBy Options: &#x60;application&#x60;, &#x60;stage&#x60;. Default: &#x60;stage&#x60;.
     * @param expand Options: &#x60;metrics&#x60;, &#x60;percentiles&#x60;.
     */
    public async getLeadTimeChart (projectKey: string, environmentKey?: string, applicationKey?: string, from?: number, to?: number, bucketType?: string, bucketMs?: number, groupBy?: string, expand?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InsightsChart;  }> {
        const localVarPath = this.basePath + '/api/v2/engineering-insights/charts/lead-time';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        // give precedence to 'application/json'
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling getLeadTimeChart.');
        }
     ...
     * @param environmentKey The environment key
     * @param applicationKey Comma separated list of application keys
     * @param hasExperiments Filter events to those associated with an experiment (&#x60;true&#x60;) or without an experiment (&#x60;false&#x60;)
     * @param global Filter to include or exclude global events. Default value is &#x60;include&#x60;. Options: &#x60;include&#x60;, &#x60;exclude&#x60;
     * @param groupBy Property to group results by. Options: &#x60;impact&#x60;
     * @param from Unix timestamp in milliseconds. Default value is 7 days ago.
     * @param to Unix timestamp in milliseconds. Default value is now.
     * @param bucketType Specify type of bucket. Options: &#x60;rolling&#x60;, &#x60;hour&#x60;, &#x60;day&#x60;. Default: &#x60;rolling&#x60;.
     * @param bucketMs Duration of intervals for x-axis in milliseconds. Default value is one day (&#x60;86400000&#x60; milliseconds).
     * @param expand Options: &#x60;metrics&#x60;
     */
    public async getReleaseFrequencyChart (projectKey: string, environmentKey: string, applicationKey?: string, hasExperiments?: boolean, global?: string, groupBy?: string, from?: Date, to?: Date, bucketType?: string, bucketMs?: number, expand?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InsightsChart;  }> {
        const localVarPath = this.basePath + '/api/v2/engineering-insights/charts/releases/frequency';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        // give precedence to 'application/json'
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling getReleaseFrequencyChart.');
        }

        // verify required parameter 'environmentKey' is not null or undefined
        if (environmentKey === null || environmentKey === undefined) {
            throw new Error('Required parameter environmentKey was null or undefined when calling getReleaseFrequencyChart.');
        }
        ...
        if (hasExperiments !== undefined) {
            localVarQueryParameters['hasExperiments'] = ObjectSerializer.serialize(hasExperiments, "boolean");
        }

        if (global !== undefined) {
            localVarQueryParameters['global'] = ObjectSerializer.serialize(global, "string");
        }
     ...
     * @param environmentKey The environment key
     * @param applicationKey Comma separated list of application keys
     * @param groupBy Property to group results by. Options: &#x60;maintainer&#x60;
     * @param maintainerId Comma-separated list of individual maintainers to filter results.
     * @param maintainerTeamKey Comma-separated list of team maintainer keys to filter results.
     * @param expand Options: &#x60;metrics&#x60;
     */
    public async getStaleFlagsChart (projectKey: string, environmentKey: string, applicationKey?: string, groupBy?: string, maintainerId?: string, maintainerTeamKey?: string, expand?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InsightsChart;  }> {
        const localVarPath = this.basePath + '/api/v2/engineering-insights/charts/flags/stale';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        // give precedence to 'application/json'
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling getStaleFlagsChart.');
        }

        // verify required parameter 'environmentKey' is not null or undefined
        if (environmentKey === null || environmentKey === undefined) {
            throw new Error('Required parameter environmentKey was null or undefined when calling getStaleFlagsChart.');
        }
        ...
        if (maintainerId !== undefined) {
            localVarQueryParameters['maintainerId'] = ObjectSerializer.serialize(maintainerId, "string");
        }

        if (maintainerTeamKey !== undefined) {
            localVarQueryParameters['maintainerTeamKey'] = ObjectSerializer.serialize(maintainerTeamKey, "string");
        }
