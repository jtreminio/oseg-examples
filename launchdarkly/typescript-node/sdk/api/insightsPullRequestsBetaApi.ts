...
export enum InsightsPullRequestsBetaApiApiKeys {
    ApiKey,
}

export class InsightsPullRequestsBetaApi {
    ...
    public setApiKey(key: InsightsPullRequestsBetaApiApiKeys, value: string) {
        (this.authentications as any)[InsightsPullRequestsBetaApiApiKeys[key]].apiKey = value;
    }
     ...
     * @param environmentKey Required if you are using the &lt;code&gt;sort&lt;/code&gt; parameter\&#39;s &lt;code&gt;leadTime&lt;/code&gt; option to sort pull requests.
     * @param applicationKey Filter the results to pull requests deployed to a comma separated list of applications
     ...
     */
    public async getPullRequests (projectKey: string, environmentKey?: string, applicationKey?: string, status?: string, query?: string, limit?: number, expand?: string, sort?: string, from?: Date, to?: Date, after?: string, before?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PullRequestCollectionRep;  }> {
        const localVarPath = this.basePath + '/api/v2/engineering-insights/pull-requests';
        ...
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling getPullRequests.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PullRequestCollectionRep;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "PullRequestCollectionRep");
