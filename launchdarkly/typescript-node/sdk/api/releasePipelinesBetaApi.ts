...
export enum ReleasePipelinesBetaApiApiKeys {
    ApiKey,
}

export class ReleasePipelinesBetaApi {
    ...
    public setApiKey(key: ReleasePipelinesBetaApiApiKeys, value: string) {
        (this.authentications as any)[ReleasePipelinesBetaApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async deleteReleasePipeline (projectKey: string, pipelineKey: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/api/v2/projects/{projectKey}/release-pipelines/{pipelineKey}'
        ...
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling deleteReleasePipeline.');
        }

        // verify required parameter 'pipelineKey' is not null or undefined
        if (pipelineKey === null || pipelineKey === undefined) {
            throw new Error('Required parameter pipelineKey was null or undefined when calling deleteReleasePipeline.');
        }
     ...
     * @param offset Where to start in the list. Defaults to 0. Use this with pagination. For example, an offset of 10 skips the first ten items and then returns the next items in the list, up to the query &#x60;limit&#x60;.
     */
    public async getAllReleasePipelines (projectKey: string, filter?: string, limit?: number, offset?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ReleasePipelineCollection;  }> {
        const localVarPath = this.basePath + '/api/v2/projects/{projectKey}/release-pipelines'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling getAllReleasePipelines.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ReleasePipelineCollection;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "ReleasePipelineCollection");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     * @param offset Where to start in the list. Defaults to 0. Use this with pagination. For example, an offset of 10 skips the first ten items and then returns the next items in the list, up to the query &#x60;limit&#x60;.
     */
    public async getAllReleaseProgressionsForReleasePipeline (projectKey: string, pipelineKey: string, filter?: string, limit?: number, offset?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ReleaseProgressionCollection;  }> {
        const localVarPath = this.basePath + '/api/v2/projects/{projectKey}/release-pipelines/{pipelineKey}/releases'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'pipelineKey' + '}', encodeURIComponent(String(pipelineKey)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling getAllReleaseProgressionsForReleasePipeline.');
        }

        // verify required parameter 'pipelineKey' is not null or undefined
        if (pipelineKey === null || pipelineKey === undefined) {
            throw new Error('Required parameter pipelineKey was null or undefined when calling getAllReleaseProgressionsForReleasePipeline.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ReleaseProgressionCollection;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "ReleaseProgressionCollection");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     * @param pipelineKey The release pipeline key
     */
    public async getReleasePipelineByKey (projectKey: string, pipelineKey: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ReleasePipeline;  }> {
        const localVarPath = this.basePath + '/api/v2/projects/{projectKey}/release-pipelines/{pipelineKey}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'pipelineKey' + '}', encodeURIComponent(String(pipelineKey)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling getReleasePipelineByKey.');
        }

        // verify required parameter 'pipelineKey' is not null or undefined
        if (pipelineKey === null || pipelineKey === undefined) {
            throw new Error('Required parameter pipelineKey was null or undefined when calling getReleasePipelineByKey.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ReleasePipeline;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "ReleasePipeline");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     */
    public async postReleasePipeline (projectKey: string, createReleasePipelineInput: CreateReleasePipelineInput, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ReleasePipeline;  }> {
        const localVarPath = this.basePath + '/api/v2/projects/{projectKey}/release-pipelines'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling postReleasePipeline.');
        }

        // verify required parameter 'createReleasePipelineInput' is not null or undefined
        if (createReleasePipelineInput === null || createReleasePipelineInput === undefined) {
            throw new Error('Required parameter createReleasePipelineInput was null or undefined when calling postReleasePipeline.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(createReleasePipelineInput, "CreateReleasePipelineInput")
        };
     ...
     */
    public async putReleasePipeline (projectKey: string, pipelineKey: string, updateReleasePipelineInput: UpdateReleasePipelineInput, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ReleasePipeline;  }> {
        const localVarPath = this.basePath + '/api/v2/projects/{projectKey}/release-pipelines/{pipelineKey}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'pipelineKey' + '}', encodeURIComponent(String(pipelineKey)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling putReleasePipeline.');
        }

        // verify required parameter 'pipelineKey' is not null or undefined
        if (pipelineKey === null || pipelineKey === undefined) {
            throw new Error('Required parameter pipelineKey was null or undefined when calling putReleasePipeline.');
        }

        // verify required parameter 'updateReleasePipelineInput' is not null or undefined
        if (updateReleasePipelineInput === null || updateReleasePipelineInput === undefined) {
            throw new Error('Required parameter updateReleasePipelineInput was null or undefined when calling putReleasePipeline.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(updateReleasePipelineInput, "UpdateReleasePipelineInput")
        };
