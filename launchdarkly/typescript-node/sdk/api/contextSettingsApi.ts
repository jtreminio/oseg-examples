...
export enum ContextSettingsApiApiKeys {
    ApiKey,
}

export class ContextSettingsApi {
    ...
    public setApiKey(key: ContextSettingsApiApiKeys, value: string) {
        (this.authentications as any)[ContextSettingsApiApiKeys[key]].apiKey = value;
    }
     ...
     * @param valuePut 
     */
    public async putContextFlagSetting (projectKey: string, environmentKey: string, contextKind: string, contextKey: string, featureFlagKey: string, valuePut: ValuePut, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/api/v2/projects/{projectKey}/environments/{environmentKey}/contexts/{contextKind}/{contextKey}/flags/{featureFlagKey}'
        ...
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling putContextFlagSetting.');
        }

        // verify required parameter 'environmentKey' is not null or undefined
        if (environmentKey === null || environmentKey === undefined) {
            throw new Error('Required parameter environmentKey was null or undefined when calling putContextFlagSetting.');
        }

        // verify required parameter 'contextKind' is not null or undefined
        if (contextKind === null || contextKind === undefined) {
            throw new Error('Required parameter contextKind was null or undefined when calling putContextFlagSetting.');
        }

        // verify required parameter 'contextKey' is not null or undefined
        if (contextKey === null || contextKey === undefined) {
            throw new Error('Required parameter contextKey was null or undefined when calling putContextFlagSetting.');
        }

        // verify required parameter 'featureFlagKey' is not null or undefined
        if (featureFlagKey === null || featureFlagKey === undefined) {
            throw new Error('Required parameter featureFlagKey was null or undefined when calling putContextFlagSetting.');
        }

        // verify required parameter 'valuePut' is not null or undefined
        if (valuePut === null || valuePut === undefined) {
            throw new Error('Required parameter valuePut was null or undefined when calling putContextFlagSetting.');
        }
