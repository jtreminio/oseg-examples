...
export enum FeatureFlagsBetaApiApiKeys {
    ApiKey,
}

export class FeatureFlagsBetaApi {
    ...
    public setApiKey(key: FeatureFlagsBetaApiApiKeys, value: string) {
        (this.authentications as any)[FeatureFlagsBetaApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async getDependentFlags (projectKey: string, featureFlagKey: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: MultiEnvironmentDependentFlags;  }> {
        const localVarPath = this.basePath + '/api/v2/flags/{projectKey}/{featureFlagKey}/dependent-flags'
        ...
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling getDependentFlags.');
        }

        // verify required parameter 'featureFlagKey' is not null or undefined
        if (featureFlagKey === null || featureFlagKey === undefined) {
            throw new Error('Required parameter featureFlagKey was null or undefined when calling getDependentFlags.');
        }
     ...
     * @param featureFlagKey The feature flag key
     */
    public async getDependentFlagsByEnv (projectKey: string, environmentKey: string, featureFlagKey: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DependentFlagsByEnvironment;  }> {
        const localVarPath = this.basePath + '/api/v2/flags/{projectKey}/{environmentKey}/{featureFlagKey}/dependent-flags'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling getDependentFlagsByEnv.');
        }

        // verify required parameter 'environmentKey' is not null or undefined
        if (environmentKey === null || environmentKey === undefined) {
            throw new Error('Required parameter environmentKey was null or undefined when calling getDependentFlagsByEnv.');
        }

        // verify required parameter 'featureFlagKey' is not null or undefined
        if (featureFlagKey === null || featureFlagKey === undefined) {
            throw new Error('Required parameter featureFlagKey was null or undefined when calling getDependentFlagsByEnv.');
        }
