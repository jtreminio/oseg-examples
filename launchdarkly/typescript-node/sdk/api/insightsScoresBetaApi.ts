...
export enum InsightsScoresBetaApiApiKeys {
    ApiKey,
}

export class InsightsScoresBetaApi {
    ...
    public setApiKey(key: InsightsScoresBetaApiApiKeys, value: string) {
        (this.authentications as any)[InsightsScoresBetaApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async createInsightGroup (postInsightGroupParams: PostInsightGroupParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InsightGroup;  }> {
        const localVarPath = this.basePath + '/api/v2/engineering-insights/insights/group';
        ...
        if (postInsightGroupParams === null || postInsightGroupParams === undefined) {
            throw new Error('Required parameter postInsightGroupParams was null or undefined when calling createInsightGroup.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(postInsightGroupParams, "PostInsightGroupParams")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: InsightGroup;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "InsightGroup");
     ...
     */
    public async deleteInsightGroup (insightGroupKey: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/api/v2/engineering-insights/insights/groups/{insightGroupKey}'
        ...
        if (insightGroupKey === null || insightGroupKey === undefined) {
            throw new Error('Required parameter insightGroupKey was null or undefined when calling deleteInsightGroup.');
        }
     ...
     * @param insightGroupKey The insight group key
     * @param expand Options: &#x60;scores&#x60;, &#x60;environment&#x60;
     */
    public async getInsightGroup (insightGroupKey: string, expand?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InsightGroup;  }> {
        const localVarPath = this.basePath + '/api/v2/engineering-insights/insights/groups/{insightGroupKey}'
            .replace('{' + 'insightGroupKey' + '}', encodeURIComponent(String(insightGroupKey)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'insightGroupKey' is not null or undefined
        if (insightGroupKey === null || insightGroupKey === undefined) {
            throw new Error('Required parameter insightGroupKey was null or undefined when calling getInsightGroup.');
        }
     ...
     * @param limit The number of insight groups to return. Default is 20. Must be between 1 and 20 inclusive.
     ...
     * @param sort Sort flag list by field. Prefix field with &lt;code&gt;-&lt;/code&gt; to sort in descending order. Allowed fields: name
     * @param query Filter list of insights groups by name.
     * @param expand Options: &#x60;scores&#x60;, &#x60;environment&#x60;, &#x60;metadata&#x60;
     */
    public async getInsightGroups (limit?: number, offset?: number, sort?: string, query?: string, expand?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InsightGroupCollection;  }> {
        const localVarPath = this.basePath + '/api/v2/engineering-insights/insights/groups';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        // give precedence to 'application/json'
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: InsightGroupCollection;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "InsightGroupCollection");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     */
    public async getInsightsScores (projectKey: string, environmentKey: string, applicationKey?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InsightScores;  }> {
        const localVarPath = this.basePath + '/api/v2/engineering-insights/insights/scores';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        // give precedence to 'application/json'
        ...
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling getInsightsScores.');
        }

        // verify required parameter 'environmentKey' is not null or undefined
        if (environmentKey === null || environmentKey === undefined) {
            throw new Error('Required parameter environmentKey was null or undefined when calling getInsightsScores.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: InsightScores;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "InsightScores");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     */
    public async patchInsightGroup (insightGroupKey: string, patchOperation: Array<PatchOperation>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InsightGroup;  }> {
        const localVarPath = this.basePath + '/api/v2/engineering-insights/insights/groups/{insightGroupKey}'
            .replace('{' + 'insightGroupKey' + '}', encodeURIComponent(String(insightGroupKey)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'insightGroupKey' is not null or undefined
        if (insightGroupKey === null || insightGroupKey === undefined) {
            throw new Error('Required parameter insightGroupKey was null or undefined when calling patchInsightGroup.');
        }

        // verify required parameter 'patchOperation' is not null or undefined
        if (patchOperation === null || patchOperation === undefined) {
            throw new Error('Required parameter patchOperation was null or undefined when calling patchInsightGroup.');
        }
