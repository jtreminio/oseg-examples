...
export enum InsightsDeploymentsBetaApiApiKeys {
    ApiKey,
}

export class InsightsDeploymentsBetaApi {
    ...
    public setApiKey(key: InsightsDeploymentsBetaApiApiKeys, value: string) {
        (this.authentications as any)[InsightsDeploymentsBetaApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async createDeploymentEvent (postDeploymentEventInput: PostDeploymentEventInput, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/api/v2/engineering-insights/deployment-events';
        ...
        if (postDeploymentEventInput === null || postDeploymentEventInput === undefined) {
            throw new Error('Required parameter postDeploymentEventInput was null or undefined when calling createDeploymentEvent.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(postDeploymentEventInput, "PostDeploymentEventInput")
        };
     ...
     * @param expand Expand properties in response. Options: &#x60;pullRequests&#x60;, &#x60;flagReferences&#x60;
     */
    public async getDeployment (deploymentID: string, expand?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeploymentRep;  }> {
        const localVarPath = this.basePath + '/api/v2/engineering-insights/deployments/{deploymentID}'
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: DeploymentRep;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "DeploymentRep");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     * @param limit The number of deployments to return. Default is 20. Maximum allowed is 100.
     * @param expand Expand properties in response. Options: &#x60;pullRequests&#x60;, &#x60;flagReferences&#x60;
     ...
     * @param after Identifier used for pagination
     * @param before Identifier used for pagination
     * @param kind The deployment kind
     * @param status The deployment status
     */
    public async getDeployments (projectKey: string, environmentKey: string, applicationKey?: string, limit?: number, expand?: string, from?: number, to?: number, after?: string, before?: string, kind?: string, status?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeploymentCollectionRep;  }> {
        const localVarPath = this.basePath + '/api/v2/engineering-insights/deployments';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        // give precedence to 'application/json'
        ...
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling getDeployments.');
        }

        // verify required parameter 'environmentKey' is not null or undefined
        if (environmentKey === null || environmentKey === undefined) {
            throw new Error('Required parameter environmentKey was null or undefined when calling getDeployments.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: DeploymentCollectionRep;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "DeploymentCollectionRep");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     */
    public async updateDeployment (deploymentID: string, patchOperation: Array<PatchOperation>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeploymentRep;  }> {
        const localVarPath = this.basePath + '/api/v2/engineering-insights/deployments/{deploymentID}'
            .replace('{' + 'deploymentID' + '}', encodeURIComponent(String(deploymentID)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'deploymentID' is not null or undefined
        if (deploymentID === null || deploymentID === undefined) {
            throw new Error('Required parameter deploymentID was null or undefined when calling updateDeployment.');
        }

        // verify required parameter 'patchOperation' is not null or undefined
        if (patchOperation === null || patchOperation === undefined) {
            throw new Error('Required parameter patchOperation was null or undefined when calling updateDeployment.');
        }
