...
export enum FlagLinksBetaApiApiKeys {
    ApiKey,
}

export class FlagLinksBetaApi {
    ...
    public setApiKey(key: FlagLinksBetaApiApiKeys, value: string) {
        (this.authentications as any)[FlagLinksBetaApiApiKeys[key]].apiKey = value;
    }
     ...
     * @param flagLinkPost 
     */
    public async createFlagLink (projectKey: string, featureFlagKey: string, flagLinkPost: FlagLinkPost, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FlagLinkRep;  }> {
        const localVarPath = this.basePath + '/api/v2/flag-links/projects/{projectKey}/flags/{featureFlagKey}'
        ...
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling createFlagLink.');
        }

        // verify required parameter 'featureFlagKey' is not null or undefined
        if (featureFlagKey === null || featureFlagKey === undefined) {
            throw new Error('Required parameter featureFlagKey was null or undefined when calling createFlagLink.');
        }

        // verify required parameter 'flagLinkPost' is not null or undefined
        if (flagLinkPost === null || flagLinkPost === undefined) {
            throw new Error('Required parameter flagLinkPost was null or undefined when calling createFlagLink.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(flagLinkPost, "FlagLinkPost")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: FlagLinkRep;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "FlagLinkRep");
     ...
     */
    public async deleteFlagLink (projectKey: string, featureFlagKey: string, id: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/api/v2/flag-links/projects/{projectKey}/flags/{featureFlagKey}/{id}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'featureFlagKey' + '}', encodeURIComponent(String(featureFlagKey)))
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling deleteFlagLink.');
        }

        // verify required parameter 'featureFlagKey' is not null or undefined
        if (featureFlagKey === null || featureFlagKey === undefined) {
            throw new Error('Required parameter featureFlagKey was null or undefined when calling deleteFlagLink.');
        }

        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling deleteFlagLink.');
        }
     ...
     * @param featureFlagKey The feature flag key
     */
    public async getFlagLinks (projectKey: string, featureFlagKey: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FlagLinkCollectionRep;  }> {
        const localVarPath = this.basePath + '/api/v2/flag-links/projects/{projectKey}/flags/{featureFlagKey}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'featureFlagKey' + '}', encodeURIComponent(String(featureFlagKey)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling getFlagLinks.');
        }

        // verify required parameter 'featureFlagKey' is not null or undefined
        if (featureFlagKey === null || featureFlagKey === undefined) {
            throw new Error('Required parameter featureFlagKey was null or undefined when calling getFlagLinks.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: FlagLinkCollectionRep;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "FlagLinkCollectionRep");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     */
    public async updateFlagLink (projectKey: string, featureFlagKey: string, id: string, patchOperation: Array<PatchOperation>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FlagLinkRep;  }> {
        const localVarPath = this.basePath + '/api/v2/flag-links/projects/{projectKey}/flags/{featureFlagKey}/{id}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'featureFlagKey' + '}', encodeURIComponent(String(featureFlagKey)))
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling updateFlagLink.');
        }

        // verify required parameter 'featureFlagKey' is not null or undefined
        if (featureFlagKey === null || featureFlagKey === undefined) {
            throw new Error('Required parameter featureFlagKey was null or undefined when calling updateFlagLink.');
        }

        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling updateFlagLink.');
        }

        // verify required parameter 'patchOperation' is not null or undefined
        if (patchOperation === null || patchOperation === undefined) {
            throw new Error('Required parameter patchOperation was null or undefined when calling updateFlagLink.');
        }
