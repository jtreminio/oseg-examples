...
export class LayersApi {
    ...
    public setApiKey(key: LayersApiApiKeys, value: string) {
        (this.authentications as any)[LayersApiApiKeys[key]].apiKey = value;
    }
     ...
     * @param layerPost 
     */
    public async createLayer (projectKey: string, layerPost: LayerPost, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: LayerRep;  }> {
        const localVarPath = this.basePath + '/api/v2/projects/{projectKey}/layers'
        ...
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling createLayer.');
        }

        // verify required parameter 'layerPost' is not null or undefined
        if (layerPost === null || layerPost === undefined) {
            throw new Error('Required parameter layerPost was null or undefined when calling createLayer.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(layerPost, "LayerPost")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: LayerRep;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "LayerRep");
     ...
     * @summary Get layers
     * @param projectKey The project key
     * @param filter A comma-separated list of filters. This endpoint only accepts filtering by &#x60;experimentKey&#x60;. The filter returns layers which include that experiment for the selected environment(s). For example: &#x60;filter&#x3D;reservations.experimentKey contains expKey&#x60;.
     */
    public async getLayers (projectKey: string, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: LayerCollectionRep;  }> {
        const localVarPath = this.basePath + '/api/v2/projects/{projectKey}/layers'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling getLayers.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: LayerCollectionRep;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "LayerCollectionRep");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     */
    public async updateLayer (projectKey: string, layerKey: string, layerPatchInput: LayerPatchInput, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: LayerRep;  }> {
        const localVarPath = this.basePath + '/api/v2/projects/{projectKey}/layers/{layerKey}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'layerKey' + '}', encodeURIComponent(String(layerKey)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        // give precedence to 'application/json'
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling updateLayer.');
        }

        // verify required parameter 'layerKey' is not null or undefined
        if (layerKey === null || layerKey === undefined) {
            throw new Error('Required parameter layerKey was null or undefined when calling updateLayer.');
        }

        // verify required parameter 'layerPatchInput' is not null or undefined
        if (layerPatchInput === null || layerPatchInput === undefined) {
            throw new Error('Required parameter layerPatchInput was null or undefined when calling updateLayer.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(layerPatchInput, "LayerPatchInput")
        };
