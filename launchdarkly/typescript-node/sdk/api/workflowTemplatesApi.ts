...
export enum WorkflowTemplatesApiApiKeys {
    ApiKey,
}
...
export class WorkflowTemplatesApi {
    ...
    public setApiKey(key: WorkflowTemplatesApiApiKeys, value: string) {
        (this.authentications as any)[WorkflowTemplatesApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async createWorkflowTemplate (createWorkflowTemplateInput: CreateWorkflowTemplateInput, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WorkflowTemplateOutput;  }> {
        const localVarPath = this.basePath + '/api/v2/templates';
        ...
        if (createWorkflowTemplateInput === null || createWorkflowTemplateInput === undefined) {
            throw new Error('Required parameter createWorkflowTemplateInput was null or undefined when calling createWorkflowTemplate.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(createWorkflowTemplateInput, "CreateWorkflowTemplateInput")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: WorkflowTemplateOutput;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "WorkflowTemplateOutput");
     ...
     */
    public async deleteWorkflowTemplate (templateKey: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/api/v2/templates/{templateKey}'
        ...
        if (templateKey === null || templateKey === undefined) {
            throw new Error('Required parameter templateKey was null or undefined when calling deleteWorkflowTemplate.');
        }
     ...
     * @param summary Whether the entire template object or just a summary should be returned
     * @param search The substring in either the name or description of a template
     */
    public async getWorkflowTemplates (summary?: boolean, search?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WorkflowTemplatesListingOutputRep;  }> {
        const localVarPath = this.basePath + '/api/v2/templates';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: WorkflowTemplatesListingOutputRep;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "WorkflowTemplatesListingOutputRep");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
