...
export enum OAuth2ClientsApiApiKeys {
    ApiKey,
}
...
export class OAuth2ClientsApi {
    ...
    public setApiKey(key: OAuth2ClientsApiApiKeys, value: string) {
        (this.authentications as any)[OAuth2ClientsApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async createOAuth2Client (oauthClientPost: OauthClientPost, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Client;  }> {
        const localVarPath = this.basePath + '/api/v2/oauth/clients';
        ...
        if (oauthClientPost === null || oauthClientPost === undefined) {
            throw new Error('Required parameter oauthClientPost was null or undefined when calling createOAuth2Client.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(oauthClientPost, "OauthClientPost")
        };
     ...
     */
    public async deleteOAuthClient (clientId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/api/v2/oauth/clients/{clientId}'
        ...
        if (clientId === null || clientId === undefined) {
            throw new Error('Required parameter clientId was null or undefined when calling deleteOAuthClient.');
        }
     ...
     * @param clientId The client ID
     */
    public async getOAuthClientById (clientId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Client;  }> {
        const localVarPath = this.basePath + '/api/v2/oauth/clients/{clientId}'
            .replace('{' + 'clientId' + '}', encodeURIComponent(String(clientId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'clientId' is not null or undefined
        if (clientId === null || clientId === undefined) {
            throw new Error('Required parameter clientId was null or undefined when calling getOAuthClientById.');
        }
     ...
     * @summary Get clients
     */
    public async getOAuthClients (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ClientCollection;  }> {
        const localVarPath = this.basePath + '/api/v2/oauth/clients';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ClientCollection;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "ClientCollection");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     */
    public async patchOAuthClient (clientId: string, patchOperation: Array<PatchOperation>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Client;  }> {
        const localVarPath = this.basePath + '/api/v2/oauth/clients/{clientId}'
            .replace('{' + 'clientId' + '}', encodeURIComponent(String(clientId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'clientId' is not null or undefined
        if (clientId === null || clientId === undefined) {
            throw new Error('Required parameter clientId was null or undefined when calling patchOAuthClient.');
        }

        // verify required parameter 'patchOperation' is not null or undefined
        if (patchOperation === null || patchOperation === undefined) {
            throw new Error('Required parameter patchOperation was null or undefined when calling patchOAuthClient.');
        }
