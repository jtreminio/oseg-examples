...
export enum AccountMembersApiApiKeys {
    ApiKey,
}
...
export class AccountMembersApi {
    ...
    public setApiKey(key: AccountMembersApiApiKeys, value: string) {
        (this.authentications as any)[AccountMembersApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async deleteMember (id: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/api/v2/members/{id}'
     ...
     */
    public async getMember (id: string, expand?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Member;  }> {
        const localVarPath = this.basePath + '/api/v2/members/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     * @param limit The number of members to return in the response. Defaults to 20.
     ...
     */
    public async getMembers (limit?: number, offset?: number, filter?: string, expand?: string, sort?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Members;  }> {
        const localVarPath = this.basePath + '/api/v2/members';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        // give precedence to 'application/json'
     ...
     */
    public async patchMember (id: string, patchOperation: Array<PatchOperation>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Member;  }> {
        const localVarPath = this.basePath + '/api/v2/members/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling patchMember.');
        }

        // verify required parameter 'patchOperation' is not null or undefined
        if (patchOperation === null || patchOperation === undefined) {
            throw new Error('Required parameter patchOperation was null or undefined when calling patchMember.');
        }
     ...
     */
    public async postMemberTeams (id: string, memberTeamsPostInput: MemberTeamsPostInput, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Member;  }> {
        const localVarPath = this.basePath + '/api/v2/members/{id}/teams'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling postMemberTeams.');
        }

        // verify required parameter 'memberTeamsPostInput' is not null or undefined
        if (memberTeamsPostInput === null || memberTeamsPostInput === undefined) {
            throw new Error('Required parameter memberTeamsPostInput was null or undefined when calling postMemberTeams.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(memberTeamsPostInput, "MemberTeamsPostInput")
        };
     ...
     * @param newMemberForm 
     */
    public async postMembers (newMemberForm: Array<NewMemberForm>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Members;  }> {
        const localVarPath = this.basePath + '/api/v2/members';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        if (newMemberForm === null || newMemberForm === undefined) {
            throw new Error('Required parameter newMemberForm was null or undefined when calling postMembers.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(newMemberForm, "Array<NewMemberForm>")
        };
