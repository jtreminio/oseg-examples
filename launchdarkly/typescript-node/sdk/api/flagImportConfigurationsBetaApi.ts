...
export enum FlagImportConfigurationsBetaApiApiKeys {
    ApiKey,
}

export class FlagImportConfigurationsBetaApi {
    ...
    public setApiKey(key: FlagImportConfigurationsBetaApiApiKeys, value: string) {
        (this.authentications as any)[FlagImportConfigurationsBetaApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async createFlagImportConfiguration (projectKey: string, integrationKey: string, flagImportConfigurationPost: FlagImportConfigurationPost, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FlagImportIntegration;  }> {
        const localVarPath = this.basePath + '/api/v2/integration-capabilities/flag-import/{projectKey}/{integrationKey}'
        ...
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling createFlagImportConfiguration.');
        }

        // verify required parameter 'integrationKey' is not null or undefined
        if (integrationKey === null || integrationKey === undefined) {
            throw new Error('Required parameter integrationKey was null or undefined when calling createFlagImportConfiguration.');
        }

        // verify required parameter 'flagImportConfigurationPost' is not null or undefined
        if (flagImportConfigurationPost === null || flagImportConfigurationPost === undefined) {
            throw new Error('Required parameter flagImportConfigurationPost was null or undefined when calling createFlagImportConfiguration.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(flagImportConfigurationPost, "FlagImportConfigurationPost")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: FlagImportIntegration;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "FlagImportIntegration");
     ...
     */
    public async deleteFlagImportConfiguration (projectKey: string, integrationKey: string, integrationId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/api/v2/integration-capabilities/flag-import/{projectKey}/{integrationKey}/{integrationId}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'integrationKey' + '}', encodeURIComponent(String(integrationKey)))
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling deleteFlagImportConfiguration.');
        }

        // verify required parameter 'integrationKey' is not null or undefined
        if (integrationKey === null || integrationKey === undefined) {
            throw new Error('Required parameter integrationKey was null or undefined when calling deleteFlagImportConfiguration.');
        }

        // verify required parameter 'integrationId' is not null or undefined
        if (integrationId === null || integrationId === undefined) {
            throw new Error('Required parameter integrationId was null or undefined when calling deleteFlagImportConfiguration.');
        }
     ...
     * @param integrationId The integration ID
     */
    public async getFlagImportConfiguration (projectKey: string, integrationKey: string, integrationId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FlagImportIntegration;  }> {
        const localVarPath = this.basePath + '/api/v2/integration-capabilities/flag-import/{projectKey}/{integrationKey}/{integrationId}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'integrationKey' + '}', encodeURIComponent(String(integrationKey)))
            .replace('{' + 'integrationId' + '}', encodeURIComponent(String(integrationId)));
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling getFlagImportConfiguration.');
        }

        // verify required parameter 'integrationKey' is not null or undefined
        if (integrationKey === null || integrationKey === undefined) {
            throw new Error('Required parameter integrationKey was null or undefined when calling getFlagImportConfiguration.');
        }

        // verify required parameter 'integrationId' is not null or undefined
        if (integrationId === null || integrationId === undefined) {
            throw new Error('Required parameter integrationId was null or undefined when calling getFlagImportConfiguration.');
        }
     ...
     */
    public async getFlagImportConfigurations (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FlagImportIntegrationCollection;  }> {
        const localVarPath = this.basePath + '/api/v2/integration-capabilities/flag-import';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        // give precedence to 'application/json'
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: FlagImportIntegrationCollection;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "FlagImportIntegrationCollection");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     */
    public async patchFlagImportConfiguration (projectKey: string, integrationKey: string, integrationId: string, patchOperation: Array<PatchOperation>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FlagImportIntegration;  }> {
        const localVarPath = this.basePath + '/api/v2/integration-capabilities/flag-import/{projectKey}/{integrationKey}/{integrationId}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'integrationKey' + '}', encodeURIComponent(String(integrationKey)))
            .replace('{' + 'integrationId' + '}', encodeURIComponent(String(integrationId)));
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling patchFlagImportConfiguration.');
        }

        // verify required parameter 'integrationKey' is not null or undefined
        if (integrationKey === null || integrationKey === undefined) {
            throw new Error('Required parameter integrationKey was null or undefined when calling patchFlagImportConfiguration.');
        }

        // verify required parameter 'integrationId' is not null or undefined
        if (integrationId === null || integrationId === undefined) {
            throw new Error('Required parameter integrationId was null or undefined when calling patchFlagImportConfiguration.');
        }

        // verify required parameter 'patchOperation' is not null or undefined
        if (patchOperation === null || patchOperation === undefined) {
            throw new Error('Required parameter patchOperation was null or undefined when calling patchFlagImportConfiguration.');
        }
     ...
     * @param integrationId The integration ID
     */
    public async triggerFlagImportJob (projectKey: string, integrationKey: string, integrationId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/api/v2/integration-capabilities/flag-import/{projectKey}/{integrationKey}/{integrationId}/trigger'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'integrationKey' + '}', encodeURIComponent(String(integrationKey)))
            .replace('{' + 'integrationId' + '}', encodeURIComponent(String(integrationId)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling triggerFlagImportJob.');
        }

        // verify required parameter 'integrationKey' is not null or undefined
        if (integrationKey === null || integrationKey === undefined) {
            throw new Error('Required parameter integrationKey was null or undefined when calling triggerFlagImportJob.');
        }

        // verify required parameter 'integrationId' is not null or undefined
        if (integrationId === null || integrationId === undefined) {
            throw new Error('Required parameter integrationId was null or undefined when calling triggerFlagImportJob.');
        }
