...
export enum InsightsFlagEventsBetaApiApiKeys {
    ApiKey,
}

export class InsightsFlagEventsBetaApi {
    ...
    public setApiKey(key: InsightsFlagEventsBetaApiApiKeys, value: string) {
        (this.authentications as any)[InsightsFlagEventsBetaApiApiKeys[key]].apiKey = value;
    }
     ...
     * @param impactSize Filter events by impact size. A small impact created a less than 20% change in the proportion of end users receiving one or more flag variations. A medium impact created between a 20%-80% change. A large impact created a more than 80% change. Options: &#x60;none&#x60;, &#x60;small&#x60;, &#x60;medium&#x60;, &#x60;large&#x60;
     ...
     */
    public async getFlagEvents (projectKey: string, environmentKey: string, applicationKey?: string, query?: string, impactSize?: string, hasExperiments?: boolean, global?: string, expand?: string, limit?: number, from?: number, to?: number, after?: string, before?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FlagEventCollectionRep;  }> {
        const localVarPath = this.basePath + '/api/v2/engineering-insights/flag-events';
        ...
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling getFlagEvents.');
        }

        // verify required parameter 'environmentKey' is not null or undefined
        if (environmentKey === null || environmentKey === undefined) {
            throw new Error('Required parameter environmentKey was null or undefined when calling getFlagEvents.');
        }
        ...
        if (impactSize !== undefined) {
            localVarQueryParameters['impactSize'] = ObjectSerializer.serialize(impactSize, "string");
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: FlagEventCollectionRep;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "FlagEventCollectionRep");
