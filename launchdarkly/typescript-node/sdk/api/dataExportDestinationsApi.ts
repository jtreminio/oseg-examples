...
export class DataExportDestinationsApi {
     ...
     */
    public async deleteDestination (projectKey: string, environmentKey: string, id: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/api/v2/destinations/{projectKey}/{environmentKey}/{id}'
        ...
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling deleteDestination.');
        }
     ...
     * @param id The Data Export destination ID
     */
    public async getDestination (projectKey: string, environmentKey: string, id: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Destination;  }> {
        const localVarPath = this.basePath + '/api/v2/destinations/{projectKey}/{environmentKey}/{id}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'environmentKey' + '}', encodeURIComponent(String(environmentKey)))
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling getDestination.');
        }
     ...
     */
    public async getDestinations (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Destinations;  }> {
        const localVarPath = this.basePath + '/api/v2/destinations';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        // give precedence to 'application/json'
     ...
     */
    public async patchDestination (projectKey: string, environmentKey: string, id: string, patchOperation: Array<PatchOperation>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Destination;  }> {
        const localVarPath = this.basePath + '/api/v2/destinations/{projectKey}/{environmentKey}/{id}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'environmentKey' + '}', encodeURIComponent(String(environmentKey)))
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling patchDestination.');
        }

        // verify required parameter 'patchOperation' is not null or undefined
        if (patchOperation === null || patchOperation === undefined) {
            throw new Error('Required parameter patchOperation was null or undefined when calling patchDestination.');
        }
     ...
     */
    public async postDestination (projectKey: string, environmentKey: string, destinationPost: DestinationPost, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Destination;  }> {
        const localVarPath = this.basePath + '/api/v2/destinations/{projectKey}/{environmentKey}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'environmentKey' + '}', encodeURIComponent(String(environmentKey)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        if (destinationPost === null || destinationPost === undefined) {
            throw new Error('Required parameter destinationPost was null or undefined when calling postDestination.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(destinationPost, "DestinationPost")
        };
