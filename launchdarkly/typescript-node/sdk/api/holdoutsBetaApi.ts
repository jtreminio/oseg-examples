...
export enum HoldoutsBetaApiApiKeys {
    ApiKey,
}

export class HoldoutsBetaApi {
    ...
    public setApiKey(key: HoldoutsBetaApiApiKeys, value: string) {
        (this.authentications as any)[HoldoutsBetaApiApiKeys[key]].apiKey = value;
    }
     ...
     * @param limit The number of holdouts to return in the response. Defaults to 20
     ...
     */
    public async getAllHoldouts (projectKey: string, environmentKey: string, limit?: number, offset?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: HoldoutsCollectionRep;  }> {
        const localVarPath = this.basePath + '/api/v2/projects/{projectKey}/environments/{environmentKey}/holdouts'
        ...
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling getAllHoldouts.');
        }

        // verify required parameter 'environmentKey' is not null or undefined
        if (environmentKey === null || environmentKey === undefined) {
            throw new Error('Required parameter environmentKey was null or undefined when calling getAllHoldouts.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: HoldoutsCollectionRep;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "HoldoutsCollectionRep");
     ...
     * @param expand A comma-separated list of properties that can reveal additional information in the response. Supported fields are explained above. Holdout experiment expansion fields have no prefix. Related experiment expansion fields have &#x60;rel-&#x60; as a prefix.
     */
    public async getHoldout (projectKey: string, environmentKey: string, holdoutKey: string, expand?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: HoldoutDetailRep;  }> {
        const localVarPath = this.basePath + '/api/v2/projects/{projectKey}/environments/{environmentKey}/holdouts/{holdoutKey}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'environmentKey' + '}', encodeURIComponent(String(environmentKey)))
            .replace('{' + 'holdoutKey' + '}', encodeURIComponent(String(holdoutKey)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        // give precedence to 'application/json'
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling getHoldout.');
        }

        // verify required parameter 'environmentKey' is not null or undefined
        if (environmentKey === null || environmentKey === undefined) {
            throw new Error('Required parameter environmentKey was null or undefined when calling getHoldout.');
        }

        // verify required parameter 'holdoutKey' is not null or undefined
        if (holdoutKey === null || holdoutKey === undefined) {
            throw new Error('Required parameter holdoutKey was null or undefined when calling getHoldout.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: HoldoutDetailRep;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "HoldoutDetailRep");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     */
    public async getHoldoutById (projectKey: string, environmentKey: string, holdoutId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: HoldoutRep;  }> {
        const localVarPath = this.basePath + '/api/v2/projects/{projectKey}/environments/{environmentKey}/holdouts/id/{holdoutId}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'environmentKey' + '}', encodeURIComponent(String(environmentKey)))
            .replace('{' + 'holdoutId' + '}', encodeURIComponent(String(holdoutId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        // give precedence to 'application/json'
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling getHoldoutById.');
        }

        // verify required parameter 'environmentKey' is not null or undefined
        if (environmentKey === null || environmentKey === undefined) {
            throw new Error('Required parameter environmentKey was null or undefined when calling getHoldoutById.');
        }

        // verify required parameter 'holdoutId' is not null or undefined
        if (holdoutId === null || holdoutId === undefined) {
            throw new Error('Required parameter holdoutId was null or undefined when calling getHoldoutById.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: HoldoutRep;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "HoldoutRep");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     */
    public async patchHoldout (projectKey: string, environmentKey: string, holdoutKey: string, holdoutPatchInput: HoldoutPatchInput, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: HoldoutRep;  }> {
        const localVarPath = this.basePath + '/api/v2/projects/{projectKey}/environments/{environmentKey}/holdouts/{holdoutKey}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'environmentKey' + '}', encodeURIComponent(String(environmentKey)))
            .replace('{' + 'holdoutKey' + '}', encodeURIComponent(String(holdoutKey)));
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling patchHoldout.');
        }

        // verify required parameter 'environmentKey' is not null or undefined
        if (environmentKey === null || environmentKey === undefined) {
            throw new Error('Required parameter environmentKey was null or undefined when calling patchHoldout.');
        }

        // verify required parameter 'holdoutKey' is not null or undefined
        if (holdoutKey === null || holdoutKey === undefined) {
            throw new Error('Required parameter holdoutKey was null or undefined when calling patchHoldout.');
        }

        // verify required parameter 'holdoutPatchInput' is not null or undefined
        if (holdoutPatchInput === null || holdoutPatchInput === undefined) {
            throw new Error('Required parameter holdoutPatchInput was null or undefined when calling patchHoldout.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(holdoutPatchInput, "HoldoutPatchInput")
        };
     ...
     */
    public async postHoldout (projectKey: string, environmentKey: string, holdoutPostRequest: HoldoutPostRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: HoldoutRep;  }> {
        const localVarPath = this.basePath + '/api/v2/projects/{projectKey}/environments/{environmentKey}/holdouts'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'environmentKey' + '}', encodeURIComponent(String(environmentKey)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling postHoldout.');
        }

        // verify required parameter 'environmentKey' is not null or undefined
        if (environmentKey === null || environmentKey === undefined) {
            throw new Error('Required parameter environmentKey was null or undefined when calling postHoldout.');
        }

        // verify required parameter 'holdoutPostRequest' is not null or undefined
        if (holdoutPostRequest === null || holdoutPostRequest === undefined) {
            throw new Error('Required parameter holdoutPostRequest was null or undefined when calling postHoldout.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(holdoutPostRequest, "HoldoutPostRequest")
        };
