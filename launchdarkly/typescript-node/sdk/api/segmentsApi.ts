...
let defaultBasePath = 'https://app.launchdarkly.com';
...
export class SegmentsApi {
     ...
     */
    public async createBigSegmentExport (projectKey: string, environmentKey: string, segmentKey: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/api/v2/segments/{projectKey}/{environmentKey}/{segmentKey}/exports'
        ...
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling createBigSegmentExport.');
        }

        // verify required parameter 'environmentKey' is not null or undefined
        if (environmentKey === null || environmentKey === undefined) {
            throw new Error('Required parameter environmentKey was null or undefined when calling createBigSegmentExport.');
        }

        // verify required parameter 'segmentKey' is not null or undefined
        if (segmentKey === null || segmentKey === undefined) {
            throw new Error('Required parameter segmentKey was null or undefined when calling createBigSegmentExport.');
        }
     ...
     * @param waitOnApprovals Whether to wait for approvals before processing the import
     */
    public async createBigSegmentImport (projectKey: string, environmentKey: string, segmentKey: string, file?: RequestFile, mode?: string, waitOnApprovals?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/api/v2/segments/{projectKey}/{environmentKey}/{segmentKey}/imports'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'environmentKey' + '}', encodeURIComponent(String(environmentKey)))
            .replace('{' + 'segmentKey' + '}', encodeURIComponent(String(segmentKey)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling createBigSegmentImport.');
        }

        // verify required parameter 'environmentKey' is not null or undefined
        if (environmentKey === null || environmentKey === undefined) {
            throw new Error('Required parameter environmentKey was null or undefined when calling createBigSegmentImport.');
        }

        // verify required parameter 'segmentKey' is not null or undefined
        if (segmentKey === null || segmentKey === undefined) {
            throw new Error('Required parameter segmentKey was null or undefined when calling createBigSegmentImport.');
        }
        ...
        if (waitOnApprovals !== undefined) {
            localVarFormParams['waitOnApprovals'] = ObjectSerializer.serialize(waitOnApprovals, "boolean");
        }
     ...
     * @param segmentKey The segment key
     */
    public async deleteSegment (projectKey: string, environmentKey: string, segmentKey: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/api/v2/segments/{projectKey}/{environmentKey}/{segmentKey}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'environmentKey' + '}', encodeURIComponent(String(environmentKey)))
            .replace('{' + 'segmentKey' + '}', encodeURIComponent(String(segmentKey)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling deleteSegment.');
        }

        // verify required parameter 'environmentKey' is not null or undefined
        if (environmentKey === null || environmentKey === undefined) {
            throw new Error('Required parameter environmentKey was null or undefined when calling deleteSegment.');
        }

        // verify required parameter 'segmentKey' is not null or undefined
        if (segmentKey === null || segmentKey === undefined) {
            throw new Error('Required parameter segmentKey was null or undefined when calling deleteSegment.');
        }
     ...
     */
    public async getBigSegmentExport (projectKey: string, environmentKey: string, segmentKey: string, exportID: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Export;  }> {
        const localVarPath = this.basePath + '/api/v2/segments/{projectKey}/{environmentKey}/{segmentKey}/exports/{exportID}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'environmentKey' + '}', encodeURIComponent(String(environmentKey)))
            .replace('{' + 'segmentKey' + '}', encodeURIComponent(String(segmentKey)))
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling getBigSegmentExport.');
        }

        // verify required parameter 'environmentKey' is not null or undefined
        if (environmentKey === null || environmentKey === undefined) {
            throw new Error('Required parameter environmentKey was null or undefined when calling getBigSegmentExport.');
        }

        // verify required parameter 'segmentKey' is not null or undefined
        if (segmentKey === null || segmentKey === undefined) {
            throw new Error('Required parameter segmentKey was null or undefined when calling getBigSegmentExport.');
        }

        // verify required parameter 'exportID' is not null or undefined
        if (exportID === null || exportID === undefined) {
            throw new Error('Required parameter exportID was null or undefined when calling getBigSegmentExport.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: Export;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "Export");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     */
    public async getBigSegmentImport (projectKey: string, environmentKey: string, segmentKey: string, importID: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Import;  }> {
        const localVarPath = this.basePath + '/api/v2/segments/{projectKey}/{environmentKey}/{segmentKey}/imports/{importID}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'environmentKey' + '}', encodeURIComponent(String(environmentKey)))
            .replace('{' + 'segmentKey' + '}', encodeURIComponent(String(segmentKey)))
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling getBigSegmentImport.');
        }

        // verify required parameter 'environmentKey' is not null or undefined
        if (environmentKey === null || environmentKey === undefined) {
            throw new Error('Required parameter environmentKey was null or undefined when calling getBigSegmentImport.');
        }

        // verify required parameter 'segmentKey' is not null or undefined
        if (segmentKey === null || segmentKey === undefined) {
            throw new Error('Required parameter segmentKey was null or undefined when calling getBigSegmentImport.');
        }

        // verify required parameter 'importID' is not null or undefined
        if (importID === null || importID === undefined) {
            throw new Error('Required parameter importID was null or undefined when calling getBigSegmentImport.');
        }
     ...
     * @param requestBody 
     */
    public async getContextInstanceSegmentsMembershipByEnv (projectKey: string, environmentKey: string, requestBody: { [key: string]: any; }, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ContextInstanceSegmentMemberships;  }> {
        const localVarPath = this.basePath + '/api/v2/projects/{projectKey}/environments/{environmentKey}/segments/evaluate'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'environmentKey' + '}', encodeURIComponent(String(environmentKey)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling getContextInstanceSegmentsMembershipByEnv.');
        }

        // verify required parameter 'environmentKey' is not null or undefined
        if (environmentKey === null || environmentKey === undefined) {
            throw new Error('Required parameter environmentKey was null or undefined when calling getContextInstanceSegmentsMembershipByEnv.');
        }

        // verify required parameter 'requestBody' is not null or undefined
        if (requestBody === null || requestBody === undefined) {
            throw new Error('Required parameter requestBody was null or undefined when calling getContextInstanceSegmentsMembershipByEnv.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ContextInstanceSegmentMemberships;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "ContextInstanceSegmentMemberships");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     * @param segmentKey The segment key
     */
    public async getExpiringTargetsForSegment (projectKey: string, environmentKey: string, segmentKey: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ExpiringTargetGetResponse;  }> {
        const localVarPath = this.basePath + '/api/v2/segments/{projectKey}/{segmentKey}/expiring-targets/{environmentKey}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'environmentKey' + '}', encodeURIComponent(String(environmentKey)))
            .replace('{' + 'segmentKey' + '}', encodeURIComponent(String(segmentKey)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling getExpiringTargetsForSegment.');
        }

        // verify required parameter 'environmentKey' is not null or undefined
        if (environmentKey === null || environmentKey === undefined) {
            throw new Error('Required parameter environmentKey was null or undefined when calling getExpiringTargetsForSegment.');
        }

        // verify required parameter 'segmentKey' is not null or undefined
        if (segmentKey === null || segmentKey === undefined) {
            throw new Error('Required parameter segmentKey was null or undefined when calling getExpiringTargetsForSegment.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ExpiringTargetGetResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "ExpiringTargetGetResponse");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     * @param segmentKey The segment key
     */
    public async getExpiringUserTargetsForSegment (projectKey: string, environmentKey: string, segmentKey: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ExpiringUserTargetGetResponse;  }> {
        const localVarPath = this.basePath + '/api/v2/segments/{projectKey}/{segmentKey}/expiring-user-targets/{environmentKey}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'environmentKey' + '}', encodeURIComponent(String(environmentKey)))
            .replace('{' + 'segmentKey' + '}', encodeURIComponent(String(segmentKey)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling getExpiringUserTargetsForSegment.');
        }

        // verify required parameter 'environmentKey' is not null or undefined
        if (environmentKey === null || environmentKey === undefined) {
            throw new Error('Required parameter environmentKey was null or undefined when calling getExpiringUserTargetsForSegment.');
        }

        // verify required parameter 'segmentKey' is not null or undefined
        if (segmentKey === null || segmentKey === undefined) {
            throw new Error('Required parameter segmentKey was null or undefined when calling getExpiringUserTargetsForSegment.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ExpiringUserTargetGetResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "ExpiringUserTargetGetResponse");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     * @param segmentKey The segment key
     */
    public async getSegment (projectKey: string, environmentKey: string, segmentKey: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: UserSegment;  }> {
        const localVarPath = this.basePath + '/api/v2/segments/{projectKey}/{environmentKey}/{segmentKey}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'environmentKey' + '}', encodeURIComponent(String(environmentKey)))
            .replace('{' + 'segmentKey' + '}', encodeURIComponent(String(segmentKey)));
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling getSegment.');
        }

        // verify required parameter 'environmentKey' is not null or undefined
        if (environmentKey === null || environmentKey === undefined) {
            throw new Error('Required parameter environmentKey was null or undefined when calling getSegment.');
        }

        // verify required parameter 'segmentKey' is not null or undefined
        if (segmentKey === null || segmentKey === undefined) {
            throw new Error('Required parameter segmentKey was null or undefined when calling getSegment.');
        }
     ...
     */
    public async getSegmentMembershipForContext (projectKey: string, environmentKey: string, segmentKey: string, contextKey: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: BigSegmentTarget;  }> {
        const localVarPath = this.basePath + '/api/v2/segments/{projectKey}/{environmentKey}/{segmentKey}/contexts/{contextKey}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'environmentKey' + '}', encodeURIComponent(String(environmentKey)))
            .replace('{' + 'segmentKey' + '}', encodeURIComponent(String(segmentKey)))
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling getSegmentMembershipForContext.');
        }

        // verify required parameter 'environmentKey' is not null or undefined
        if (environmentKey === null || environmentKey === undefined) {
            throw new Error('Required parameter environmentKey was null or undefined when calling getSegmentMembershipForContext.');
        }

        // verify required parameter 'segmentKey' is not null or undefined
        if (segmentKey === null || segmentKey === undefined) {
            throw new Error('Required parameter segmentKey was null or undefined when calling getSegmentMembershipForContext.');
        }

        // verify required parameter 'contextKey' is not null or undefined
        if (contextKey === null || contextKey === undefined) {
            throw new Error('Required parameter contextKey was null or undefined when calling getSegmentMembershipForContext.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: BigSegmentTarget;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "BigSegmentTarget");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     */
    public async getSegmentMembershipForUser (projectKey: string, environmentKey: string, segmentKey: string, userKey: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: BigSegmentTarget;  }> {
        const localVarPath = this.basePath + '/api/v2/segments/{projectKey}/{environmentKey}/{segmentKey}/users/{userKey}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'environmentKey' + '}', encodeURIComponent(String(environmentKey)))
            .replace('{' + 'segmentKey' + '}', encodeURIComponent(String(segmentKey)))
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling getSegmentMembershipForUser.');
        }

        // verify required parameter 'environmentKey' is not null or undefined
        if (environmentKey === null || environmentKey === undefined) {
            throw new Error('Required parameter environmentKey was null or undefined when calling getSegmentMembershipForUser.');
        }

        // verify required parameter 'segmentKey' is not null or undefined
        if (segmentKey === null || segmentKey === undefined) {
            throw new Error('Required parameter segmentKey was null or undefined when calling getSegmentMembershipForUser.');
        }

        // verify required parameter 'userKey' is not null or undefined
        if (userKey === null || userKey === undefined) {
            throw new Error('Required parameter userKey was null or undefined when calling getSegmentMembershipForUser.');
        }
     ...
     * @param filter Accepts filter by &#x60;excludedKeys&#x60;, &#x60;external&#x60;, &#x60;includedKeys&#x60;, &#x60;query&#x60;, &#x60;tags&#x60;, &#x60;unbounded&#x60;. To learn more about the filter syntax, read the  \&#39;Filtering segments\&#39; section above.
     */
    public async getSegments (projectKey: string, environmentKey: string, limit?: number, offset?: number, sort?: string, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: UserSegments;  }> {
        const localVarPath = this.basePath + '/api/v2/segments/{projectKey}/{environmentKey}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'environmentKey' + '}', encodeURIComponent(String(environmentKey)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling getSegments.');
        }

        // verify required parameter 'environmentKey' is not null or undefined
        if (environmentKey === null || environmentKey === undefined) {
            throw new Error('Required parameter environmentKey was null or undefined when calling getSegments.');
        }
     ...
     */
    public async patchExpiringTargetsForSegment (projectKey: string, environmentKey: string, segmentKey: string, patchSegmentExpiringTargetInputRep: PatchSegmentExpiringTargetInputRep, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ExpiringTargetPatchResponse;  }> {
        const localVarPath = this.basePath + '/api/v2/segments/{projectKey}/{segmentKey}/expiring-targets/{environmentKey}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'environmentKey' + '}', encodeURIComponent(String(environmentKey)))
            .replace('{' + 'segmentKey' + '}', encodeURIComponent(String(segmentKey)));
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling patchExpiringTargetsForSegment.');
        }

        // verify required parameter 'environmentKey' is not null or undefined
        if (environmentKey === null || environmentKey === undefined) {
            throw new Error('Required parameter environmentKey was null or undefined when calling patchExpiringTargetsForSegment.');
        }

        // verify required parameter 'segmentKey' is not null or undefined
        if (segmentKey === null || segmentKey === undefined) {
            throw new Error('Required parameter segmentKey was null or undefined when calling patchExpiringTargetsForSegment.');
        }

        // verify required parameter 'patchSegmentExpiringTargetInputRep' is not null or undefined
        if (patchSegmentExpiringTargetInputRep === null || patchSegmentExpiringTargetInputRep === undefined) {
            throw new Error('Required parameter patchSegmentExpiringTargetInputRep was null or undefined when calling patchExpiringTargetsForSegment.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(patchSegmentExpiringTargetInputRep, "PatchSegmentExpiringTargetInputRep")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ExpiringTargetPatchResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "ExpiringTargetPatchResponse");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     */
    public async patchExpiringUserTargetsForSegment (projectKey: string, environmentKey: string, segmentKey: string, patchSegmentRequest: PatchSegmentRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ExpiringUserTargetPatchResponse;  }> {
        const localVarPath = this.basePath + '/api/v2/segments/{projectKey}/{segmentKey}/expiring-user-targets/{environmentKey}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'environmentKey' + '}', encodeURIComponent(String(environmentKey)))
            .replace('{' + 'segmentKey' + '}', encodeURIComponent(String(segmentKey)));
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling patchExpiringUserTargetsForSegment.');
        }

        // verify required parameter 'environmentKey' is not null or undefined
        if (environmentKey === null || environmentKey === undefined) {
            throw new Error('Required parameter environmentKey was null or undefined when calling patchExpiringUserTargetsForSegment.');
        }

        // verify required parameter 'segmentKey' is not null or undefined
        if (segmentKey === null || segmentKey === undefined) {
            throw new Error('Required parameter segmentKey was null or undefined when calling patchExpiringUserTargetsForSegment.');
        }

        // verify required parameter 'patchSegmentRequest' is not null or undefined
        if (patchSegmentRequest === null || patchSegmentRequest === undefined) {
            throw new Error('Required parameter patchSegmentRequest was null or undefined when calling patchExpiringUserTargetsForSegment.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(patchSegmentRequest, "PatchSegmentRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ExpiringUserTargetPatchResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "ExpiringUserTargetPatchResponse");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     */
    public async patchSegment (projectKey: string, environmentKey: string, segmentKey: string, patchWithComment: PatchWithComment, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: UserSegment;  }> {
        const localVarPath = this.basePath + '/api/v2/segments/{projectKey}/{environmentKey}/{segmentKey}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'environmentKey' + '}', encodeURIComponent(String(environmentKey)))
            .replace('{' + 'segmentKey' + '}', encodeURIComponent(String(segmentKey)));
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling patchSegment.');
        }

        // verify required parameter 'environmentKey' is not null or undefined
        if (environmentKey === null || environmentKey === undefined) {
            throw new Error('Required parameter environmentKey was null or undefined when calling patchSegment.');
        }

        // verify required parameter 'segmentKey' is not null or undefined
        if (segmentKey === null || segmentKey === undefined) {
            throw new Error('Required parameter segmentKey was null or undefined when calling patchSegment.');
        }

        // verify required parameter 'patchWithComment' is not null or undefined
        if (patchWithComment === null || patchWithComment === undefined) {
            throw new Error('Required parameter patchWithComment was null or undefined when calling patchSegment.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(patchWithComment, "PatchWithComment")
        };
     ...
     * @param segmentBody 
     */
    public async postSegment (projectKey: string, environmentKey: string, segmentBody: SegmentBody, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: UserSegment;  }> {
        const localVarPath = this.basePath + '/api/v2/segments/{projectKey}/{environmentKey}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'environmentKey' + '}', encodeURIComponent(String(environmentKey)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling postSegment.');
        }

        // verify required parameter 'environmentKey' is not null or undefined
        if (environmentKey === null || environmentKey === undefined) {
            throw new Error('Required parameter environmentKey was null or undefined when calling postSegment.');
        }

        // verify required parameter 'segmentBody' is not null or undefined
        if (segmentBody === null || segmentBody === undefined) {
            throw new Error('Required parameter segmentBody was null or undefined when calling postSegment.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(segmentBody, "SegmentBody")
        };
     ...
     */
    public async updateBigSegmentContextTargets (projectKey: string, environmentKey: string, segmentKey: string, segmentUserState: SegmentUserState, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/api/v2/segments/{projectKey}/{environmentKey}/{segmentKey}/contexts'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'environmentKey' + '}', encodeURIComponent(String(environmentKey)))
            .replace('{' + 'segmentKey' + '}', encodeURIComponent(String(segmentKey)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling updateBigSegmentContextTargets.');
        }

        // verify required parameter 'environmentKey' is not null or undefined
        if (environmentKey === null || environmentKey === undefined) {
            throw new Error('Required parameter environmentKey was null or undefined when calling updateBigSegmentContextTargets.');
        }

        // verify required parameter 'segmentKey' is not null or undefined
        if (segmentKey === null || segmentKey === undefined) {
            throw new Error('Required parameter segmentKey was null or undefined when calling updateBigSegmentContextTargets.');
        }

        // verify required parameter 'segmentUserState' is not null or undefined
        if (segmentUserState === null || segmentUserState === undefined) {
            throw new Error('Required parameter segmentUserState was null or undefined when calling updateBigSegmentContextTargets.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(segmentUserState, "SegmentUserState")
        };
     ...
     * @param segmentUserState 
     */
    public async updateBigSegmentTargets (projectKey: string, environmentKey: string, segmentKey: string, segmentUserState: SegmentUserState, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/api/v2/segments/{projectKey}/{environmentKey}/{segmentKey}/users'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'environmentKey' + '}', encodeURIComponent(String(environmentKey)))
            .replace('{' + 'segmentKey' + '}', encodeURIComponent(String(segmentKey)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'segmentKey' is not null or undefined
        if (segmentKey === null || segmentKey === undefined) {
            throw new Error('Required parameter segmentKey was null or undefined when calling updateBigSegmentTargets.');
        }

        // verify required parameter 'segmentUserState' is not null or undefined
        if (segmentUserState === null || segmentUserState === undefined) {
            throw new Error('Required parameter segmentUserState was null or undefined when calling updateBigSegmentTargets.');
        }
