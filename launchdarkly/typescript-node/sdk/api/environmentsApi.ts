...
export class EnvironmentsApi {
     ...
     */
    public async deleteEnvironment (projectKey: string, environmentKey: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/api/v2/projects/{projectKey}/environments/{environmentKey}'
     ...
     * @param environmentKey The environment key
     */
    public async getEnvironment (projectKey: string, environmentKey: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Environment;  }> {
        const localVarPath = this.basePath + '/api/v2/projects/{projectKey}/environments/{environmentKey}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'environmentKey' + '}', encodeURIComponent(String(environmentKey)));
        let localVarQueryParameters: any = {};
     ...
     * @param projectKey The project key
     * @param limit The number of environments to return in the response. Defaults to 20.
     ...
     */
    public async getEnvironmentsByProject (projectKey: string, limit?: number, offset?: number, filter?: string, sort?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Environments;  }> {
        const localVarPath = this.basePath + '/api/v2/projects/{projectKey}/environments'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling getEnvironmentsByProject.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: Environments;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "Environments");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     */
    public async patchEnvironment (projectKey: string, environmentKey: string, patchOperation: Array<PatchOperation>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Environment;  }> {
        const localVarPath = this.basePath + '/api/v2/projects/{projectKey}/environments/{environmentKey}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'environmentKey' + '}', encodeURIComponent(String(environmentKey)));
        let localVarQueryParameters: any = {};
        ...
        if (patchOperation === null || patchOperation === undefined) {
            throw new Error('Required parameter patchOperation was null or undefined when calling patchEnvironment.');
        }
     ...
     */
    public async postEnvironment (projectKey: string, environmentPost: EnvironmentPost, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Environment;  }> {
        const localVarPath = this.basePath + '/api/v2/projects/{projectKey}/environments'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        if (environmentPost === null || environmentPost === undefined) {
            throw new Error('Required parameter environmentPost was null or undefined when calling postEnvironment.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(environmentPost, "EnvironmentPost")
        };
     ...
     * @param environmentKey The environment key
     */
    public async resetEnvironmentMobileKey (projectKey: string, environmentKey: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Environment;  }> {
        const localVarPath = this.basePath + '/api/v2/projects/{projectKey}/environments/{environmentKey}/mobileKey'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'environmentKey' + '}', encodeURIComponent(String(environmentKey)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     * @param projectKey The project key
     * @param environmentKey The environment key
     * @param expiry The time at which you want the old SDK key to expire, in UNIX milliseconds. By default, the key expires immediately. During the period between this call and the time when the old SDK key expires, both the old SDK key and the new SDK key will work.
     */
    public async resetEnvironmentSDKKey (projectKey: string, environmentKey: string, expiry?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Environment;  }> {
        const localVarPath = this.basePath + '/api/v2/projects/{projectKey}/environments/{environmentKey}/apiKey'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'environmentKey' + '}', encodeURIComponent(String(environmentKey)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
