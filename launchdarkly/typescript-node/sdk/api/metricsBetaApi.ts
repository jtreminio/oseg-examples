...
export enum MetricsBetaApiApiKeys {
    ApiKey,
}

export class MetricsBetaApi {
    ...
    public setApiKey(key: MetricsBetaApiApiKeys, value: string) {
        (this.authentications as any)[MetricsBetaApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async createMetricGroup (projectKey: string, metricGroupPost: MetricGroupPost, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: MetricGroupRep;  }> {
        const localVarPath = this.basePath + '/api/v2/projects/{projectKey}/metric-groups'
        ...
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling createMetricGroup.');
        }

        // verify required parameter 'metricGroupPost' is not null or undefined
        if (metricGroupPost === null || metricGroupPost === undefined) {
            throw new Error('Required parameter metricGroupPost was null or undefined when calling createMetricGroup.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(metricGroupPost, "MetricGroupPost")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: MetricGroupRep;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "MetricGroupRep");
     ...
     */
    public async deleteMetricGroup (projectKey: string, metricGroupKey: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/api/v2/projects/{projectKey}/metric-groups/{metricGroupKey}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling deleteMetricGroup.');
        }

        // verify required parameter 'metricGroupKey' is not null or undefined
        if (metricGroupKey === null || metricGroupKey === undefined) {
            throw new Error('Required parameter metricGroupKey was null or undefined when calling deleteMetricGroup.');
        }
     ...
     */
    public async getMetricGroup (projectKey: string, metricGroupKey: string, expand?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: MetricGroupRep;  }> {
        const localVarPath = this.basePath + '/api/v2/projects/{projectKey}/metric-groups/{metricGroupKey}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'metricGroupKey' + '}', encodeURIComponent(String(metricGroupKey)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling getMetricGroup.');
        }

        // verify required parameter 'metricGroupKey' is not null or undefined
        if (metricGroupKey === null || metricGroupKey === undefined) {
            throw new Error('Required parameter metricGroupKey was null or undefined when calling getMetricGroup.');
        }
     ...
     * @param projectKey The project key
     * @param filter Accepts filter by &#x60;experimentStatus&#x60; and &#x60;query&#x60;. Example: &#x60;filter&#x3D;experimentStatus equals \&#39;running\&#39; and query equals \&#39;test\&#39;&#x60;.
     * @param expand A comma-separated list of properties that can reveal additional information in the response.
     * @param limit The number of metric groups to return in the response. Defaults to 20. Maximum limit is 50.
     ...
     */
    public async getMetricGroups (projectKey: string, filter?: string, expand?: string, limit?: number, offset?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: MetricGroupCollectionRep;  }> {
        const localVarPath = this.basePath + '/api/v2/projects/{projectKey}/metric-groups'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling getMetricGroups.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: MetricGroupCollectionRep;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "MetricGroupCollectionRep");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     */
    public async patchMetricGroup (projectKey: string, metricGroupKey: string, patchOperation: Array<PatchOperation>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: MetricGroupRep;  }> {
        const localVarPath = this.basePath + '/api/v2/projects/{projectKey}/metric-groups/{metricGroupKey}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'metricGroupKey' + '}', encodeURIComponent(String(metricGroupKey)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling patchMetricGroup.');
        }

        // verify required parameter 'metricGroupKey' is not null or undefined
        if (metricGroupKey === null || metricGroupKey === undefined) {
            throw new Error('Required parameter metricGroupKey was null or undefined when calling patchMetricGroup.');
        }

        // verify required parameter 'patchOperation' is not null or undefined
        if (patchOperation === null || patchOperation === undefined) {
            throw new Error('Required parameter patchOperation was null or undefined when calling patchMetricGroup.');
        }
