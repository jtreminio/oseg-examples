...
export enum ScheduledChangesApiApiKeys {
    ApiKey,
}

export class ScheduledChangesApi {
    ...
    public setApiKey(key: ScheduledChangesApiApiKeys, value: string) {
        (this.authentications as any)[ScheduledChangesApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async deleteFlagConfigScheduledChanges (projectKey: string, featureFlagKey: string, environmentKey: string, id: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/scheduled-changes/{id}'
        ...
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling deleteFlagConfigScheduledChanges.');
        }
     ...
     * @param id The scheduled change id
     */
    public async getFeatureFlagScheduledChange (projectKey: string, featureFlagKey: string, environmentKey: string, id: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FeatureFlagScheduledChange;  }> {
        const localVarPath = this.basePath + '/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/scheduled-changes/{id}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'featureFlagKey' + '}', encodeURIComponent(String(featureFlagKey)))
            .replace('{' + 'environmentKey' + '}', encodeURIComponent(String(environmentKey)))
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling getFeatureFlagScheduledChange.');
        }

        // verify required parameter 'featureFlagKey' is not null or undefined
        if (featureFlagKey === null || featureFlagKey === undefined) {
            throw new Error('Required parameter featureFlagKey was null or undefined when calling getFeatureFlagScheduledChange.');
        }

        // verify required parameter 'environmentKey' is not null or undefined
        if (environmentKey === null || environmentKey === undefined) {
            throw new Error('Required parameter environmentKey was null or undefined when calling getFeatureFlagScheduledChange.');
        }

        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling getFeatureFlagScheduledChange.');
        }
     ...
     * @param environmentKey The environment key
     */
    public async getFlagConfigScheduledChanges (projectKey: string, featureFlagKey: string, environmentKey: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FeatureFlagScheduledChanges;  }> {
        const localVarPath = this.basePath + '/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/scheduled-changes'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'featureFlagKey' + '}', encodeURIComponent(String(featureFlagKey)))
            .replace('{' + 'environmentKey' + '}', encodeURIComponent(String(environmentKey)));
        let localVarQueryParameters: any = {};
     ...
     * @param ignoreConflicts Whether to succeed (&#x60;true&#x60;) or fail (&#x60;false&#x60;) when these new instructions conflict with existing scheduled changes
     */
    public async patchFlagConfigScheduledChange (projectKey: string, featureFlagKey: string, environmentKey: string, id: string, flagScheduledChangesInput: FlagScheduledChangesInput, ignoreConflicts?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FeatureFlagScheduledChange;  }> {
        const localVarPath = this.basePath + '/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/scheduled-changes/{id}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'featureFlagKey' + '}', encodeURIComponent(String(featureFlagKey)))
            .replace('{' + 'environmentKey' + '}', encodeURIComponent(String(environmentKey)))
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling patchFlagConfigScheduledChange.');
        }

        // verify required parameter 'flagScheduledChangesInput' is not null or undefined
        if (flagScheduledChangesInput === null || flagScheduledChangesInput === undefined) {
            throw new Error('Required parameter flagScheduledChangesInput was null or undefined when calling patchFlagConfigScheduledChange.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(flagScheduledChangesInput, "FlagScheduledChangesInput")
        };
     ...
     * @param ignoreConflicts Whether to succeed (&#x60;true&#x60;) or fail (&#x60;false&#x60;) when these instructions conflict with existing scheduled changes
     */
    public async postFlagConfigScheduledChanges (projectKey: string, featureFlagKey: string, environmentKey: string, postFlagScheduledChangesInput: PostFlagScheduledChangesInput, ignoreConflicts?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FeatureFlagScheduledChange;  }> {
        const localVarPath = this.basePath + '/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/scheduled-changes'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'featureFlagKey' + '}', encodeURIComponent(String(featureFlagKey)))
            .replace('{' + 'environmentKey' + '}', encodeURIComponent(String(environmentKey)));
        ...
        if (postFlagScheduledChangesInput === null || postFlagScheduledChangesInput === undefined) {
            throw new Error('Required parameter postFlagScheduledChangesInput was null or undefined when calling postFlagConfigScheduledChanges.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(postFlagScheduledChangesInput, "PostFlagScheduledChangesInput")
        };
