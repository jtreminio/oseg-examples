...
export class UserSettingsApi {
     ...
     * @deprecated
     */
    public async getExpiringFlagsForUser (projectKey: string, userKey: string, environmentKey: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ExpiringUserTargetGetResponse;  }> {
        const localVarPath = this.basePath + '/api/v2/users/{projectKey}/{userKey}/expiring-user-targets/{environmentKey}'
        ...
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling getExpiringFlagsForUser.');
        }

        // verify required parameter 'userKey' is not null or undefined
        if (userKey === null || userKey === undefined) {
            throw new Error('Required parameter userKey was null or undefined when calling getExpiringFlagsForUser.');
        }

        // verify required parameter 'environmentKey' is not null or undefined
        if (environmentKey === null || environmentKey === undefined) {
            throw new Error('Required parameter environmentKey was null or undefined when calling getExpiringFlagsForUser.');
        }
     ...
     * @deprecated
     */
    public async getUserFlagSetting (projectKey: string, environmentKey: string, userKey: string, featureFlagKey: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: UserFlagSetting;  }> {
        const localVarPath = this.basePath + '/api/v2/users/{projectKey}/{environmentKey}/{userKey}/flags/{featureFlagKey}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'environmentKey' + '}', encodeURIComponent(String(environmentKey)))
            .replace('{' + 'userKey' + '}', encodeURIComponent(String(userKey)))
     ...
     * @deprecated
     */
    public async getUserFlagSettings (projectKey: string, environmentKey: string, userKey: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: UserFlagSettings;  }> {
        const localVarPath = this.basePath + '/api/v2/users/{projectKey}/{environmentKey}/{userKey}/flags'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'environmentKey' + '}', encodeURIComponent(String(environmentKey)))
            .replace('{' + 'userKey' + '}', encodeURIComponent(String(userKey)));
        let localVarQueryParameters: any = {};
     ...
     * @deprecated
     */
    public async patchExpiringFlagsForUser (projectKey: string, userKey: string, environmentKey: string, patchUsersRequest: PatchUsersRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ExpiringUserTargetPatchResponse;  }> {
        const localVarPath = this.basePath + '/api/v2/users/{projectKey}/{userKey}/expiring-user-targets/{environmentKey}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'userKey' + '}', encodeURIComponent(String(userKey)))
            .replace('{' + 'environmentKey' + '}', encodeURIComponent(String(environmentKey)));
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling patchExpiringFlagsForUser.');
        }

        // verify required parameter 'userKey' is not null or undefined
        if (userKey === null || userKey === undefined) {
            throw new Error('Required parameter userKey was null or undefined when calling patchExpiringFlagsForUser.');
        }

        // verify required parameter 'environmentKey' is not null or undefined
        if (environmentKey === null || environmentKey === undefined) {
            throw new Error('Required parameter environmentKey was null or undefined when calling patchExpiringFlagsForUser.');
        }

        // verify required parameter 'patchUsersRequest' is not null or undefined
        if (patchUsersRequest === null || patchUsersRequest === undefined) {
            throw new Error('Required parameter patchUsersRequest was null or undefined when calling patchExpiringFlagsForUser.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(patchUsersRequest, "PatchUsersRequest")
        };
     ...
     * @deprecated
     */
    public async putFlagSetting (projectKey: string, environmentKey: string, userKey: string, featureFlagKey: string, valuePut: ValuePut, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/api/v2/users/{projectKey}/{environmentKey}/{userKey}/flags/{featureFlagKey}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'environmentKey' + '}', encodeURIComponent(String(environmentKey)))
            .replace('{' + 'userKey' + '}', encodeURIComponent(String(userKey)))
        ...
        if (valuePut === null || valuePut === undefined) {
            throw new Error('Required parameter valuePut was null or undefined when calling putFlagSetting.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(valuePut, "ValuePut")
        };
