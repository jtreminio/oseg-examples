...
export enum IntegrationsBetaApiApiKeys {
    ApiKey,
}

export class IntegrationsBetaApi {
    ...
    public setApiKey(key: IntegrationsBetaApiApiKeys, value: string) {
        (this.authentications as any)[IntegrationsBetaApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async createIntegrationConfiguration (integrationKey: string, integrationConfigurationPost: IntegrationConfigurationPost, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: IntegrationConfigurationsRep;  }> {
        const localVarPath = this.basePath + '/api/v2/integration-configurations/keys/{integrationKey}'
        ...
        if (integrationKey === null || integrationKey === undefined) {
            throw new Error('Required parameter integrationKey was null or undefined when calling createIntegrationConfiguration.');
        }

        // verify required parameter 'integrationConfigurationPost' is not null or undefined
        if (integrationConfigurationPost === null || integrationConfigurationPost === undefined) {
            throw new Error('Required parameter integrationConfigurationPost was null or undefined when calling createIntegrationConfiguration.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(integrationConfigurationPost, "IntegrationConfigurationPost")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: IntegrationConfigurationsRep;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "IntegrationConfigurationsRep");
     ...
     */
    public async deleteIntegrationConfiguration (integrationConfigurationId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/api/v2/integration-configurations/{integrationConfigurationId}'
            .replace('{' + 'integrationConfigurationId' + '}', encodeURIComponent(String(integrationConfigurationId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        // give precedence to 'application/json'
        ...
        // verify required parameter 'integrationConfigurationId' is not null or undefined
        if (integrationConfigurationId === null || integrationConfigurationId === undefined) {
            throw new Error('Required parameter integrationConfigurationId was null or undefined when calling deleteIntegrationConfiguration.');
        }
     ...
     */
    public async getAllIntegrationConfigurations (integrationKey: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: IntegrationConfigurationCollectionRep;  }> {
        const localVarPath = this.basePath + '/api/v2/integration-configurations/keys/{integrationKey}'
            .replace('{' + 'integrationKey' + '}', encodeURIComponent(String(integrationKey)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'integrationKey' is not null or undefined
        if (integrationKey === null || integrationKey === undefined) {
            throw new Error('Required parameter integrationKey was null or undefined when calling getAllIntegrationConfigurations.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: IntegrationConfigurationCollectionRep;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "IntegrationConfigurationCollectionRep");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     */
    public async getIntegrationConfiguration (integrationConfigurationId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: IntegrationConfigurationsRep;  }> {
        const localVarPath = this.basePath + '/api/v2/integration-configurations/{integrationConfigurationId}'
            .replace('{' + 'integrationConfigurationId' + '}', encodeURIComponent(String(integrationConfigurationId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'integrationConfigurationId' is not null or undefined
        if (integrationConfigurationId === null || integrationConfigurationId === undefined) {
            throw new Error('Required parameter integrationConfigurationId was null or undefined when calling getIntegrationConfiguration.');
        }
     ...
     */
    public async updateIntegrationConfiguration (integrationConfigurationId: string, patchOperation: Array<PatchOperation>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: IntegrationConfigurationsRep;  }> {
        const localVarPath = this.basePath + '/api/v2/integration-configurations/{integrationConfigurationId}'
            .replace('{' + 'integrationConfigurationId' + '}', encodeURIComponent(String(integrationConfigurationId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'integrationConfigurationId' is not null or undefined
        if (integrationConfigurationId === null || integrationConfigurationId === undefined) {
            throw new Error('Required parameter integrationConfigurationId was null or undefined when calling updateIntegrationConfiguration.');
        }

        // verify required parameter 'patchOperation' is not null or undefined
        if (patchOperation === null || patchOperation === undefined) {
            throw new Error('Required parameter patchOperation was null or undefined when calling updateIntegrationConfiguration.');
        }
