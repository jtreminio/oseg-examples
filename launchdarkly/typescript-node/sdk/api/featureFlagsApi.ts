...
export class FeatureFlagsApi {
     ...
     */
    public async copyFeatureFlag (projectKey: string, featureFlagKey: string, flagCopyConfigPost: FlagCopyConfigPost, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FeatureFlag;  }> {
        const localVarPath = this.basePath + '/api/v2/flags/{projectKey}/{featureFlagKey}/copy'
        ...
        if (flagCopyConfigPost === null || flagCopyConfigPost === undefined) {
            throw new Error('Required parameter flagCopyConfigPost was null or undefined when calling copyFeatureFlag.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(flagCopyConfigPost, "FlagCopyConfigPost")
        };
     ...
     * @param featureFlagKey The feature flag key. The key identifies the flag in your code.
     */
    public async deleteFeatureFlag (projectKey: string, featureFlagKey: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/api/v2/flags/{projectKey}/{featureFlagKey}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'featureFlagKey' + '}', encodeURIComponent(String(featureFlagKey)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     */
    public async getExpiringContextTargets (projectKey: string, environmentKey: string, featureFlagKey: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ExpiringTargetGetResponse;  }> {
        const localVarPath = this.basePath + '/api/v2/flags/{projectKey}/{featureFlagKey}/expiring-targets/{environmentKey}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling getExpiringContextTargets.');
        }

        // verify required parameter 'environmentKey' is not null or undefined
        if (environmentKey === null || environmentKey === undefined) {
            throw new Error('Required parameter environmentKey was null or undefined when calling getExpiringContextTargets.');
        }

        // verify required parameter 'featureFlagKey' is not null or undefined
        if (featureFlagKey === null || featureFlagKey === undefined) {
            throw new Error('Required parameter featureFlagKey was null or undefined when calling getExpiringContextTargets.');
        }
     ...
     * @param featureFlagKey The feature flag key
     */
    public async getExpiringUserTargets (projectKey: string, environmentKey: string, featureFlagKey: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ExpiringUserTargetGetResponse;  }> {
        const localVarPath = this.basePath + '/api/v2/flags/{projectKey}/{featureFlagKey}/expiring-user-targets/{environmentKey}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'environmentKey' + '}', encodeURIComponent(String(environmentKey)))
            .replace('{' + 'featureFlagKey' + '}', encodeURIComponent(String(featureFlagKey)));
        let localVarQueryParameters: any = {};
     ...
     */
    public async getFeatureFlag (projectKey: string, featureFlagKey: string, env?: string, expand?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FeatureFlag;  }> {
        const localVarPath = this.basePath + '/api/v2/flags/{projectKey}/{featureFlagKey}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'featureFlagKey' + '}', encodeURIComponent(String(featureFlagKey)));
        let localVarQueryParameters: any = {};
     ...
     * @param featureFlagKey The feature flag key
     */
    public async getFeatureFlagStatus (projectKey: string, environmentKey: string, featureFlagKey: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FlagStatusRep;  }> {
        const localVarPath = this.basePath + '/api/v2/flag-statuses/{projectKey}/{environmentKey}/{featureFlagKey}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'environmentKey' + '}', encodeURIComponent(String(environmentKey)))
            .replace('{' + 'featureFlagKey' + '}', encodeURIComponent(String(featureFlagKey)));
        let localVarQueryParameters: any = {};
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: FlagStatusRep;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "FlagStatusRep");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     */
    public async getFeatureFlagStatusAcrossEnvironments (projectKey: string, featureFlagKey: string, env?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FeatureFlagStatusAcrossEnvironments;  }> {
        const localVarPath = this.basePath + '/api/v2/flag-status/{projectKey}/{featureFlagKey}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'featureFlagKey' + '}', encodeURIComponent(String(featureFlagKey)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     * @param environmentKey The environment key
     */
    public async getFeatureFlagStatuses (projectKey: string, environmentKey: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FeatureFlagStatuses;  }> {
        const localVarPath = this.basePath + '/api/v2/flag-statuses/{projectKey}/{environmentKey}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'environmentKey' + '}', encodeURIComponent(String(environmentKey)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     * @param expand A comma-separated list of fields to expand in the response. Supported fields are explained above.
     */
    public async getFeatureFlags (projectKey: string, env?: string, tag?: string, limit?: number, offset?: number, archived?: boolean, summary?: boolean, filter?: string, sort?: string, compare?: boolean, expand?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FeatureFlags;  }> {
        const localVarPath = this.basePath + '/api/v2/flags/{projectKey}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        if (compare !== undefined) {
            localVarQueryParameters['compare'] = ObjectSerializer.serialize(compare, "boolean");
        }
     ...
     */
    public async patchExpiringTargets (projectKey: string, environmentKey: string, featureFlagKey: string, patchFlagsRequest: PatchFlagsRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ExpiringTargetPatchResponse;  }> {
        const localVarPath = this.basePath + '/api/v2/flags/{projectKey}/{featureFlagKey}/expiring-targets/{environmentKey}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'environmentKey' + '}', encodeURIComponent(String(environmentKey)))
            .replace('{' + 'featureFlagKey' + '}', encodeURIComponent(String(featureFlagKey)));
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling patchExpiringTargets.');
        }

        // verify required parameter 'environmentKey' is not null or undefined
        if (environmentKey === null || environmentKey === undefined) {
            throw new Error('Required parameter environmentKey was null or undefined when calling patchExpiringTargets.');
        }

        // verify required parameter 'featureFlagKey' is not null or undefined
        if (featureFlagKey === null || featureFlagKey === undefined) {
            throw new Error('Required parameter featureFlagKey was null or undefined when calling patchExpiringTargets.');
        }

        // verify required parameter 'patchFlagsRequest' is not null or undefined
        if (patchFlagsRequest === null || patchFlagsRequest === undefined) {
            throw new Error('Required parameter patchFlagsRequest was null or undefined when calling patchExpiringTargets.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(patchFlagsRequest, "PatchFlagsRequest")
        };
     ...
     * @param patchFlagsRequest 
     */
    public async patchExpiringUserTargets (projectKey: string, environmentKey: string, featureFlagKey: string, patchFlagsRequest: PatchFlagsRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ExpiringUserTargetPatchResponse;  }> {
        const localVarPath = this.basePath + '/api/v2/flags/{projectKey}/{featureFlagKey}/expiring-user-targets/{environmentKey}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'environmentKey' + '}', encodeURIComponent(String(environmentKey)))
            .replace('{' + 'featureFlagKey' + '}', encodeURIComponent(String(featureFlagKey)));
        ...
        // verify required parameter 'patchFlagsRequest' is not null or undefined
        if (patchFlagsRequest === null || patchFlagsRequest === undefined) {
            throw new Error('Required parameter patchFlagsRequest was null or undefined when calling patchExpiringUserTargets.');
        }
     ...
     * @param ignoreConflicts If true, the patch will be applied even if it causes a pending scheduled change or approval request to fail.
     */
    public async patchFeatureFlag (projectKey: string, featureFlagKey: string, patchWithComment: PatchWithComment, ignoreConflicts?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FeatureFlag;  }> {
        const localVarPath = this.basePath + '/api/v2/flags/{projectKey}/{featureFlagKey}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
            .replace('{' + 'featureFlagKey' + '}', encodeURIComponent(String(featureFlagKey)));
        let localVarQueryParameters: any = {};
        ...
        if (patchWithComment === null || patchWithComment === undefined) {
            throw new Error('Required parameter patchWithComment was null or undefined when calling patchFeatureFlag.');
        }

        if (ignoreConflicts !== undefined) {
            localVarQueryParameters['ignoreConflicts'] = ObjectSerializer.serialize(ignoreConflicts, "boolean");
        }
     ...
     */
    public async postFeatureFlag (projectKey: string, featureFlagBody: FeatureFlagBody, clone?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FeatureFlag;  }> {
        const localVarPath = this.basePath + '/api/v2/flags/{projectKey}'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     * @param flagSempatch 
     */
    public async postMigrationSafetyIssues (projectKey: string, flagKey: string, environmentKey: string, flagSempatch: FlagSempatch, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<MigrationSafetyIssueRep>;  }> {
        const localVarPath = this.basePath + '/api/v2/projects/{projectKey}/flags/{flagKey}/environments/{environmentKey}/migration-safety-issues'
            .replace('{' + 'projectKey' + '}', encodeURIComponent(String(projectKey)))
        ...
        // verify required parameter 'projectKey' is not null or undefined
        if (projectKey === null || projectKey === undefined) {
            throw new Error('Required parameter projectKey was null or undefined when calling postMigrationSafetyIssues.');
        }

        // verify required parameter 'flagKey' is not null or undefined
        if (flagKey === null || flagKey === undefined) {
            throw new Error('Required parameter flagKey was null or undefined when calling postMigrationSafetyIssues.');
        }

        // verify required parameter 'environmentKey' is not null or undefined
        if (environmentKey === null || environmentKey === undefined) {
            throw new Error('Required parameter environmentKey was null or undefined when calling postMigrationSafetyIssues.');
        }

        // verify required parameter 'flagSempatch' is not null or undefined
        if (flagSempatch === null || flagSempatch === undefined) {
            throw new Error('Required parameter flagSempatch was null or undefined when calling postMigrationSafetyIssues.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(flagSempatch, "FlagSempatch")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: Array<MigrationSafetyIssueRep>;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "Array<MigrationSafetyIssueRep>");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
