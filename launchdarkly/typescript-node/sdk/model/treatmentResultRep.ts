...
export class TreatmentResultRep {
    /**
    ...
    */
    'model'?: TreatmentResultRep.ModelEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "treatmentId",
            "baseName": "treatmentId",
            "type": "string"
        },
        {
            "name": "treatmentName",
            "baseName": "treatmentName",
            "type": "string"
        },
        {
            "name": "mean",
        ...
        {
            "name": "relativeDifferences",
            "baseName": "relativeDifferences",
        ...
        {
            "name": "standardDeviationRatio",
            "baseName": "standardDeviationRatio",
            "type": "number"
        },
        {
            "name": "covariateImbalance",
            "baseName": "covariateImbalance",
            "type": "number"
        },
        {
            "name": "varianceReduction",
            "baseName": "varianceReduction",
            "type": "number"
        },
        {
            "name": "model",
            "baseName": "model",
            "type": "TreatmentResultRep.ModelEnum"
        },
        {
            "name": "bayesianNormal",
            "baseName": "bayesianNormal",
            "type": "BayesianNormalStatsRep"
        },
        {
            "name": "bayesianBeta",
            "baseName": "bayesianBeta",
            "type": "BayesianBetaBinomialStatsRep"
        }    ];

    static getAttributeTypeMap() {
        return TreatmentResultRep.attributeTypeMap;
    }
}

export namespace TreatmentResultRep {
    export enum ModelEnum {
        BayesianNormal = <any> 'bayesianNormal',
        BayesianBeta = <any> 'bayesianBeta'
    }
}
