...
namespace Org.LaunchDarklyTools.Api
{
    ...
    /// </summary>
    public interface ITeamsBetaApiSync : IApiAccessor
    {
        ...
        /// <param name="teamsPatchInput"></param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>BulkEditTeamsRep</returns>
        BulkEditTeamsRep PatchTeams(TeamsPatchInput teamsPatchInput, int operationIndex = 0);
        ...
        /// <param name="teamsPatchInput"></param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of BulkEditTeamsRep</returns>
        ApiResponse<BulkEditTeamsRep> PatchTeamsWithHttpInfo(TeamsPatchInput teamsPatchInput, int operationIndex = 0);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ITeamsBetaApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of BulkEditTeamsRep</returns>
        System.Threading.Tasks.Task<BulkEditTeamsRep> PatchTeamsAsync(TeamsPatchInput teamsPatchInput, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (BulkEditTeamsRep)</returns>
        System.Threading.Tasks.Task<ApiResponse<BulkEditTeamsRep>> PatchTeamsWithHttpInfoAsync(TeamsPatchInput teamsPatchInput, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ITeamsBetaApi : ITeamsBetaApiSync, ITeamsBetaApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class TeamsBetaApi : ITeamsBetaApi
    {
        private Org.LaunchDarklyTools.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="TeamsBetaApi"/> class.
        /// </summary>
        /// <returns></returns>
        public TeamsBetaApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public TeamsBetaApi(string basePath)
        {
        ...
        /// <returns></returns>
        public TeamsBetaApi(Org.LaunchDarklyTools.Client.Configuration configuration)
        {
        ...
        public TeamsBetaApi(Org.LaunchDarklyTools.Client.ISynchronousClient client, Org.LaunchDarklyTools.Client.IAsynchronousClient asyncClient, Org.LaunchDarklyTools.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>BulkEditTeamsRep</returns>
        public BulkEditTeamsRep PatchTeams(TeamsPatchInput teamsPatchInput, int operationIndex = 0)
        {
            Org.LaunchDarklyTools.Client.ApiResponse<BulkEditTeamsRep> localVarResponse = PatchTeamsWithHttpInfo(teamsPatchInput);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of BulkEditTeamsRep</returns>
        public Org.LaunchDarklyTools.Client.ApiResponse<BulkEditTeamsRep> PatchTeamsWithHttpInfo(TeamsPatchInput teamsPatchInput, int operationIndex = 0)
        {
            // verify the required parameter 'teamsPatchInput' is set
            if (teamsPatchInput == null)
            {
                throw new Org.LaunchDarklyTools.Client.ApiException(400, "Missing required parameter 'teamsPatchInput' when calling TeamsBetaApi->PatchTeams");
            }
            ...
            localVarRequestOptions.Data = teamsPatchInput;

            localVarRequestOptions.Operation = "TeamsBetaApi.PatchTeams";
            ...
            var localVarResponse = this.Client.Patch<BulkEditTeamsRep>("/api/v2/teams", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PatchTeams", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of BulkEditTeamsRep</returns>
        public async System.Threading.Tasks.Task<BulkEditTeamsRep> PatchTeamsAsync(TeamsPatchInput teamsPatchInput, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            Org.LaunchDarklyTools.Client.ApiResponse<BulkEditTeamsRep> localVarResponse = await PatchTeamsWithHttpInfoAsync(teamsPatchInput, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (BulkEditTeamsRep)</returns>
        public async System.Threading.Tasks.Task<Org.LaunchDarklyTools.Client.ApiResponse<BulkEditTeamsRep>> PatchTeamsWithHttpInfoAsync(TeamsPatchInput teamsPatchInput, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            // verify the required parameter 'teamsPatchInput' is set
            if (teamsPatchInput == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PatchAsync<BulkEditTeamsRep>("/api/v2/teams", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
