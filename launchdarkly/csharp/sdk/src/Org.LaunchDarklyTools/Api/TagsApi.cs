...
namespace Org.LaunchDarklyTools.Api
{
    ...
    public interface ITagsApiSync : IApiAccessor
    {
        ...
        /// <param name="kind">Fetch tags associated with the specified resource type. Options are &#x60;flag&#x60;, &#x60;project&#x60;, &#x60;environment&#x60;, &#x60;segment&#x60;, &#x60;metric&#x60;. Returns all types by default. (optional)</param>
        /// <param name="pre">Return tags with the specified prefix (optional)</param>
        /// <param name="archived">Whether or not to return archived flags (optional)</param>
        /// <param name="limit">The number of tags to return. Maximum is 1000. (optional)</param>
        /// <param name="offset">The index of the first tag to return. Default is 0. (optional)</param>
        /// <param name="asOf">The time to retrieve tags as of. Default is the current time. (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>TagsCollection</returns>
        TagsCollection GetTags(List<string>? kind = default(List<string>?), string? pre = default(string?), bool? archived = default(bool?), int? limit = default(int?), int? offset = default(int?), string? asOf = default(string?), int operationIndex = 0);
        ...
        /// <param name="asOf">The time to retrieve tags as of. Default is the current time. (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of TagsCollection</returns>
        ApiResponse<TagsCollection> GetTagsWithHttpInfo(List<string>? kind = default(List<string>?), string? pre = default(string?), bool? archived = default(bool?), int? limit = default(int?), int? offset = default(int?), string? asOf = default(string?), int operationIndex = 0);
    ...
    public interface ITagsApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of TagsCollection</returns>
        System.Threading.Tasks.Task<TagsCollection> GetTagsAsync(List<string>? kind = default(List<string>?), string? pre = default(string?), bool? archived = default(bool?), int? limit = default(int?), int? offset = default(int?), string? asOf = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (TagsCollection)</returns>
        System.Threading.Tasks.Task<ApiResponse<TagsCollection>> GetTagsWithHttpInfoAsync(List<string>? kind = default(List<string>?), string? pre = default(string?), bool? archived = default(bool?), int? limit = default(int?), int? offset = default(int?), string? asOf = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
    ...
    public partial class TagsApi : ITagsApi
    {
        ...
        /// <returns></returns>
        public TagsApi(Org.LaunchDarklyTools.Client.Configuration configuration)
        {
        ...
        public TagsApi(Org.LaunchDarklyTools.Client.ISynchronousClient client, Org.LaunchDarklyTools.Client.IAsynchronousClient asyncClient, Org.LaunchDarklyTools.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>TagsCollection</returns>
        public TagsCollection GetTags(List<string>? kind = default(List<string>?), string? pre = default(string?), bool? archived = default(bool?), int? limit = default(int?), int? offset = default(int?), string? asOf = default(string?), int operationIndex = 0)
        {
            Org.LaunchDarklyTools.Client.ApiResponse<TagsCollection> localVarResponse = GetTagsWithHttpInfo(kind, pre, archived, limit, offset, asOf);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of TagsCollection</returns>
        public Org.LaunchDarklyTools.Client.ApiResponse<TagsCollection> GetTagsWithHttpInfo(List<string>? kind = default(List<string>?), string? pre = default(string?), bool? archived = default(bool?), int? limit = default(int?), int? offset = default(int?), string? asOf = default(string?), int operationIndex = 0)
        {
            ...
            if (kind != null)
            {
                localVarRequestOptions.QueryParameters.Add(Org.LaunchDarklyTools.Client.ClientUtils.ParameterToMultiMap("multi", "kind", kind));
            }
            if (pre != null)
            {
                localVarRequestOptions.QueryParameters.Add(Org.LaunchDarklyTools.Client.ClientUtils.ParameterToMultiMap("", "pre", pre));
            }
            if (archived != null)
            {
            ...
            if (asOf != null)
            {
                localVarRequestOptions.QueryParameters.Add(Org.LaunchDarklyTools.Client.ClientUtils.ParameterToMultiMap("", "asOf", asOf));
            }
            ...
            var localVarResponse = this.Client.Get<TagsCollection>("/api/v2/tags", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of TagsCollection</returns>
        public async System.Threading.Tasks.Task<TagsCollection> GetTagsAsync(List<string>? kind = default(List<string>?), string? pre = default(string?), bool? archived = default(bool?), int? limit = default(int?), int? offset = default(int?), string? asOf = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            Org.LaunchDarklyTools.Client.ApiResponse<TagsCollection> localVarResponse = await GetTagsWithHttpInfoAsync(kind, pre, archived, limit, offset, asOf, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<Org.LaunchDarklyTools.Client.ApiResponse<TagsCollection>> GetTagsWithHttpInfoAsync(List<string>? kind = default(List<string>?), string? pre = default(string?), bool? archived = default(bool?), int? limit = default(int?), int? offset = default(int?), string? asOf = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<TagsCollection>("/api/v2/tags", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
