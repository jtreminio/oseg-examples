...
namespace Org.LaunchDarklyTools.Api
{
    ...
    /// </summary>
    public interface IInsightsPullRequestsBetaApiSync : IApiAccessor
    {
        ...
        /// <param name="environmentKey">Required if you are using the &lt;code&gt;sort&lt;/code&gt; parameter&#39;s &lt;code&gt;leadTime&lt;/code&gt; option to sort pull requests. (optional)</param>
        /// <param name="applicationKey">Filter the results to pull requests deployed to a comma separated list of applications (optional)</param>
        /// <param name="status">Filter results to pull requests with the given status. Options: &#x60;open&#x60;, &#x60;merged&#x60;, &#x60;closed&#x60;, &#x60;deployed&#x60;. (optional)</param>
        /// <param name="query">Filter list of pull requests by title or author (optional)</param>
        /// <param name="limit">The number of pull requests to return. Default is 20. Maximum allowed is 100. (optional)</param>
        /// <param name="expand">Expand properties in response. Options: &#x60;deployments&#x60;, &#x60;flagReferences&#x60;, &#x60;leadTime&#x60;. (optional)</param>
        /// <param name="sort">Sort results. Requires the &#x60;environmentKey&#x60; to be set. Options: &#x60;leadTime&#x60; (asc) and &#x60;-leadTime&#x60; (desc). When query option is excluded, default sort is by created or merged date. (optional)</param>
        ...
        /// <returns>PullRequestCollectionRep</returns>
        PullRequestCollectionRep GetPullRequests(string projectKey, string? environmentKey = default(string?), string? applicationKey = default(string?), string? status = default(string?), string? query = default(string?), long? limit = default(long?), string? expand = default(string?), string? sort = default(string?), DateTime? from = default(DateTime?), DateTime? to = default(DateTime?), string? after = default(string?), string? before = default(string?), int operationIndex = 0);
        ...
        /// <param name="before">Identifier used for pagination (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PullRequestCollectionRep</returns>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IInsightsPullRequestsBetaApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of PullRequestCollectionRep</returns>
        System.Threading.Tasks.Task<PullRequestCollectionRep> GetPullRequestsAsync(string projectKey, string? environmentKey = default(string?), string? applicationKey = default(string?), string? status = default(string?), string? query = default(string?), long? limit = default(long?), string? expand = default(string?), string? sort = default(string?), DateTime? from = default(DateTime?), DateTime? to = default(DateTime?), string? after = default(string?), string? before = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (PullRequestCollectionRep)</returns>
        System.Threading.Tasks.Task<ApiResponse<PullRequestCollectionRep>> GetPullRequestsWithHttpInfoAsync(string projectKey, string? environmentKey = default(string?), string? applicationKey = default(string?), string? status = default(string?), string? query = default(string?), long? limit = default(long?), string? expand = default(string?), string? sort = default(string?), DateTime? from = default(DateTime?), DateTime? to = default(DateTime?), string? after = default(string?), string? before = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IInsightsPullRequestsBetaApi : IInsightsPullRequestsBetaApiSync, IInsightsPullRequestsBetaApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class InsightsPullRequestsBetaApi : IInsightsPullRequestsBetaApi
    {
        private Org.LaunchDarklyTools.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="InsightsPullRequestsBetaApi"/> class.
        /// </summary>
        /// <returns></returns>
        public InsightsPullRequestsBetaApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public InsightsPullRequestsBetaApi(string basePath)
        {
        ...
        /// <returns></returns>
        public InsightsPullRequestsBetaApi(Org.LaunchDarklyTools.Client.Configuration configuration)
        {
        ...
        public InsightsPullRequestsBetaApi(Org.LaunchDarklyTools.Client.ISynchronousClient client, Org.LaunchDarklyTools.Client.IAsynchronousClient asyncClient, Org.LaunchDarklyTools.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Org.LaunchDarklyTools.Client.ApiResponse<PullRequestCollectionRep> localVarResponse = GetPullRequestsWithHttpInfo(projectKey, environmentKey, applicationKey, status, query, limit, expand, sort, from, to, after, before);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PullRequestCollectionRep</returns>
        public Org.LaunchDarklyTools.Client.ApiResponse<PullRequestCollectionRep> GetPullRequestsWithHttpInfo(string projectKey, string? environmentKey = default(string?), string? applicationKey = default(string?), string? status = default(string?), string? query = default(string?), long? limit = default(long?), string? expand = default(string?), string? sort = default(string?), DateTime? from = default(DateTime?), DateTime? to = default(DateTime?), string? after = default(string?), string? before = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'projectKey' is set
            if (projectKey == null)
            {
                throw new Org.LaunchDarklyTools.Client.ApiException(400, "Missing required parameter 'projectKey' when calling InsightsPullRequestsBetaApi->GetPullRequests");
            }
            ...
            localVarRequestOptions.Operation = "InsightsPullRequestsBetaApi.GetPullRequests";
            ...
            var localVarResponse = this.Client.Get<PullRequestCollectionRep>("/api/v2/engineering-insights/pull-requests", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetPullRequests", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of PullRequestCollectionRep</returns>
        public async System.Threading.Tasks.Task<PullRequestCollectionRep> GetPullRequestsAsync(string projectKey, string? environmentKey = default(string?), string? applicationKey = default(string?), string? status = default(string?), string? query = default(string?), long? limit = default(long?), string? expand = default(string?), string? sort = default(string?), DateTime? from = default(DateTime?), DateTime? to = default(DateTime?), string? after = default(string?), string? before = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            Org.LaunchDarklyTools.Client.ApiResponse<PullRequestCollectionRep> localVarResponse = await GetPullRequestsWithHttpInfoAsync(projectKey, environmentKey, applicationKey, status, query, limit, expand, sort, from, to, after, before, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (PullRequestCollectionRep)</returns>
        public async System.Threading.Tasks.Task<Org.LaunchDarklyTools.Client.ApiResponse<PullRequestCollectionRep>> GetPullRequestsWithHttpInfoAsync(string projectKey, string? environmentKey = default(string?), string? applicationKey = default(string?), string? status = default(string?), string? query = default(string?), long? limit = default(long?), string? expand = default(string?), string? sort = default(string?), DateTime? from = default(DateTime?), DateTime? to = default(DateTime?), string? after = default(string?), string? before = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            // verify the required parameter 'projectKey' is set
            if (projectKey == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<PullRequestCollectionRep>("/api/v2/engineering-insights/pull-requests", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
