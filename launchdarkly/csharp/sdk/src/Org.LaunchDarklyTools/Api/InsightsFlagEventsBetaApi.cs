...
namespace Org.LaunchDarklyTools.Api
{
    ...
    /// </summary>
    public interface IInsightsFlagEventsBetaApiSync : IApiAccessor
    {
        ...
        /// <param name="query">Filter events by flag key (optional)</param>
        /// <param name="impactSize">Filter events by impact size. A small impact created a less than 20% change in the proportion of end users receiving one or more flag variations. A medium impact created between a 20%-80% change. A large impact created a more than 80% change. Options: &#x60;none&#x60;, &#x60;small&#x60;, &#x60;medium&#x60;, &#x60;large&#x60; (optional)</param>
        ...
        /// <param name="expand">Expand properties in response. Options: &#x60;experiments&#x60; (optional)</param>
        ...
        /// <returns>FlagEventCollectionRep</returns>
        FlagEventCollectionRep GetFlagEvents(string projectKey, string environmentKey, string? applicationKey = default(string?), string? query = default(string?), string? impactSize = default(string?), bool? hasExperiments = default(bool?), string? global = default(string?), string? expand = default(string?), long? limit = default(long?), long? from = default(long?), long? to = default(long?), string? after = default(string?), string? before = default(string?), int operationIndex = 0);
        ...
        /// <param name="before">Identifier used for pagination (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of FlagEventCollectionRep</returns>
        ApiResponse<FlagEventCollectionRep> GetFlagEventsWithHttpInfo(string projectKey, string environmentKey, string? applicationKey = default(string?), string? query = default(string?), string? impactSize = default(string?), bool? hasExperiments = default(bool?), string? global = default(string?), string? expand = default(string?), long? limit = default(long?), long? from = default(long?), long? to = default(long?), string? after = default(string?), string? before = default(string?), int operationIndex = 0);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IInsightsFlagEventsBetaApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of FlagEventCollectionRep</returns>
        System.Threading.Tasks.Task<FlagEventCollectionRep> GetFlagEventsAsync(string projectKey, string environmentKey, string? applicationKey = default(string?), string? query = default(string?), string? impactSize = default(string?), bool? hasExperiments = default(bool?), string? global = default(string?), string? expand = default(string?), long? limit = default(long?), long? from = default(long?), long? to = default(long?), string? after = default(string?), string? before = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (FlagEventCollectionRep)</returns>
        System.Threading.Tasks.Task<ApiResponse<FlagEventCollectionRep>> GetFlagEventsWithHttpInfoAsync(string projectKey, string environmentKey, string? applicationKey = default(string?), string? query = default(string?), string? impactSize = default(string?), bool? hasExperiments = default(bool?), string? global = default(string?), string? expand = default(string?), long? limit = default(long?), long? from = default(long?), long? to = default(long?), string? after = default(string?), string? before = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IInsightsFlagEventsBetaApi : IInsightsFlagEventsBetaApiSync, IInsightsFlagEventsBetaApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class InsightsFlagEventsBetaApi : IInsightsFlagEventsBetaApi
    {
        private Org.LaunchDarklyTools.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="InsightsFlagEventsBetaApi"/> class.
        /// </summary>
        /// <returns></returns>
        public InsightsFlagEventsBetaApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public InsightsFlagEventsBetaApi(string basePath)
        {
        ...
        /// <returns></returns>
        public InsightsFlagEventsBetaApi(Org.LaunchDarklyTools.Client.Configuration configuration)
        {
        ...
        public InsightsFlagEventsBetaApi(Org.LaunchDarklyTools.Client.ISynchronousClient client, Org.LaunchDarklyTools.Client.IAsynchronousClient asyncClient, Org.LaunchDarklyTools.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>FlagEventCollectionRep</returns>
        public FlagEventCollectionRep GetFlagEvents(string projectKey, string environmentKey, string? applicationKey = default(string?), string? query = default(string?), string? impactSize = default(string?), bool? hasExperiments = default(bool?), string? global = default(string?), string? expand = default(string?), long? limit = default(long?), long? from = default(long?), long? to = default(long?), string? after = default(string?), string? before = default(string?), int operationIndex = 0)
        {
            Org.LaunchDarklyTools.Client.ApiResponse<FlagEventCollectionRep> localVarResponse = GetFlagEventsWithHttpInfo(projectKey, environmentKey, applicationKey, query, impactSize, hasExperiments, global, expand, limit, from, to, after, before);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of FlagEventCollectionRep</returns>
        public Org.LaunchDarklyTools.Client.ApiResponse<FlagEventCollectionRep> GetFlagEventsWithHttpInfo(string projectKey, string environmentKey, string? applicationKey = default(string?), string? query = default(string?), string? impactSize = default(string?), bool? hasExperiments = default(bool?), string? global = default(string?), string? expand = default(string?), long? limit = default(long?), long? from = default(long?), long? to = default(long?), string? after = default(string?), string? before = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'projectKey' is set
            if (projectKey == null)
            {
                throw new Org.LaunchDarklyTools.Client.ApiException(400, "Missing required parameter 'projectKey' when calling InsightsFlagEventsBetaApi->GetFlagEvents");
            }

            // verify the required parameter 'environmentKey' is set
            if (environmentKey == null)
            {
                throw new Org.LaunchDarklyTools.Client.ApiException(400, "Missing required parameter 'environmentKey' when calling InsightsFlagEventsBetaApi->GetFlagEvents");
            }
            ...
            if (impactSize != null)
            {
                localVarRequestOptions.QueryParameters.Add(Org.LaunchDarklyTools.Client.ClientUtils.ParameterToMultiMap("", "impactSize", impactSize));
            }
            ...
            localVarRequestOptions.Operation = "InsightsFlagEventsBetaApi.GetFlagEvents";
            ...
            var localVarResponse = this.Client.Get<FlagEventCollectionRep>("/api/v2/engineering-insights/flag-events", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetFlagEvents", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of FlagEventCollectionRep</returns>
        public async System.Threading.Tasks.Task<FlagEventCollectionRep> GetFlagEventsAsync(string projectKey, string environmentKey, string? applicationKey = default(string?), string? query = default(string?), string? impactSize = default(string?), bool? hasExperiments = default(bool?), string? global = default(string?), string? expand = default(string?), long? limit = default(long?), long? from = default(long?), long? to = default(long?), string? after = default(string?), string? before = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            Org.LaunchDarklyTools.Client.ApiResponse<FlagEventCollectionRep> localVarResponse = await GetFlagEventsWithHttpInfoAsync(projectKey, environmentKey, applicationKey, query, impactSize, hasExperiments, global, expand, limit, from, to, after, before, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (FlagEventCollectionRep)</returns>
        public async System.Threading.Tasks.Task<Org.LaunchDarklyTools.Client.ApiResponse<FlagEventCollectionRep>> GetFlagEventsWithHttpInfoAsync(string projectKey, string environmentKey, string? applicationKey = default(string?), string? query = default(string?), string? impactSize = default(string?), bool? hasExperiments = default(bool?), string? global = default(string?), string? expand = default(string?), long? limit = default(long?), long? from = default(long?), long? to = default(long?), string? after = default(string?), string? before = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            // verify the required parameter 'projectKey' is set
            if (projectKey == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<FlagEventCollectionRep>("/api/v2/engineering-insights/flag-events", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
