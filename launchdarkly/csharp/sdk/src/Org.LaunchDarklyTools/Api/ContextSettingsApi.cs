...
namespace Org.LaunchDarklyTools.Api
{
    ...
    /// </summary>
    public interface IContextSettingsApiSync : IApiAccessor
    {
        ...
        /// <returns></returns>
        void PutContextFlagSetting(string projectKey, string environmentKey, string contextKind, string contextKey, string featureFlagKey, ValuePut valuePut, int operationIndex = 0);
        ...
        ApiResponse<Object> PutContextFlagSettingWithHttpInfo(string projectKey, string environmentKey, string contextKind, string contextKey, string featureFlagKey, ValuePut valuePut, int operationIndex = 0);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IContextSettingsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task PutContextFlagSettingAsync(string projectKey, string environmentKey, string contextKind, string contextKey, string featureFlagKey, ValuePut valuePut, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> PutContextFlagSettingWithHttpInfoAsync(string projectKey, string environmentKey, string contextKind, string contextKey, string featureFlagKey, ValuePut valuePut, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IContextSettingsApi : IContextSettingsApiSync, IContextSettingsApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class ContextSettingsApi : IContextSettingsApi
    {
        private Org.LaunchDarklyTools.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="ContextSettingsApi"/> class.
        /// </summary>
        /// <returns></returns>
        public ContextSettingsApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public ContextSettingsApi(string basePath)
        {
        ...
        /// <returns></returns>
        public ContextSettingsApi(Org.LaunchDarklyTools.Client.Configuration configuration)
        {
        ...
        public ContextSettingsApi(Org.LaunchDarklyTools.Client.ISynchronousClient client, Org.LaunchDarklyTools.Client.IAsynchronousClient asyncClient, Org.LaunchDarklyTools.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns></returns>
        public void PutContextFlagSetting(string projectKey, string environmentKey, string contextKind, string contextKey, string featureFlagKey, ValuePut valuePut, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Org.LaunchDarklyTools.Client.ApiResponse<Object> PutContextFlagSettingWithHttpInfo(string projectKey, string environmentKey, string contextKind, string contextKey, string featureFlagKey, ValuePut valuePut, int operationIndex = 0)
        {
            // verify the required parameter 'projectKey' is set
            if (projectKey == null)
            {
                throw new Org.LaunchDarklyTools.Client.ApiException(400, "Missing required parameter 'projectKey' when calling ContextSettingsApi->PutContextFlagSetting");
            }

            // verify the required parameter 'environmentKey' is set
            if (environmentKey == null)
            {
                throw new Org.LaunchDarklyTools.Client.ApiException(400, "Missing required parameter 'environmentKey' when calling ContextSettingsApi->PutContextFlagSetting");
            }

            // verify the required parameter 'contextKind' is set
            if (contextKind == null)
            {
                throw new Org.LaunchDarklyTools.Client.ApiException(400, "Missing required parameter 'contextKind' when calling ContextSettingsApi->PutContextFlagSetting");
            }

            // verify the required parameter 'contextKey' is set
            if (contextKey == null)
            {
                throw new Org.LaunchDarklyTools.Client.ApiException(400, "Missing required parameter 'contextKey' when calling ContextSettingsApi->PutContextFlagSetting");
            }

            // verify the required parameter 'featureFlagKey' is set
            if (featureFlagKey == null)
            {
                throw new Org.LaunchDarklyTools.Client.ApiException(400, "Missing required parameter 'featureFlagKey' when calling ContextSettingsApi->PutContextFlagSetting");
            }

            // verify the required parameter 'valuePut' is set
            if (valuePut == null)
            {
                throw new Org.LaunchDarklyTools.Client.ApiException(400, "Missing required parameter 'valuePut' when calling ContextSettingsApi->PutContextFlagSetting");
            }
            ...
            localVarRequestOptions.PathParameters.Add("contextKind", Org.LaunchDarklyTools.Client.ClientUtils.ParameterToString(contextKind)); // path parameter
            ...
            localVarRequestOptions.Operation = "ContextSettingsApi.PutContextFlagSetting";
            ...
            var localVarResponse = this.Client.Put<Object>("/api/v2/projects/{projectKey}/environments/{environmentKey}/contexts/{contextKind}/{contextKey}/flags/{featureFlagKey}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PutContextFlagSetting", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task PutContextFlagSettingAsync(string projectKey, string environmentKey, string contextKind, string contextKey, string featureFlagKey, ValuePut valuePut, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            await PutContextFlagSettingWithHttpInfoAsync(projectKey, environmentKey, contextKind, contextKey, featureFlagKey, valuePut, operationIndex, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Org.LaunchDarklyTools.Client.ApiResponse<Object>> PutContextFlagSettingWithHttpInfoAsync(string projectKey, string environmentKey, string contextKind, string contextKey, string featureFlagKey, ValuePut valuePut, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            // verify the required parameter 'projectKey' is set
            if (projectKey == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PutAsync<Object>("/api/v2/projects/{projectKey}/environments/{environmentKey}/contexts/{contextKind}/{contextKey}/flags/{featureFlagKey}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
