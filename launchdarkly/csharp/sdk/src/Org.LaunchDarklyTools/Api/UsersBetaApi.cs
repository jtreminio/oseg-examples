...
namespace Org.LaunchDarklyTools.Api
{
    ...
    /// </summary>
    public interface IUsersBetaApiSync : IApiAccessor
    {
        ...
        /// <returns>UserAttributeNamesRep</returns>
        [Obsolete]
        UserAttributeNamesRep GetUserAttributeNames(string projectKey, string environmentKey, int operationIndex = 0);
        ...
        /// <param name="environmentKey">The environment key</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of UserAttributeNamesRep</returns>
        [Obsolete]
        ApiResponse<UserAttributeNamesRep> GetUserAttributeNamesWithHttpInfo(string projectKey, string environmentKey, int operationIndex = 0);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IUsersBetaApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of UserAttributeNamesRep</returns>
        [Obsolete]
        System.Threading.Tasks.Task<UserAttributeNamesRep> GetUserAttributeNamesAsync(string projectKey, string environmentKey, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (UserAttributeNamesRep)</returns>
        [Obsolete]
        System.Threading.Tasks.Task<ApiResponse<UserAttributeNamesRep>> GetUserAttributeNamesWithHttpInfoAsync(string projectKey, string environmentKey, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IUsersBetaApi : IUsersBetaApiSync, IUsersBetaApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class UsersBetaApi : IUsersBetaApi
    {
        private Org.LaunchDarklyTools.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="UsersBetaApi"/> class.
        /// </summary>
        /// <returns></returns>
        public UsersBetaApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public UsersBetaApi(string basePath)
        {
        ...
        /// <returns></returns>
        public UsersBetaApi(Org.LaunchDarklyTools.Client.Configuration configuration)
        {
        ...
        public UsersBetaApi(Org.LaunchDarklyTools.Client.ISynchronousClient client, Org.LaunchDarklyTools.Client.IAsynchronousClient asyncClient, Org.LaunchDarklyTools.Client.IReadableConfiguration configuration)
        {
        ...
        /// <returns>UserAttributeNamesRep</returns>
        [Obsolete]
        public UserAttributeNamesRep GetUserAttributeNames(string projectKey, string environmentKey, int operationIndex = 0)
        {
            Org.LaunchDarklyTools.Client.ApiResponse<UserAttributeNamesRep> localVarResponse = GetUserAttributeNamesWithHttpInfo(projectKey, environmentKey);
        ...
        /// <returns>ApiResponse of UserAttributeNamesRep</returns>
        [Obsolete]
        public Org.LaunchDarklyTools.Client.ApiResponse<UserAttributeNamesRep> GetUserAttributeNamesWithHttpInfo(string projectKey, string environmentKey, int operationIndex = 0)
        {
            // verify the required parameter 'projectKey' is set
            if (projectKey == null)
            {
                throw new Org.LaunchDarklyTools.Client.ApiException(400, "Missing required parameter 'projectKey' when calling UsersBetaApi->GetUserAttributeNames");
            }

            // verify the required parameter 'environmentKey' is set
            if (environmentKey == null)
            {
                throw new Org.LaunchDarklyTools.Client.ApiException(400, "Missing required parameter 'environmentKey' when calling UsersBetaApi->GetUserAttributeNames");
            }
            ...
            localVarRequestOptions.Operation = "UsersBetaApi.GetUserAttributeNames";
            ...
            var localVarResponse = this.Client.Get<UserAttributeNamesRep>("/api/v2/user-attributes/{projectKey}/{environmentKey}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetUserAttributeNames", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <returns>Task of UserAttributeNamesRep</returns>
        [Obsolete]
        public async System.Threading.Tasks.Task<UserAttributeNamesRep> GetUserAttributeNamesAsync(string projectKey, string environmentKey, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            Org.LaunchDarklyTools.Client.ApiResponse<UserAttributeNamesRep> localVarResponse = await GetUserAttributeNamesWithHttpInfoAsync(projectKey, environmentKey, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <returns>Task of ApiResponse (UserAttributeNamesRep)</returns>
        [Obsolete]
        public async System.Threading.Tasks.Task<Org.LaunchDarklyTools.Client.ApiResponse<UserAttributeNamesRep>> GetUserAttributeNamesWithHttpInfoAsync(string projectKey, string environmentKey, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            // verify the required parameter 'projectKey' is set
            if (projectKey == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<UserAttributeNamesRep>("/api/v2/user-attributes/{projectKey}/{environmentKey}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
