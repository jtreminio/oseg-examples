...
namespace Org.LaunchDarklyTools.Model
{
    ...
    /// ProjectRep
    /// </summary>
    [DataContract(Name = "ProjectRep")]
    public partial class ProjectRep : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectRep" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProjectRep() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectRep" /> class.
        /// </summary>
        /// <param name="links">The location and content type of related resources (required).</param>
        /// <param name="id">The ID of this project (required).</param>
        /// <param name="key">The key of this project (required).</param>
        /// <param name="includeInSnippetByDefault">Whether or not flags created in this project are made available to the client-side JavaScript SDK by default (required).</param>
        /// <param name="defaultClientSideAvailability">defaultClientSideAvailability.</param>
        /// <param name="name">A human-friendly name for the project (required).</param>
        /// <param name="access">access.</param>
        /// <param name="tags">A list of tags for the project (required).</param>
        /// <param name="defaultReleasePipelineKey">The key of the default release pipeline for this project.</param>
        /// <param name="environments">A list of environments for the project (required).</param>
        public ProjectRep(Dictionary<string, Link> links = default(Dictionary<string, Link>), string id = default(string), string key = default(string), bool includeInSnippetByDefault = default(bool), ClientSideAvailability defaultClientSideAvailability = default(ClientSideAvailability), string name = default(string), Access access = default(Access), List<string> tags = default(List<string>), string defaultReleasePipelineKey = default(string), List<ModelEnvironment> environments = default(List<ModelEnvironment>))
        {
            // to ensure "links" is required (not null)
            if (links == null)
            {
                throw new ArgumentNullException("links is a required property for ProjectRep and cannot be null");
            }
            this.Links = links;
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for ProjectRep and cannot be null");
            }
            this.Id = id;
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for ProjectRep and cannot be null");
            }
            this.Key = key;
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for ProjectRep and cannot be null");
            }
            this.Name = name;
            // to ensure "tags" is required (not null)
            if (tags == null)
            {
                throw new ArgumentNullException("tags is a required property for ProjectRep and cannot be null");
            }
            this.Tags = tags;
            // to ensure "environments" is required (not null)
            if (environments == null)
            {
                throw new ArgumentNullException("environments is a required property for ProjectRep and cannot be null");
            }
        ...
        /*
        <example>{&quot;environments&quot;:{&quot;href&quot;:&quot;/api/v2/projects/my-project/environments&quot;,&quot;type&quot;:&quot;application/json&quot;},&quot;self&quot;:{&quot;href&quot;:&quot;/api/v2/projects/my-project&quot;,&quot;type&quot;:&quot;application/json&quot;}}</example>
        */
        ...
        /// </summary>
        /// <value>The ID of this project</value>
        /*
        <example>57be1db38b75bf0772d11383</example>
        */
        ...
        /// </summary>
        /// <value>The key of this project</value>
        /*
        <example>project-key-123abc</example>
        */
        ...
        /// </summary>
        /// <value>Whether or not flags created in this project are made available to the client-side JavaScript SDK by default</value>
        /*
        <example>true</example>
        */
        [DataMember(Name = "includeInSnippetByDefault", IsRequired = true, EmitDefaultValue = true)]
        ...
        /// </summary>
        /// <value>A human-friendly name for the project</value>
        /*
        ...
        */
        ...
        /// </summary>
        /// <value>A list of tags for the project</value>
        /*
        <example>[&quot;ops&quot;]</example>
        */
        ...
        /// </summary>
        /// <value>The key of the default release pipeline for this project</value>
        [DataMember(Name = "defaultReleasePipelineKey", EmitDefaultValue = false)]
        public string DefaultReleasePipelineKey { get; set; }

        /// <summary>
        /// A list of environments for the project
        /// </summary>
        /// <value>A list of environments for the project</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  DefaultReleasePipelineKey: ").Append(DefaultReleasePipelineKey).Append("\n");
