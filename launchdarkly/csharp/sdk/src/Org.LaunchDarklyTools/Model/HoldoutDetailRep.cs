...
namespace Org.LaunchDarklyTools.Model
{
    ...
    /// HoldoutDetailRep
    /// </summary>
    [DataContract(Name = "HoldoutDetailRep")]
    public partial class HoldoutDetailRep : IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="HoldoutDetailRep" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected HoldoutDetailRep() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="HoldoutDetailRep" /> class.
        /// </summary>
        ...
        /// <param name="holdoutAmount">The percentage of traffic allocated to this holdout. (required).</param>
        /// <param name="isDirty">Indicates if the holdout experiment is running and if any related experiments are running..</param>
        /// <param name="createdAt">createdAt (required).</param>
        /// <param name="updatedAt">updatedAt (required).</param>
        /// <param name="baseExperiment">baseExperiment (required).</param>
        /// <param name="relatedExperiments">relatedExperiments.</param>
        public HoldoutDetailRep(string id = default(string), StatusEnum status = default(StatusEnum), string description = default(string), string holdoutAmount = default(string), bool isDirty = default(bool), long createdAt = default(long), long updatedAt = default(long), Experiment baseExperiment = default(Experiment), List<Experiment> relatedExperiments = default(List<Experiment>))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for HoldoutDetailRep and cannot be null");
            }
            this.Id = id;
            this.Status = status;
            // to ensure "holdoutAmount" is required (not null)
            if (holdoutAmount == null)
            {
                throw new ArgumentNullException("holdoutAmount is a required property for HoldoutDetailRep and cannot be null");
            }
            this.HoldoutAmount = holdoutAmount;
            this.CreatedAt = createdAt;
            this.UpdatedAt = updatedAt;
            // to ensure "baseExperiment" is required (not null)
            if (baseExperiment == null)
            {
                throw new ArgumentNullException("baseExperiment is a required property for HoldoutDetailRep and cannot be null");
            }
        ...
        /// </summary>
        /// <value>The percentage of traffic allocated to this holdout.</value>
        [DataMember(Name = "holdoutAmount", IsRequired = true, EmitDefaultValue = true)]
        ...
        /// </summary>
        /// <value>Indicates if the holdout experiment is running and if any related experiments are running.</value>
        [DataMember(Name = "isDirty", EmitDefaultValue = true)]
        ...
        */
        ...
        /// <summary>
        /// Gets or Sets BaseExperiment
        /// </summary>
        [DataMember(Name = "baseExperiment", IsRequired = true, EmitDefaultValue = true)]
        public Experiment BaseExperiment { get; set; }

        /// <summary>
        /// Gets or Sets RelatedExperiments
        /// </summary>
        [DataMember(Name = "relatedExperiments", EmitDefaultValue = false)]
        public List<Experiment> RelatedExperiments { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  BaseExperiment: ").Append(BaseExperiment).Append("\n");
            sb.Append("  RelatedExperiments: ").Append(RelatedExperiments).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
