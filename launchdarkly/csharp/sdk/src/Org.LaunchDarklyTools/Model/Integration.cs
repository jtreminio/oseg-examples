...
namespace Org.LaunchDarklyTools.Model
{
    ...
    public partial class Integration : IValidatableObject
    {
        ...
        /// <param name="id">The ID for this integration audit log subscription.</param>
        /// <param name="kind">The type of integration.</param>
        /// <param name="name">A human-friendly name for the integration.</param>
        /// <param name="config">Details on configuration for an integration of this type. Refer to the &lt;code&gt;formVariables&lt;/code&gt; field in the corresponding &lt;code&gt;manifest.json&lt;/code&gt; for a full list of fields for each integration..</param>
        /// <param name="statements">Represents a Custom role policy, defining a resource kinds filter the integration audit log subscription responds to..</param>
        /// <param name="on">Whether the integration is currently active.</param>
        /// <param name="tags">An array of tags for this integration.</param>
        /// <param name="access">access.</param>
        /// <param name="status">status.</param>
        /// <param name="url">Slack webhook receiver URL. Only used for legacy Slack webhook integrations..</param>
        /// <param name="apiKey">Datadog API key. Only used for legacy Datadog webhook integrations..</param>
        public Integration(Dictionary<string, Link> links = default(Dictionary<string, Link>), string id = default(string), string kind = default(string), string name = default(string), Dictionary<string, Object> config = default(Dictionary<string, Object>), List<Statement> statements = default(List<Statement>), bool on = default(bool), List<string> tags = default(List<string>), Access access = default(Access), IntegrationSubscriptionStatusRep status = default(IntegrationSubscriptionStatusRep), string url = default(string), string apiKey = default(string))
        {
            this.Links = links;
            this.Id = id;
            this.Kind = kind;
        ...
        /// </summary>
        /// <value>The ID for this integration audit log subscription</value>
        /*
        ...
        */
        ...
        /// </summary>
        /// <value>Represents a Custom role policy, defining a resource kinds filter the integration audit log subscription responds to.</value>
        ...
        */
        ...
        public IntegrationSubscriptionStatusRep Status { get; set; }

        /// <summary>
        /// Slack webhook receiver URL. Only used for legacy Slack webhook integrations.
        /// </summary>
        /// <value>Slack webhook receiver URL. Only used for legacy Slack webhook integrations.</value>
        ...
        /// </summary>
        /// <value>Datadog API key. Only used for legacy Datadog webhook integrations.</value>
