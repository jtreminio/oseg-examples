...
namespace Org.LaunchDarklyTools.Model
{
    ...
    /// FlagEventRep
    /// </summary>
    [DataContract(Name = "FlagEventRep")]
    public partial class FlagEventRep : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FlagEventRep" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FlagEventRep() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FlagEventRep" /> class.
        /// </summary>
        /// <param name="id">The flag event ID (required).</param>
        ...
        /// <param name="flagKey">The flag key (required).</param>
        /// <param name="eventType">eventType (required).</param>
        /// <param name="eventTime">eventTime (required).</param>
        /// <param name="description">The event description (required).</param>
        /// <param name="auditLogEntryId">The audit log entry ID.</param>
        /// <param name="member">member.</param>
        /// <param name="actions">The resource actions.</param>
        /// <param name="impact">impact (required).</param>
        /// <param name="experiments">experiments.</param>
        public FlagEventRep(Guid id = default(Guid), string projectId = default(string), string projectKey = default(string), string environmentId = default(string), string environmentKey = default(string), string flagKey = default(string), string eventType = default(string), long eventTime = default(long), string description = default(string), string auditLogEntryId = default(string), FlagEventMemberRep member = default(FlagEventMemberRep), List<string> actions = default(List<string>), FlagEventImpactRep impact = default(FlagEventImpactRep), FlagEventExperimentCollection experiments = default(FlagEventExperimentCollection))
        {
            this.Id = id;
            // to ensure "projectId" is required (not null)
            if (projectId == null)
            {
                throw new ArgumentNullException("projectId is a required property for FlagEventRep and cannot be null");
            }
            this.ProjectId = projectId;
            // to ensure "projectKey" is required (not null)
            if (projectKey == null)
            {
                throw new ArgumentNullException("projectKey is a required property for FlagEventRep and cannot be null");
            }
            this.ProjectKey = projectKey;
            // to ensure "flagKey" is required (not null)
            if (flagKey == null)
            {
                throw new ArgumentNullException("flagKey is a required property for FlagEventRep and cannot be null");
            }
            this.FlagKey = flagKey;
            // to ensure "eventType" is required (not null)
            if (eventType == null)
            {
                throw new ArgumentNullException("eventType is a required property for FlagEventRep and cannot be null");
            }
            ...
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for FlagEventRep and cannot be null");
            }
            this.Description = description;
            // to ensure "impact" is required (not null)
            if (impact == null)
            {
                throw new ArgumentNullException("impact is a required property for FlagEventRep and cannot be null");
            }
            this.Impact = impact;
        ...
        /// The flag event ID
        /// </summary>
        /// <value>The flag event ID</value>
        /*
        <example>e3b2b0e0-9e9b-4c9a-8e9a-0e0e0e0e0e0e</example>
        */
        ...
        /*
        <example>65baa44ecc4b5bce113bb4f7</example>
        */
        ...
        */
        ...
        /// The flag key
        /// </summary>
        /// <value>The flag key</value>
        /*
        <example>enable-new-payment-method</example>
        */
        [DataMember(Name = "flagKey", IsRequired = true, EmitDefaultValue = true)]
        ...
        */
        ...
        /*
        <example>Targeting rule enabled</example>
        */
        ...
        /// </summary>
        /// <value>The audit log entry ID</value>
        /*
        <example>e3b2b0e0-9e9b-4c9a-8e9a-0e0e0e0e0e0e</example>
        */
        ...
        public FlagEventMemberRep Member { get; set; }

        /// <summary>
        /// The resource actions
        /// </summary>
        /// <value>The resource actions</value>
        ...
        public FlagEventImpactRep Impact { get; set; }

        /// <summary>
        /// Gets or Sets Experiments
        /// </summary>
        [DataMember(Name = "experiments", EmitDefaultValue = false)]
        public FlagEventExperimentCollection Experiments { get; set; }
