...
namespace Org.LaunchDarklyTools.Model
{
    ...
    /// PullRequestRep
    /// </summary>
    [DataContract(Name = "PullRequestRep")]
    public partial class PullRequestRep : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PullRequestRep" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PullRequestRep() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PullRequestRep" /> class.
        /// </summary>
        /// <param name="id">The pull request internal ID (required).</param>
        /// <param name="externalId">The pull request number (required).</param>
        /// <param name="title">The pull request title (required).</param>
        /// <param name="status">The pull request status (required).</param>
        /// <param name="author">The pull request author (required).</param>
        /// <param name="createTime">createTime (required).</param>
        /// <param name="mergeTime">mergeTime.</param>
        /// <param name="mergeCommitKey">The pull request merge commit key.</param>
        /// <param name="baseCommitKey">The pull request base commit key (required).</param>
        /// <param name="headCommitKey">The pull request head commit key (required).</param>
        /// <param name="filesChanged">The number of files changed (required).</param>
        ...
        /// <param name="url">The pull request URL (required).</param>
        /// <param name="deployments">deployments.</param>
        /// <param name="flagReferences">flagReferences.</param>
        /// <param name="leadTime">leadTime.</param>
        public PullRequestRep(Guid id = default(Guid), string externalId = default(string), string title = default(string), string status = default(string), string author = default(string), long createTime = default(long), long mergeTime = default(long), string mergeCommitKey = default(string), string baseCommitKey = default(string), string headCommitKey = default(string), int filesChanged = default(int), int linesAdded = default(int), int linesDeleted = default(int), string url = default(string), DeploymentCollectionRep deployments = default(DeploymentCollectionRep), FlagReferenceCollectionRep flagReferences = default(FlagReferenceCollectionRep), PullRequestLeadTimeRep leadTime = default(PullRequestLeadTimeRep))
        {
            this.Id = id;
            // to ensure "externalId" is required (not null)
            if (externalId == null)
            {
                throw new ArgumentNullException("externalId is a required property for PullRequestRep and cannot be null");
            }
            this.ExternalId = externalId;
            // to ensure "title" is required (not null)
            if (title == null)
            {
                throw new ArgumentNullException("title is a required property for PullRequestRep and cannot be null");
            }
            this.Title = title;
            // to ensure "status" is required (not null)
            if (status == null)
            {
                throw new ArgumentNullException("status is a required property for PullRequestRep and cannot be null");
            }
            this.Status = status;
            // to ensure "author" is required (not null)
            if (author == null)
            {
                throw new ArgumentNullException("author is a required property for PullRequestRep and cannot be null");
            }
            this.Author = author;
            this.CreateTime = createTime;
            // to ensure "baseCommitKey" is required (not null)
            if (baseCommitKey == null)
            {
                throw new ArgumentNullException("baseCommitKey is a required property for PullRequestRep and cannot be null");
            }
            this.BaseCommitKey = baseCommitKey;
            // to ensure "headCommitKey" is required (not null)
            if (headCommitKey == null)
            {
                throw new ArgumentNullException("headCommitKey is a required property for PullRequestRep and cannot be null");
            }
            ...
            if (url == null)
            {
                throw new ArgumentNullException("url is a required property for PullRequestRep and cannot be null");
            }
            this.Url = url;
        ...
        /// </summary>
        /// <value>The pull request internal ID</value>
        /*
        ...
        */
        ...
        /// </summary>
        /// <value>The pull request title</value>
        /*
        <example>Enable new payment structure</example>
        */
        ...
        /// </summary>
        /// <value>The pull request status</value>
        /*
        ...
        */
        ...
        /// </summary>
        /// <value>The pull request author</value>
        /*
        ...
        */
        ...
        /// <summary>
        /// Gets or Sets MergeTime
        /// </summary>
        /*
        <example>1706701522000</example>
        */
        [DataMember(Name = "mergeTime", EmitDefaultValue = false)]
        public long MergeTime { get; set; }

        /// <summary>
        /// The pull request merge commit key
        /// </summary>
        /// <value>The pull request merge commit key</value>
        /*
        <example>a90a8a2</example>
        */
        [DataMember(Name = "mergeCommitKey", EmitDefaultValue = false)]
        public string MergeCommitKey { get; set; }

        /// <summary>
        /// The pull request base commit key
        /// </summary>
        /// <value>The pull request base commit key</value>
        /*
        <example>a90a8a2</example>
        */
        [DataMember(Name = "baseCommitKey", IsRequired = true, EmitDefaultValue = true)]
        public string BaseCommitKey { get; set; }

        /// <summary>
        /// The pull request head commit key
        /// </summary>
        /// <value>The pull request head commit key</value>
        /*
        <example>a90a8a2</example>
        */
        [DataMember(Name = "headCommitKey", IsRequired = true, EmitDefaultValue = true)]
        public string HeadCommitKey { get; set; }

        /// <summary>
        /// The number of files changed
        /// </summary>
        /// <value>The number of files changed</value>
        /*
        <example>2</example>
        */
        [DataMember(Name = "filesChanged", IsRequired = true, EmitDefaultValue = true)]
        ...
        */
        ...
        /// </summary>
        /// <value>The pull request URL</value>
        /*
        <example>https://github.com/launchdarkly/LaunchDarkly-Docs/pull/406</example>
        */
        ...
        public DeploymentCollectionRep Deployments { get; set; }
        ...
        public PullRequestLeadTimeRep LeadTime { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  MergeTime: ").Append(MergeTime).Append("\n");
            sb.Append("  MergeCommitKey: ").Append(MergeCommitKey).Append("\n");
            sb.Append("  BaseCommitKey: ").Append(BaseCommitKey).Append("\n");
            sb.Append("  HeadCommitKey: ").Append(HeadCommitKey).Append("\n");
