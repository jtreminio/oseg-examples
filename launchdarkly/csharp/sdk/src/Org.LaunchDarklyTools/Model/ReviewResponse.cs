...
namespace Org.LaunchDarklyTools.Model
{
    ...
    /// ReviewResponse
    /// </summary>
    [DataContract(Name = "ReviewResponse")]
    public partial class ReviewResponse : IValidatableObject
    {
        /// <summary>
        /// The type of review action to take
        /// </summary>
        /// <value>The type of review action to take</value>
        ...
        */
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ReviewResponse" /> class.
        /// </summary>
        ...
        /// Initializes a new instance of the <see cref="ReviewResponse" /> class.
        /// </summary>
        /// <param name="id">The approval request ID (required).</param>
        /// <param name="kind">The type of review action to take (required).</param>
        /// <param name="creationDate">creationDate.</param>
        /// <param name="comment">A comment describing the approval response.</param>
        /// <param name="memberId">ID of account member that reviewed request.</param>
        /// <param name="serviceTokenId">ID of account service token that reviewed request.</param>
        public ReviewResponse(string id = default(string), KindEnum kind = default(KindEnum), long creationDate = default(long), string comment = default(string), string memberId = default(string), string serviceTokenId = default(string))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for ReviewResponse and cannot be null");
            }
            this.Id = id;
            this.Kind = kind;
        ...
        /// </summary>
        /// <value>The approval request ID</value>
        /*
        ...
        */
        ...
        /// </summary>
        /// <value>A comment describing the approval response</value>
        /*
        ...
        */
        ...
        /// </summary>
        /// <value>ID of account member that reviewed request</value>
        /*
        <example>12ab3c45de678910abc12345</example>
        */
        ...
        /// </summary>
        /// <value>ID of account service token that reviewed request</value>
        /*
        <example>12ab3c45de678910abc12345</example>
        */
        [DataMember(Name = "serviceTokenId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ServiceTokenId: ").Append(ServiceTokenId).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
