...
namespace Org.LaunchDarklyTools.Model
{
    ...
    /// ApplicationRep
    /// </summary>
    [DataContract(Name = "ApplicationRep")]
    public partial class ApplicationRep : IValidatableObject
    {
        /// <summary>
        /// To distinguish the kind of application
        /// </summary>
        /// <value>To distinguish the kind of application</value>
        ...
        */
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationRep" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ApplicationRep() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationRep" /> class.
        /// </summary>
        ...
        /// <param name="autoAdded">Whether the application was automatically created because it was included in a context when a LaunchDarkly SDK evaluated a feature flag, or was created through the LaunchDarkly UI or REST API. (required).</param>
        /// <param name="creationDate">creationDate.</param>
        /// <param name="description">The application description.</param>
        /// <param name="key">The unique identifier of this application (required).</param>
        /// <param name="kind">To distinguish the kind of application (required).</param>
        /// <param name="maintainer">maintainer.</param>
        /// <param name="name">The name of the application (required).</param>
        public ApplicationRep(ApplicationFlagCollectionRep flags = default(ApplicationFlagCollectionRep), Access access = default(Access), Dictionary<string, Link> links = default(Dictionary<string, Link>), int varVersion = default(int), bool autoAdded = default(bool), long creationDate = default(long), string description = default(string), string key = default(string), KindEnum kind = default(KindEnum), MaintainerRep maintainer = default(MaintainerRep), string name = default(string))
        {
            this.AutoAdded = autoAdded;
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for ApplicationRep and cannot be null");
            }
            this.Key = key;
            this.Kind = kind;
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for ApplicationRep and cannot be null");
            }
            this.Name = name;
            this.Flags = flags;
            this.Access = access;
        ...
        public ApplicationFlagCollectionRep Flags { get; set; }
        ...
        /// </summary>
        /// <value>Whether the application was automatically created because it was included in a context when a LaunchDarkly SDK evaluated a feature flag, or was created through the LaunchDarkly UI or REST API.</value>
        /*
        <example>true</example>
        */
        [DataMember(Name = "autoAdded", IsRequired = true, EmitDefaultValue = true)]
        ...
        */
        ...
        /*
        <example>The LaunchDarkly Cafe app</example>
        */
        ...
        /// </summary>
        /// <value>The unique identifier of this application</value>
        /*
        <example>com.launchdarkly.cafe</example>
        */
        ...
        /*
        <example>LaunchDarklyCafe</example>
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AutoAdded: ").Append(AutoAdded).Append("\n");
