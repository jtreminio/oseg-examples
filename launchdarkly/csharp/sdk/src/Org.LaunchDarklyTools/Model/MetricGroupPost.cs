...
namespace Org.LaunchDarklyTools.Model
{
    ...
    /// MetricGroupPost
    /// </summary>
    [DataContract(Name = "MetricGroupPost")]
    public partial class MetricGroupPost : IValidatableObject
    {
        /// <summary>
        ...
        */
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MetricGroupPost" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MetricGroupPost() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MetricGroupPost" /> class.
        /// </summary>
        ...
        /// <param name="maintainerId">The ID of the member who maintains this metric group (required).</param>
        ...
        public MetricGroupPost(string key = default(string), string name = default(string), KindEnum kind = default(KindEnum), string description = default(string), string maintainerId = default(string), List<string> tags = default(List<string>), List<MetricInMetricGroupInput> metrics = default(List<MetricInMetricGroupInput>))
        {
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for MetricGroupPost and cannot be null");
            }
            this.Key = key;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for MetricGroupPost and cannot be null");
            }
            this.Name = name;
            this.Kind = kind;
            ...
            {
                throw new ArgumentNullException("maintainerId is a required property for MetricGroupPost and cannot be null");
            }
            this.MaintainerId = maintainerId;
            // to ensure "tags" is required (not null)
            if (tags == null)
            {
                throw new ArgumentNullException("tags is a required property for MetricGroupPost and cannot be null");
            }
            this.Tags = tags;
            // to ensure "metrics" is required (not null)
            if (metrics == null)
            {
                throw new ArgumentNullException("metrics is a required property for MetricGroupPost and cannot be null");
            }
        ...
        */
        ...
        /// </summary>
        /// <value>The ID of the member who maintains this metric group</value>
        /*
        <example>569fdeadbeef1644facecafe</example>
        */
        [DataMember(Name = "maintainerId", IsRequired = true, EmitDefaultValue = true)]
        ...
        */
        ...
        public List<MetricInMetricGroupInput> Metrics { get; set; }
