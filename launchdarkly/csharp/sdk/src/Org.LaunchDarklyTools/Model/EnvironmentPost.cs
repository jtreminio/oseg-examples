...
namespace Org.LaunchDarklyTools.Model
{
    ...
    /// EnvironmentPost
    /// </summary>
    [DataContract(Name = "EnvironmentPost")]
    public partial class EnvironmentPost : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EnvironmentPost" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EnvironmentPost() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EnvironmentPost" /> class.
        /// </summary>
        ...
        /// <param name="color">A color to indicate this environment in the UI (required).</param>
        /// <param name="defaultTtl">The default time (in minutes) that the PHP SDK can cache feature flag rules locally.</param>
        /// <param name="secureMode">Ensures that one end user of the client-side SDK cannot inspect the variations for another end user.</param>
        /// <param name="defaultTrackEvents">Enables tracking detailed information for new flags by default.</param>
        /// <param name="confirmChanges">Requires confirmation for all flag and segment changes via the UI in this environment.</param>
        /// <param name="requireComments">Requires comments for all flag and segment changes via the UI in this environment.</param>
        /// <param name="tags">Tags to apply to the new environment.</param>
        /// <param name="source">source.</param>
        /// <param name="critical">Whether the environment is critical.</param>
        public EnvironmentPost(string name = default(string), string key = default(string), string color = default(string), int defaultTtl = default(int), bool secureMode = default(bool), bool defaultTrackEvents = default(bool), bool confirmChanges = default(bool), bool requireComments = default(bool), List<string> tags = default(List<string>), SourceEnv source = default(SourceEnv), bool critical = default(bool))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for EnvironmentPost and cannot be null");
            }
            this.Name = name;
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for EnvironmentPost and cannot be null");
            }
            this.Key = key;
            // to ensure "color" is required (not null)
            if (color == null)
            {
                throw new ArgumentNullException("color is a required property for EnvironmentPost and cannot be null");
            }
            this.Color = color;
        ...
        */
        ...
        /// </summary>
        /// <value>A color to indicate this environment in the UI</value>
        /*
        ...
        */
        ...
        /// </summary>
        /// <value>Requires confirmation for all flag and segment changes via the UI in this environment</value>
        /*
        <example>false</example>
        */
        ...
        /// </summary>
        /// <value>Requires comments for all flag and segment changes via the UI in this environment</value>
        /*
        <example>false</example>
        */
        ...
        /// </summary>
        /// <value>Tags to apply to the new environment</value>
        /*
        <example>[&quot;ops&quot;]</example>
        */
        ...
        public SourceEnv Source { get; set; }
