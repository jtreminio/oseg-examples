...
namespace Org.LaunchDarklyTools.Model
{
    ...
    public partial class User : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="key">The user key. This is the only mandatory user attribute..</param>
        /// <param name="secondary">If provided, used with the user key to generate a variation in percentage rollouts.</param>
        /// <param name="ip">The user&#39;s IP address.</param>
        /// <param name="country">The user&#39;s country.</param>
        /// <param name="email">The user&#39;s email.</param>
        /// <param name="firstName">The user&#39;s first name.</param>
        /// <param name="lastName">The user&#39;s last name.</param>
        /// <param name="avatar">An absolute URL to an avatar image..</param>
        /// <param name="name">The user&#39;s full name.</param>
        /// <param name="anonymous">Whether the user is anonymous. If true, this user does not appear on the Contexts list in the LaunchDarkly user interface..</param>
        /// <param name="custom">Any other custom attributes for this user. Custom attributes contain any other user data that you would like to use to conditionally target your users..</param>
        /// <param name="privateAttrs">A list of attribute names that are marked as private. You can use these attributes in targeting rules and segments. If you are using a server-side SDK, the SDK will not send the private attribute back to LaunchDarkly. If you are using a client-side SDK, the SDK will send the private attribute back to LaunchDarkly for evaluation. However, the SDK won&#39;t send the attribute to LaunchDarkly in events data, LaunchDarkly won&#39;t store the private attribute, and the private attribute will not appear on the Contexts list..</param>
        public User(string key = default(string), string secondary = default(string), string ip = default(string), string country = default(string), string email = default(string), string firstName = default(string), string lastName = default(string), string avatar = default(string), string name = default(string), bool anonymous = default(bool), Dictionary<string, Object> custom = default(Dictionary<string, Object>), List<string> privateAttrs = default(List<string>))
        {
            this.Key = key;
        ...
        /// </summary>
        /// <value>The user key. This is the only mandatory user attribute.</value>
        /*
        ...
        */
        ...
        /// </summary>
        /// <value>If provided, used with the user key to generate a variation in percentage rollouts</value>
        /*
        <example>2398127</example>
        */
        ...
        */
        ...
        /*
        <example>sandy@example.com</example>
        */
        ...
        */
        ...
        /// </summary>
        /// <value>An absolute URL to an avatar image.</value>
        /*
        <example>http://example.com/avatar.png</example>
        */
        ...
        */
        ...
        /// </summary>
        /// <value>Whether the user is anonymous. If true, this user does not appear on the Contexts list in the LaunchDarkly user interface.</value>
        /*
        ...
        */
        ...
        /// </summary>
        /// <value>Any other custom attributes for this user. Custom attributes contain any other user data that you would like to use to conditionally target your users.</value>
        ...
        /// </summary>
        /// <value>A list of attribute names that are marked as private. You can use these attributes in targeting rules and segments. If you are using a server-side SDK, the SDK will not send the private attribute back to LaunchDarkly. If you are using a client-side SDK, the SDK will send the private attribute back to LaunchDarkly for evaluation. However, the SDK won&#39;t send the attribute to LaunchDarkly in events data, LaunchDarkly won&#39;t store the private attribute, and the private attribute will not appear on the Contexts list.</value>
        [DataMember(Name = "privateAttrs", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  PrivateAttrs: ").Append(PrivateAttrs).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
