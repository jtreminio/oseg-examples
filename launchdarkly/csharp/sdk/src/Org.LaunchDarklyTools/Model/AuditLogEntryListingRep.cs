...
namespace Org.LaunchDarklyTools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AuditLogEntryListingRep")]
    public partial class AuditLogEntryListingRep : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditLogEntryListingRep" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AuditLogEntryListingRep() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditLogEntryListingRep" /> class.
        /// </summary>
        ...
        public AuditLogEntryListingRep(Dictionary<string, Link> links = default(Dictionary<string, Link>), string id = default(string), string accountId = default(string), long date = default(long), List<ResourceAccess> accesses = default(List<ResourceAccess>), string kind = default(string), string name = default(string), string description = default(string), string shortDescription = default(string), string comment = default(string), SubjectDataRep subject = default(SubjectDataRep), MemberDataRep member = default(MemberDataRep), TokenSummary token = default(TokenSummary), AuthorizedAppDataRep app = default(AuthorizedAppDataRep), string titleVerb = default(string), string title = default(string), TargetResourceRep target = default(TargetResourceRep), ParentResourceRep parent = default(ParentResourceRep))
        {
            // to ensure "links" is required (not null)
            if (links == null)
            {
                throw new ArgumentNullException("links is a required property for AuditLogEntryListingRep and cannot be null");
            }
            this.Links = links;
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for AuditLogEntryListingRep and cannot be null");
            }
            this.Id = id;
            // to ensure "accountId" is required (not null)
            if (accountId == null)
            {
                throw new ArgumentNullException("accountId is a required property for AuditLogEntryListingRep and cannot be null");
            }
            ...
            if (accesses == null)
            {
                throw new ArgumentNullException("accesses is a required property for AuditLogEntryListingRep and cannot be null");
            }
            this.Accesses = accesses;
            // to ensure "kind" is required (not null)
            if (kind == null)
            {
                throw new ArgumentNullException("kind is a required property for AuditLogEntryListingRep and cannot be null");
            }
            this.Kind = kind;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for AuditLogEntryListingRep and cannot be null");
            }
            this.Name = name;
            // to ensure "description" is required (not null)
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for AuditLogEntryListingRep and cannot be null");
            }
            this.Description = description;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for AuditLogEntryListingRep and cannot be null");
            }
