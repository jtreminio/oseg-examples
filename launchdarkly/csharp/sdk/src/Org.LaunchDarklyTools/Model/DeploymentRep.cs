...
namespace Org.LaunchDarklyTools.Model
{
    ...
    /// DeploymentRep
    /// </summary>
    [DataContract(Name = "DeploymentRep")]
    public partial class DeploymentRep : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeploymentRep" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DeploymentRep() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DeploymentRep" /> class.
        /// </summary>
        /// <param name="id">The deployment ID (required).</param>
        /// <param name="applicationKey">The application key (required).</param>
        /// <param name="applicationVersion">The application version (required).</param>
        /// <param name="startedAt">startedAt (required).</param>
        /// <param name="endedAt">endedAt.</param>
        /// <param name="durationMs">The duration of the deployment in milliseconds.</param>
        /// <param name="status">status (required).</param>
        /// <param name="kind">kind (required).</param>
        /// <param name="active">Whether the deployment is active (required).</param>
        /// <param name="metadata">The metadata associated with the deployment.</param>
        /// <param name="archived">Whether the deployment is archived (required).</param>
        /// <param name="environmentKey">The environment key (required).</param>
        /// <param name="numberOfContributors">The number of contributors (required).</param>
        /// <param name="numberOfPullRequests">The number of pull requests (required).</param>
        /// <param name="linesAdded">The number of lines added (required).</param>
        /// <param name="linesDeleted">The number of lines deleted (required).</param>
        /// <param name="leadTime">The total lead time from first commit to deployment end in milliseconds (required).</param>
        /// <param name="pullRequests">pullRequests.</param>
        /// <param name="flagReferences">flagReferences.</param>
        /// <param name="leadTimeStages">leadTimeStages.</param>
        public DeploymentRep(Guid id = default(Guid), string applicationKey = default(string), string applicationVersion = default(string), long startedAt = default(long), long endedAt = default(long), long durationMs = default(long), string status = default(string), string kind = default(string), bool active = default(bool), Dictionary<string, Object> metadata = default(Dictionary<string, Object>), bool archived = default(bool), string environmentKey = default(string), int numberOfContributors = default(int), int numberOfPullRequests = default(int), long linesAdded = default(long), long linesDeleted = default(long), long leadTime = default(long), PullRequestCollectionRep pullRequests = default(PullRequestCollectionRep), FlagReferenceCollectionRep flagReferences = default(FlagReferenceCollectionRep), LeadTimeStagesRep leadTimeStages = default(LeadTimeStagesRep))
        {
            this.Id = id;
            // to ensure "applicationKey" is required (not null)
            if (applicationKey == null)
            {
                throw new ArgumentNullException("applicationKey is a required property for DeploymentRep and cannot be null");
            }
            this.ApplicationKey = applicationKey;
            // to ensure "applicationVersion" is required (not null)
            if (applicationVersion == null)
            {
                throw new ArgumentNullException("applicationVersion is a required property for DeploymentRep and cannot be null");
            }
            ...
            if (status == null)
            {
                throw new ArgumentNullException("status is a required property for DeploymentRep and cannot be null");
            }
            this.Status = status;
            // to ensure "kind" is required (not null)
            if (kind == null)
            {
                throw new ArgumentNullException("kind is a required property for DeploymentRep and cannot be null");
            }
            this.Kind = kind;
            this.Active = active;
            this.Archived = archived;
            // to ensure "environmentKey" is required (not null)
            if (environmentKey == null)
            {
                throw new ArgumentNullException("environmentKey is a required property for DeploymentRep and cannot be null");
            }
        ...
        */
        [DataMember(Name = "applicationKey", IsRequired = true, EmitDefaultValue = true)]
        ...
        /*
        <example>a90a8a2</example>
        */
        [DataMember(Name = "applicationVersion", IsRequired = true, EmitDefaultValue = true)]
        ...
        */
        ...
        /// </summary>
        /// <value>The duration of the deployment in milliseconds</value>
        /*
        <example>10996000</example>
        */
        ...
        /// </summary>
        /// <value>Whether the deployment is active</value>
        /*
        ...
        */
        ...
        /// </summary>
        /// <value>The metadata associated with the deployment</value>
        /*
        <example>{&quot;buildNumber&quot;:&quot;1234&quot;}</example>
        */
        ...
        /// </summary>
        /// <value>Whether the deployment is archived</value>
        /*
        ...
        */
        [DataMember(Name = "environmentKey", IsRequired = true, EmitDefaultValue = true)]
        public string EnvironmentKey { get; set; }

        /// <summary>
        /// The number of contributors
        /// </summary>
        /// <value>The number of contributors</value>
        /*
        <example>1</example>
        */
        [DataMember(Name = "numberOfContributors", IsRequired = true, EmitDefaultValue = true)]
        public int NumberOfContributors { get; set; }

        /// <summary>
        /// The number of pull requests
        /// </summary>
        /// <value>The number of pull requests</value>
        /*
        <example>2</example>
        */
        [DataMember(Name = "numberOfPullRequests", IsRequired = true, EmitDefaultValue = true)]
        public int NumberOfPullRequests { get; set; }

        /// <summary>
        /// The number of lines added
        /// </summary>
        /// <value>The number of lines added</value>
        /*
        <example>100</example>
        */
        [DataMember(Name = "linesAdded", IsRequired = true, EmitDefaultValue = true)]
        public long LinesAdded { get; set; }

        /// <summary>
        /// The number of lines deleted
        /// </summary>
        /// <value>The number of lines deleted</value>
        /*
        <example>50</example>
        */
        [DataMember(Name = "linesDeleted", IsRequired = true, EmitDefaultValue = true)]
        public long LinesDeleted { get; set; }

        /// <summary>
        /// The total lead time from first commit to deployment end in milliseconds
        /// </summary>
        /// <value>The total lead time from first commit to deployment end in milliseconds</value>
        /*
        <example>20237000</example>
        */
        [DataMember(Name = "leadTime", IsRequired = true, EmitDefaultValue = true)]
        ...
        public PullRequestCollectionRep PullRequests { get; set; }

        /// <summary>
        /// Gets or Sets FlagReferences
        /// </summary>
        [DataMember(Name = "flagReferences", EmitDefaultValue = false)]
        public FlagReferenceCollectionRep FlagReferences { get; set; }

        /// <summary>
        /// Gets or Sets LeadTimeStages
        /// </summary>
        [DataMember(Name = "leadTimeStages", EmitDefaultValue = false)]
        public LeadTimeStagesRep LeadTimeStages { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  NumberOfContributors: ").Append(NumberOfContributors).Append("\n");
            sb.Append("  NumberOfPullRequests: ").Append(NumberOfPullRequests).Append("\n");
            sb.Append("  LinesAdded: ").Append(LinesAdded).Append("\n");
            sb.Append("  LinesDeleted: ").Append(LinesDeleted).Append("\n");
            sb.Append("  LeadTime: ").Append(LeadTime).Append("\n");
            sb.Append("  PullRequests: ").Append(PullRequests).Append("\n");
            sb.Append("  FlagReferences: ").Append(FlagReferences).Append("\n");
            sb.Append("  LeadTimeStages: ").Append(LeadTimeStages).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
