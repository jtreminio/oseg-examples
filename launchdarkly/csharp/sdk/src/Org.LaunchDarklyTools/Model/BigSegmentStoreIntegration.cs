...
namespace Org.LaunchDarklyTools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BigSegmentStoreIntegration")]
    public partial class BigSegmentStoreIntegration : IValidatableObject
    {
        /// <summary>
        /// The integration key
        /// </summary>
        /// <value>The integration key</value>
        ...
        public enum IntegrationKeyEnum
        {
            ...
            /// <summary>
            /// Enum Dynamodb for value: dynamodb
            /// </summary>
        ...
        */
        [DataMember(Name = "integrationKey", IsRequired = true, EmitDefaultValue = true)]
        public IntegrationKeyEnum IntegrationKey { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="BigSegmentStoreIntegration" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BigSegmentStoreIntegration() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BigSegmentStoreIntegration" /> class.
        /// </summary>
        /// <param name="links">links (required).</param>
        /// <param name="id">The integration ID (required).</param>
        /// <param name="integrationKey">The integration key (required).</param>
        ...
        /// <param name="on">Whether the configuration is turned on (required).</param>
        /// <param name="tags">List of tags for this configuration (required).</param>
        /// <param name="name">Name of the configuration (required).</param>
        /// <param name="varVersion">Version of the current configuration (required).</param>
        /// <param name="access">access.</param>
        /// <param name="status">status (required).</param>
        public BigSegmentStoreIntegration(BigSegmentStoreIntegrationLinks links = default(BigSegmentStoreIntegrationLinks), string id = default(string), IntegrationKeyEnum integrationKey = default(IntegrationKeyEnum), string projectKey = default(string), string environmentKey = default(string), Dictionary<string, Object> config = default(Dictionary<string, Object>), bool on = default(bool), List<string> tags = default(List<string>), string name = default(string), int varVersion = default(int), Access access = default(Access), BigSegmentStoreStatus status = default(BigSegmentStoreStatus))
        {
            // to ensure "links" is required (not null)
            if (links == null)
            {
                throw new ArgumentNullException("links is a required property for BigSegmentStoreIntegration and cannot be null");
            }
            this.Links = links;
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for BigSegmentStoreIntegration and cannot be null");
            }
            this.Id = id;
            ...
            if (projectKey == null)
            {
                throw new ArgumentNullException("projectKey is a required property for BigSegmentStoreIntegration and cannot be null");
            }
            this.ProjectKey = projectKey;
            // to ensure "environmentKey" is required (not null)
            if (environmentKey == null)
            {
                throw new ArgumentNullException("environmentKey is a required property for BigSegmentStoreIntegration and cannot be null");
            }
            this.EnvironmentKey = environmentKey;
            // to ensure "config" is required (not null)
            if (config == null)
            {
                throw new ArgumentNullException("config is a required property for BigSegmentStoreIntegration and cannot be null");
            }
            this.Config = config;
            this.On = on;
            ...
            if (tags == null)
            {
                throw new ArgumentNullException("tags is a required property for BigSegmentStoreIntegration and cannot be null");
            }
            this.Tags = tags;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for BigSegmentStoreIntegration and cannot be null");
            }
            this.Name = name;
            ...
            if (status == null)
            {
                throw new ArgumentNullException("status is a required property for BigSegmentStoreIntegration and cannot be null");
            }
            this.Status = status;
            this.Access = access;
        }
        ...
        public BigSegmentStoreIntegrationLinks Links { get; set; }
        ...
        */
        ...
        /// </summary>
        /// <value>Whether the configuration is turned on</value>
        /*
        ...
        */
        ...
        /// </summary>
        /// <value>List of tags for this configuration</value>
        /*
        <example>[]</example>
        */
        ...
        /*
        <example>Development environment configuration</example>
        */
        ...
        */
        ...
        /// Gets or Sets Status
        /// </summary>
        [DataMember(Name = "_status", IsRequired = true, EmitDefaultValue = true)]
        public BigSegmentStoreStatus Status { get; set; }
