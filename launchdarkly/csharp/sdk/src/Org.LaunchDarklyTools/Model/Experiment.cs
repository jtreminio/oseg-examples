...
namespace Org.LaunchDarklyTools.Model
{
    ...
    public partial class Experiment : IValidatableObject
    {
        ...
        /// <param name="key">The experiment key (required).</param>
        /// <param name="name">The experiment name (required).</param>
        /// <param name="description">The experiment description.</param>
        /// <param name="maintainerId">The ID of the member who maintains this experiment. (required).</param>
        /// <param name="creationDate">creationDate (required).</param>
        /// <param name="environmentKey">environmentKey (required).</param>
        ...
        /// <param name="currentIteration">currentIteration.</param>
        /// <param name="draftIteration">draftIteration.</param>
        /// <param name="previousIterations">Details on the previous iterations for this experiment..</param>
        public Experiment(string id = default(string), string key = default(string), string name = default(string), string description = default(string), string maintainerId = default(string), long creationDate = default(long), string environmentKey = default(string), long archivedDate = default(long), Dictionary<string, Link> links = default(Dictionary<string, Link>), string holdoutId = default(string), IterationRep currentIteration = default(IterationRep), IterationRep draftIteration = default(IterationRep), List<IterationRep> previousIterations = default(List<IterationRep>))
        {
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for Experiment and cannot be null");
            }
            this.Key = key;
            ...
            {
                throw new ArgumentNullException("maintainerId is a required property for Experiment and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("environmentKey is a required property for Experiment and cannot be null");
            }
            this.EnvironmentKey = environmentKey;
            // to ensure "links" is required (not null)
            if (links == null)
            {
                throw new ArgumentNullException("links is a required property for Experiment and cannot be null");
            }
            this.Links = links;
            this.Id = id;
        ...
        */
        ...
        /// The experiment key
        /// </summary>
        /// <value>The experiment key</value>
        /*
        <example>experiment-key-123abc</example>
        */
        ...
        /// The experiment name
        /// </summary>
        /// <value>The experiment name</value>
        /*
        <example>Example experiment</example>
        */
        ...
        /// </summary>
        /// <value>The experiment description</value>
        /*
        <example>An example experiment, used in testing</example>
        */
        ...
        /// </summary>
        /// <value>The ID of the member who maintains this experiment.</value>
        /*
        <example>12ab3c45de678910fgh12345</example>
        */
        ...
        */
        ...
        /*
        <example>{&quot;parent&quot;:{&quot;href&quot;:&quot;/api/v2/projects/my-project/environments/my-environment&quot;,&quot;type&quot;:&quot;application/json&quot;},&quot;self&quot;:{&quot;href&quot;:&quot;/api/v2/projects/my-project/environments/my-environment/experiments/my-experiment&quot;,&quot;type&quot;:&quot;application/json&quot;}}</example>
        */
        ...
        /// The holdout ID
        /// </summary>
        /// <value>The holdout ID</value>
        /*
        <example>f3b74309-d581-44e1-8a2b-bb2933b4fe40</example>
        */
        [DataMember(Name = "holdoutId", EmitDefaultValue = false)]
        public string HoldoutId { get; set; }

        /// <summary>
        /// Gets or Sets CurrentIteration
        /// </summary>
        [DataMember(Name = "currentIteration", EmitDefaultValue = false)]
        public IterationRep CurrentIteration { get; set; }

        /// <summary>
        /// Gets or Sets DraftIteration
        /// </summary>
        [DataMember(Name = "draftIteration", EmitDefaultValue = false)]
        public IterationRep DraftIteration { get; set; }

        /// <summary>
        /// Details on the previous iterations for this experiment.
        /// </summary>
        /// <value>Details on the previous iterations for this experiment.</value>
        [DataMember(Name = "previousIterations", EmitDefaultValue = false)]
        public List<IterationRep> PreviousIterations { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  HoldoutId: ").Append(HoldoutId).Append("\n");
            sb.Append("  CurrentIteration: ").Append(CurrentIteration).Append("\n");
            sb.Append("  DraftIteration: ").Append(DraftIteration).Append("\n");
            sb.Append("  PreviousIterations: ").Append(PreviousIterations).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
