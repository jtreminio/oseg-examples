...
namespace Org.LaunchDarklyTools.Model
{
    ...
    /// MetricInGroupRep
    /// </summary>
    [DataContract(Name = "MetricInGroupRep")]
    public partial class MetricInGroupRep : IValidatableObject
    {
        /// <summary>
        ...
        */
        ...
        /// </summary>
        /// <value>The type of unit aggregation to use for the metric</value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        */
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MetricInGroupRep" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MetricInGroupRep() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MetricInGroupRep" /> class.
        /// </summary>
        /// <param name="key">The metric key (required).</param>
        /// <param name="versionId">The version ID of the metric.</param>
        /// <param name="name">The metric name (required).</param>
        ...
        /// <param name="unitAggregationType">The type of unit aggregation to use for the metric.</param>
        /// <param name="links">The location and content type of related resources (required).</param>
        /// <param name="nameInGroup">Name of the metric when used within the associated metric group. Can be different from the original name of the metric. Required if and only if the metric group is a &lt;code&gt;funnel&lt;/code&gt;..</param>
        /// <param name="randomizationUnits">The randomization units for the metric.</param>
        public MetricInGroupRep(string key = default(string), string versionId = default(string), string name = default(string), KindEnum kind = default(KindEnum), bool isNumeric = default(bool), UnitAggregationTypeEnum? unitAggregationType = default(UnitAggregationTypeEnum?), Dictionary<string, Link> links = default(Dictionary<string, Link>), string nameInGroup = default(string), List<string> randomizationUnits = default(List<string>))
        {
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for MetricInGroupRep and cannot be null");
            }
            this.Key = key;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for MetricInGroupRep and cannot be null");
            }
            this.Name = name;
            this.Kind = kind;
            ...
            if (links == null)
            {
                throw new ArgumentNullException("links is a required property for MetricInGroupRep and cannot be null");
            }
            this.Links = links;
        ...
        */
        [DataMember(Name = "_versionId", EmitDefaultValue = false)]
        ...
        */
        ...
        /*
        <example>{&quot;self&quot;:{&quot;href&quot;:&quot;/api/v2/metrics/my-project/my-metric&quot;,&quot;type&quot;:&quot;application/json&quot;}}</example>
        */
        ...
        /// </summary>
        /// <value>Name of the metric when used within the associated metric group. Can be different from the original name of the metric. Required if and only if the metric group is a &lt;code&gt;funnel&lt;/code&gt;.</value>
        /*
        <example>Step 1</example>
        */
        [DataMember(Name = "nameInGroup", EmitDefaultValue = false)]
        public string NameInGroup { get; set; }

        /// <summary>
        /// The randomization units for the metric
        /// </summary>
        /// <value>The randomization units for the metric</value>
        /*
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("  NameInGroup: ").Append(NameInGroup).Append("\n");
