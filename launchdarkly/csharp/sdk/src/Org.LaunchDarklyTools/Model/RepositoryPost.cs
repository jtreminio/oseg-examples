...
namespace Org.LaunchDarklyTools.Model
{
    ...
    /// RepositoryPost
    /// </summary>
    [DataContract(Name = "repositoryPost")]
    public partial class RepositoryPost : IValidatableObject
    {
        /// <summary>
        /// The type of repository. If not specified, the default value is &lt;code&gt;custom&lt;/code&gt;.
        /// </summary>
        /// <value>The type of repository. If not specified, the default value is &lt;code&gt;custom&lt;/code&gt;.</value>
        ...
        */
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RepositoryPost" /> class.
        /// </summary>
        ...
        /// <param name="type">The type of repository. If not specified, the default value is &lt;code&gt;custom&lt;/code&gt;..</param>
        /// <param name="defaultBranch">The repository&#39;s default branch. If not specified, the default value is &lt;code&gt;main&lt;/code&gt;..</param>
        public RepositoryPost(string name = default(string), string sourceLink = default(string), string commitUrlTemplate = default(string), string hunkUrlTemplate = default(string), TypeEnum? type = default(TypeEnum?), string defaultBranch = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for RepositoryPost and cannot be null");
            }
            this.Name = name;
        ...
        */
        ...
        /// </summary>
        /// <value>The repository&#39;s default branch. If not specified, the default value is &lt;code&gt;main&lt;/code&gt;.</value>
        /*
