...
namespace Org.LaunchDarklyTools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ContextInstanceSegmentMembership")]
    public partial class ContextInstanceSegmentMembership : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContextInstanceSegmentMembership" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ContextInstanceSegmentMembership() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ContextInstanceSegmentMembership" /> class.
        /// </summary>
        ...
        /// <param name="description">A description of the segment&#39;s purpose (required).</param>
        /// <param name="unbounded">Whether this is an unbounded segment. Unbounded segments, also called big segments, may be list-based segments with more than 15,000 entries, or synced segments. (required).</param>
        /// <param name="external">If the segment is a synced segment, the name of the external source (required).</param>
        /// <param name="isMember">Whether the context is a member of this segment, either by explicit inclusion or by rule matching (required).</param>
        /// <param name="isIndividuallyTargeted">Whether the context is explicitly included in this segment (required).</param>
        /// <param name="isRuleTargeted">Whether the context is captured by this segment&#39;s rules. The value of this field is undefined if the context is also explicitly included (&lt;code&gt;isIndividuallyTargeted&lt;/code&gt; is &lt;code&gt;true&lt;/code&gt;). (required).</param>
        /// <param name="links">The location and content type of related resources (required).</param>
        public ContextInstanceSegmentMembership(string name = default(string), string key = default(string), string description = default(string), bool unbounded = default(bool), string external = default(string), bool isMember = default(bool), bool isIndividuallyTargeted = default(bool), bool isRuleTargeted = default(bool), Dictionary<string, Link> links = default(Dictionary<string, Link>))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for ContextInstanceSegmentMembership and cannot be null");
            }
            this.Name = name;
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for ContextInstanceSegmentMembership and cannot be null");
            }
            this.Key = key;
            // to ensure "description" is required (not null)
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for ContextInstanceSegmentMembership and cannot be null");
            }
            ...
            if (external == null)
            {
                throw new ArgumentNullException("external is a required property for ContextInstanceSegmentMembership and cannot be null");
            }
            ...
            if (links == null)
            {
                throw new ArgumentNullException("links is a required property for ContextInstanceSegmentMembership and cannot be null");
            }
            this.Links = links;
        }
        ...
        */
        ...
        /// </summary>
        /// <value>A description of the segment&#39;s purpose</value>
        /*
        <example>Segment description</example>
        */
        ...
        /// </summary>
        /// <value>Whether this is an unbounded segment. Unbounded segments, also called big segments, may be list-based segments with more than 15,000 entries, or synced segments.</value>
        /*
        <example>false</example>
        */
        [DataMember(Name = "unbounded", IsRequired = true, EmitDefaultValue = true)]
        public bool Unbounded { get; set; }

        /// <summary>
        /// If the segment is a synced segment, the name of the external source
        /// </summary>
        /// <value>If the segment is a synced segment, the name of the external source</value>
        /*
        <example>https://amplitude.com/myCohort</example>
        */
        ...
        /// </summary>
        /// <value>Whether the context is a member of this segment, either by explicit inclusion or by rule matching</value>
        /*
        ...
        */
        ...
        /// </summary>
        /// <value>Whether the context is explicitly included in this segment</value>
        /*
        <example>true</example>
        */
        [DataMember(Name = "isIndividuallyTargeted", IsRequired = true, EmitDefaultValue = true)]
        ...
        /// </summary>
        /// <value>Whether the context is captured by this segment&#39;s rules. The value of this field is undefined if the context is also explicitly included (&lt;code&gt;isIndividuallyTargeted&lt;/code&gt; is &lt;code&gt;true&lt;/code&gt;).</value>
        /*
        <example>false</example>
        */
        [DataMember(Name = "isRuleTargeted", IsRequired = true, EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  IsIndividuallyTargeted: ").Append(IsIndividuallyTargeted).Append("\n");
            sb.Append("  IsRuleTargeted: ").Append(IsRuleTargeted).Append("\n");
