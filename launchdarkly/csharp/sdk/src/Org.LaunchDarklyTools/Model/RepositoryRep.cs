...
namespace Org.LaunchDarklyTools.Model
{
    ...
    /// RepositoryRep
    /// </summary>
    [DataContract(Name = "RepositoryRep")]
    public partial class RepositoryRep : IValidatableObject
    {
        /// <summary>
        ...
        */
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RepositoryRep" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RepositoryRep() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RepositoryRep" /> class.
        /// </summary>
        /// <param name="name">The repository name (required).</param>
        /// <param name="sourceLink">A URL to access the repository.</param>
        /// <param name="commitUrlTemplate">A template for constructing a valid URL to view the commit.</param>
        /// <param name="hunkUrlTemplate">A template for constructing a valid URL to view the hunk.</param>
        ...
        /// <param name="branches">An array of the repository&#39;s branches that have been scanned for code references.</param>
        /// <param name="links">links (required).</param>
        /// <param name="access">access.</param>
        public RepositoryRep(string name = default(string), string sourceLink = default(string), string commitUrlTemplate = default(string), string hunkUrlTemplate = default(string), TypeEnum type = default(TypeEnum), string defaultBranch = default(string), bool enabled = default(bool), int varVersion = default(int), List<BranchRep> branches = default(List<BranchRep>), Dictionary<string, Object> links = default(Dictionary<string, Object>), Access access = default(Access))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for RepositoryRep and cannot be null");
            }
            this.Name = name;
            this.Type = type;
            ...
            {
                throw new ArgumentNullException("defaultBranch is a required property for RepositoryRep and cannot be null");
            }
            ...
            if (links == null)
            {
                throw new ArgumentNullException("links is a required property for RepositoryRep and cannot be null");
            }
            this.Links = links;
        ...
        */
        ...
        /// </summary>
        /// <value>A template for constructing a valid URL to view the commit</value>
        /*
        <example>https://github.com/launchdarkly/LaunchDarkly-Docs/commit/${sha}</example>
        */
        [DataMember(Name = "commitUrlTemplate", EmitDefaultValue = false)]
        public string CommitUrlTemplate { get; set; }

        /// <summary>
        /// A template for constructing a valid URL to view the hunk
        /// </summary>
        /// <value>A template for constructing a valid URL to view the hunk</value>
        /*
        <example>https://github.com/launchdarkly/LaunchDarkly-Docs/blob/${sha}/${filePath}#L${lineNumber}</example>
        */
        [DataMember(Name = "hunkUrlTemplate", EmitDefaultValue = false)]
        ...
        */
        ...
        /// </summary>
        /// <value>An array of the repository&#39;s branches that have been scanned for code references</value>
        [DataMember(Name = "branches", EmitDefaultValue = false)]
        public List<BranchRep> Branches { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CommitUrlTemplate: ").Append(CommitUrlTemplate).Append("\n");
            sb.Append("  HunkUrlTemplate: ").Append(HunkUrlTemplate).Append("\n");
