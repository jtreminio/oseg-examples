...
namespace Org.LaunchDarklyTools.Model
{
    ...
    public partial class Project : IValidatableObject
    {
        ...
        public Project(Dictionary<string, Link> links = default(Dictionary<string, Link>), string id = default(string), string key = default(string), bool includeInSnippetByDefault = default(bool), ClientSideAvailability defaultClientSideAvailability = default(ClientSideAvailability), string name = default(string), Access access = default(Access), List<string> tags = default(List<string>), string defaultReleasePipelineKey = default(string), Environments environments = default(Environments))
        {
            // to ensure "links" is required (not null)
            if (links == null)
            {
                throw new ArgumentNullException("links is a required property for Project and cannot be null");
            }
            this.Links = links;
            ...
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for Project and cannot be null");
            }
            this.Key = key;
            ...
            if (tags == null)
            {
                throw new ArgumentNullException("tags is a required property for Project and cannot be null");
            }
            this.Tags = tags;
