...
namespace Org.LaunchDarklyTools.Model
{
    ...
    /// HoldoutPostRequest
    /// </summary>
    [DataContract(Name = "HoldoutPostRequest")]
    public partial class HoldoutPostRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HoldoutPostRequest" /> class.
        /// </summary>
        /// <param name="name">A human-friendly name for the holdout.</param>
        /// <param name="key">A key that identifies the holdout.</param>
        /// <param name="description">Description of the holdout.</param>
        /// <param name="randomizationunit">The chosen randomization unit for the holdout base experiment.</param>
        /// <param name="attributes">The attributes that the holdout iteration&#39;s results can be sliced by.</param>
        /// <param name="holdoutamount">Audience allocation for the holdout.</param>
        /// <param name="primarymetrickey">The key of the primary metric for this holdout.</param>
        /// <param name="metrics">Details on the metrics for this experiment.</param>
        /// <param name="prerequisiteflagkey">The key of the flag that the holdout is dependent on.</param>
        /// <param name="maintainerId">Maintainer id.</param>
        public HoldoutPostRequest(string name = default(string), string key = default(string), string description = default(string), string randomizationunit = default(string), List<string> attributes = default(List<string>), string holdoutamount = default(string), string primarymetrickey = default(string), List<MetricInput> metrics = default(List<MetricInput>), string prerequisiteflagkey = default(string), string maintainerId = default(string))
        {
            this.Name = name;
            this.Key = key;
        ...
        /// </summary>
        /// <value>A human-friendly name for the holdout</value>
        /*
        <example>holdout-one-name</example>
        */
        ...
        /// </summary>
        /// <value>A key that identifies the holdout</value>
        /*
        <example>holdout-key</example>
        */
        ...
        /// </summary>
        /// <value>Description of the holdout</value>
        /*
        <example>My holdout-one description</example>
        */
        ...
        /// </summary>
        /// <value>The chosen randomization unit for the holdout base experiment</value>
        /*
        ...
        */
        ...
        /// </summary>
        /// <value>The attributes that the holdout iteration&#39;s results can be sliced by</value>
        /*
        ...
        */
        ...
        /// </summary>
        /// <value>Audience allocation for the holdout</value>
        /*
        <example>10</example>
        */
        [DataMember(Name = "holdoutamount", EmitDefaultValue = false)]
        public string Holdoutamount { get; set; }

        /// <summary>
        /// The key of the primary metric for this holdout
        /// </summary>
        /// <value>The key of the primary metric for this holdout</value>
        /*
        <example>metric-key-123abc</example>
        */
        [DataMember(Name = "primarymetrickey", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>The key of the flag that the holdout is dependent on</value>
        /*
        <example>flag-key-123abc</example>
        */
        [DataMember(Name = "prerequisiteflagkey", EmitDefaultValue = false)]
        public string Prerequisiteflagkey { get; set; }

        /// <summary>
        /// Maintainer id
        /// </summary>
        /// <value>Maintainer id</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  Holdoutamount: ").Append(Holdoutamount).Append("\n");
            sb.Append("  Primarymetrickey: ").Append(Primarymetrickey).Append("\n");
            sb.Append("  Metrics: ").Append(Metrics).Append("\n");
            sb.Append("  Prerequisiteflagkey: ").Append(Prerequisiteflagkey).Append("\n");
