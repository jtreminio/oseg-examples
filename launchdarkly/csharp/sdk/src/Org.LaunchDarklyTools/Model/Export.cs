...
namespace Org.LaunchDarklyTools.Model
{
    ...
    public partial class Export : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="Export" /> class.
        /// </summary>
        /// <param name="id">The export ID (required).</param>
        /// <param name="segmentKey">The segment key (required).</param>
        /// <param name="creationTime">creationTime (required).</param>
        /// <param name="status">The export status (required).</param>
        /// <param name="sizeBytes">The export size, in bytes (required).</param>
        /// <param name="size">The export size, with units (required).</param>
        /// <param name="initiator">initiator (required).</param>
        /// <param name="links">The location and content type of related resources, including the location of the exported file (required).</param>
        public Export(string id = default(string), string segmentKey = default(string), long creationTime = default(long), string status = default(string), long sizeBytes = default(long), string size = default(string), InitiatorRep initiator = default(InitiatorRep), Dictionary<string, Link> links = default(Dictionary<string, Link>))
        {
            ...
            this.Id = id;
            // to ensure "segmentKey" is required (not null)
            if (segmentKey == null)
            {
                throw new ArgumentNullException("segmentKey is a required property for Export and cannot be null");
            }
            ...
            if (size == null)
            {
                throw new ArgumentNullException("size is a required property for Export and cannot be null");
            }
            this.Size = size;
            // to ensure "initiator" is required (not null)
            if (initiator == null)
            {
                throw new ArgumentNullException("initiator is a required property for Export and cannot be null");
            }
            this.Initiator = initiator;
            // to ensure "links" is required (not null)
            if (links == null)
            {
                throw new ArgumentNullException("links is a required property for Export and cannot be null");
            }
            this.Links = links;
        }
        ...
        /*
        <example>1234a567-bcd8-9123-4567-abcd1234567f</example>
        */
        ...
        /// The segment key
        /// </summary>
        /// <value>The segment key</value>
        /*
        <example>example-big-segment</example>
        */
        [DataMember(Name = "segmentKey", IsRequired = true, EmitDefaultValue = true)]
        ...
        */
        ...
        /// </summary>
        /// <value>The export size, in bytes</value>
        /*
        <example>18</example>
        */
        ...
        /// </summary>
        /// <value>The export size, with units</value>
        /*
        <example>18 B</example>
        */
        ...
        public InitiatorRep Initiator { get; set; }

        /// <summary>
        /// The location and content type of related resources, including the location of the exported file
        /// </summary>
        /// <value>The location and content type of related resources, including the location of the exported file</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SegmentKey: ").Append(SegmentKey).Append("\n");
