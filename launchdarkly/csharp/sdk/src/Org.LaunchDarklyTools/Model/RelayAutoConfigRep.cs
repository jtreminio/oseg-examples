...
namespace Org.LaunchDarklyTools.Model
{
    ...
    /// RelayAutoConfigRep
    /// </summary>
    [DataContract(Name = "RelayAutoConfigRep")]
    public partial class RelayAutoConfigRep : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RelayAutoConfigRep" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RelayAutoConfigRep() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RelayAutoConfigRep" /> class.
        /// </summary>
        ...
        /// <param name="name">A human-friendly name for the Relay Proxy configuration (required).</param>
        /// <param name="policy">A description of what environments and projects the Relay Proxy should include or exclude (required).</param>
        /// <param name="fullKey">The Relay Proxy configuration key (required).</param>
        /// <param name="displayKey">The last few characters of the Relay Proxy configuration key, displayed in the LaunchDarkly UI (required).</param>
        /// <param name="creationDate">creationDate (required).</param>
        /// <param name="lastModified">lastModified (required).</param>
        public RelayAutoConfigRep(string id = default(string), MemberSummary creator = default(MemberSummary), Access access = default(Access), string name = default(string), List<Statement> policy = default(List<Statement>), string fullKey = default(string), string displayKey = default(string), long creationDate = default(long), long lastModified = default(long))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for RelayAutoConfigRep and cannot be null");
            }
            this.Id = id;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for RelayAutoConfigRep and cannot be null");
            }
            this.Name = name;
            // to ensure "policy" is required (not null)
            if (policy == null)
            {
                throw new ArgumentNullException("policy is a required property for RelayAutoConfigRep and cannot be null");
            }
            this.Policy = policy;
            // to ensure "fullKey" is required (not null)
            if (fullKey == null)
            {
                throw new ArgumentNullException("fullKey is a required property for RelayAutoConfigRep and cannot be null");
            }
            this.FullKey = fullKey;
            // to ensure "displayKey" is required (not null)
            if (displayKey == null)
            {
                throw new ArgumentNullException("displayKey is a required property for RelayAutoConfigRep and cannot be null");
            }
        ...
        /*
        <example>Relay Proxy Demo Config</example>
        */
        ...
        /// </summary>
        /// <value>A description of what environments and projects the Relay Proxy should include or exclude</value>
        [DataMember(Name = "policy", IsRequired = true, EmitDefaultValue = true)]
        public List<Statement> Policy { get; set; }

        /// <summary>
        /// The Relay Proxy configuration key
        /// </summary>
        /// <value>The Relay Proxy configuration key</value>
        [DataMember(Name = "fullKey", IsRequired = true, EmitDefaultValue = true)]
        public string FullKey { get; set; }

        /// <summary>
        /// The last few characters of the Relay Proxy configuration key, displayed in the LaunchDarkly UI
        /// </summary>
        /// <value>The last few characters of the Relay Proxy configuration key, displayed in the LaunchDarkly UI</value>
        /*
        <example>7f30</example>
        */
        [DataMember(Name = "displayKey", IsRequired = true, EmitDefaultValue = true)]
