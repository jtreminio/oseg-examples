...
namespace Org.LaunchDarklyTools.Model
{
    ...
    /// FeatureFlagConfig
    /// </summary>
    [DataContract(Name = "FeatureFlagConfig")]
    public partial class FeatureFlagConfig : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FeatureFlagConfig" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FeatureFlagConfig() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FeatureFlagConfig" /> class.
        /// </summary>
        /// <param name="on">Whether the flag is on (required).</param>
        /// <param name="archived">Boolean indicating if the feature flag is archived (required).</param>
        /// <param name="salt">salt (required).</param>
        /// <param name="sel">sel (required).</param>
        /// <param name="lastModified">lastModified (required).</param>
        /// <param name="varVersion">Version of the feature flag (required).</param>
        /// <param name="targets">An array of the individual targets that will receive a specific variation based on their key. Individual targets with a context kind of &#39;user&#39; are included here..</param>
        /// <param name="contextTargets">An array of the individual targets that will receive a specific variation based on their key. Individual targets with context kinds other than &#39;user&#39; are included here..</param>
        /// <param name="rules">An array of the rules for how to serve a variation to specific targets based on their attributes.</param>
        /// <param name="fallthrough">fallthrough.</param>
        /// <param name="offVariation">The ID of the variation to serve when the flag is off.</param>
        /// <param name="prerequisites">An array of the prerequisite flags and their variations that are required before this flag takes effect.</param>
        /// <param name="site">site (required).</param>
        /// <param name="access">access.</param>
        /// <param name="environmentName">The environment name (required).</param>
        /// <param name="trackEvents">Whether LaunchDarkly tracks events for the feature flag, for all rules (required).</param>
        /// <param name="trackEventsFallthrough">Whether LaunchDarkly tracks events for the feature flag, for the default rule (required).</param>
        /// <param name="debugEventsUntilDate">debugEventsUntilDate.</param>
        /// <param name="summary">summary.</param>
        /// <param name="evaluation">evaluation.</param>
        /// <param name="migrationSettings">migrationSettings.</param>
        public FeatureFlagConfig(bool on = default(bool), bool archived = default(bool), string salt = default(string), string sel = default(string), long lastModified = default(long), int varVersion = default(int), List<Target> targets = default(List<Target>), List<Target> contextTargets = default(List<Target>), List<Rule> rules = default(List<Rule>), VariationOrRolloutRep fallthrough = default(VariationOrRolloutRep), int offVariation = default(int), List<Prerequisite> prerequisites = default(List<Prerequisite>), Link site = default(Link), Access access = default(Access), string environmentName = default(string), bool trackEvents = default(bool), bool trackEventsFallthrough = default(bool), long debugEventsUntilDate = default(long), FlagSummary summary = default(FlagSummary), FlagConfigEvaluation evaluation = default(FlagConfigEvaluation), FlagConfigMigrationSettingsRep migrationSettings = default(FlagConfigMigrationSettingsRep))
        {
            this.On = on;
            ...
            if (salt == null)
            {
                throw new ArgumentNullException("salt is a required property for FeatureFlagConfig and cannot be null");
            }
            this.Salt = salt;
            // to ensure "sel" is required (not null)
            if (sel == null)
            {
                throw new ArgumentNullException("sel is a required property for FeatureFlagConfig and cannot be null");
            }
            this.Sel = sel;
            ...
            if (site == null)
            {
                throw new ArgumentNullException("site is a required property for FeatureFlagConfig and cannot be null");
            }
            this.Site = site;
            // to ensure "environmentName" is required (not null)
            if (environmentName == null)
            {
                throw new ArgumentNullException("environmentName is a required property for FeatureFlagConfig and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Whether the flag is on</value>
        ...
        /// Gets or Sets Sel
        /// </summary>
        [DataMember(Name = "sel", IsRequired = true, EmitDefaultValue = true)]
        ...
        */
        ...
        /// </summary>
        /// <value>An array of the individual targets that will receive a specific variation based on their key. Individual targets with a context kind of &#39;user&#39; are included here.</value>
        ...
        /// </summary>
        /// <value>An array of the individual targets that will receive a specific variation based on their key. Individual targets with context kinds other than &#39;user&#39; are included here.</value>
        [DataMember(Name = "contextTargets", EmitDefaultValue = false)]
        public List<Target> ContextTargets { get; set; }

        /// <summary>
        /// An array of the rules for how to serve a variation to specific targets based on their attributes
        /// </summary>
        /// <value>An array of the rules for how to serve a variation to specific targets based on their attributes</value>
        ...
        public VariationOrRolloutRep Fallthrough { get; set; }

        /// <summary>
        /// The ID of the variation to serve when the flag is off
        /// </summary>
        /// <value>The ID of the variation to serve when the flag is off</value>
        ...
        /// </summary>
        /// <value>An array of the prerequisite flags and their variations that are required before this flag takes effect</value>
        ...
        /// Gets or Sets Site
        /// </summary>
        [DataMember(Name = "_site", IsRequired = true, EmitDefaultValue = true)]
        ...
        [DataMember(Name = "_environmentName", IsRequired = true, EmitDefaultValue = true)]
        public string EnvironmentName { get; set; }

        /// <summary>
        /// Whether LaunchDarkly tracks events for the feature flag, for all rules
        /// </summary>
        /// <value>Whether LaunchDarkly tracks events for the feature flag, for all rules</value>
        [DataMember(Name = "trackEvents", IsRequired = true, EmitDefaultValue = true)]
        public bool TrackEvents { get; set; }

        /// <summary>
        /// Whether LaunchDarkly tracks events for the feature flag, for the default rule
        /// </summary>
        /// <value>Whether LaunchDarkly tracks events for the feature flag, for the default rule</value>
        [DataMember(Name = "trackEventsFallthrough", IsRequired = true, EmitDefaultValue = true)]
        public bool TrackEventsFallthrough { get; set; }

        /// <summary>
        /// Gets or Sets DebugEventsUntilDate
        /// </summary>
        /*
        <example>1706701522000</example>
        */
        [DataMember(Name = "_debugEventsUntilDate", EmitDefaultValue = false)]
        public long DebugEventsUntilDate { get; set; }

        /// <summary>
        /// Gets or Sets Summary
        /// </summary>
        [DataMember(Name = "_summary", EmitDefaultValue = false)]
        public FlagSummary Summary { get; set; }

        /// <summary>
        /// Gets or Sets Evaluation
        /// </summary>
        [DataMember(Name = "evaluation", EmitDefaultValue = false)]
        public FlagConfigEvaluation Evaluation { get; set; }

        /// <summary>
        /// Gets or Sets MigrationSettings
        /// </summary>
        [DataMember(Name = "migrationSettings", EmitDefaultValue = false)]
        public FlagConfigMigrationSettingsRep MigrationSettings { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ContextTargets: ").Append(ContextTargets).Append("\n");
            ...
            sb.Append("  DebugEventsUntilDate: ").Append(DebugEventsUntilDate).Append("\n");
