...
namespace Org.LaunchDarklyTools.Model
{
    ...
    /// ReleasePipeline
    /// </summary>
    [DataContract(Name = "ReleasePipeline")]
    public partial class ReleasePipeline : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReleasePipeline" /> class.
        /// </summary>
        ...
        /// Initializes a new instance of the <see cref="ReleasePipeline" /> class.
        /// </summary>
        /// <param name="createdAt">Timestamp of when the release pipeline was created (required).</param>
        /// <param name="description">The release pipeline description.</param>
        /// <param name="key">The release pipeline key (required).</param>
        /// <param name="name">The release pipeline name (required).</param>
        /// <param name="phases">An ordered list of the release pipeline phases. Each phase is a logical grouping of one or more environments that share attributes for rolling out changes. (required).</param>
        /// <param name="tags">A list of the release pipeline&#39;s tags.</param>
        /// <param name="varVersion">The release pipeline version.</param>
        /// <param name="access">access.</param>
        /// <param name="isProjectDefault">Whether this release pipeline is the default pipeline for the project.</param>
        /// <param name="isLegacy">Whether this release pipeline is a legacy pipeline.</param>
        public ReleasePipeline(DateTime createdAt = default(DateTime), string description = default(string), string key = default(string), string name = default(string), List<Phase> phases = default(List<Phase>), List<string> tags = default(List<string>), int varVersion = default(int), Access access = default(Access), bool isProjectDefault = default(bool), bool isLegacy = default(bool))
        {
            this.CreatedAt = createdAt;
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for ReleasePipeline and cannot be null");
            }
            this.Key = key;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for ReleasePipeline and cannot be null");
            }
            this.Name = name;
            // to ensure "phases" is required (not null)
            if (phases == null)
            {
                throw new ArgumentNullException("phases is a required property for ReleasePipeline and cannot be null");
            }
            this.Phases = phases;
        ...
        /// </summary>
        /// <value>Timestamp of when the release pipeline was created</value>
        ...
        /// </summary>
        /// <value>The release pipeline description</value>
        /*
        <example>Standard pipeline to roll out to production</example>
        */
        ...
        /// </summary>
        /// <value>The release pipeline key</value>
        /*
        <example>standard-pipeline</example>
        */
        ...
        /// </summary>
        /// <value>The release pipeline name</value>
        /*
        <example>Standard Pipeline</example>
        */
        ...
        /// </summary>
        /// <value>An ordered list of the release pipeline phases. Each phase is a logical grouping of one or more environments that share attributes for rolling out changes.</value>
        ...
        /// </summary>
        /// <value>A list of the release pipeline&#39;s tags</value>
        /*
        ...
        */
        ...
        /// </summary>
        /// <value>The release pipeline version</value>
        /*
        <example>1</example>
        */
        ...
        /// </summary>
        /// <value>Whether this release pipeline is the default pipeline for the project</value>
        [DataMember(Name = "isProjectDefault", EmitDefaultValue = true)]
        public bool IsProjectDefault { get; set; }

        /// <summary>
        /// Whether this release pipeline is a legacy pipeline
        /// </summary>
        /// <value>Whether this release pipeline is a legacy pipeline</value>
        /*
        <example>true</example>
        */
        [DataMember(Name = "_isLegacy", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  IsProjectDefault: ").Append(IsProjectDefault).Append("\n");
