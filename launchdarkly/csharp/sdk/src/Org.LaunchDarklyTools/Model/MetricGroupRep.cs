...
namespace Org.LaunchDarklyTools.Model
{
    ...
    /// MetricGroupRep
    /// </summary>
    [DataContract(Name = "MetricGroupRep")]
    public partial class MetricGroupRep : IValidatableObject
    {
        /// <summary>
        /// The type of the metric group
        /// </summary>
        /// <value>The type of the metric group</value>
        ...
        /// <value>The type of the metric group</value>
        /*
        <example>funnel</example>
        */
        [DataMember(Name = "kind", IsRequired = true, EmitDefaultValue = true)]
        public KindEnum Kind { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="MetricGroupRep" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MetricGroupRep() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MetricGroupRep" /> class.
        /// </summary>
        /// <param name="id">The ID of this metric group (required).</param>
        /// <param name="key">A unique key to reference the metric group (required).</param>
        /// <param name="name">A human-friendly name for the metric group (required).</param>
        /// <param name="kind">The type of the metric group (required).</param>
        /// <param name="description">Description of the metric group.</param>
        /// <param name="links">The location and content type of related resources (required).</param>
        /// <param name="access">access.</param>
        /// <param name="tags">Tags for the metric group (required).</param>
        /// <param name="creationDate">creationDate (required).</param>
        /// <param name="lastModified">lastModified (required).</param>
        /// <param name="maintainer">maintainer (required).</param>
        /// <param name="metrics">An ordered list of the metrics in this metric group (required).</param>
        /// <param name="varVersion">The version of this metric group (required).</param>
        /// <param name="experiments">experiments.</param>
        /// <param name="experimentCount">The number of experiments using this metric group.</param>
        public MetricGroupRep(string id = default(string), string key = default(string), string name = default(string), KindEnum kind = default(KindEnum), string description = default(string), Dictionary<string, Link> links = default(Dictionary<string, Link>), Access access = default(Access), List<string> tags = default(List<string>), long creationDate = default(long), long lastModified = default(long), MaintainerRep maintainer = default(MaintainerRep), List<MetricInGroupRep> metrics = default(List<MetricInGroupRep>), int varVersion = default(int), List<DependentExperimentRep> experiments = default(List<DependentExperimentRep>), int experimentCount = default(int))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for MetricGroupRep and cannot be null");
            }
            this.Id = id;
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for MetricGroupRep and cannot be null");
            }
            this.Key = key;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for MetricGroupRep and cannot be null");
            }
            this.Name = name;
            this.Kind = kind;
            ...
            if (links == null)
            {
                throw new ArgumentNullException("links is a required property for MetricGroupRep and cannot be null");
            }
            this.Links = links;
            // to ensure "tags" is required (not null)
            if (tags == null)
            {
                throw new ArgumentNullException("tags is a required property for MetricGroupRep and cannot be null");
            }
            this.Tags = tags;
            this.CreationDate = creationDate;
            this.LastModified = lastModified;
            // to ensure "maintainer" is required (not null)
            if (maintainer == null)
            {
                throw new ArgumentNullException("maintainer is a required property for MetricGroupRep and cannot be null");
            }
            this.Maintainer = maintainer;
            // to ensure "metrics" is required (not null)
            if (metrics == null)
            {
                throw new ArgumentNullException("metrics is a required property for MetricGroupRep and cannot be null");
            }
        ...
        /// </summary>
        /// <value>The ID of this metric group</value>
        /*
        <example>bc3e5be1-02d2-40c7-9926-26d0aacd7aab</example>
        */
        ...
        /// </summary>
        /// <value>A unique key to reference the metric group</value>
        /*
        <example>metric-group-key-123abc</example>
        */
        ...
        /// </summary>
        /// <value>A human-friendly name for the metric group</value>
        /*
        <example>My metric group</example>
        */
        ...
        /// </summary>
        /// <value>Description of the metric group</value>
        /*
        <example>Description of the metric group</example>
        */
        ...
        /*
        <example>{&quot;parent&quot;:{&quot;href&quot;:&quot;/api/v2/projects/my-project&quot;,&quot;type&quot;:&quot;application/json&quot;},&quot;self&quot;:{&quot;href&quot;:&quot;/api/v2/projects/my-project/metric-groups/my-metric-group&quot;,&quot;type&quot;:&quot;application/json&quot;}}</example>
        */
        ...
        /// </summary>
        /// <value>Tags for the metric group</value>
        /*
        <example>[&quot;ops&quot;]</example>
        */
        ...
        */
        ...
        <example>1706701522000</example>
        */
        [DataMember(Name = "_lastModified", IsRequired = true, EmitDefaultValue = true)]
        public long LastModified { get; set; }

        /// <summary>
        /// Gets or Sets Maintainer
        /// </summary>
        [DataMember(Name = "maintainer", IsRequired = true, EmitDefaultValue = true)]
        public MaintainerRep Maintainer { get; set; }

        /// <summary>
        /// An ordered list of the metrics in this metric group
        /// </summary>
        /// <value>An ordered list of the metrics in this metric group</value>
        [DataMember(Name = "metrics", IsRequired = true, EmitDefaultValue = true)]
        public List<MetricInGroupRep> Metrics { get; set; }

        /// <summary>
        /// The version of this metric group
        /// </summary>
        /// <value>The version of this metric group</value>
        /*
        <example>1</example>
        */
        ...
        /// </summary>
        /// <value>The number of experiments using this metric group</value>
        /*
        <example>0</example>
        */
