...
namespace Org.LaunchDarklyTools.Model
{
    ...
    /// InsightsRepository
    /// </summary>
    [DataContract(Name = "InsightsRepository")]
    public partial class InsightsRepository : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InsightsRepository" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InsightsRepository() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InsightsRepository" /> class.
        /// </summary>
        /// <param name="id">The repository ID (required).</param>
        /// <param name="varVersion">The repository version (required).</param>
        /// <param name="key">The repository key (required).</param>
        /// <param name="type">The repository type (required).</param>
        /// <param name="url">The repository URL (required).</param>
        /// <param name="mainBranch">The repository main branch (required).</param>
        /// <param name="projects">projects.</param>
        public InsightsRepository(Guid id = default(Guid), int varVersion = default(int), string key = default(string), string type = default(string), string url = default(string), string mainBranch = default(string), ProjectSummaryCollection projects = default(ProjectSummaryCollection))
        {
            this.Id = id;
            ...
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for InsightsRepository and cannot be null");
            }
            this.Key = key;
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for InsightsRepository and cannot be null");
            }
            this.Type = type;
            // to ensure "url" is required (not null)
            if (url == null)
            {
                throw new ArgumentNullException("url is a required property for InsightsRepository and cannot be null");
            }
            this.Url = url;
            // to ensure "mainBranch" is required (not null)
            if (mainBranch == null)
            {
                throw new ArgumentNullException("mainBranch is a required property for InsightsRepository and cannot be null");
            }
        ...
        /*
        <example>5f9a9b1a-5b9a-4b9a-9a9a-9a9a9a9a9a9a</example>
        */
        ...
        /// </summary>
        /// <value>The repository version</value>
        /*
        <example>1</example>
        */
        ...
        /*
        <example>launchdarkly/LaunchDarkly-Docs</example>
        */
        ...
        */
        ...
        /// </summary>
        /// <value>The repository main branch</value>
        /*
        <example>main</example>
        */
        [DataMember(Name = "mainBranch", IsRequired = true, EmitDefaultValue = true)]
        ...
        public ProjectSummaryCollection Projects { get; set; }
