...
namespace Org.LaunchDarklyTools.Model
{
    ...
    /// HoldoutRep
    /// </summary>
    [DataContract(Name = "HoldoutRep")]
    public partial class HoldoutRep : IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="HoldoutRep" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected HoldoutRep() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="HoldoutRep" /> class.
        /// </summary>
        ...
        public HoldoutRep(string id = default(string), StatusEnum status = default(StatusEnum), string description = default(string), string holdoutAmount = default(string), long createdAt = default(long), long updatedAt = default(long), Experiment baseExperiment = default(Experiment), List<RelatedExperimentRep> experiments = default(List<RelatedExperimentRep>))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for HoldoutRep and cannot be null");
            }
            this.Id = id;
            this.Status = status;
            ...
            {
                throw new ArgumentNullException("holdoutAmount is a required property for HoldoutRep and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("baseExperiment is a required property for HoldoutRep and cannot be null");
            }
        ...
        */
        ...
        public List<RelatedExperimentRep> Experiments { get; set; }
