...
namespace Org.LaunchDarklyTools.Model
{
    ...
    /// FlagCopyConfigPost
    /// </summary>
    [DataContract(Name = "FlagCopyConfigPost")]
    public partial class FlagCopyConfigPost : IValidatableObject
    {
        /// <summary>
        ...
        public enum IncludedActionsEnum
        {
            ...
            /// <summary>
            /// Enum UpdateFlagConfigMigrationSettings for value: updateFlagConfigMigrationSettings
            /// </summary>
            [EnumMember(Value = "updateFlagConfigMigrationSettings")]
            UpdateFlagConfigMigrationSettings = 7
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FlagCopyConfigPost" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FlagCopyConfigPost() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FlagCopyConfigPost" /> class.
        /// </summary>
        ...
        /// <param name="includedActions">Optional list of the flag changes to copy from the source environment to the target environment. You may include either &lt;code&gt;includedActions&lt;/code&gt; or &lt;code&gt;excludedActions&lt;/code&gt;, but not both. If you include neither, then all flag changes will be copied..</param>
        /// <param name="excludedActions">Optional list of the flag changes NOT to copy from the source environment to the target environment. You may include either  &lt;code&gt;includedActions&lt;/code&gt; or &lt;code&gt;excludedActions&lt;/code&gt;, but not both. If you include neither, then all flag changes will be copied..</param>
        public FlagCopyConfigPost(FlagCopyConfigEnvironment source = default(FlagCopyConfigEnvironment), FlagCopyConfigEnvironment target = default(FlagCopyConfigEnvironment), string comment = default(string), List<IncludedActionsEnum> includedActions = default(List<IncludedActionsEnum>), List<ExcludedActionsEnum> excludedActions = default(List<ExcludedActionsEnum>))
        {
            // to ensure "source" is required (not null)
            if (source == null)
            {
                throw new ArgumentNullException("source is a required property for FlagCopyConfigPost and cannot be null");
            }
            this.Source = source;
            // to ensure "target" is required (not null)
            if (target == null)
            {
                throw new ArgumentNullException("target is a required property for FlagCopyConfigPost and cannot be null");
            }
            this.Target = target;
        ...
        public FlagCopyConfigEnvironment Source { get; set; }

        /// <summary>
        /// Gets or Sets Target
        /// </summary>
        [DataMember(Name = "target", IsRequired = true, EmitDefaultValue = true)]
        public FlagCopyConfigEnvironment Target { get; set; }
        ...
        /// </summary>
        /// <value>Optional list of the flag changes to copy from the source environment to the target environment. You may include either &lt;code&gt;includedActions&lt;/code&gt; or &lt;code&gt;excludedActions&lt;/code&gt;, but not both. If you include neither, then all flag changes will be copied.</value>
        /*
        <example>[&quot;updateOn&quot;]</example>
        */
        [DataMember(Name = "includedActions", EmitDefaultValue = false)]
        public List<FlagCopyConfigPost.IncludedActionsEnum> IncludedActions { get; set; }
        ...
        /// </summary>
        /// <value>Optional list of the flag changes NOT to copy from the source environment to the target environment. You may include either  &lt;code&gt;includedActions&lt;/code&gt; or &lt;code&gt;excludedActions&lt;/code&gt;, but not both. If you include neither, then all flag changes will be copied.</value>
        /*
        <example>[&quot;updateOn&quot;]</example>
        */
        [DataMember(Name = "excludedActions", EmitDefaultValue = false)]
        public List<FlagCopyConfigPost.ExcludedActionsEnum> ExcludedActions { get; set; }
