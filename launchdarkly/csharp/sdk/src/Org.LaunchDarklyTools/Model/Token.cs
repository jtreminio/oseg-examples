...
namespace Org.LaunchDarklyTools.Model
{
    ...
    public partial class Token : IValidatableObject
    {
        ...
        /// <param name="name">A human-friendly name for the access token.</param>
        /// <param name="description">A description for the access token.</param>
        /// <param name="creationDate">creationDate (required).</param>
        /// <param name="lastModified">lastModified (required).</param>
        /// <param name="customRoleIds">A list of custom role IDs to use as access limits for the access token.</param>
        /// <param name="inlineRole">An array of policy statements, with three attributes: effect, resources, actions. May be used in place of a built-in or custom role..</param>
        /// <param name="role">Built-in role for the token.</param>
        /// <param name="varToken">The token value. When creating or resetting, contains the entire token value. Otherwise, contains the last four characters..</param>
        /// <param name="serviceToken">Whether this is a service token or a personal token.</param>
        /// <param name="links">The location and content type of related resources (required).</param>
        /// <param name="defaultApiVersion">The default API version for this token.</param>
        /// <param name="lastUsed">lastUsed.</param>
        public Token(string id = default(string), string ownerId = default(string), string memberId = default(string), MemberSummary member = default(MemberSummary), string name = default(string), string description = default(string), long creationDate = default(long), long lastModified = default(long), List<string> customRoleIds = default(List<string>), List<Statement> inlineRole = default(List<Statement>), string role = default(string), string varToken = default(string), bool serviceToken = default(bool), Dictionary<string, Link> links = default(Dictionary<string, Link>), int defaultApiVersion = default(int), long lastUsed = default(long))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for Token and cannot be null");
            }
            this.Id = id;
            // to ensure "ownerId" is required (not null)
            if (ownerId == null)
            {
                throw new ArgumentNullException("ownerId is a required property for Token and cannot be null");
            }
            this.OwnerId = ownerId;
            // to ensure "memberId" is required (not null)
            if (memberId == null)
            {
                throw new ArgumentNullException("memberId is a required property for Token and cannot be null");
            }
            ...
            if (links == null)
            {
                throw new ArgumentNullException("links is a required property for Token and cannot be null");
            }
            this.Links = links;
            this.Member = member;
            this.Name = name;
        ...
        /*
        <example>Example reader token</example>
        */
        ...
        /// </summary>
        /// <value>A description for the access token</value>
        /*
        <example>A reader token used in testing and examples</example>
        */
        ...
        */
        ...
        /// </summary>
        /// <value>An array of policy statements, with three attributes: effect, resources, actions. May be used in place of a built-in or custom role.</value>
        /*
        <example>[]</example>
        */
        ...
        /// </summary>
        /// <value>Built-in role for the token</value>
        /*
        ...
        */
        ...
        /// </summary>
        /// <value>The token value. When creating or resetting, contains the entire token value. Otherwise, contains the last four characters.</value>
        /*
        ...
        */
        ...
        /// </summary>
        /// <value>Whether this is a service token or a personal token</value>
        /*
        ...
        */
        ...
        /*
        <example>{&quot;parent&quot;:{&quot;href&quot;:&quot;/api/v2/tokens&quot;,&quot;type&quot;:&quot;application/json&quot;},&quot;self&quot;:{&quot;href&quot;:&quot;/api/v2/tokens/61095542756dba551110ae21&quot;,&quot;type&quot;:&quot;application/json&quot;}}</example>
        */
