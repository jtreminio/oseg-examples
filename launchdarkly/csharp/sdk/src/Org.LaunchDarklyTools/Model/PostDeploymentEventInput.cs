...
namespace Org.LaunchDarklyTools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostDeploymentEventInput")]
    public partial class PostDeploymentEventInput : IValidatableObject
    {
        /// <summary>
        /// The kind of application. Default: &lt;code&gt;server&lt;/code&gt;
        /// </summary>
        /// <value>The kind of application. Default: &lt;code&gt;server&lt;/code&gt;</value>
        ...
        */
        [DataMember(Name = "applicationKind", EmitDefaultValue = false)]
        public ApplicationKindEnum? ApplicationKind { get; set; }
        /// <summary>
        /// The event type
        /// </summary>
        ...
        */
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostDeploymentEventInput" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostDeploymentEventInput() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostDeploymentEventInput" /> class.
        /// </summary>
        /// <param name="projectKey">The project key (required).</param>
        /// <param name="environmentKey">The environment key (required).</param>
        /// <param name="applicationKey">The application key. This defines the granularity at which you want to view your insights metrics. Typically it is the name of one of the GitHub repositories that you use in this project.&lt;br/&gt;&lt;br/&gt;LaunchDarkly automatically creates a new application each time you send a unique application key. (required).</param>
        /// <param name="applicationName">The application name. This defines how the application is displayed.</param>
        /// <param name="applicationKind">The kind of application. Default: &lt;code&gt;server&lt;/code&gt;.</param>
        /// <param name="varVersion">The application version. You can set the application version to any string that includes only letters, numbers, periods (&lt;code&gt;.&lt;/code&gt;), hyphens (&lt;code&gt;-&lt;/code&gt;), or underscores (&lt;code&gt;_&lt;/code&gt;).&lt;br/&gt;&lt;br/&gt;We recommend setting the application version to at least the first seven characters of the SHA or to the tag of the GitHub commit for this deployment. (required).</param>
        /// <param name="versionName">The version name. This defines how the version is displayed.</param>
        /// <param name="eventType">The event type (required).</param>
        /// <param name="eventTime">eventTime.</param>
        /// <param name="eventMetadata">A JSON object containing metadata about the event.</param>
        /// <param name="deploymentMetadata">A JSON object containing metadata about the deployment.</param>
        public PostDeploymentEventInput(string projectKey = default(string), string environmentKey = default(string), string applicationKey = default(string), string applicationName = default(string), ApplicationKindEnum? applicationKind = default(ApplicationKindEnum?), string varVersion = default(string), string versionName = default(string), EventTypeEnum eventType = default(EventTypeEnum), long eventTime = default(long), Dictionary<string, Object> eventMetadata = default(Dictionary<string, Object>), Dictionary<string, Object> deploymentMetadata = default(Dictionary<string, Object>))
        {
            // to ensure "projectKey" is required (not null)
            if (projectKey == null)
            {
                throw new ArgumentNullException("projectKey is a required property for PostDeploymentEventInput and cannot be null");
            }
            this.ProjectKey = projectKey;
            // to ensure "environmentKey" is required (not null)
            if (environmentKey == null)
            {
                throw new ArgumentNullException("environmentKey is a required property for PostDeploymentEventInput and cannot be null");
            }
            this.EnvironmentKey = environmentKey;
            // to ensure "applicationKey" is required (not null)
            if (applicationKey == null)
            {
                throw new ArgumentNullException("applicationKey is a required property for PostDeploymentEventInput and cannot be null");
            }
            this.ApplicationKey = applicationKey;
            // to ensure "varVersion" is required (not null)
            if (varVersion == null)
            {
                throw new ArgumentNullException("varVersion is a required property for PostDeploymentEventInput and cannot be null");
            }
        ...
        */
        ...
        /// </summary>
        /// <value>The application key. This defines the granularity at which you want to view your insights metrics. Typically it is the name of one of the GitHub repositories that you use in this project.&lt;br/&gt;&lt;br/&gt;LaunchDarkly automatically creates a new application each time you send a unique application key.</value>
        /*
        ...
        */
        ...
        /// </summary>
        /// <value>The application name. This defines how the application is displayed</value>
        /*
        <example>Billing Service</example>
        */
        ...
        /// </summary>
        /// <value>The application version. You can set the application version to any string that includes only letters, numbers, periods (&lt;code&gt;.&lt;/code&gt;), hyphens (&lt;code&gt;-&lt;/code&gt;), or underscores (&lt;code&gt;_&lt;/code&gt;).&lt;br/&gt;&lt;br/&gt;We recommend setting the application version to at least the first seven characters of the SHA or to the tag of the GitHub commit for this deployment.</value>
        /*
        ...
        */
        ...
        /// </summary>
        /// <value>The version name. This defines how the version is displayed</value>
        /*
        ...
        */
        ...
        /// </summary>
        /// <value>A JSON object containing metadata about the event</value>
        /*
        <example>{&quot;buildSystemVersion&quot;:&quot;v1.2.3&quot;}</example>
        */
        ...
        /// </summary>
        /// <value>A JSON object containing metadata about the deployment</value>
        /*
        <example>{&quot;buildNumber&quot;:&quot;1234&quot;}</example>
        */
        [DataMember(Name = "deploymentMetadata", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ApplicationKind: ").Append(ApplicationKind).Append("\n");
            sb.Append("  VarVersion: ").Append(VarVersion).Append("\n");
            sb.Append("  VersionName: ").Append(VersionName).Append("\n");
            sb.Append("  EventType: ").Append(EventType).Append("\n");
            sb.Append("  EventTime: ").Append(EventTime).Append("\n");
            sb.Append("  EventMetadata: ").Append(EventMetadata).Append("\n");
            sb.Append("  DeploymentMetadata: ").Append(DeploymentMetadata).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
