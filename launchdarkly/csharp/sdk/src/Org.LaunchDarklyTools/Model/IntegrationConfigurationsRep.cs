...
namespace Org.LaunchDarklyTools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IntegrationConfigurationsRep")]
    public partial class IntegrationConfigurationsRep : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IntegrationConfigurationsRep" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected IntegrationConfigurationsRep() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="IntegrationConfigurationsRep" /> class.
        /// </summary>
        /// <param name="links">The location and content type of related resources (required).</param>
        /// <param name="id">The unique identifier for this integration configuration (required).</param>
        /// <param name="name">A human-friendly name for the integration (required).</param>
        /// <param name="createdAt">createdAt.</param>
        /// <param name="integrationKey">The type of integration.</param>
        /// <param name="tags">An array of tags for this integration.</param>
        /// <param name="enabled">Whether the integration is currently active.</param>
        /// <param name="access">access.</param>
        /// <param name="configValues">Details on configuration for an integration of this type. Refer to the &lt;code&gt;formVariables&lt;/code&gt; field in the corresponding &lt;code&gt;manifest.json&lt;/code&gt; for a full list of fields for each integration..</param>
        /// <param name="capabilityConfig">capabilityConfig.</param>
        public IntegrationConfigurationsRep(Dictionary<string, Link> links = default(Dictionary<string, Link>), string id = default(string), string name = default(string), long createdAt = default(long), string integrationKey = default(string), List<string> tags = default(List<string>), bool enabled = default(bool), Access access = default(Access), Dictionary<string, Object> configValues = default(Dictionary<string, Object>), CapabilityConfigRep capabilityConfig = default(CapabilityConfigRep))
        {
            // to ensure "links" is required (not null)
            if (links == null)
            {
                throw new ArgumentNullException("links is a required property for IntegrationConfigurationsRep and cannot be null");
            }
            this.Links = links;
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for IntegrationConfigurationsRep and cannot be null");
            }
            this.Id = id;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for IntegrationConfigurationsRep and cannot be null");
            }
            this.Name = name;
        ...
        /// </summary>
        /// <value>The unique identifier for this integration configuration</value>
        ...
        /// </summary>
        /// <value>A human-friendly name for the integration</value>
        /*
        ...
        */
        [DataMember(Name = "_createdAt", EmitDefaultValue = false)]
        ...
        */
        ...
        /// </summary>
        /// <value>An array of tags for this integration</value>
        /*
        ...
        */
        ...
        /// </summary>
        /// <value>Details on configuration for an integration of this type. Refer to the &lt;code&gt;formVariables&lt;/code&gt; field in the corresponding &lt;code&gt;manifest.json&lt;/code&gt; for a full list of fields for each integration.</value>
        [DataMember(Name = "configValues", EmitDefaultValue = false)]
        public Dictionary<string, Object> ConfigValues { get; set; }

        /// <summary>
        /// Gets or Sets CapabilityConfig
        /// </summary>
        [DataMember(Name = "capabilityConfig", EmitDefaultValue = false)]
        public CapabilityConfigRep CapabilityConfig { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CapabilityConfig: ").Append(CapabilityConfig).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
