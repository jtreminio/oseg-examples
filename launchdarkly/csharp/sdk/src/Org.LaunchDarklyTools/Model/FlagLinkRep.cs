...
namespace Org.LaunchDarklyTools.Model
{
    ...
    /// FlagLinkRep
    /// </summary>
    [DataContract(Name = "FlagLinkRep")]
    public partial class FlagLinkRep : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FlagLinkRep" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FlagLinkRep() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FlagLinkRep" /> class.
        /// </summary>
        /// <param name="links">The location and content type of related resources (required).</param>
        /// <param name="key">The flag link key.</param>
        /// <param name="integrationKey">The integration key for an integration whose &lt;code&gt;manifest.json&lt;/code&gt; includes the &lt;code&gt;flagLink&lt;/code&gt; capability, if this is a flag link for an existing integration.</param>
        /// <param name="id">The ID of this flag link (required).</param>
        /// <param name="deepLink">The URL for the external resource the flag is linked to (required).</param>
        /// <param name="timestamp">timestamp (required).</param>
        /// <param name="title">The title of the flag link.</param>
        /// <param name="description">The description of the flag link.</param>
        /// <param name="metadata">The metadata required by this integration in order to create a flag link, if this is a flag link for an existing integration. Defined in the integration&#39;s &lt;code&gt;manifest.json&lt;/code&gt; file under &lt;code&gt;flagLink&lt;/code&gt;..</param>
        /// <param name="createdAt">createdAt (required).</param>
        /// <param name="member">member.</param>
        public FlagLinkRep(Dictionary<string, Link> links = default(Dictionary<string, Link>), string key = default(string), string integrationKey = default(string), string id = default(string), string deepLink = default(string), TimestampRep timestamp = default(TimestampRep), string title = default(string), string description = default(string), Dictionary<string, string> metadata = default(Dictionary<string, string>), long createdAt = default(long), FlagLinkMember member = default(FlagLinkMember))
        {
            // to ensure "links" is required (not null)
            if (links == null)
            {
                throw new ArgumentNullException("links is a required property for FlagLinkRep and cannot be null");
            }
            this.Links = links;
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for FlagLinkRep and cannot be null");
            }
            this.Id = id;
            // to ensure "deepLink" is required (not null)
            if (deepLink == null)
            {
                throw new ArgumentNullException("deepLink is a required property for FlagLinkRep and cannot be null");
            }
            this.DeepLink = deepLink;
            // to ensure "timestamp" is required (not null)
            if (timestamp == null)
            {
                throw new ArgumentNullException("timestamp is a required property for FlagLinkRep and cannot be null");
            }
        ...
        /// The flag link key
        /// </summary>
        /// <value>The flag link key</value>
        /*
        <example>flag-link-key-123abc</example>
        */
        [DataMember(Name = "_key", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>The integration key for an integration whose &lt;code&gt;manifest.json&lt;/code&gt; includes the &lt;code&gt;flagLink&lt;/code&gt; capability, if this is a flag link for an existing integration</value>
        [DataMember(Name = "_integrationKey", EmitDefaultValue = false)]
        public string IntegrationKey { get; set; }

        /// <summary>
        /// The ID of this flag link
        /// </summary>
        /// <value>The ID of this flag link</value>
        /*
        ...
        */
        ...
        /// </summary>
        /// <value>The URL for the external resource the flag is linked to</value>
        /*
        <example>https://example.com/archives/123123123</example>
        */
        [DataMember(Name = "_deepLink", IsRequired = true, EmitDefaultValue = true)]
        public string DeepLink { get; set; }

        /// <summary>
        /// Gets or Sets Timestamp
        /// </summary>
        [DataMember(Name = "_timestamp", IsRequired = true, EmitDefaultValue = true)]
        public TimestampRep Timestamp { get; set; }

        /// <summary>
        /// The title of the flag link
        /// </summary>
        /// <value>The title of the flag link</value>
        /*
        <example>Example link title</example>
        */
        ...
        /// </summary>
        /// <value>The description of the flag link</value>
        /*
        <example>Example link description</example>
        */
        ...
        /// </summary>
        /// <value>The metadata required by this integration in order to create a flag link, if this is a flag link for an existing integration. Defined in the integration&#39;s &lt;code&gt;manifest.json&lt;/code&gt; file under &lt;code&gt;flagLink&lt;/code&gt;.</value>
        ...
        */
        [DataMember(Name = "_createdAt", IsRequired = true, EmitDefaultValue = true)]
        ...
        public FlagLinkMember Member { get; set; }
