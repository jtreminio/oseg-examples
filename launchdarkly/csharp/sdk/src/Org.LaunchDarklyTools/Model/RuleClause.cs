...
namespace Org.LaunchDarklyTools.Model
{
    ...
    public partial class RuleClause : IValidatableObject
    {
        /// <summary>
        /// The operator to apply to the given attribute
        /// </summary>
        /// <value>The operator to apply to the given attribute</value>
        ...
        public enum OpEnum
        {
            ...
            /// <summary>
            /// Enum SegmentMatch for value: segmentMatch
            /// </summary>
            [EnumMember(Value = "segmentMatch")]
            SegmentMatch = 12,

            /// <summary>
            /// Enum SemVerEqual for value: semVerEqual
            /// </summary>
            [EnumMember(Value = "semVerEqual")]
            SemVerEqual = 13,

            /// <summary>
            /// Enum SemVerLessThan for value: semVerLessThan
            /// </summary>
            [EnumMember(Value = "semVerLessThan")]
            SemVerLessThan = 14,

            /// <summary>
            /// Enum SemVerGreaterThan for value: semVerGreaterThan
            /// </summary>
            [EnumMember(Value = "semVerGreaterThan")]
            SemVerGreaterThan = 15
        }
        ...
        /// </summary>
        /// <param name="attribute">The attribute the rule applies to, for example, last name or email address.</param>
        /// <param name="op">The operator to apply to the given attribute.</param>
        /// <param name="negate">Whether the operator should be negated.</param>
        public RuleClause(string attribute = default(string), OpEnum? op = default(OpEnum?), bool negate = default(bool))
        {
        ...
        /// </summary>
        /// <value>The attribute the rule applies to, for example, last name or email address</value>
        ...
        /// </summary>
        /// <value>Whether the operator should be negated</value>
