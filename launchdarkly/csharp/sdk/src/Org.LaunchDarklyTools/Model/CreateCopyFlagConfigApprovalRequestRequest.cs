...
namespace Org.LaunchDarklyTools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "createCopyFlagConfigApprovalRequestRequest")]
    public partial class CreateCopyFlagConfigApprovalRequestRequest : IValidatableObject
    {
        /// <summary>
        /// Defines IncludedActions
        /// </summary>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum IncludedActionsEnum
        {
            /// <summary>
            /// Enum UpdateOn for value: updateOn
            /// </summary>
            [EnumMember(Value = "updateOn")]
            UpdateOn = 1,

            /// <summary>
            /// Enum UpdateFallthrough for value: updateFallthrough
            /// </summary>
            [EnumMember(Value = "updateFallthrough")]
            UpdateFallthrough = 2,

            /// <summary>
            /// Enum UpdateOffVariation for value: updateOffVariation
            /// </summary>
            [EnumMember(Value = "updateOffVariation")]
            UpdateOffVariation = 3,

            /// <summary>
            /// Enum UpdateRules for value: updateRules
            /// </summary>
            [EnumMember(Value = "updateRules")]
            UpdateRules = 4,

            /// <summary>
            /// Enum UpdateTargets for value: updateTargets
            /// </summary>
            [EnumMember(Value = "updateTargets")]
            UpdateTargets = 5,

            /// <summary>
            /// Enum UpdatePrerequisites for value: updatePrerequisites
            /// </summary>
            [EnumMember(Value = "updatePrerequisites")]
            UpdatePrerequisites = 6
        }

        /// <summary>
        /// Defines ExcludedActions
        /// </summary>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateCopyFlagConfigApprovalRequestRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateCopyFlagConfigApprovalRequestRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateCopyFlagConfigApprovalRequestRequest" /> class.
        /// </summary>
        /// <param name="comment">Optional comment describing the approval request.</param>
        /// <param name="description">A brief description of your changes (required).</param>
        /// <param name="notifyMemberIds">An array of member IDs. These members are notified to review the approval request..</param>
        /// <param name="notifyTeamKeys">An array of team keys. The members of these teams are notified to review the approval request..</param>
        /// <param name="source">source (required).</param>
        /// <param name="includedActions">Optional list of the flag changes to copy from the source environment to the target environment. You may include either &lt;code&gt;includedActions&lt;/code&gt; or &lt;code&gt;excludedActions&lt;/code&gt;, but not both. If neither are included, then all flag changes will be copied..</param>
        /// <param name="excludedActions">Optional list of the flag changes NOT to copy from the source environment to the target environment. You may include either &lt;code&gt;includedActions&lt;/code&gt; or &lt;code&gt;excludedActions&lt;/code&gt;, but not both. If neither are included, then all flag changes will be copied..</param>
        public CreateCopyFlagConfigApprovalRequestRequest(string comment = default(string), string description = default(string), List<string> notifyMemberIds = default(List<string>), List<string> notifyTeamKeys = default(List<string>), SourceFlag source = default(SourceFlag), List<IncludedActionsEnum> includedActions = default(List<IncludedActionsEnum>), List<ExcludedActionsEnum> excludedActions = default(List<ExcludedActionsEnum>))
        {
            // to ensure "description" is required (not null)
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for CreateCopyFlagConfigApprovalRequestRequest and cannot be null");
            }
            this.Description = description;
            // to ensure "source" is required (not null)
            if (source == null)
            {
                throw new ArgumentNullException("source is a required property for CreateCopyFlagConfigApprovalRequestRequest and cannot be null");
            }
            this.Source = source;
        ...
        /// </summary>
        /// <value>Optional comment describing the approval request</value>
        /*
        <example>optional comment</example>
        */
        ...
        /// </summary>
        /// <value>A brief description of your changes</value>
        /*
        <example>copy flag settings to another environment</example>
        */
        ...
        */
        ...
        /// </summary>
        /// <value>An array of team keys. The members of these teams are notified to review the approval request.</value>
        /*
        <example>[&quot;example-reviewer-team&quot;]</example>
        */
        [DataMember(Name = "notifyTeamKeys", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>Optional list of the flag changes to copy from the source environment to the target environment. You may include either &lt;code&gt;includedActions&lt;/code&gt; or &lt;code&gt;excludedActions&lt;/code&gt;, but not both. If neither are included, then all flag changes will be copied.</value>
        /*
        <example>[&quot;updateOn&quot;]</example>
        */
        [DataMember(Name = "includedActions", EmitDefaultValue = false)]
        public List<CreateCopyFlagConfigApprovalRequestRequest.IncludedActionsEnum> IncludedActions { get; set; }
        ...
        /// </summary>
        /// <value>Optional list of the flag changes NOT to copy from the source environment to the target environment. You may include either &lt;code&gt;includedActions&lt;/code&gt; or &lt;code&gt;excludedActions&lt;/code&gt;, but not both. If neither are included, then all flag changes will be copied.</value>
        /*
        <example>[&quot;updateOn&quot;]</example>
        */
        [DataMember(Name = "excludedActions", EmitDefaultValue = false)]
        public List<CreateCopyFlagConfigApprovalRequestRequest.ExcludedActionsEnum> ExcludedActions { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  NotifyTeamKeys: ").Append(NotifyTeamKeys).Append("\n");
