...
namespace Org.LaunchDarklyTools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ExpandableApprovalRequestResponse")]
    public partial class ExpandableApprovalRequestResponse : IValidatableObject
    {
        /// <summary>
        /// Current status of the review of this approval request
        /// </summary>
        /// <value>Current status of the review of this approval request</value>
        ...
        */
        ...
        /// </summary>
        /// <value>Current status of the approval request</value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        */
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExpandableApprovalRequestResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ExpandableApprovalRequestResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ExpandableApprovalRequestResponse" /> class.
        /// </summary>
        /// <param name="id">The ID of this approval request (required).</param>
        /// <param name="varVersion">Version of the approval request (required).</param>
        /// <param name="creationDate">creationDate (required).</param>
        /// <param name="serviceKind">serviceKind (required).</param>
        /// <param name="requestorId">The ID of the member who requested the approval.</param>
        /// <param name="description">A human-friendly name for the approval request.</param>
        /// <param name="reviewStatus">Current status of the review of this approval request (required).</param>
        /// <param name="allReviews">An array of individual reviews of this approval request (required).</param>
        /// <param name="notifyMemberIds">An array of member IDs. These members are notified to review the approval request. (required).</param>
        /// <param name="appliedDate">appliedDate.</param>
        /// <param name="appliedByMemberId">The member ID of the member who applied the approval request.</param>
        /// <param name="appliedByServiceTokenId">The service token ID of the service token which applied the approval request.</param>
        /// <param name="status">Current status of the approval request (required).</param>
        /// <param name="instructions">instructions (required).</param>
        /// <param name="conflicts">Details on any conflicting approval requests (required).</param>
        ...
        /// <param name="operatingOnId">ID of scheduled change to edit or delete.</param>
        /// <param name="integrationMetadata">integrationMetadata.</param>
        /// <param name="source">source.</param>
        /// <param name="customWorkflowMetadata">customWorkflowMetadata.</param>
        /// <param name="resourceId">String representation of a resource.</param>
        /// <param name="approvalSettings">approvalSettings.</param>
        /// <param name="project">project.</param>
        /// <param name="environments">List of environments the approval impacts.</param>
        /// <param name="flag">flag.</param>
        /// <param name="resource">resource.</param>
        public ExpandableApprovalRequestResponse(string id = default(string), int varVersion = default(int), long creationDate = default(long), string serviceKind = default(string), string requestorId = default(string), string description = default(string), ReviewStatusEnum reviewStatus = default(ReviewStatusEnum), List<ReviewResponse> allReviews = default(List<ReviewResponse>), List<string> notifyMemberIds = default(List<string>), long appliedDate = default(long), string appliedByMemberId = default(string), string appliedByServiceTokenId = default(string), StatusEnum status = default(StatusEnum), List<Dictionary<string, Object>> instructions = default(List<Dictionary<string, Object>>), List<Conflict> conflicts = default(List<Conflict>), Dictionary<string, Object> links = default(Dictionary<string, Object>), long executionDate = default(long), string operatingOnId = default(string), IntegrationMetadata integrationMetadata = default(IntegrationMetadata), CopiedFromEnv source = default(CopiedFromEnv), CustomWorkflowMeta customWorkflowMetadata = default(CustomWorkflowMeta), string resourceId = default(string), ApprovalSettings approvalSettings = default(ApprovalSettings), Project project = default(Project), List<ModelEnvironment> environments = default(List<ModelEnvironment>), ExpandedFlagRep flag = default(ExpandedFlagRep), ExpandedResourceRep resource = default(ExpandedResourceRep))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for ExpandableApprovalRequestResponse and cannot be null");
            }
            this.Id = id;
            ...
            if (serviceKind == null)
            {
                throw new ArgumentNullException("serviceKind is a required property for ExpandableApprovalRequestResponse and cannot be null");
            }
            this.ServiceKind = serviceKind;
            this.ReviewStatus = reviewStatus;
            // to ensure "allReviews" is required (not null)
            if (allReviews == null)
            {
                throw new ArgumentNullException("allReviews is a required property for ExpandableApprovalRequestResponse and cannot be null");
            }
            this.AllReviews = allReviews;
            // to ensure "notifyMemberIds" is required (not null)
            if (notifyMemberIds == null)
            {
                throw new ArgumentNullException("notifyMemberIds is a required property for ExpandableApprovalRequestResponse and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("instructions is a required property for ExpandableApprovalRequestResponse and cannot be null");
            }
            this.Instructions = instructions;
            // to ensure "conflicts" is required (not null)
            if (conflicts == null)
            {
                throw new ArgumentNullException("conflicts is a required property for ExpandableApprovalRequestResponse and cannot be null");
            }
            this.Conflicts = conflicts;
            // to ensure "links" is required (not null)
            if (links == null)
            {
                throw new ArgumentNullException("links is a required property for ExpandableApprovalRequestResponse and cannot be null");
            }
            this.Links = links;
        ...
        /// </summary>
        /// <value>The ID of this approval request</value>
        /*
        <example>12ab3c45de678910abc12345</example>
        */
        ...
        /// </summary>
        /// <value>Version of the approval request</value>
        /*
        <example>1</example>
        */
        ...
        */
        ...
        /// </summary>
        [DataMember(Name = "serviceKind", IsRequired = true, EmitDefaultValue = true)]
        public string ServiceKind { get; set; }

        /// <summary>
        /// The ID of the member who requested the approval
        /// </summary>
        /// <value>The ID of the member who requested the approval</value>
        /*
        <example>12ab3c45de678910abc12345</example>
        */
        ...
        /// </summary>
        /// <value>A human-friendly name for the approval request</value>
        /*
        <example>example: request approval from someone</example>
        */
        ...
        /// </summary>
        /// <value>An array of individual reviews of this approval request</value>
        [DataMember(Name = "allReviews", IsRequired = true, EmitDefaultValue = true)]
        public List<ReviewResponse> AllReviews { get; set; }

        /// <summary>
        /// An array of member IDs. These members are notified to review the approval request.
        /// </summary>
        /// <value>An array of member IDs. These members are notified to review the approval request.</value>
        /*
        <example>[&quot;1234a56b7c89d012345e678f&quot;]</example>
        */
        [DataMember(Name = "notifyMemberIds", IsRequired = true, EmitDefaultValue = true)]
        ...
        */
        ...
        /// </summary>
        /// <value>The member ID of the member who applied the approval request</value>
        /*
        <example>1234a56b7c89d012345e678f</example>
        */
        ...
        /// </summary>
        /// <value>The service token ID of the service token which applied the approval request</value>
        /*
        <example>1234a56b7c89d012345e678f</example>
        */
        [DataMember(Name = "appliedByServiceTokenId", EmitDefaultValue = false)]
        ...
        public List<Dictionary<string, Object>> Instructions { get; set; }

        /// <summary>
        /// Details on any conflicting approval requests
        /// </summary>
        /// <value>Details on any conflicting approval requests</value>
        ...
        */
        ...
        /// <summary>
        /// Gets or Sets IntegrationMetadata
        /// </summary>
        [DataMember(Name = "integrationMetadata", EmitDefaultValue = false)]
        public IntegrationMetadata IntegrationMetadata { get; set; }

        /// <summary>
        /// Gets or Sets Source
        /// </summary>
        [DataMember(Name = "source", EmitDefaultValue = false)]
        public CopiedFromEnv Source { get; set; }

        /// <summary>
        /// Gets or Sets CustomWorkflowMetadata
        /// </summary>
        [DataMember(Name = "customWorkflowMetadata", EmitDefaultValue = false)]
        public CustomWorkflowMeta CustomWorkflowMetadata { get; set; }

        /// <summary>
        /// String representation of a resource
        /// </summary>
        /// <value>String representation of a resource</value>
        ...
        /// </summary>
        /// <value>List of environments the approval impacts</value>
        ...
        public ExpandedFlagRep Flag { get; set; }

        /// <summary>
        /// Gets or Sets Resource
        /// </summary>
        [DataMember(Name = "resource", EmitDefaultValue = false)]
        public ExpandedResourceRep Resource { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AppliedByServiceTokenId: ").Append(AppliedByServiceTokenId).Append("\n");
            ...
            sb.Append("  IntegrationMetadata: ").Append(IntegrationMetadata).Append("\n");
            sb.Append("  Source: ").Append(Source).Append("\n");
            sb.Append("  CustomWorkflowMetadata: ").Append(CustomWorkflowMetadata).Append("\n");
