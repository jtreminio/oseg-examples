...
namespace Org.LaunchDarklyTools.Model
{
    ...
    /// ReleasePhase
    /// </summary>
    [DataContract(Name = "ReleasePhase")]
    public partial class ReleasePhase : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReleasePhase" /> class.
        /// </summary>
        ...
        /// Initializes a new instance of the <see cref="ReleasePhase" /> class.
        /// </summary>
        /// <param name="id">The phase ID (required).</param>
        /// <param name="name">The release phase name (required).</param>
        /// <param name="complete">Whether this phase is complete (required).</param>
        ...
        /// <param name="audiences">A logical grouping of one or more environments that share attributes for rolling out changes (required).</param>
        /// <param name="status">status.</param>
        /// <param name="started">Whether or not this phase has started.</param>
        /// <param name="startedDate">startedDate.</param>
        /// <param name="varConfiguration">varConfiguration.</param>
        public ReleasePhase(string id = default(string), string name = default(string), bool complete = default(bool), long creationDate = default(long), long completionDate = default(long), CompletedBy completedBy = default(CompletedBy), List<ReleaseAudience> audiences = default(List<ReleaseAudience>), string status = default(string), bool started = default(bool), long startedDate = default(long), Object varConfiguration = default(Object))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for ReleasePhase and cannot be null");
            }
            this.Id = id;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for ReleasePhase and cannot be null");
            }
            this.Name = name;
            ...
            if (audiences == null)
            {
                throw new ArgumentNullException("audiences is a required property for ReleasePhase and cannot be null");
            }
        ...
        */
        ...
        /// </summary>
        /// <value>The release phase name</value>
        /*
        <example>Phase 1 - Testing</example>
        */
        [DataMember(Name = "_name", IsRequired = true, EmitDefaultValue = true)]
        public string Name { get; set; }

        /// <summary>
        /// Whether this phase is complete
        /// </summary>
        /// <value>Whether this phase is complete</value>
        /*
        ...
        */
        ...
        <example>1706701522000</example>
        */
        [DataMember(Name = "_completionDate", EmitDefaultValue = false)]
        public long CompletionDate { get; set; }

        /// <summary>
        /// Gets or Sets CompletedBy
        /// </summary>
        [DataMember(Name = "_completedBy", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>A logical grouping of one or more environments that share attributes for rolling out changes</value>
        [DataMember(Name = "_audiences", IsRequired = true, EmitDefaultValue = true)]
        public List<ReleaseAudience> Audiences { get; set; }
        ...
        /// </summary>
        /// <value>Whether or not this phase has started</value>
        ...
        <example>1706701522000</example>
        */
        [DataMember(Name = "_startedDate", EmitDefaultValue = false)]
