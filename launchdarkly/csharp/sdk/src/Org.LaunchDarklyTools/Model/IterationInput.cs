...
namespace Org.LaunchDarklyTools.Model
{
    ...
    /// IterationInput
    /// </summary>
    [DataContract(Name = "IterationInput")]
    public partial class IterationInput : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IterationInput" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected IterationInput() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="IterationInput" /> class.
        /// </summary>
        /// <param name="hypothesis">The expected outcome of this experiment (required).</param>
        /// <param name="canReshuffleTraffic">Whether to allow the experiment to reassign traffic to different variations when you increase or decrease the traffic in your experiment audience (true) or keep all traffic assigned to its initial variation (false). Defaults to true..</param>
        /// <param name="metrics">metrics (required).</param>
        /// <param name="primarySingleMetricKey">The key of the primary metric for this experiment. Either &lt;code&gt;primarySingleMetricKey&lt;/code&gt; or &lt;code&gt;primaryFunnelKey&lt;/code&gt; must be present..</param>
        /// <param name="primaryFunnelKey">The key of the primary funnel group for this experiment. Either &lt;code&gt;primarySingleMetricKey&lt;/code&gt; or &lt;code&gt;primaryFunnelKey&lt;/code&gt; must be present..</param>
        /// <param name="treatments">treatments (required).</param>
        /// <param name="flags">flags (required).</param>
        /// <param name="randomizationUnit">The unit of randomization for this iteration. Defaults to user..</param>
        /// <param name="attributes">The attributes that this iteration&#39;s results can be sliced by.</param>
        public IterationInput(string hypothesis = default(string), bool canReshuffleTraffic = default(bool), List<MetricInput> metrics = default(List<MetricInput>), string primarySingleMetricKey = default(string), string primaryFunnelKey = default(string), List<TreatmentInput> treatments = default(List<TreatmentInput>), Dictionary<string, FlagInput> flags = default(Dictionary<string, FlagInput>), string randomizationUnit = default(string), List<string> attributes = default(List<string>))
        {
            // to ensure "hypothesis" is required (not null)
            if (hypothesis == null)
            {
                throw new ArgumentNullException("hypothesis is a required property for IterationInput and cannot be null");
            }
            this.Hypothesis = hypothesis;
            // to ensure "metrics" is required (not null)
            if (metrics == null)
            {
                throw new ArgumentNullException("metrics is a required property for IterationInput and cannot be null");
            }
            this.Metrics = metrics;
            // to ensure "treatments" is required (not null)
            if (treatments == null)
            {
                throw new ArgumentNullException("treatments is a required property for IterationInput and cannot be null");
            }
            this.Treatments = treatments;
            // to ensure "flags" is required (not null)
            if (flags == null)
            {
                throw new ArgumentNullException("flags is a required property for IterationInput and cannot be null");
            }
            this.Flags = flags;
        ...
        /*
        <example>Example hypothesis, the new button placement will increase conversion</example>
        */
        ...
        /// </summary>
        /// <value>Whether to allow the experiment to reassign traffic to different variations when you increase or decrease the traffic in your experiment audience (true) or keep all traffic assigned to its initial variation (false). Defaults to true.</value>
        /*
        ...
        */
        ...
        /// </summary>
        /// <value>The key of the primary metric for this experiment. Either &lt;code&gt;primarySingleMetricKey&lt;/code&gt; or &lt;code&gt;primaryFunnelKey&lt;/code&gt; must be present.</value>
        /*
        <example>metric-key-123abc</example>
        */
        [DataMember(Name = "primarySingleMetricKey", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>The key of the primary funnel group for this experiment. Either &lt;code&gt;primarySingleMetricKey&lt;/code&gt; or &lt;code&gt;primaryFunnelKey&lt;/code&gt; must be present.</value>
        /*
        <example>metric-group-key-123abc</example>
        */
        [DataMember(Name = "primaryFunnelKey", EmitDefaultValue = false)]
        public string PrimaryFunnelKey { get; set; }

        /// <summary>
        /// Gets or Sets Treatments
        /// </summary>
        [DataMember(Name = "treatments", IsRequired = true, EmitDefaultValue = true)]
        ...
        public Dictionary<string, FlagInput> Flags { get; set; }

        /// <summary>
        /// The unit of randomization for this iteration. Defaults to user.
        /// </summary>
        /// <value>The unit of randomization for this iteration. Defaults to user.</value>
        /*
        ...
        */
        ...
        /// </summary>
        /// <value>The attributes that this iteration&#39;s results can be sliced by</value>
        /*
        <example>[&quot;country&quot;,&quot;device&quot;,&quot;os&quot;]</example>
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("  PrimarySingleMetricKey: ").Append(PrimarySingleMetricKey).Append("\n");
            sb.Append("  PrimaryFunnelKey: ").Append(PrimaryFunnelKey).Append("\n");
