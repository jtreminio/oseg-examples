...
namespace Org.LaunchDarklyTools.Model
{
    ...
    public partial class DependentMetricOrMetricGroupRep : IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>If this is a metric, then it represents the kind of event the metric tracks. If this is a metric group, then it represents the group type</value>
        ...
        */
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DependentMetricOrMetricGroupRep" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DependentMetricOrMetricGroupRep() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DependentMetricOrMetricGroupRep" /> class.
        /// </summary>
        /// <param name="key">A unique key to reference the metric or metric group (required).</param>
        /// <param name="versionId">The version ID of the metric or metric group (required).</param>
        /// <param name="name">A human-friendly name for the metric or metric group (required).</param>
        /// <param name="kind">If this is a metric, then it represents the kind of event the metric tracks. If this is a metric group, then it represents the group type (required).</param>
        ...
        /// <param name="isGroup">Whether this is a metric group or a metric (required).</param>
        /// <param name="metrics">An ordered list of the metrics in this metric group.</param>
        public DependentMetricOrMetricGroupRep(string key = default(string), string versionId = default(string), string name = default(string), KindEnum kind = default(KindEnum), bool isNumeric = default(bool), Dictionary<string, Link> links = default(Dictionary<string, Link>), bool isGroup = default(bool), List<MetricInGroupRep> metrics = default(List<MetricInGroupRep>))
        {
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for DependentMetricOrMetricGroupRep and cannot be null");
            }
            this.Key = key;
            // to ensure "versionId" is required (not null)
            if (versionId == null)
            {
                throw new ArgumentNullException("versionId is a required property for DependentMetricOrMetricGroupRep and cannot be null");
            }
            this.VersionId = versionId;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for DependentMetricOrMetricGroupRep and cannot be null");
            }
            this.Name = name;
            this.Kind = kind;
            ...
            if (links == null)
            {
                throw new ArgumentNullException("links is a required property for DependentMetricOrMetricGroupRep and cannot be null");
            }
            this.Links = links;
        ...
        /// </summary>
        /// <value>A unique key to reference the metric or metric group</value>
        /*
        ...
        */
        ...
        /// </summary>
        /// <value>The version ID of the metric or metric group</value>
        ...
        /// </summary>
        /// <value>A human-friendly name for the metric or metric group</value>
        /*
        ...
        */
        ...
        /// </summary>
        /// <value>Whether this is a metric group or a metric</value>
