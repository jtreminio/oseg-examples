...
namespace Org.LaunchDarklyTools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CustomWorkflowOutput")]
    public partial class CustomWorkflowOutput : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomWorkflowOutput" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CustomWorkflowOutput() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomWorkflowOutput" /> class.
        /// </summary>
        /// <param name="id">The ID of the workflow (required).</param>
        /// <param name="varVersion">The version of the workflow (required).</param>
        /// <param name="conflicts">Any conflicts that are present in the workflow stages (required).</param>
        /// <param name="creationDate">creationDate (required).</param>
        /// <param name="maintainerId">The member ID of the maintainer of the workflow. Defaults to the workflow creator. (required).</param>
        ...
        /// <param name="description">A brief description of the workflow.</param>
        /// <param name="kind">The kind of workflow.</param>
        /// <param name="stages">The stages that make up the workflow. Each stage contains conditions and actions..</param>
        /// <param name="execution">execution (required).</param>
        /// <param name="meta">meta.</param>
        /// <param name="templateKey">For workflows being created from a workflow template, this value is the template&#39;s key.</param>
        public CustomWorkflowOutput(string id = default(string), int varVersion = default(int), List<ConflictOutput> conflicts = default(List<ConflictOutput>), long creationDate = default(long), string maintainerId = default(string), Dictionary<string, Link> links = default(Dictionary<string, Link>), string name = default(string), string description = default(string), string kind = default(string), List<StageOutput> stages = default(List<StageOutput>), ExecutionOutput execution = default(ExecutionOutput), WorkflowTemplateMetadata meta = default(WorkflowTemplateMetadata), string templateKey = default(string))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for CustomWorkflowOutput and cannot be null");
            }
            this.Id = id;
            ...
            if (conflicts == null)
            {
                throw new ArgumentNullException("conflicts is a required property for CustomWorkflowOutput and cannot be null");
            }
            this.Conflicts = conflicts;
            this.CreationDate = creationDate;
            // to ensure "maintainerId" is required (not null)
            if (maintainerId == null)
            {
                throw new ArgumentNullException("maintainerId is a required property for CustomWorkflowOutput and cannot be null");
            }
            this.MaintainerId = maintainerId;
            // to ensure "links" is required (not null)
            if (links == null)
            {
                throw new ArgumentNullException("links is a required property for CustomWorkflowOutput and cannot be null");
            }
            this.Links = links;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for CustomWorkflowOutput and cannot be null");
            }
            this.Name = name;
            // to ensure "execution" is required (not null)
            if (execution == null)
            {
                throw new ArgumentNullException("execution is a required property for CustomWorkflowOutput and cannot be null");
            }
        ...
        /*
        <example>12ab3c4d5ef1a2345bcde67f</example>
        */
        ...
        /// </summary>
        /// <value>The version of the workflow</value>
        /*
        <example>1</example>
        */
        ...
        /// </summary>
        /// <value>Any conflicts that are present in the workflow stages</value>
        [DataMember(Name = "_conflicts", IsRequired = true, EmitDefaultValue = true)]
        ...
        */
        ...
        /// </summary>
        /// <value>The member ID of the maintainer of the workflow. Defaults to the workflow creator.</value>
        /*
        <example>12ab3c45de678910abc12345</example>
        */
        [DataMember(Name = "_maintainerId", IsRequired = true, EmitDefaultValue = true)]
        ...
        /*
        <example>Progressive rollout starting in two days</example>
        */
        ...
        /*
        <example>Turn flag on for 10% of customers each day</example>
        */
        ...
        /// </summary>
        /// <value>The kind of workflow</value>
        /*
        ...
        */
        ...
        /// </summary>
        /// <value>The stages that make up the workflow. Each stage contains conditions and actions.</value>
        [DataMember(Name = "stages", EmitDefaultValue = false)]
        public List<StageOutput> Stages { get; set; }

        /// <summary>
        /// Gets or Sets Execution
        /// </summary>
        [DataMember(Name = "_execution", IsRequired = true, EmitDefaultValue = true)]
        public ExecutionOutput Execution { get; set; }

        /// <summary>
        /// Gets or Sets Meta
        /// </summary>
        [DataMember(Name = "meta", EmitDefaultValue = false)]
        public WorkflowTemplateMetadata Meta { get; set; }

        /// <summary>
        /// For workflows being created from a workflow template, this value is the template&#39;s key
        /// </summary>
        /// <value>For workflows being created from a workflow template, this value is the template&#39;s key</value>
        /*
        <example>example-workflow-template</example>
        */
