...
namespace Org.LaunchDarklyTools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "patchSegmentExpiringTargetInstruction")]
    public partial class PatchSegmentExpiringTargetInstruction : IValidatableObject
    {
        /// <summary>
        /// The type of change to make to the context&#39;s removal date from this segment
        /// </summary>
        /// <value>The type of change to make to the context&#39;s removal date from this segment</value>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum KindEnum
        {
            /// <summary>
            /// Enum AddExpiringTarget for value: addExpiringTarget
            /// </summary>
            [EnumMember(Value = "addExpiringTarget")]
            AddExpiringTarget = 1,

            /// <summary>
            /// Enum UpdateExpiringTarget for value: updateExpiringTarget
            /// </summary>
            [EnumMember(Value = "updateExpiringTarget")]
            UpdateExpiringTarget = 2,

            /// <summary>
            /// Enum RemoveExpiringTarget for value: removeExpiringTarget
            /// </summary>
            [EnumMember(Value = "removeExpiringTarget")]
            RemoveExpiringTarget = 3
        }
        ...
        /// <value>The type of change to make to the context&#39;s removal date from this segment</value>
        /*
        <example>addExpiringTarget</example>
        */
        ...
        /// </summary>
        /// <value>The segment&#39;s target type</value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PatchSegmentExpiringTargetInstruction" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PatchSegmentExpiringTargetInstruction() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PatchSegmentExpiringTargetInstruction" /> class.
        /// </summary>
        /// <param name="kind">The type of change to make to the context&#39;s removal date from this segment (required).</param>
        /// <param name="contextKey">A unique key used to represent the context (required).</param>
        /// <param name="contextKind">The kind of context (required).</param>
        /// <param name="targetType">The segment&#39;s target type (required).</param>
        /// <param name="value">The time, in Unix milliseconds, when the context should be removed from this segment. Required if &lt;code&gt;kind&lt;/code&gt; is &lt;code&gt;addExpiringTarget&lt;/code&gt; or &lt;code&gt;updateExpiringTarget&lt;/code&gt;..</param>
        /// <param name="varVersion">The version of the expiring target to update. Optional and only used if &lt;code&gt;kind&lt;/code&gt; is &lt;code&gt;updateExpiringTarget&lt;/code&gt;. If included, update will fail if version doesn&#39;t match current version of the expiring target..</param>
        public PatchSegmentExpiringTargetInstruction(KindEnum kind = default(KindEnum), string contextKey = default(string), string contextKind = default(string), TargetTypeEnum targetType = default(TargetTypeEnum), long value = default(long), int varVersion = default(int))
        {
            this.Kind = kind;
            // to ensure "contextKey" is required (not null)
            if (contextKey == null)
            {
                throw new ArgumentNullException("contextKey is a required property for PatchSegmentExpiringTargetInstruction and cannot be null");
            }
            this.ContextKey = contextKey;
            // to ensure "contextKind" is required (not null)
            if (contextKind == null)
            {
                throw new ArgumentNullException("contextKind is a required property for PatchSegmentExpiringTargetInstruction and cannot be null");
            }
        ...
        /// </summary>
        /// <value>A unique key used to represent the context</value>
        [DataMember(Name = "contextKey", IsRequired = true, EmitDefaultValue = true)]
        public string ContextKey { get; set; }

        /// <summary>
        /// The kind of context
        /// </summary>
        /// <value>The kind of context</value>
        /*
        <example>user</example>
        */
        [DataMember(Name = "contextKind", IsRequired = true, EmitDefaultValue = true)]
        ...
        /// </summary>
        /// <value>The time, in Unix milliseconds, when the context should be removed from this segment. Required if &lt;code&gt;kind&lt;/code&gt; is &lt;code&gt;addExpiringTarget&lt;/code&gt; or &lt;code&gt;updateExpiringTarget&lt;/code&gt;.</value>
        /*
        <example>1653469200000</example>
        */
        ...
        /// </summary>
        /// <value>The version of the expiring target to update. Optional and only used if &lt;code&gt;kind&lt;/code&gt; is &lt;code&gt;updateExpiringTarget&lt;/code&gt;. If included, update will fail if version doesn&#39;t match current version of the expiring target.</value>
        /*
        <example>1</example>
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ContextKind: ").Append(ContextKind).Append("\n");
