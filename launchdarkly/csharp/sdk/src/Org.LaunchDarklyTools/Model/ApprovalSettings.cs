...
namespace Org.LaunchDarklyTools.Model
{
    ...
    /// ApprovalSettings
    /// </summary>
    [DataContract(Name = "ApprovalSettings")]
    public partial class ApprovalSettings : IValidatableObject
    {
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="ApprovalSettings" /> class.
        /// </summary>
        /// <param name="required">If approvals are required for this environment (required).</param>
        /// <param name="bypassApprovalsForPendingChanges">Whether to skip approvals for pending changes (required).</param>
        /// <param name="minNumApprovals">Sets the amount of approvals required before a member can apply a change. The minimum is one and the maximum is five. (required).</param>
        /// <param name="canReviewOwnRequest">Allow someone who makes an approval request to apply their own change (required).</param>
        /// <param name="canApplyDeclinedChanges">Allow applying the change as long as at least one person has approved (required).</param>
        /// <param name="autoApplyApprovedChanges">Automatically apply changes that have been approved by all reviewers. This field is only applicable for approval services other than LaunchDarkly..</param>
        /// <param name="serviceKind">Which service to use for managing approvals (required).</param>
        /// <param name="serviceConfig">serviceConfig (required).</param>
        /// <param name="requiredApprovalTags">Require approval only on flags with the provided tags. Otherwise all flags will require approval. (required).</param>
        /// <param name="serviceKindConfigurationId">Optional field for integration configuration ID of a custom approval integration. This is an Enterprise-only feature..</param>
        /// <param name="resourceKind">The kind of resource for which the approval settings apply, for example, flag or segment.</param>
        public ApprovalSettings(bool required = default(bool), bool bypassApprovalsForPendingChanges = default(bool), int minNumApprovals = default(int), bool canReviewOwnRequest = default(bool), bool canApplyDeclinedChanges = default(bool), bool autoApplyApprovedChanges = default(bool), string serviceKind = default(string), Dictionary<string, Object> serviceConfig = default(Dictionary<string, Object>), List<string> requiredApprovalTags = default(List<string>), string serviceKindConfigurationId = default(string), string resourceKind = default(string))
        {
            ...
            if (serviceKind == null)
            {
                throw new ArgumentNullException("serviceKind is a required property for ApprovalSettings and cannot be null");
            }
            this.ServiceKind = serviceKind;
            // to ensure "serviceConfig" is required (not null)
            if (serviceConfig == null)
            {
                throw new ArgumentNullException("serviceConfig is a required property for ApprovalSettings and cannot be null");
            }
            this.ServiceConfig = serviceConfig;
            // to ensure "requiredApprovalTags" is required (not null)
            if (requiredApprovalTags == null)
            {
                throw new ArgumentNullException("requiredApprovalTags is a required property for ApprovalSettings and cannot be null");
            }
        ...
        /// </summary>
        /// <value>If approvals are required for this environment</value>
        /*
        ...
        */
        ...
        /// </summary>
        /// <value>Whether to skip approvals for pending changes</value>
        /*
        <example>false</example>
        */
        [DataMember(Name = "bypassApprovalsForPendingChanges", IsRequired = true, EmitDefaultValue = true)]
        ...
        /// </summary>
        /// <value>Sets the amount of approvals required before a member can apply a change. The minimum is one and the maximum is five.</value>
        /*
        <example>1</example>
        */
        [DataMember(Name = "minNumApprovals", IsRequired = true, EmitDefaultValue = true)]
        public int MinNumApprovals { get; set; }

        /// <summary>
        /// Allow someone who makes an approval request to apply their own change
        /// </summary>
        /// <value>Allow someone who makes an approval request to apply their own change</value>
        /*
        <example>false</example>
        */
        [DataMember(Name = "canReviewOwnRequest", IsRequired = true, EmitDefaultValue = true)]
        public bool CanReviewOwnRequest { get; set; }

        /// <summary>
        /// Allow applying the change as long as at least one person has approved
        /// </summary>
        /// <value>Allow applying the change as long as at least one person has approved</value>
        /*
        <example>true</example>
        */
        [DataMember(Name = "canApplyDeclinedChanges", IsRequired = true, EmitDefaultValue = true)]
        ...
        /// </summary>
        /// <value>Automatically apply changes that have been approved by all reviewers. This field is only applicable for approval services other than LaunchDarkly.</value>
        /*
        <example>true</example>
        */
        [DataMember(Name = "autoApplyApprovedChanges", EmitDefaultValue = true)]
        public bool AutoApplyApprovedChanges { get; set; }

        /// <summary>
        /// Which service to use for managing approvals
        /// </summary>
        /// <value>Which service to use for managing approvals</value>
        /*
        <example>launchdarkly</example>
        */
        [DataMember(Name = "serviceKind", IsRequired = true, EmitDefaultValue = true)]
        public string ServiceKind { get; set; }

        /// <summary>
        /// Gets or Sets ServiceConfig
        /// </summary>
        /*
        <example>{}</example>
        */
        [DataMember(Name = "serviceConfig", IsRequired = true, EmitDefaultValue = true)]
        ...
        /// </summary>
        /// <value>Require approval only on flags with the provided tags. Otherwise all flags will require approval.</value>
        /*
        <example>[&quot;require-approval&quot;]</example>
        */
        [DataMember(Name = "requiredApprovalTags", IsRequired = true, EmitDefaultValue = true)]
        ...
        /// </summary>
        /// <value>Optional field for integration configuration ID of a custom approval integration. This is an Enterprise-only feature.</value>
        /*
        <example>1ef45a85-218f-4428-a8b2-a97e5f56c258</example>
        */
        [DataMember(Name = "serviceKindConfigurationId", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>The kind of resource for which the approval settings apply, for example, flag or segment</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  BypassApprovalsForPendingChanges: ").Append(BypassApprovalsForPendingChanges).Append("\n");
            ...
            sb.Append("  AutoApplyApprovedChanges: ").Append(AutoApplyApprovedChanges).Append("\n");
            ...
            sb.Append("  ServiceKindConfigurationId: ").Append(ServiceKindConfigurationId).Append("\n");
