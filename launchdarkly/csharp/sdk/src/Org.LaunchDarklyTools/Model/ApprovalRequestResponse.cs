...
namespace Org.LaunchDarklyTools.Model
{
    ...
    public partial class ApprovalRequestResponse : IValidatableObject
    {
        ...
        */
        ...
        public ApprovalRequestResponse(string id = default(string), int varVersion = default(int), long creationDate = default(long), string serviceKind = default(string), string requestorId = default(string), string description = default(string), ReviewStatusEnum reviewStatus = default(ReviewStatusEnum), List<ReviewResponse> allReviews = default(List<ReviewResponse>), List<string> notifyMemberIds = default(List<string>), long appliedDate = default(long), string appliedByMemberId = default(string), string appliedByServiceTokenId = default(string), StatusEnum status = default(StatusEnum), List<Dictionary<string, Object>> instructions = default(List<Dictionary<string, Object>>), List<Conflict> conflicts = default(List<Conflict>), Dictionary<string, Object> links = default(Dictionary<string, Object>), long executionDate = default(long), string operatingOnId = default(string), IntegrationMetadata integrationMetadata = default(IntegrationMetadata), CopiedFromEnv source = default(CopiedFromEnv), CustomWorkflowMeta customWorkflowMetadata = default(CustomWorkflowMeta), string resourceId = default(string), ApprovalSettings approvalSettings = default(ApprovalSettings))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for ApprovalRequestResponse and cannot be null");
            }
            this.Id = id;
            ...
            if (serviceKind == null)
            {
                throw new ArgumentNullException("serviceKind is a required property for ApprovalRequestResponse and cannot be null");
            }
            ...
            if (allReviews == null)
            {
                throw new ArgumentNullException("allReviews is a required property for ApprovalRequestResponse and cannot be null");
            }
            this.AllReviews = allReviews;
            // to ensure "notifyMemberIds" is required (not null)
            if (notifyMemberIds == null)
            {
                throw new ArgumentNullException("notifyMemberIds is a required property for ApprovalRequestResponse and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("instructions is a required property for ApprovalRequestResponse and cannot be null");
            }
            this.Instructions = instructions;
            // to ensure "conflicts" is required (not null)
            if (conflicts == null)
            {
                throw new ArgumentNullException("conflicts is a required property for ApprovalRequestResponse and cannot be null");
            }
            this.Conflicts = conflicts;
            // to ensure "links" is required (not null)
            if (links == null)
            {
                throw new ArgumentNullException("links is a required property for ApprovalRequestResponse and cannot be null");
            }
            this.Links = links;
