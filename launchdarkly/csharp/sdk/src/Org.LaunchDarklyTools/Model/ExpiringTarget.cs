...
namespace Org.LaunchDarklyTools.Model
{
    ...
    /// ExpiringTarget
    /// </summary>
    [DataContract(Name = "ExpiringTarget")]
    public partial class ExpiringTarget : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExpiringTarget" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ExpiringTarget() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ExpiringTarget" /> class.
        /// </summary>
        /// <param name="id">The ID of this expiring target (required).</param>
        /// <param name="varVersion">The version of this expiring target (required).</param>
        /// <param name="expirationDate">expirationDate (required).</param>
        /// <param name="contextKind">The context kind of the context to be removed (required).</param>
        /// <param name="contextKey">A unique key used to represent the context to be removed (required).</param>
        /// <param name="targetType">A segment&#39;s target type, &lt;code&gt;included&lt;/code&gt; or &lt;code&gt;excluded&lt;/code&gt;. Included when expiring targets are updated on a segment..</param>
        /// <param name="variationId">A unique ID used to represent the flag variation. Included when expiring targets are updated on a feature flag..</param>
        /// <param name="resourceId">resourceId (required).</param>
        public ExpiringTarget(string id = default(string), int varVersion = default(int), long expirationDate = default(long), string contextKind = default(string), string contextKey = default(string), string targetType = default(string), string variationId = default(string), ResourceId resourceId = default(ResourceId))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for ExpiringTarget and cannot be null");
            }
            this.Id = id;
            ...
            if (contextKind == null)
            {
                throw new ArgumentNullException("contextKind is a required property for ExpiringTarget and cannot be null");
            }
            this.ContextKind = contextKind;
            // to ensure "contextKey" is required (not null)
            if (contextKey == null)
            {
                throw new ArgumentNullException("contextKey is a required property for ExpiringTarget and cannot be null");
            }
            this.ContextKey = contextKey;
            // to ensure "resourceId" is required (not null)
            if (resourceId == null)
            {
                throw new ArgumentNullException("resourceId is a required property for ExpiringTarget and cannot be null");
            }
        ...
        /// </summary>
        /// <value>The ID of this expiring target</value>
        /*
        ...
        */
        ...
        /// </summary>
        /// <value>The version of this expiring target</value>
        /*
        <example>1</example>
        */
        ...
        */
        ...
        /// </summary>
        /// <value>The context kind of the context to be removed</value>
        /*
        ...
        */
        ...
        /// </summary>
        /// <value>A unique key used to represent the context to be removed</value>
        /*
        <example>context-key-123abc</example>
        */
        ...
        /// </summary>
        /// <value>A segment&#39;s target type, &lt;code&gt;included&lt;/code&gt; or &lt;code&gt;excluded&lt;/code&gt;. Included when expiring targets are updated on a segment.</value>
        /*
        ...
        */
        ...
        /// </summary>
        /// <value>A unique ID used to represent the flag variation. Included when expiring targets are updated on a feature flag.</value>
        /*
        <example>cc4332e2-bd4d-4fe0-b509-dfd2caf8dd73</example>
        */
        ...
        /// </summary>
        [DataMember(Name = "_resourceId", IsRequired = true, EmitDefaultValue = true)]
