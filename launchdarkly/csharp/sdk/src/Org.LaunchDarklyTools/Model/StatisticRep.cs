...
namespace Org.LaunchDarklyTools.Model
{
    ...
    /// StatisticRep
    /// </summary>
    [DataContract(Name = "StatisticRep")]
    public partial class StatisticRep : IValidatableObject
    {
        /// <summary>
        /// The type of repository
        /// </summary>
        /// <value>The type of repository</value>
        ...
        */
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StatisticRep" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected StatisticRep() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StatisticRep" /> class.
        /// </summary>
        /// <param name="name">The repository name (required).</param>
        /// <param name="type">The type of repository (required).</param>
        /// <param name="sourceLink">A URL to access the repository (required).</param>
        /// <param name="defaultBranch">The repository&#39;s default branch (required).</param>
        /// <param name="enabled">Whether or not a repository is enabled for code reference scanning (required).</param>
        /// <param name="varVersion">The version of the repository&#39;s saved information (required).</param>
        /// <param name="hunkCount">The number of code reference hunks in which the flag appears in this repository (required).</param>
        /// <param name="fileCount">The number of files in which the flag appears in this repository (required).</param>
        /// <param name="links">The location and content type of related resources (required).</param>
        /// <param name="latestCommitTime">latestCommitTime.</param>
        public StatisticRep(string name = default(string), TypeEnum type = default(TypeEnum), string sourceLink = default(string), string defaultBranch = default(string), bool enabled = default(bool), int varVersion = default(int), int hunkCount = default(int), int fileCount = default(int), Dictionary<string, Link> links = default(Dictionary<string, Link>), long latestCommitTime = default(long))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for StatisticRep and cannot be null");
            }
            this.Name = name;
            this.Type = type;
            // to ensure "sourceLink" is required (not null)
            if (sourceLink == null)
            {
                throw new ArgumentNullException("sourceLink is a required property for StatisticRep and cannot be null");
            }
            this.SourceLink = sourceLink;
            // to ensure "defaultBranch" is required (not null)
            if (defaultBranch == null)
            {
                throw new ArgumentNullException("defaultBranch is a required property for StatisticRep and cannot be null");
            }
            ...
            if (links == null)
            {
                throw new ArgumentNullException("links is a required property for StatisticRep and cannot be null");
            }
            this.Links = links;
        ...
        /*
        <example>LaunchDarkly-Docs</example>
        */
        ...
        /// </summary>
        /// <value>A URL to access the repository</value>
        /*
        <example>https://github.com/launchdarkly/LaunchDarkly-Docs</example>
        */
        [DataMember(Name = "sourceLink", IsRequired = true, EmitDefaultValue = true)]
        public string SourceLink { get; set; }

        /// <summary>
        /// The repository&#39;s default branch
        /// </summary>
        /// <value>The repository&#39;s default branch</value>
        /*
        ...
        */
        ...
        /// </summary>
        /// <value>Whether or not a repository is enabled for code reference scanning</value>
        /*
        ...
        */
        ...
        /// </summary>
        /// <value>The version of the repository&#39;s saved information</value>
        /*
        <example>3</example>
        */
        ...
        /// </summary>
        /// <value>The number of code reference hunks in which the flag appears in this repository</value>
        [DataMember(Name = "hunkCount", IsRequired = true, EmitDefaultValue = true)]
        public int HunkCount { get; set; }

        /// <summary>
        /// The number of files in which the flag appears in this repository
        /// </summary>
        /// <value>The number of files in which the flag appears in this repository</value>
        ...
        /// <summary>
        /// Gets or Sets LatestCommitTime
        /// </summary>
        /*
        <example>1706701522000</example>
        */
        [DataMember(Name = "latestCommitTime", EmitDefaultValue = false)]
        public long LatestCommitTime { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  HunkCount: ").Append(HunkCount).Append("\n");
            sb.Append("  FileCount: ").Append(FileCount).Append("\n");
            sb.Append("  Links: ").Append(Links).Append("\n");
            sb.Append("  LatestCommitTime: ").Append(LatestCommitTime).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
