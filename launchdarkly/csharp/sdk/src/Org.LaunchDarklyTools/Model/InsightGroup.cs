...
namespace Org.LaunchDarklyTools.Model
{
    ...
    /// InsightGroup
    /// </summary>
    [DataContract(Name = "InsightGroup")]
    public partial class InsightGroup : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InsightGroup" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InsightGroup() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InsightGroup" /> class.
        /// </summary>
        ...
        /// <param name="key">The insight group key (required).</param>
        /// <param name="name">The insight group name (required).</param>
        /// <param name="projectKey">The project key (required).</param>
        /// <param name="environmentKey">The environment key (required).</param>
        /// <param name="applicationKeys">The application keys.</param>
        /// <param name="createdAt">createdAt (required).</param>
        public InsightGroup(ModelEnvironment varEnvironment = default(ModelEnvironment), InsightGroupScores scores = default(InsightGroupScores), InsightGroupCollectionScoreMetadata scoreMetadata = default(InsightGroupCollectionScoreMetadata), string key = default(string), string name = default(string), string projectKey = default(string), string environmentKey = default(string), List<string> applicationKeys = default(List<string>), long createdAt = default(long))
        {
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for InsightGroup and cannot be null");
            }
            this.Key = key;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for InsightGroup and cannot be null");
            }
            this.Name = name;
            // to ensure "projectKey" is required (not null)
            if (projectKey == null)
            {
                throw new ArgumentNullException("projectKey is a required property for InsightGroup and cannot be null");
            }
            this.ProjectKey = projectKey;
            // to ensure "environmentKey" is required (not null)
            if (environmentKey == null)
            {
                throw new ArgumentNullException("environmentKey is a required property for InsightGroup and cannot be null");
            }
        ...
        public InsightGroupScores Scores { get; set; }

        /// <summary>
        /// Gets or Sets ScoreMetadata
        /// </summary>
        [DataMember(Name = "scoreMetadata", EmitDefaultValue = false)]
        public InsightGroupCollectionScoreMetadata ScoreMetadata { get; set; }

        /// <summary>
        /// The insight group key
        /// </summary>
        /// <value>The insight group key</value>
        /*
        <example>default-production-all-apps</example>
        */
        ...
        /// </summary>
        /// <value>The insight group name</value>
        /*
        <example>Production - All Apps</example>
        */
        ...
        */
        ...
        /*
        <example>[&quot;billing-service&quot;,&quot;inventory-service&quot;]</example>
        */
