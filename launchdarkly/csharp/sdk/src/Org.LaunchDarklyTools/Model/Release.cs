...
namespace Org.LaunchDarklyTools.Model
{
    ...
    public partial class Release : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="Release" /> class.
        /// </summary>
        /// <param name="links">The location and content type of related resources.</param>
        /// <param name="name">The release pipeline name (required).</param>
        /// <param name="releasePipelineKey">The release pipeline key (required).</param>
        /// <param name="releasePipelineDescription">The release pipeline description (required).</param>
        /// <param name="phases">An ordered list of the release pipeline phases (required).</param>
        /// <param name="varVersion">The release version (required).</param>
        /// <param name="releaseVariationId">The chosen release variation ID to use across all phases of a release.</param>
        /// <param name="canceledAt">canceledAt.</param>
        public Release(Dictionary<string, Link> links = default(Dictionary<string, Link>), string name = default(string), string releasePipelineKey = default(string), string releasePipelineDescription = default(string), List<ReleasePhase> phases = default(List<ReleasePhase>), int varVersion = default(int), string releaseVariationId = default(string), long canceledAt = default(long))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for Release and cannot be null");
            }
            this.Name = name;
            // to ensure "releasePipelineKey" is required (not null)
            if (releasePipelineKey == null)
            {
                throw new ArgumentNullException("releasePipelineKey is a required property for Release and cannot be null");
            }
            this.ReleasePipelineKey = releasePipelineKey;
            // to ensure "releasePipelineDescription" is required (not null)
            if (releasePipelineDescription == null)
            {
                throw new ArgumentNullException("releasePipelineDescription is a required property for Release and cannot be null");
            }
            this.ReleasePipelineDescription = releasePipelineDescription;
            // to ensure "phases" is required (not null)
            if (phases == null)
            {
                throw new ArgumentNullException("phases is a required property for Release and cannot be null");
            }
            this.Phases = phases;
        ...
        /*
        <example>Example release pipeline</example>
        */
        ...
        <example>example-release-pipeline</example>
        */
        [DataMember(Name = "releasePipelineKey", IsRequired = true, EmitDefaultValue = true)]
        ...
        /*
        <example>Our release pipeline for typical testing and deployment</example>
        */
        [DataMember(Name = "releasePipelineDescription", IsRequired = true, EmitDefaultValue = true)]
        public string ReleasePipelineDescription { get; set; }

        /// <summary>
        /// An ordered list of the release pipeline phases
        /// </summary>
        /// <value>An ordered list of the release pipeline phases</value>
        [DataMember(Name = "phases", IsRequired = true, EmitDefaultValue = true)]
        public List<ReleasePhase> Phases { get; set; }
        ...
        */
        ...
        /// </summary>
        /// <value>The chosen release variation ID to use across all phases of a release</value>
        [DataMember(Name = "_releaseVariationId", EmitDefaultValue = false)]
        ...
        */
        [DataMember(Name = "_canceledAt", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ReleasePipelineKey: ").Append(ReleasePipelineKey).Append("\n");
            sb.Append("  ReleasePipelineDescription: ").Append(ReleasePipelineDescription).Append("\n");
            sb.Append("  Phases: ").Append(Phases).Append("\n");
            sb.Append("  VarVersion: ").Append(VarVersion).Append("\n");
            sb.Append("  ReleaseVariationId: ").Append(ReleaseVariationId).Append("\n");
