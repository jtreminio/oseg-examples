...
namespace Org.LaunchDarklyTools.Model
{
    ...
    public partial class ModelClient : IValidatableObject
    {
        ...
        /// <param name="accountId">The account ID the client is registered under (required).</param>
        /// <param name="clientId">The client&#39;s unique ID (required).</param>
        /// <param name="clientSecret">The client secret. This will only be shown upon creation..</param>
        /// <param name="redirectUri">The client&#39;s redirect URI (required).</param>
        /// <param name="creationDate">creationDate (required).</param>
        public ModelClient(Dictionary<string, Link> links = default(Dictionary<string, Link>), string name = default(string), string description = default(string), string accountId = default(string), string clientId = default(string), string clientSecret = default(string), string redirectUri = default(string), long creationDate = default(long))
        {
            // to ensure "links" is required (not null)
            if (links == null)
            {
                throw new ArgumentNullException("links is a required property for ModelClient and cannot be null");
            }
            this.Links = links;
            ...
            if (accountId == null)
            {
                throw new ArgumentNullException("accountId is a required property for ModelClient and cannot be null");
            }
            ...
            if (redirectUri == null)
            {
                throw new ArgumentNullException("redirectUri is a required property for ModelClient and cannot be null");
            }
        ...
        /*
        <example>{&quot;parent&quot;:{&quot;href&quot;:&quot;/api/v2/oauth/clients&quot;,&quot;type&quot;:&quot;application/json&quot;},&quot;self&quot;:{&quot;href&quot;:&quot;/api/v2/oauth/clients/50666563-9144-4125-b822-33f308227e45&quot;,&quot;type&quot;:&quot;application/json&quot;}}</example>
        */
        ...
        /// </summary>
        /// <value>The account ID the client is registered under</value>
        ...
        [DataMember(Name = "_clientId", IsRequired = true, EmitDefaultValue = true)]
        public string ClientId { get; set; }

        /// <summary>
        /// The client secret. This will only be shown upon creation.
        /// </summary>
        /// <value>The client secret. This will only be shown upon creation.</value>
        [DataMember(Name = "_clientSecret", EmitDefaultValue = false)]
        public string ClientSecret { get; set; }

        /// <summary>
        /// The client&#39;s redirect URI
        /// </summary>
        /// <value>The client&#39;s redirect URI</value>
