...
namespace Org.LaunchDarklyTools.Model
{
    ...
    /// ContextKindRep
    /// </summary>
    [DataContract(Name = "ContextKindRep")]
    public partial class ContextKindRep : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContextKindRep" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ContextKindRep() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ContextKindRep" /> class.
        /// </summary>
        /// <param name="key">The context kind key (required).</param>
        /// <param name="name">The context kind name (required).</param>
        /// <param name="description">The context kind description (required).</param>
        /// <param name="varVersion">The context kind version (required).</param>
        ...
        /// <param name="createdFrom">createdFrom (required).</param>
        /// <param name="hideInTargeting">Alias for archived..</param>
        /// <param name="archived">Whether the context kind is archived. Archived context kinds are unavailable for targeting..</param>
        /// <param name="links">The location and content type of related resources.</param>
        public ContextKindRep(string key = default(string), string name = default(string), string description = default(string), int varVersion = default(int), long creationDate = default(long), long lastModified = default(long), long lastSeen = default(long), string createdFrom = default(string), bool hideInTargeting = default(bool), bool archived = default(bool), Dictionary<string, Link> links = default(Dictionary<string, Link>))
        {
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for ContextKindRep and cannot be null");
            }
            this.Key = key;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for ContextKindRep and cannot be null");
            }
            this.Name = name;
            // to ensure "description" is required (not null)
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for ContextKindRep and cannot be null");
            }
            this.Description = description;
            this.VarVersion = varVersion;
            this.CreationDate = creationDate;
            this.LastModified = lastModified;
            // to ensure "createdFrom" is required (not null)
            if (createdFrom == null)
            {
                throw new ArgumentNullException("createdFrom is a required property for ContextKindRep and cannot be null");
            }
        ...
        /// </summary>
        /// <value>The context kind key</value>
        /*
        <example>organization-key-123abc</example>
        */
        ...
        /// </summary>
        /// <value>The context kind name</value>
        /*
        ...
        */
        ...
        /// </summary>
        /// <value>The context kind description</value>
        /*
        <example>An example context kind, to enable targeting based on organization</example>
        */
        ...
        /// </summary>
        /// <value>The context kind version</value>
        /*
        <example>4</example>
        */
        ...
        */
        ...
        /// </summary>
        [DataMember(Name = "createdFrom", IsRequired = true, EmitDefaultValue = true)]
        public string CreatedFrom { get; set; }

        /// <summary>
        /// Alias for archived.
        /// </summary>
        /// <value>Alias for archived.</value>
        /*
        <example>false</example>
        */
        [DataMember(Name = "hideInTargeting", EmitDefaultValue = true)]
        ...
        /// </summary>
        /// <value>Whether the context kind is archived. Archived context kinds are unavailable for targeting.</value>
        /*
        <example>false</example>
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("  HideInTargeting: ").Append(HideInTargeting).Append("\n");
