...
namespace Org.LaunchDarklyTools.Model
{
    ...
    public partial class Import : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="Import" /> class.
        /// </summary>
        /// <param name="id">The import ID (required).</param>
        /// <param name="segmentKey">The segment key (required).</param>
        /// <param name="creationTime">creationTime (required).</param>
        /// <param name="mode">The import mode used, either &lt;code&gt;merge&lt;/code&gt; or &lt;code&gt;replace&lt;/code&gt; (required).</param>
        /// <param name="status">The import status (required).</param>
        /// <param name="files">The imported files and their status.</param>
        /// <param name="links">The location and content type of related resources (required).</param>
        public Import(string id = default(string), string segmentKey = default(string), long creationTime = default(long), string mode = default(string), string status = default(string), List<FileRep> files = default(List<FileRep>), Dictionary<string, Link> links = default(Dictionary<string, Link>))
        {
            ...
            if (segmentKey == null)
            {
                throw new ArgumentNullException("segmentKey is a required property for Import and cannot be null");
            }
            ...
            if (links == null)
            {
                throw new ArgumentNullException("links is a required property for Import and cannot be null");
            }
            this.Links = links;
            this.Files = files;
        }
        ...
        */
        ...
        /// </summary>
        /// <value>The import mode used, either &lt;code&gt;merge&lt;/code&gt; or &lt;code&gt;replace&lt;/code&gt;</value>
        /*
        ...
        */
        ...
        /// </summary>
        /// <value>The imported files and their status</value>
        /*
        <example>[{&quot;filename&quot;:&quot;bigsegimport.csv&quot;,&quot;status&quot;:&quot;complete&quot;}]</example>
        */
        [DataMember(Name = "files", EmitDefaultValue = false)]
        public List<FileRep> Files { get; set; }
