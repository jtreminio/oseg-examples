...
namespace Org.LaunchDarklyTools.Model
{
    ...
    /// MetricV2Rep
    /// </summary>
    [DataContract(Name = "MetricV2Rep")]
    public partial class MetricV2Rep : IValidatableObject
    {
        /// <summary>
        ...
        */
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MetricV2Rep" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MetricV2Rep() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MetricV2Rep" /> class.
        /// </summary>
        ...
        public MetricV2Rep(string key = default(string), string versionId = default(string), string name = default(string), KindEnum kind = default(KindEnum), bool isNumeric = default(bool), UnitAggregationTypeEnum? unitAggregationType = default(UnitAggregationTypeEnum?), Dictionary<string, Link> links = default(Dictionary<string, Link>))
        {
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for MetricV2Rep and cannot be null");
            }
            this.Key = key;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for MetricV2Rep and cannot be null");
            }
            this.Name = name;
            this.Kind = kind;
            ...
            if (links == null)
            {
                throw new ArgumentNullException("links is a required property for MetricV2Rep and cannot be null");
            }
            this.Links = links;
