...
public class FirstLastNamePhoneCodedOut {
  ...
  public FirstLastNamePhoneCodedOut script(@javax.annotation.Nullable String script) {
    this.script = script;
    return this;
  }
  ...
  public FirstLastNamePhoneCodedOut id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public FirstLastNamePhoneCodedOut explanation(@javax.annotation.Nullable String explanation) {
  ...
  public FirstLastNamePhoneCodedOut firstName(@javax.annotation.Nullable String firstName) {
  ...
  public FirstLastNamePhoneCodedOut lastName(@javax.annotation.Nullable String lastName) {
  ...
  public FirstLastNamePhoneCodedOut internationalPhoneNumberVerified(@javax.annotation.Nullable String internationalPhoneNumberVerified) {
  ...
  public void setInternationalPhoneNumberVerified(@javax.annotation.Nullable String internationalPhoneNumberVerified) {
    this.internationalPhoneNumberVerified = internationalPhoneNumberVerified;
  }


  public FirstLastNamePhoneCodedOut phoneCountryIso2Verified(@javax.annotation.Nullable String phoneCountryIso2Verified) {
  ...
  public void setPhoneCountryIso2Verified(@javax.annotation.Nullable String phoneCountryIso2Verified) {
    this.phoneCountryIso2Verified = phoneCountryIso2Verified;
  }


  public FirstLastNamePhoneCodedOut phoneCountryCode(@javax.annotation.Nullable Integer phoneCountryCode) {
  ...
  public void setPhoneCountryCode(@javax.annotation.Nullable Integer phoneCountryCode) {
    this.phoneCountryCode = phoneCountryCode;
  }


  public FirstLastNamePhoneCodedOut phoneCountryCodeAlt(@javax.annotation.Nullable Integer phoneCountryCodeAlt) {
  ...
  public void setPhoneCountryCodeAlt(@javax.annotation.Nullable Integer phoneCountryCodeAlt) {
    this.phoneCountryCodeAlt = phoneCountryCodeAlt;
  }


  public FirstLastNamePhoneCodedOut phoneCountryIso2(@javax.annotation.Nullable String phoneCountryIso2) {
  ...
  public void setPhoneCountryIso2(@javax.annotation.Nullable String phoneCountryIso2) {
    this.phoneCountryIso2 = phoneCountryIso2;
  }


  public FirstLastNamePhoneCodedOut phoneCountryIso2Alt(@javax.annotation.Nullable String phoneCountryIso2Alt) {
  ...
  public void setPhoneCountryIso2Alt(@javax.annotation.Nullable String phoneCountryIso2Alt) {
    this.phoneCountryIso2Alt = phoneCountryIso2Alt;
  }


  public FirstLastNamePhoneCodedOut originCountryIso2(@javax.annotation.Nullable String originCountryIso2) {
  ...
  public void setOriginCountryIso2(@javax.annotation.Nullable String originCountryIso2) {
    this.originCountryIso2 = originCountryIso2;
  }


  public FirstLastNamePhoneCodedOut originCountryIso2Alt(@javax.annotation.Nullable String originCountryIso2Alt) {
  ...
  public void setOriginCountryIso2Alt(@javax.annotation.Nullable String originCountryIso2Alt) {
    this.originCountryIso2Alt = originCountryIso2Alt;
  }


  public FirstLastNamePhoneCodedOut phoneNumber(@javax.annotation.Nullable String phoneNumber) {
  ...
  public FirstLastNamePhoneCodedOut verified(@javax.annotation.Nullable Boolean verified) {
  ...
  public FirstLastNamePhoneCodedOut score(@javax.annotation.Nullable Double score) {
    this.score = score;
    return this;
  }
  ...
  public FirstLastNamePhoneCodedOut countryIso2(@javax.annotation.Nullable String countryIso2) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to FirstLastNamePhoneCodedOut
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FirstLastNamePhoneCodedOut.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FirstLastNamePhoneCodedOut.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FirstLastNamePhoneCodedOut` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
