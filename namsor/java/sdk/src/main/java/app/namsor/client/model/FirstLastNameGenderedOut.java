...
public class FirstLastNameGenderedOut {
  ...
  public FirstLastNameGenderedOut script(@javax.annotation.Nullable String script) {
    this.script = script;
    return this;
  }
  ...
  public FirstLastNameGenderedOut id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public FirstLastNameGenderedOut explanation(@javax.annotation.Nullable String explanation) {
  ...
  public FirstLastNameGenderedOut firstName(@javax.annotation.Nullable String firstName) {
  ...
  public FirstLastNameGenderedOut lastName(@javax.annotation.Nullable String lastName) {
  ...
  public FirstLastNameGenderedOut likelyGender(@javax.annotation.Nullable LikelyGenderEnum likelyGender) {
  ...
  public void setLikelyGender(@javax.annotation.Nullable LikelyGenderEnum likelyGender) {
    this.likelyGender = likelyGender;
  }


  public FirstLastNameGenderedOut genderScale(@javax.annotation.Nullable Double genderScale) {
  ...
  public void setGenderScale(@javax.annotation.Nullable Double genderScale) {
    this.genderScale = genderScale;
  }


  public FirstLastNameGenderedOut score(@javax.annotation.Nullable Double score) {
    this.score = score;
    return this;
  }
  ...
  public FirstLastNameGenderedOut probabilityCalibrated(@javax.annotation.Nullable Double probabilityCalibrated) {
