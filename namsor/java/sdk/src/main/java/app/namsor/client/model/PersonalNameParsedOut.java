...
import app.namsor.client.model.FirstLastNameOut;
...
public class PersonalNameParsedOut {
  ...
  public PersonalNameParsedOut script(@javax.annotation.Nullable String script) {
    this.script = script;
    return this;
  }
  ...
  public PersonalNameParsedOut id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public PersonalNameParsedOut explanation(@javax.annotation.Nullable String explanation) {
  ...
  public PersonalNameParsedOut name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public PersonalNameParsedOut nameParserType(@javax.annotation.Nullable NameParserTypeEnum nameParserType) {
  ...
  public void setNameParserType(@javax.annotation.Nullable NameParserTypeEnum nameParserType) {
    this.nameParserType = nameParserType;
  }


  public PersonalNameParsedOut nameParserTypeAlt(@javax.annotation.Nullable NameParserTypeAltEnum nameParserTypeAlt) {
  ...
  public void setNameParserTypeAlt(@javax.annotation.Nullable NameParserTypeAltEnum nameParserTypeAlt) {
    this.nameParserTypeAlt = nameParserTypeAlt;
  }


  public PersonalNameParsedOut firstLastName(@javax.annotation.Nullable FirstLastNameOut firstLastName) {
  ...
  public void setFirstLastName(@javax.annotation.Nullable FirstLastNameOut firstLastName) {
    this.firstLastName = firstLastName;
  }


  public PersonalNameParsedOut score(@javax.annotation.Nullable Double score) {
    this.score = score;
    return this;
  }
