...
import app.namsor.client.model.APIKeyOut;
...
public class APICounterV2Out {
  ...
  public APICounterV2Out apiKey(@javax.annotation.Nullable APIKeyOut apiKey) {
    this.apiKey = apiKey;
    return this;
  }
  ...
  public void setApiKey(@javax.annotation.Nullable APIKeyOut apiKey) {
    this.apiKey = apiKey;
  }


  public APICounterV2Out apiService(@javax.annotation.Nullable String apiService) {
  ...
  public void setApiService(@javax.annotation.Nullable String apiService) {
    this.apiService = apiService;
  }


  public APICounterV2Out hostAddress(@javax.annotation.Nullable String hostAddress) {
  ...
  public APICounterV2Out createdDateTime(@javax.annotation.Nullable Long createdDateTime) {
  ...
  public void setCreatedDateTime(@javax.annotation.Nullable Long createdDateTime) {
    this.createdDateTime = createdDateTime;
  }


  public APICounterV2Out totalUsage(@javax.annotation.Nullable Long totalUsage) {
  ...
  public APICounterV2Out lastFlushedDateTime(@javax.annotation.Nullable Long lastFlushedDateTime) {
  ...
  public void setLastFlushedDateTime(@javax.annotation.Nullable Long lastFlushedDateTime) {
    this.lastFlushedDateTime = lastFlushedDateTime;
  }


  public APICounterV2Out lastUsedDateTime(@javax.annotation.Nullable Long lastUsedDateTime) {
  ...
  public void setLastUsedDateTime(@javax.annotation.Nullable Long lastUsedDateTime) {
    this.lastUsedDateTime = lastUsedDateTime;
  }


  public APICounterV2Out serviceFeaturesUsage(@javax.annotation.Nullable Map<String, Long> serviceFeaturesUsage) {
  ...
  public void setServiceFeaturesUsage(@javax.annotation.Nullable Map<String, Long> serviceFeaturesUsage) {
    this.serviceFeaturesUsage = serviceFeaturesUsage;
  }
