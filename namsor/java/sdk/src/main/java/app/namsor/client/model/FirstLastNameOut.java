...
public class FirstLastNameOut {
  ...
  public FirstLastNameOut script(@javax.annotation.Nullable String script) {
    this.script = script;
    return this;
  }
  ...
  public FirstLastNameOut id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public FirstLastNameOut explanation(@javax.annotation.Nullable String explanation) {
  ...
  public FirstLastNameOut firstName(@javax.annotation.Nullable String firstName) {
  ...
  public FirstLastNameOut lastName(@javax.annotation.Nullable String lastName) {
