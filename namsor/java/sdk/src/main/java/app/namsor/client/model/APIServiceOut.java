...
public class APIServiceOut {
  ...
  public APIServiceOut serviceName(@javax.annotation.Nullable String serviceName) {
  ...
  public APIServiceOut serviceGroup(@javax.annotation.Nullable String serviceGroup) {
  ...
  public APIServiceOut costInUnits(@javax.annotation.Nullable Integer costInUnits) {
  ...
  public void setCostInUnits(@javax.annotation.Nullable Integer costInUnits) {
    this.costInUnits = costInUnits;
  }
