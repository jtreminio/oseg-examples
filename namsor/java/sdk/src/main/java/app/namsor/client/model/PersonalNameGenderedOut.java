...
public class PersonalNameGenderedOut {
  ...
  public PersonalNameGenderedOut script(@javax.annotation.Nullable String script) {
    this.script = script;
    return this;
  }
  ...
  public PersonalNameGenderedOut id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public PersonalNameGenderedOut explanation(@javax.annotation.Nullable String explanation) {
  ...
  public PersonalNameGenderedOut name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public PersonalNameGenderedOut likelyGender(@javax.annotation.Nullable LikelyGenderEnum likelyGender) {
  ...
  public PersonalNameGenderedOut genderScale(@javax.annotation.Nullable Double genderScale) {
  ...
  public PersonalNameGenderedOut score(@javax.annotation.Nullable Double score) {
    this.score = score;
    return this;
  }
  ...
  public PersonalNameGenderedOut probabilityCalibrated(@javax.annotation.Nullable Double probabilityCalibrated) {
