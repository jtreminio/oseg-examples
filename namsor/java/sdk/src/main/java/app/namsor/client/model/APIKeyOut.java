...
import app.namsor.client.model.CommunityEngageOptionOut;
...
public class APIKeyOut {
  ...
  public APIKeyOut apiKey(@javax.annotation.Nullable String apiKey) {
    this.apiKey = apiKey;
    return this;
  }
  ...
  public APIKeyOut userId(@javax.annotation.Nullable String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public APIKeyOut admin(@javax.annotation.Nullable Boolean admin) {
    this.admin = admin;
    return this;
  }
  ...
  public APIKeyOut vetted(@javax.annotation.Nullable Boolean vetted) {
    this.vetted = vetted;
    return this;
  }
  ...
  public void setVetted(@javax.annotation.Nullable Boolean vetted) {
    this.vetted = vetted;
  }


  public APIKeyOut learnable(@javax.annotation.Nullable Boolean learnable) {
  ...
  public void setLearnable(@javax.annotation.Nullable Boolean learnable) {
    this.learnable = learnable;
  }


  public APIKeyOut anonymized(@javax.annotation.Nullable Boolean anonymized) {
  ...
  public APIKeyOut partner(@javax.annotation.Nullable Boolean partner) {
  ...
  public void setPartner(@javax.annotation.Nullable Boolean partner) {
    this.partner = partner;
  }


  public APIKeyOut striped(@javax.annotation.Nullable Boolean striped) {
  ...
  public void setStriped(@javax.annotation.Nullable Boolean striped) {
    this.striped = striped;
  }


  public APIKeyOut corporate(@javax.annotation.Nullable Boolean corporate) {
  ...
  public APIKeyOut disabled(@javax.annotation.Nullable Boolean disabled) {
  ...
  public APIKeyOut explainable(@javax.annotation.Nullable Boolean explainable) {
  ...
  public void setExplainable(@javax.annotation.Nullable Boolean explainable) {
    this.explainable = explainable;
  }


  public APIKeyOut ipAddress(@javax.annotation.Nullable String ipAddress) {
  ...
  public APIKeyOut communityEngageOption(@javax.annotation.Nullable CommunityEngageOptionOut communityEngageOption) {
  ...
  public void setCommunityEngageOption(@javax.annotation.Nullable CommunityEngageOptionOut communityEngageOption) {
    this.communityEngageOption = communityEngageOption;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("communityEngageOption") != null && !jsonObj.get("communityEngageOption").isJsonNull()) {
        CommunityEngageOptionOut.validateJsonElement(jsonObj.get("communityEngageOption"));
      }
  }
