...
public class NameMatchedOut {
  ...
  public NameMatchedOut script(@javax.annotation.Nullable String script) {
    this.script = script;
    return this;
  }
  ...
  public NameMatchedOut id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public NameMatchedOut explanation(@javax.annotation.Nullable String explanation) {
  ...
  public NameMatchedOut matchStatus(@javax.annotation.Nullable MatchStatusEnum matchStatus) {
  ...
  public void setMatchStatus(@javax.annotation.Nullable MatchStatusEnum matchStatus) {
    this.matchStatus = matchStatus;
  }


  public NameMatchedOut score(@javax.annotation.Nullable Double score) {
    this.score = score;
    return this;
  }
