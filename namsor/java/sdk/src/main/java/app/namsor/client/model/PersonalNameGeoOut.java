...
public class PersonalNameGeoOut {
  ...
  public PersonalNameGeoOut script(@javax.annotation.Nullable String script) {
    this.script = script;
    return this;
  }
  ...
  public PersonalNameGeoOut id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public PersonalNameGeoOut explanation(@javax.annotation.Nullable String explanation) {
  ...
  public PersonalNameGeoOut name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public PersonalNameGeoOut score(@javax.annotation.Nullable Double score) {
    this.score = score;
    return this;
  }
  ...
  public PersonalNameGeoOut country(@javax.annotation.Nullable String country) {
  ...
  public PersonalNameGeoOut countryAlt(@javax.annotation.Nullable String countryAlt) {
  ...
  public PersonalNameGeoOut region(@javax.annotation.Nullable String region) {
    this.region = region;
    return this;
  }
  ...
  public PersonalNameGeoOut topRegion(@javax.annotation.Nullable String topRegion) {
  ...
  public PersonalNameGeoOut subRegion(@javax.annotation.Nullable String subRegion) {
  ...
  public PersonalNameGeoOut countriesTop(@javax.annotation.Nullable List<String> countriesTop) {
  ...
  public PersonalNameGeoOut probabilityCalibrated(@javax.annotation.Nullable Double probabilityCalibrated) {
  ...
  public PersonalNameGeoOut probabilityAltCalibrated(@javax.annotation.Nullable Double probabilityAltCalibrated) {
  ...
  public PersonalNameGeoOut religionStats(@javax.annotation.Nullable List<ReligionStatOut> religionStats) {
  ...
  public PersonalNameGeoOut religionStatsAlt(@javax.annotation.Nullable List<ReligionStatOut> religionStatsAlt) {
