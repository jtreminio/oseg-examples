...
public class FirstLastNameGeoSubdivisionIn {
  ...
  public FirstLastNameGeoSubdivisionIn id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public FirstLastNameGeoSubdivisionIn firstName(@javax.annotation.Nullable String firstName) {
  ...
  public FirstLastNameGeoSubdivisionIn lastName(@javax.annotation.Nullable String lastName) {
  ...
  public FirstLastNameGeoSubdivisionIn countryIso2(@javax.annotation.Nullable String countryIso2) {
  ...
  public FirstLastNameGeoSubdivisionIn subdivisionIso(@javax.annotation.Nullable String subdivisionIso) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to FirstLastNameGeoSubdivisionIn
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FirstLastNameGeoSubdivisionIn.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FirstLastNameGeoSubdivisionIn.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FirstLastNameGeoSubdivisionIn` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
