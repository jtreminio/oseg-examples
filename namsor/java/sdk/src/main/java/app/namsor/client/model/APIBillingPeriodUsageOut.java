...
public class APIBillingPeriodUsageOut {
  ...
  public APIBillingPeriodUsageOut apiKey(@javax.annotation.Nullable String apiKey) {
    this.apiKey = apiKey;
    return this;
  }
  ...
  public APIBillingPeriodUsageOut subscriptionStarted(@javax.annotation.Nullable Long subscriptionStarted) {
  ...
  public void setSubscriptionStarted(@javax.annotation.Nullable Long subscriptionStarted) {
    this.subscriptionStarted = subscriptionStarted;
  }


  public APIBillingPeriodUsageOut periodStarted(@javax.annotation.Nullable Long periodStarted) {
  ...
  public void setPeriodStarted(@javax.annotation.Nullable Long periodStarted) {
    this.periodStarted = periodStarted;
  }


  public APIBillingPeriodUsageOut periodEnded(@javax.annotation.Nullable Long periodEnded) {
  ...
  public void setPeriodEnded(@javax.annotation.Nullable Long periodEnded) {
    this.periodEnded = periodEnded;
  }


  public APIBillingPeriodUsageOut stripeCurrentPeriodEnd(@javax.annotation.Nullable Long stripeCurrentPeriodEnd) {
  ...
  public void setStripeCurrentPeriodEnd(@javax.annotation.Nullable Long stripeCurrentPeriodEnd) {
    this.stripeCurrentPeriodEnd = stripeCurrentPeriodEnd;
  }


  public APIBillingPeriodUsageOut stripeCurrentPeriodStart(@javax.annotation.Nullable Long stripeCurrentPeriodStart) {
  ...
  public void setStripeCurrentPeriodStart(@javax.annotation.Nullable Long stripeCurrentPeriodStart) {
    this.stripeCurrentPeriodStart = stripeCurrentPeriodStart;
  }


  public APIBillingPeriodUsageOut billingStatus(@javax.annotation.Nullable String billingStatus) {
  ...
  public APIBillingPeriodUsageOut usage(@javax.annotation.Nullable Long usage) {
    this.usage = usage;
    return this;
  }
  ...
  public void setUsage(@javax.annotation.Nullable Long usage) {
    this.usage = usage;
  }


  public APIBillingPeriodUsageOut softLimit(@javax.annotation.Nullable Long softLimit) {
  ...
  public void setSoftLimit(@javax.annotation.Nullable Long softLimit) {
    this.softLimit = softLimit;
  }


  public APIBillingPeriodUsageOut hardLimit(@javax.annotation.Nullable Long hardLimit) {
