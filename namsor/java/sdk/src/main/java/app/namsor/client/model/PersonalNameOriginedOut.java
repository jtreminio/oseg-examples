...
import app.namsor.client.model.ReligionStatOut;
...
public class PersonalNameOriginedOut {
  ...
  @javax.annotation.Nullable
  private List<ReligionStatOut> religionStats = new ArrayList<>();
  ...
  @javax.annotation.Nullable
  private List<ReligionStatOut> religionStatsAlt = new ArrayList<>();
  ...
  @javax.annotation.Nullable
  private List<ReligionStatOut> religionStatsSynthetic = new ArrayList<>();

  public PersonalNameOriginedOut() {
  }

  public PersonalNameOriginedOut script(@javax.annotation.Nullable String script) {
    this.script = script;
    return this;
  }
  ...
  public PersonalNameOriginedOut id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public PersonalNameOriginedOut explanation(@javax.annotation.Nullable String explanation) {
  ...
  public PersonalNameOriginedOut name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public PersonalNameOriginedOut countryOrigin(@javax.annotation.Nullable String countryOrigin) {
  ...
  public void setCountryOrigin(@javax.annotation.Nullable String countryOrigin) {
    this.countryOrigin = countryOrigin;
  }


  public PersonalNameOriginedOut countryOriginAlt(@javax.annotation.Nullable String countryOriginAlt) {
  ...
  public void setCountryOriginAlt(@javax.annotation.Nullable String countryOriginAlt) {
    this.countryOriginAlt = countryOriginAlt;
  }


  public PersonalNameOriginedOut countriesOriginTop(@javax.annotation.Nullable List<String> countriesOriginTop) {
  ...
  public void setCountriesOriginTop(@javax.annotation.Nullable List<String> countriesOriginTop) {
    this.countriesOriginTop = countriesOriginTop;
  }


  public PersonalNameOriginedOut score(@javax.annotation.Nullable Double score) {
    this.score = score;
    return this;
  }
  ...
  public PersonalNameOriginedOut regionOrigin(@javax.annotation.Nullable String regionOrigin) {
  ...
  public void setRegionOrigin(@javax.annotation.Nullable String regionOrigin) {
    this.regionOrigin = regionOrigin;
  }


  public PersonalNameOriginedOut topRegionOrigin(@javax.annotation.Nullable String topRegionOrigin) {
  ...
  public void setTopRegionOrigin(@javax.annotation.Nullable String topRegionOrigin) {
    this.topRegionOrigin = topRegionOrigin;
  }


  public PersonalNameOriginedOut subRegionOrigin(@javax.annotation.Nullable String subRegionOrigin) {
  ...
  public void setSubRegionOrigin(@javax.annotation.Nullable String subRegionOrigin) {
    this.subRegionOrigin = subRegionOrigin;
  }


  public PersonalNameOriginedOut probabilityCalibrated(@javax.annotation.Nullable Double probabilityCalibrated) {
  ...
  public PersonalNameOriginedOut probabilityAltCalibrated(@javax.annotation.Nullable Double probabilityAltCalibrated) {
  ...
  public PersonalNameOriginedOut religionStats(@javax.annotation.Nullable List<ReligionStatOut> religionStats) {
  ...
  public void setReligionStats(@javax.annotation.Nullable List<ReligionStatOut> religionStats) {
    this.religionStats = religionStats;
  }


  public PersonalNameOriginedOut religionStatsAlt(@javax.annotation.Nullable List<ReligionStatOut> religionStatsAlt) {
  ...
  public void setReligionStatsAlt(@javax.annotation.Nullable List<ReligionStatOut> religionStatsAlt) {
    this.religionStatsAlt = religionStatsAlt;
  }


  public PersonalNameOriginedOut religionStatsSynthetic(@javax.annotation.Nullable List<ReligionStatOut> religionStatsSynthetic) {
  ...
  public void setReligionStatsSynthetic(@javax.annotation.Nullable List<ReligionStatOut> religionStatsSynthetic) {
    this.religionStatsSynthetic = religionStatsSynthetic;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PersonalNameOriginedOut
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PersonalNameOriginedOut.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PersonalNameOriginedOut.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PersonalNameOriginedOut` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("religionStats") != null && !jsonObj.get("religionStats").isJsonNull()) {
        ...
        if (jsonArrayreligionStats != null) {
          ...
          for (int i = 0; i < jsonArrayreligionStats.size(); i++) {
            ReligionStatOut.validateJsonElement(jsonArrayreligionStats.get(i));
          };
        }
      }
      if (jsonObj.get("religionStatsAlt") != null && !jsonObj.get("religionStatsAlt").isJsonNull()) {
        ...
        if (jsonArrayreligionStatsAlt != null) {
          ...
          for (int i = 0; i < jsonArrayreligionStatsAlt.size(); i++) {
            ReligionStatOut.validateJsonElement(jsonArrayreligionStatsAlt.get(i));
          };
        }
      }
      if (jsonObj.get("religionStatsSynthetic") != null && !jsonObj.get("religionStatsSynthetic").isJsonNull()) {
        ...
        if (jsonArrayreligionStatsSynthetic != null) {
          ...
          for (int i = 0; i < jsonArrayreligionStatsSynthetic.size(); i++) {
            ReligionStatOut.validateJsonElement(jsonArrayreligionStatsSynthetic.get(i));
          };
        }
      }
  }
