...
public class FirstLastNameUSRaceEthnicityOut {
  ...
  public FirstLastNameUSRaceEthnicityOut script(@javax.annotation.Nullable String script) {
    this.script = script;
    return this;
  }
  ...
  public FirstLastNameUSRaceEthnicityOut id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public FirstLastNameUSRaceEthnicityOut explanation(@javax.annotation.Nullable String explanation) {
  ...
  public FirstLastNameUSRaceEthnicityOut firstName(@javax.annotation.Nullable String firstName) {
  ...
  public FirstLastNameUSRaceEthnicityOut lastName(@javax.annotation.Nullable String lastName) {
  ...
  public FirstLastNameUSRaceEthnicityOut raceEthnicityAlt(@javax.annotation.Nullable RaceEthnicityAltEnum raceEthnicityAlt) {
  ...
  public FirstLastNameUSRaceEthnicityOut raceEthnicity(@javax.annotation.Nullable RaceEthnicityEnum raceEthnicity) {
  ...
  public FirstLastNameUSRaceEthnicityOut score(@javax.annotation.Nullable Double score) {
    this.score = score;
    return this;
  }
  ...
  public FirstLastNameUSRaceEthnicityOut raceEthnicitiesTop(@javax.annotation.Nullable List<String> raceEthnicitiesTop) {
  ...
  public FirstLastNameUSRaceEthnicityOut probabilityCalibrated(@javax.annotation.Nullable Double probabilityCalibrated) {
  ...
  public FirstLastNameUSRaceEthnicityOut probabilityAltCalibrated(@javax.annotation.Nullable Double probabilityAltCalibrated) {
