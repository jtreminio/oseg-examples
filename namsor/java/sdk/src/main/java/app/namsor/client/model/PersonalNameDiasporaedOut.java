...
public class PersonalNameDiasporaedOut {
  ...
  public PersonalNameDiasporaedOut script(@javax.annotation.Nullable String script) {
    this.script = script;
    return this;
  }
  ...
  public PersonalNameDiasporaedOut id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public PersonalNameDiasporaedOut explanation(@javax.annotation.Nullable String explanation) {
  ...
  public PersonalNameDiasporaedOut name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public PersonalNameDiasporaedOut score(@javax.annotation.Nullable Double score) {
    this.score = score;
    return this;
  }
  ...
  public PersonalNameDiasporaedOut ethnicityAlt(@javax.annotation.Nullable String ethnicityAlt) {
  ...
  public void setEthnicityAlt(@javax.annotation.Nullable String ethnicityAlt) {
    this.ethnicityAlt = ethnicityAlt;
  }


  public PersonalNameDiasporaedOut ethnicity(@javax.annotation.Nullable String ethnicity) {
  ...
  public PersonalNameDiasporaedOut lifted(@javax.annotation.Nullable Boolean lifted) {
    this.lifted = lifted;
    return this;
  }
  ...
  public void setLifted(@javax.annotation.Nullable Boolean lifted) {
    this.lifted = lifted;
  }


  public PersonalNameDiasporaedOut countryIso2(@javax.annotation.Nullable String countryIso2) {
  ...
  public PersonalNameDiasporaedOut ethnicitiesTop(@javax.annotation.Nullable List<String> ethnicitiesTop) {
  ...
  public void setEthnicitiesTop(@javax.annotation.Nullable List<String> ethnicitiesTop) {
    this.ethnicitiesTop = ethnicitiesTop;
  }


  public PersonalNameDiasporaedOut probabilityCalibrated(@javax.annotation.Nullable Double probabilityCalibrated) {
  ...
  public PersonalNameDiasporaedOut probabilityAltCalibrated(@javax.annotation.Nullable Double probabilityAltCalibrated) {
  ...
  public PersonalNameDiasporaedOut religionStats(@javax.annotation.Nullable List<ReligionStatOut> religionStats) {
  ...
  public PersonalNameDiasporaedOut religionStatsAlt(@javax.annotation.Nullable List<ReligionStatOut> religionStatsAlt) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to PersonalNameDiasporaedOut
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PersonalNameDiasporaedOut.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PersonalNameDiasporaedOut.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PersonalNameDiasporaedOut` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
