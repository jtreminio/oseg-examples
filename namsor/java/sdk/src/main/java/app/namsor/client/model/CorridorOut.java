...
public class CorridorOut {
  ...
  public CorridorOut id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public CorridorOut firstLastNameGenderedOut(@javax.annotation.Nullable FirstLastNameGenderedOut firstLastNameGenderedOut) {
  ...
  public void setFirstLastNameGenderedOut(@javax.annotation.Nullable FirstLastNameGenderedOut firstLastNameGenderedOut) {
    this.firstLastNameGenderedOut = firstLastNameGenderedOut;
  }


  public CorridorOut firstLastNameOriginedOut(@javax.annotation.Nullable FirstLastNameOriginedOut firstLastNameOriginedOut) {
  ...
  public void setFirstLastNameOriginedOut(@javax.annotation.Nullable FirstLastNameOriginedOut firstLastNameOriginedOut) {
    this.firstLastNameOriginedOut = firstLastNameOriginedOut;
  }


  public CorridorOut firstLastNameDiasporaedOut(@javax.annotation.Nullable FirstLastNameDiasporaedOut firstLastNameDiasporaedOut) {
  ...
  public void setFirstLastNameDiasporaedOut(@javax.annotation.Nullable FirstLastNameDiasporaedOut firstLastNameDiasporaedOut) {
    this.firstLastNameDiasporaedOut = firstLastNameDiasporaedOut;
  }


  public CorridorOut script(@javax.annotation.Nullable String script) {
    this.script = script;
    return this;
  }
