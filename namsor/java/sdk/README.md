...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'namsor-java-client' jar has been published to maven central.
    mavenLocal()       // Needed if the 'namsor-java-client' jar has been published to the local maven repo.
  }

  dependencies {
     implementation "org.openapitools:namsor-java-client:2.0.29"
  }
```
...
* `target/namsor-java-client-2.0.29.jar`
* `target/lib/*.jar`
...
import app.namsor.client.api.AdminApi;
