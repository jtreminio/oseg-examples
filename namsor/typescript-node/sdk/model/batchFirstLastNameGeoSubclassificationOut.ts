...
*/
export class BatchFirstLastNameGeoSubclassificationOut {
    /**
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "Array<FirstLastNameGeoSubclassificationOut>"
        }    ];

    static getAttributeTypeMap() {
        return BatchFirstLastNameGeoSubclassificationOut.attributeTypeMap;
    }
}
