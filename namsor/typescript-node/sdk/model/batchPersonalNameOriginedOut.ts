...
*/
export class BatchPersonalNameOriginedOut {
    /**
    * Classified origined names
    */
    'personalNames'?: Array<PersonalNameOriginedOut>;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "Array<PersonalNameOriginedOut>"
        }    ];

    static getAttributeTypeMap() {
        return BatchPersonalNameOriginedOut.attributeTypeMap;
    }
}
