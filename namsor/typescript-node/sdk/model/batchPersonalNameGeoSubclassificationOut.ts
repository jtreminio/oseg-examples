...
*/
export class BatchPersonalNameGeoSubclassificationOut {
    /**
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "Array<PersonalNameGeoSubclassificationOut>"
        }    ];

    static getAttributeTypeMap() {
        return BatchPersonalNameGeoSubclassificationOut.attributeTypeMap;
    }
}
