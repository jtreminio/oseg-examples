...
*/
export class BatchFirstLastNameUSRaceEthnicityOut {
    /**
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "Array<FirstLastNameUSRaceEthnicityOut>"
        }    ];

    static getAttributeTypeMap() {
        return BatchFirstLastNameUSRaceEthnicityOut.attributeTypeMap;
    }
}
