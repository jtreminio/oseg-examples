...
*/
export class BatchFirstLastNameCastegroupOut {
    /**
    * Classified origined names
    */
    'personalNames'?: Array<FirstLastNameCastegroupOut>;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "Array<FirstLastNameCastegroupOut>"
        }    ];

    static getAttributeTypeMap() {
        return BatchFirstLastNameCastegroupOut.attributeTypeMap;
    }
}
