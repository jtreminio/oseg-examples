...
*/
export class BatchPersonalNameUSRaceEthnicityOut {
    /**
    * Classified origined names
    */
    'personalNames'?: Array<PersonalNameUSRaceEthnicityOut>;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "Array<PersonalNameUSRaceEthnicityOut>"
        }    ];

    static getAttributeTypeMap() {
        return BatchPersonalNameUSRaceEthnicityOut.attributeTypeMap;
    }
}
