...
*/
export class NameMatchCandidatesOut {
    'script'?: string;
    'id'?: string;
    'explanation'?: string;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "orderOption",
            "baseName": "orderOption",
            "type": "string"
        },
        {
            "name": "matchCandidates",
            "baseName": "matchCandidates",
            "type": "Array<NameMatchCandidateOut>"
        }    ];

    static getAttributeTypeMap() {
        return NameMatchCandidatesOut.attributeTypeMap;
    }
}
