...
*/
export class BatchFirstLastNameCasteOut {
    /**
    * Classified origined names
    */
    'personalNames'?: Array<FirstLastNameCasteOut>;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "Array<FirstLastNameCasteOut>"
        }    ];

    static getAttributeTypeMap() {
        return BatchFirstLastNameCasteOut.attributeTypeMap;
    }
}
