...
class APIPlanSubscriptionOut(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["apiKey", "planStarted", "priorPlanStarted", "planEnded", "taxRate", "planName", "planBaseFeesKey", "planStatus", "planQuota", "priceUSD", "priceOverageUSD", "price", "priceOverage", "currency", "currencyFactor", "stripeCustomerId", "stripeStatus", "stripeSubscription", "userId"]
