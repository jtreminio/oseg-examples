...
class FirstLastNameUSRaceEthnicityOut(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["script", "id", "explanation", "firstName", "lastName", "raceEthnicityAlt", "raceEthnicity", "score", "raceEthnicitiesTop", "probabilityCalibrated", "probabilityAltCalibrated"]
