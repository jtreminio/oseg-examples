...
class PersonalNameUSRaceEthnicityOut(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["script", "id", "explanation", "name", "raceEthnicityAlt", "raceEthnicity", "score", "raceEthnicitiesTop", "probabilityCalibrated", "probabilityAltCalibrated"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PersonalNameUSRaceEthnicityOut from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PersonalNameUSRaceEthnicityOut from a dict"""
        if obj is None:
            return None
