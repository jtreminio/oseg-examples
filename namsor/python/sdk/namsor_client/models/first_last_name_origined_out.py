...
class FirstLastNameOriginedOut(BaseModel):
    ...
    religion_stats_alt: Optional[List[ReligionStatOut]] = Field(default=None, description="Geographic religious statistics, for origin best alternative.", alias="religionStatsAlt")
    __properties: ClassVar[List[str]] = ["script", "id", "explanation", "firstName", "lastName", "countryOrigin", "countryOriginAlt", "countriesOriginTop", "score", "regionOrigin", "topRegionOrigin", "subRegionOrigin", "probabilityCalibrated", "probabilityAltCalibrated", "religionStats", "religionStatsAlt"]
