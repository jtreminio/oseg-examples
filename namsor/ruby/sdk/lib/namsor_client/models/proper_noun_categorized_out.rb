...
module NamsorClient
  ...
  class ProperNounCategorizedOut
    ...
    attr_accessor :common_type

    # Best alternative for : The most likely common name type
    attr_accessor :common_type_alt
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NamsorClient::ProperNounCategorizedOut` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NamsorClient::ProperNounCategorizedOut`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'common_type')
        self.common_type = attributes[:'common_type']
      end

      if attributes.key?(:'common_type_alt')
        self.common_type_alt = attributes[:'common_type_alt']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          name == o.name &&
          common_type == o.common_type &&
          common_type_alt == o.common_type_alt &&
          score == o.score
    end
    ...
    def hash
      [script, id, explanation, name, common_type, common_type_alt, score].hash
    end
