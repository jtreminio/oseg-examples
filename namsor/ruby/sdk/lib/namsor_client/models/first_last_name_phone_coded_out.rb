...
module NamsorClient
  ...
  class FirstLastNamePhoneCodedOut
    ...
    def hash
      [script, id, explanation, first_name, last_name, international_phone_number_verified, phone_country_iso2_verified, phone_country_code, phone_country_code_alt, phone_country_iso2, phone_country_iso2_alt, origin_country_iso2, origin_country_iso2_alt, phone_number, verified, score, country_iso2].hash
    end
