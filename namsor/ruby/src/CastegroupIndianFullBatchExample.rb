...
personal_names_1.subdivision_iso = "IN-UP"
...
begin
    response = NamsorClient::IndianApi.new.castegroup_indian_full_batch(
        {
    ...
    puts "Exception when calling IndianApi#castegroup_indian_full_batch: #{e}"
end
