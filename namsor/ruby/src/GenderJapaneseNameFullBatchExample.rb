...
begin
    response = NamsorClient::JapaneseApi.new.gender_japanese_name_full_batch(
        {
    ...
    puts "Exception when calling JapaneseApi#gender_japanese_name_full_batch: #{e}"
end
