...
begin
    response = NamsorClient::ChineseApi.new.gender_chinese_name_batch(
        {
    ...
    puts "Exception when calling ChineseApi#gender_chinese_name_batch: #{e}"
end
