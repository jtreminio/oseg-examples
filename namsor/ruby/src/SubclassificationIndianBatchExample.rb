...
personal_names_1.first_name = "Jannat"
personal_names_1.last_name = "Rahmani"
...
begin
    response = NamsorClient::IndianApi.new.subclassification_indian_batch(
        {
    ...
    puts "Exception when calling IndianApi#subclassification_indian_batch: #{e}"
end
