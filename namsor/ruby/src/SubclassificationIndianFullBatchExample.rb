...
personal_names_1.name = "Jannat Rahmani"
...
begin
    response = NamsorClient::IndianApi.new.subclassification_indian_full_batch(
        {
    ...
    puts "Exception when calling IndianApi#subclassification_indian_full_batch: #{e}"
end
