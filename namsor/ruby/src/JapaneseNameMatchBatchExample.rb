...
begin
    response = NamsorClient::JapaneseApi.new.japanese_name_match_batch(
        {
    ...
    puts "Exception when calling JapaneseApi#japanese_name_match_batch: #{e}"
end
