...
personal_names_1.first_name = "Sanae"
personal_names_1.last_name = "Yamamoto"
...
begin
    response = NamsorClient::JapaneseApi.new.japanese_name_kanji_candidates_batch(
        {
    ...
    puts "Exception when calling JapaneseApi#japanese_name_kanji_candidates_batch: #{e}"
end
