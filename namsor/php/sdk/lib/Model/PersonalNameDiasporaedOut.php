...
/**
 * PersonalNameDiasporaedOut Class Doc Comment
 *
 * @category Class
 ...
 */
class PersonalNameDiasporaedOut implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PersonalNameDiasporaedOut';
    ...
    */
    ...
    public function setScore($score)
    {
        ...
        if (($score > 100)) {
            throw new \InvalidArgumentException('invalid value for $score when calling PersonalNameDiasporaedOut., must be smaller than or equal to 100.');
        }
        if (($score < 0)) {
            throw new \InvalidArgumentException('invalid value for $score when calling PersonalNameDiasporaedOut., must be bigger than or equal to 0.');
        }
    ...
    public function setProbabilityCalibrated($probability_calibrated)
    {
        ...
        if (($probability_calibrated > 1)) {
            throw new \InvalidArgumentException('invalid value for $probability_calibrated when calling PersonalNameDiasporaedOut., must be smaller than or equal to 1.');
        }
        if (($probability_calibrated < -1)) {
            throw new \InvalidArgumentException('invalid value for $probability_calibrated when calling PersonalNameDiasporaedOut., must be bigger than or equal to -1.');
        }
    ...
    public function setProbabilityAltCalibrated($probability_alt_calibrated)
    {
        ...
        if (($probability_alt_calibrated > 1)) {
            throw new \InvalidArgumentException('invalid value for $probability_alt_calibrated when calling PersonalNameDiasporaedOut., must be smaller than or equal to 1.');
        }
        if (($probability_alt_calibrated < -1)) {
            throw new \InvalidArgumentException('invalid value for $probability_alt_calibrated when calling PersonalNameDiasporaedOut., must be bigger than or equal to -1.');
        }
