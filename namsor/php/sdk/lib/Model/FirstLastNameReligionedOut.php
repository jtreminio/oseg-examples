...
/**
 * FirstLastNameReligionedOut Class Doc Comment
 *
 * @category Class
 ...
 */
class FirstLastNameReligionedOut implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FirstLastNameReligionedOut';
    ...
    */
     ...
     * Sets religions_top
     *
     * @param string[]|null $religions_top List countries (top 10)
     *
     * @return self
     */
    ...
    public function setScore($score)
    {
        ...
        if (($score > 100)) {
            throw new \InvalidArgumentException('invalid value for $score when calling FirstLastNameReligionedOut., must be smaller than or equal to 100.');
        }
        if (($score < 0)) {
            throw new \InvalidArgumentException('invalid value for $score when calling FirstLastNameReligionedOut., must be bigger than or equal to 0.');
        }
    ...
    public function setProbabilityCalibrated($probability_calibrated)
    {
        ...
        if (($probability_calibrated > 1)) {
            throw new \InvalidArgumentException('invalid value for $probability_calibrated when calling FirstLastNameReligionedOut., must be smaller than or equal to 1.');
        }
        if (($probability_calibrated < -1)) {
            throw new \InvalidArgumentException('invalid value for $probability_calibrated when calling FirstLastNameReligionedOut., must be bigger than or equal to -1.');
        }
    ...
    public function setProbabilityAltCalibrated($probability_alt_calibrated)
    {
        ...
        if (($probability_alt_calibrated > 1)) {
            throw new \InvalidArgumentException('invalid value for $probability_alt_calibrated when calling FirstLastNameReligionedOut., must be smaller than or equal to 1.');
        }
        if (($probability_alt_calibrated < -1)) {
            throw new \InvalidArgumentException('invalid value for $probability_alt_calibrated when calling FirstLastNameReligionedOut., must be bigger than or equal to -1.');
        }
