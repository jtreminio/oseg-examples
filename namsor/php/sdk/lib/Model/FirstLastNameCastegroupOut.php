...
/**
 * FirstLastNameCastegroupOut Class Doc Comment
 *
 * @category Class
 ...
 */
class FirstLastNameCastegroupOut implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FirstLastNameCastegroupOut';
    ...
    protected static array $openAPINullables = [
        ...
        'last_name' => false,
        'castegroup' => false,
        'castegroup_alt' => false,
        'castegroup_top' => false,
        'score' => false,
    ...
    protected static $setters = [
        ...
        'castegroup' => 'setCastegroup',
        'castegroup_alt' => 'setCastegroupAlt',
        'castegroup_top' => 'setCastegroupTop',
        'score' => 'setScore',
    ...
    protected static $getters = [
        ...
        'castegroup' => 'getCastegroup',
        'castegroup_alt' => 'getCastegroupAlt',
        'castegroup_top' => 'getCastegroupTop',
        'score' => 'getScore',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('castegroup', $data ?? [], null);
        $this->setIfExists('castegroup_alt', $data ?? [], null);
        $this->setIfExists('castegroup_top', $data ?? [], null);
    ...
    */
     ...
     * @return string|null
     */
    public function getCastegroup()
    {
        return $this->container['castegroup'];
    }

    /**
     * Sets castegroup
     *
     * @param string|null $castegroup Most likely caste group
     *
     * @return self
     */
    public function setCastegroup($castegroup)
    {
        if (is_null($castegroup)) {
            throw new \InvalidArgumentException('non-nullable castegroup cannot be null');
        }
        $this->container['castegroup'] = $castegroup;
     ...
     * @return string|null
     */
    public function getCastegroupAlt()
    {
        return $this->container['castegroup_alt'];
    }

    /**
     * Sets castegroup_alt
     *
     * @param string|null $castegroup_alt Second best alternative : caste group
     *
     * @return self
     */
    public function setCastegroupAlt($castegroup_alt)
    {
        if (is_null($castegroup_alt)) {
            throw new \InvalidArgumentException('non-nullable castegroup_alt cannot be null');
        }
        $this->container['castegroup_alt'] = $castegroup_alt;
     ...
     * @return string[]|null
     */
    public function getCastegroupTop()
    {
        return $this->container['castegroup_top'];
    }

    /**
     * Sets castegroup_top
     *
     * @param string[]|null $castegroup_top List caste group (top 10)
     *
     * @return self
     */
    public function setCastegroupTop($castegroup_top)
    {
        if (is_null($castegroup_top)) {
            throw new \InvalidArgumentException('non-nullable castegroup_top cannot be null');
        }
        $this->container['castegroup_top'] = $castegroup_top;
    ...
    public function setScore($score)
    {
        ...
        if (($score > 100)) {
            throw new \InvalidArgumentException('invalid value for $score when calling FirstLastNameCastegroupOut., must be smaller than or equal to 100.');
        }
        if (($score < 0)) {
            throw new \InvalidArgumentException('invalid value for $score when calling FirstLastNameCastegroupOut., must be bigger than or equal to 0.');
        }
     ...
     *
     * @param float|null $probability_calibrated The calibrated probability for caste to have been guessed correctly. -1 = still calibrating.
     *
     * @return self
     */
    public function setProbabilityCalibrated($probability_calibrated)
    {
        ...
        if (($probability_calibrated > 1)) {
            throw new \InvalidArgumentException('invalid value for $probability_calibrated when calling FirstLastNameCastegroupOut., must be smaller than or equal to 1.');
        }
        if (($probability_calibrated < -1)) {
            throw new \InvalidArgumentException('invalid value for $probability_calibrated when calling FirstLastNameCastegroupOut., must be bigger than or equal to -1.');
        }
     ...
     *
     * @param float|null $probability_alt_calibrated The calibrated probability for caste OR casteAlt to have been guessed correctly. -1 = still calibrating.
     *
     * @return self
     */
    public function setProbabilityAltCalibrated($probability_alt_calibrated)
    {
        ...
        if (($probability_alt_calibrated > 1)) {
            throw new \InvalidArgumentException('invalid value for $probability_alt_calibrated when calling FirstLastNameCastegroupOut., must be smaller than or equal to 1.');
        }
        if (($probability_alt_calibrated < -1)) {
            throw new \InvalidArgumentException('invalid value for $probability_alt_calibrated when calling FirstLastNameCastegroupOut., must be bigger than or equal to -1.');
        }
