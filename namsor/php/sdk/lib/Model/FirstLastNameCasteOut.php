...
/**
 * FirstLastNameCasteOut Class Doc Comment
 *
 * @category Class
 ...
 */
class FirstLastNameCasteOut implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FirstLastNameCasteOut';
    ...
    protected static $setters = [
        ...
        'caste' => 'setCaste',
        'caste_alt' => 'setCasteAlt',
        'caste_top' => 'setCasteTop',
        'score' => 'setScore',
    ...
    protected static $getters = [
        ...
        'caste' => 'getCaste',
        'caste_alt' => 'getCasteAlt',
        'caste_top' => 'getCasteTop',
        'score' => 'getScore',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('caste', $data ?? [], null);
        $this->setIfExists('caste_alt', $data ?? [], null);
        $this->setIfExists('caste_top', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['caste'];
    }

    /**
     * Sets caste
     *
     * @param string|null $caste Most likely caste
     *
     * @return self
     */
    ...
    {
        if (is_null($caste)) {
            throw new \InvalidArgumentException('non-nullable caste cannot be null');
        }
        $this->container['caste'] = $caste;
     ...
     * @return string|null
     */
    public function getCasteAlt()
    {
        return $this->container['caste_alt'];
    }

    /**
     * Sets caste_alt
     *
     * @param string|null $caste_alt Second best alternative : caste
     *
     * @return self
     */
    public function setCasteAlt($caste_alt)
    {
        if (is_null($caste_alt)) {
            throw new \InvalidArgumentException('non-nullable caste_alt cannot be null');
        }
        $this->container['caste_alt'] = $caste_alt;
     ...
     * @return string[]|null
     */
    public function getCasteTop()
    {
        return $this->container['caste_top'];
    }

    /**
     * Sets caste_top
     *
     * @param string[]|null $caste_top List caste(top 10)
     *
     * @return self
     */
    public function setCasteTop($caste_top)
    {
        if (is_null($caste_top)) {
            throw new \InvalidArgumentException('non-nullable caste_top cannot be null');
        }
        $this->container['caste_top'] = $caste_top;
    ...
    public function setScore($score)
    {
        ...
        if (($score > 100)) {
            throw new \InvalidArgumentException('invalid value for $score when calling FirstLastNameCasteOut., must be smaller than or equal to 100.');
        }
        if (($score < 0)) {
            throw new \InvalidArgumentException('invalid value for $score when calling FirstLastNameCasteOut., must be bigger than or equal to 0.');
        }
    ...
    public function setProbabilityCalibrated($probability_calibrated)
    {
        ...
        if (($probability_calibrated > 1)) {
            throw new \InvalidArgumentException('invalid value for $probability_calibrated when calling FirstLastNameCasteOut., must be smaller than or equal to 1.');
        }
        if (($probability_calibrated < -1)) {
            throw new \InvalidArgumentException('invalid value for $probability_calibrated when calling FirstLastNameCasteOut., must be bigger than or equal to -1.');
        }
    ...
    public function setProbabilityAltCalibrated($probability_alt_calibrated)
    {
        ...
        if (($probability_alt_calibrated > 1)) {
            throw new \InvalidArgumentException('invalid value for $probability_alt_calibrated when calling FirstLastNameCasteOut., must be smaller than or equal to 1.');
        }
        if (($probability_alt_calibrated < -1)) {
            throw new \InvalidArgumentException('invalid value for $probability_alt_calibrated when calling FirstLastNameCasteOut., must be bigger than or equal to -1.');
        }
