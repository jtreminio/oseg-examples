 ...
 */
class NameMatchedOut implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const MATCH_STATUS_MATCH = 'Match';
    ...
    {
        return [
            self::MATCH_STATUS_MATCH,
            self::MATCH_STATUS_MISMATCH,
        ];
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['match_status']) && !in_array($this->container['match_status'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'match_status', must be one of '%s'",
                $this->container['match_status'],
     ...
     * Sets match_status
     *
     * @param string|null $match_status The name matching status.
     *
     * @return self
     */
