...
public class SubclassificationBatchExample
{
    public static void Run()
    {
        ...
        try
        {
            var response = new PersonalApi(config).SubclassificationBatch(
        ...
        {
            Console.WriteLine("Exception when calling PersonalApi#SubclassificationBatch: " + e.Message);
