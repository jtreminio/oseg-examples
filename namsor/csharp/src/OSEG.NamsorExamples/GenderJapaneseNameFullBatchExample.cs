...
public class GenderJapaneseNameFullBatchExample
{
    public static void Run()
    {
        ...
        try
        {
            var response = new JapaneseApi(config).GenderJapaneseNameFullBatch(
        ...
        {
            Console.WriteLine("Exception when calling JapaneseApi#GenderJapaneseNameFullBatch: " + e.Message);
