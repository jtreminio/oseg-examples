...
public class JapaneseNameKanjiCandidatesBatchExample
{
    public static void Run()
    {
        ...
        try
        {
            var response = new JapaneseApi(config).JapaneseNameKanjiCandidatesBatch(
        ...
        {
            Console.WriteLine("Exception when calling JapaneseApi#JapaneseNameKanjiCandidatesBatch: " + e.Message);
