...
public class ReligionIndianFullBatchExample
{
    public static void Run()
    {
        ...
        try
        {
            var response = new IndianApi(config).ReligionIndianFullBatch(
        ...
        {
            Console.WriteLine("Exception when calling IndianApi#ReligionIndianFullBatch: " + e.Message);
