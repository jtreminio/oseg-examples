...
public class GenderChineseNamePinyinBatchExample
{
    public static void Run()
    {
        ...
        try
        {
            var response = new ChineseApi(config).GenderChineseNamePinyinBatch(
        ...
        {
            Console.WriteLine("Exception when calling ChineseApi#GenderChineseNamePinyinBatch: " + e.Message);
