...
namespace App.Namsor.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FirstLastNameCasteOut")]
    public partial class FirstLastNameCasteOut : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FirstLastNameCasteOut" /> class.
        /// </summary>
        ...
        /// <param name="caste">Most likely caste.</param>
        /// <param name="casteAlt">Second best alternative : caste.</param>
        /// <param name="casteTop">List caste(top 10).</param>
        ...
        public FirstLastNameCasteOut(string script = default(string), string id = default(string), string explanation = default(string), string firstName = default(string), string lastName = default(string), string caste = default(string), string casteAlt = default(string), List<string> casteTop = default(List<string>), double score = default(double), double probabilityCalibrated = default(double), double probabilityAltCalibrated = default(double))
        {
            this.Script = script;
            this.Id = id;
        ...
        /// Most likely caste
        /// </summary>
        /// <value>Most likely caste</value>
        [DataMember(Name = "caste", EmitDefaultValue = false)]
        public string Caste { get; set; }

        /// <summary>
        /// Second best alternative : caste
        /// </summary>
        /// <value>Second best alternative : caste</value>
        [DataMember(Name = "casteAlt", EmitDefaultValue = false)]
        public string CasteAlt { get; set; }

        /// <summary>
        /// List caste(top 10)
        /// </summary>
        /// <value>List caste(top 10)</value>
        [DataMember(Name = "casteTop", EmitDefaultValue = false)]
        public List<string> CasteTop { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CasteAlt: ").Append(CasteAlt).Append("\n");
            sb.Append("  CasteTop: ").Append(CasteTop).Append("\n");
