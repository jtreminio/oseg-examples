...
namespace App.Namsor.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PersonalNameGeoSubdivisionIn")]
    public partial class PersonalNameGeoSubdivisionIn : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PersonalNameGeoSubdivisionIn" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="name">name.</param>
        /// <param name="countryIso2">countryIso2.</param>
        /// <param name="subdivisionIso">subdivisionIso.</param>
        public PersonalNameGeoSubdivisionIn(string id = default(string), string name = default(string), string countryIso2 = default(string), string subdivisionIso = default(string))
        {
            this.Id = id;
            this.Name = name;
