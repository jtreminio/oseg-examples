...
namespace App.Namsor.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PersonalNameSubdivisionIn")]
    public partial class PersonalNameSubdivisionIn : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PersonalNameSubdivisionIn" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="name">name.</param>
        /// <param name="subdivisionIso">subdivisionIso.</param>
        public PersonalNameSubdivisionIn(string id = default(string), string name = default(string), string subdivisionIso = default(string))
        {
            this.Id = id;
            this.Name = name;
