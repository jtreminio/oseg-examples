...
namespace App.Namsor.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PersonalNameGenderedOut")]
    public partial class PersonalNameGenderedOut : IValidatableObject
    {
        /// <summary>
        /// Most likely gender
        /// </summary>
        ...
        public PersonalNameGenderedOut(string script = default(string), string id = default(string), string explanation = default(string), string name = default(string), LikelyGenderEnum? likelyGender = default(LikelyGenderEnum?), double genderScale = default(double), double score = default(double), double probabilityCalibrated = default(double))
        {
            this.Script = script;
            this.Id = id;
