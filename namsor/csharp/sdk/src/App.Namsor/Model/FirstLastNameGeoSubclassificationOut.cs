...
namespace App.Namsor.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FirstLastNameGeoSubclassificationOut")]
    public partial class FirstLastNameGeoSubclassificationOut : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FirstLastNameGeoSubclassificationOut" /> class.
        /// </summary>
        ...
        public FirstLastNameGeoSubclassificationOut(string script = default(string), string id = default(string), string explanation = default(string), string firstName = default(string), string lastName = default(string), string countryIso2 = default(string), string subClassification = default(string), string subClassificationAlt = default(string), List<string> subclassificationTop = default(List<string>), double score = default(double), double probabilityCalibrated = default(double), double probabilityAltCalibrated = default(double))
        {
            this.Script = script;
            this.Id = id;
