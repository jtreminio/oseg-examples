...
namespace App.Namsor.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FirstLastNameOut")]
    public partial class FirstLastNameOut : IValidatableObject
    {
        /// <summary>
        ...
        public FirstLastNameOut(string script = default(string), string id = default(string), string explanation = default(string), string firstName = default(string), string lastName = default(string))
        {
            this.Script = script;
            this.Id = id;
