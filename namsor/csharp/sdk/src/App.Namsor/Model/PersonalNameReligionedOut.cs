...
namespace App.Namsor.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PersonalNameReligionedOut")]
    public partial class PersonalNameReligionedOut : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PersonalNameReligionedOut" /> class.
        /// </summary>
        ...
        /// <param name="religionsTop">List religions (top 10).</param>
        ...
        public PersonalNameReligionedOut(string script = default(string), string id = default(string), string explanation = default(string), string name = default(string), double score = default(double), string religion = default(string), string religionAlt = default(string), List<string> religionsTop = default(List<string>), double probabilityCalibrated = default(double), double probabilityAltCalibrated = default(double))
        {
            this.Script = script;
            this.Id = id;
        ...
        /// </summary>
        /// <value>List religions (top 10)</value>
