...
namespace App.Namsor.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ReligionStatOut")]
    public partial class ReligionStatOut : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReligionStatOut" /> class.
        /// </summary>
        /// <param name="religion">religion.</param>
        /// <param name="pct">pct.</param>
        public ReligionStatOut(string religion = default(string), double pct = default(double))
        {
