...
namespace App.Namsor.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PersonalNameOriginedOut")]
    public partial class PersonalNameOriginedOut : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PersonalNameOriginedOut" /> class.
        /// </summary>
        ...
        /// <param name="topRegionOrigin">Most likely top region of Origin (based on countryOrigin ISO2 code).</param>
        /// <param name="subRegionOrigin">Most likely sub region of Origin (based on countryOrigin ISO2 code).</param>
        /// <param name="probabilityCalibrated">The calibrated probability for countryOrigin to have been guessed correctly. -1 &#x3D; still calibrating. .</param>
        /// <param name="probabilityAltCalibrated">The calibrated probability for countryOrigin OR countryOriginAlt to have been guessed correctly. -1 &#x3D; still calibrating. .</param>
        /// <param name="religionStats">Geographic religious statistics, assuming country of origin is correctly predicted..</param>
        /// <param name="religionStatsAlt">Geographic religious statistics, for country best alternative..</param>
        /// <param name="religionStatsSynthetic">Geographic religious statistics, assuming country of origin OR best alternative is correctly predicted..</param>
        public PersonalNameOriginedOut(string script = default(string), string id = default(string), string explanation = default(string), string name = default(string), string countryOrigin = default(string), string countryOriginAlt = default(string), List<string> countriesOriginTop = default(List<string>), double score = default(double), string regionOrigin = default(string), string topRegionOrigin = default(string), string subRegionOrigin = default(string), double probabilityCalibrated = default(double), double probabilityAltCalibrated = default(double), List<ReligionStatOut> religionStats = default(List<ReligionStatOut>), List<ReligionStatOut> religionStatsAlt = default(List<ReligionStatOut>), List<ReligionStatOut> religionStatsSynthetic = default(List<ReligionStatOut>))
        {
            this.Script = script;
            this.Id = id;
        ...
        /// </summary>
        /// <value>Most likely top region of Origin (based on countryOrigin ISO2 code)</value>
        ...
        /// </summary>
        /// <value>Most likely sub region of Origin (based on countryOrigin ISO2 code)</value>
        ...
        /// </summary>
        /// <value>The calibrated probability for countryOrigin to have been guessed correctly. -1 &#x3D; still calibrating. </value>
        ...
        /// </summary>
        /// <value>The calibrated probability for countryOrigin OR countryOriginAlt to have been guessed correctly. -1 &#x3D; still calibrating. </value>
        ...
        /// </summary>
        /// <value>Geographic religious statistics, assuming country of origin is correctly predicted.</value>
        ...
        /// </summary>
        /// <value>Geographic religious statistics, assuming country of origin OR best alternative is correctly predicted.</value>
        [DataMember(Name = "religionStatsSynthetic", EmitDefaultValue = false)]
        public List<ReligionStatOut> ReligionStatsSynthetic { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ReligionStatsSynthetic: ").Append(ReligionStatsSynthetic).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
