...
namespace App.Namsor.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PersonalNameUSRaceEthnicityOut")]
    public partial class PersonalNameUSRaceEthnicityOut : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PersonalNameUSRaceEthnicityOut" /> class.
        /// </summary>
        ...
        public PersonalNameUSRaceEthnicityOut(string script = default(string), string id = default(string), string explanation = default(string), string name = default(string), RaceEthnicityAltEnum? raceEthnicityAlt = default(RaceEthnicityAltEnum?), RaceEthnicityEnum? raceEthnicity = default(RaceEthnicityEnum?), double score = default(double), List<string> raceEthnicitiesTop = default(List<string>), double probabilityCalibrated = default(double), double probabilityAltCalibrated = default(double))
        {
            this.Script = script;
            this.Id = id;
