...
namespace App.Namsor.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PersonalNameDiasporaedOut")]
    public partial class PersonalNameDiasporaedOut : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PersonalNameDiasporaedOut" /> class.
        /// </summary>
        ...
        public PersonalNameDiasporaedOut(string script = default(string), string id = default(string), string explanation = default(string), string name = default(string), double score = default(double), string ethnicityAlt = default(string), string ethnicity = default(string), bool lifted = default(bool), string countryIso2 = default(string), List<string> ethnicitiesTop = default(List<string>), double probabilityCalibrated = default(double), double probabilityAltCalibrated = default(double), List<ReligionStatOut> religionStats = default(List<ReligionStatOut>), List<ReligionStatOut> religionStatsAlt = default(List<ReligionStatOut>))
        {
            this.Script = script;
            this.Id = id;
